...
//       }
//     } else {
//       // No next row — add a new empty row (same logic as context-menu addRow)
...
//       // Rebuild the product select in column 2 as a clean empty element
//       var secondCell = newRow.cells[1];
//       if (secondCell) {
//         var originalSelect = sourceRow.cells[1].querySelector('select');
//         var selectName = originalSelect ? originalSelect.name : 'part_number[]';
//         secondCell.innerHTML = '';
//         var newSelect = document.createElement('select');
//         newSelect.className = 'form-control noborder';
//         newSelect.name = selectName;
//         secondCell.appendChild(newSelect);
//       }

//       // Append and recalculate serial numbers
...
//       // Focus first navigable field of the new row
//       var $newRow = $(newRow);
