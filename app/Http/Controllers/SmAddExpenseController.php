...
class SmAddExpenseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            $add_expense->expense_sub_head_id = $request->sub_head;
            ...
            $add_expense->cost_center_id = $request->cost_center;
    ...
    public function show(Request $request,$id)
    {
        ...
        try{
            ...
            return view('backEnd.accounts.add_expense', compact('add_expenses', 'add_expense', 'expense_heads', 'bank_accounts', 'payment_methods', 'cost_centers', 'sub_heads', 'total_balance'));
        }catch (\Exception $e) {
           Toastr::error('Operation Failed', 'Failed');
           return redirect()->back(); 
        }
