...
class SysCrmServiceController extends Controller
{
    ...
    public function service(Request $request)
    {
        try {
            if($request->part_number != null){
                ...
                $partnumber = implode(",",$part_number);
            }else{$partnumber = "";}
    ...
    public function servicelist(Request $request)
    {
        try {
            ...
            $support_person = SmStaff::select('user_id','full_name')->where('active_status', 1)->wherein('user_id',$support_array)->orderby('full_name','asc')->get();
            
            return view('backEnd.crm.DealServiceList', compact('service','support_person'));
