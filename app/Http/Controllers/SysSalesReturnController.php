                ...
                for ($i = 0; $i < count($request->adj_paid); $i++) {
                    if ($request->adj_paid[$i] != "" && $request->adj_paid[$i] != 0) {
                        $data = [
                            ...
                            'balance_amount' => str_replace(',', '', $request->adj_balance[$i]) - str_replace(',', '', $request->adj_paid[$i]),
                ...
                for ($i = 0; $i < count($request->adj_paid); $i++) {
                    if ($adj_paid[$i] != "" && $adj_paid[$i] != 0) {
                        $data = [
                            ...
                            'balance_amount' => $adj_balance[$i] - $adj_paid[$i],
                ...
                for ($i = 0; $i < count($request->adj_paid); $i++) {
                    if ($request->adj_paid[$i] != "" && $request->adj_paid[$i] != 0) {
                        $data = [
                            ...
                            'balance_amount' => $request->adj_balance[$i],
                            'status' => 1,
                            'created_by' => Auth::user()->id,
                        ];
