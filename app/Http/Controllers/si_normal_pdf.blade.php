...
<head>
  ...
  <style>
    ...
    header { position: fixed; left: 20px; top: -80px; right: 20px; height: 80px; background-color: white; text-align: center; border-bottom:solid 0px #808080; color:#555555;  }
    
    footer { position: fixed; left: 0px; bottom: 0px; right: 0px; height: 110px; background-color: white;  background-image: url('{!! asset("public/backEnd/img/".$company->pdf_watermark."") !!}');}
...
<body>
  ...
  <main class="m2" style="margin-top: 20px;">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="55%" valign="top" style="line-height: 18px; padding-left: 20px;">Bill To,<br />
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr><td>
                {{ $si->currency_name->code }}  <?php echo ucwords(getIndianCurrency(@App\SysHelper::com_curr_format($total_amount-$deal_discount_amount, 2, '.', ''),$si->currency_name->r_code,$si->currency_name->p_code));?>
              </td>
              </tr>
            </table>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
