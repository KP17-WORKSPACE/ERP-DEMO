...
class SysSupplierLedgerController extends Controller
{
    ...
    public function index(Request $request)
    {
        try{
            $account_id="";
            $accounts = SysChartofAccounts::select('id','account_name')->where('subgroup',3)->where('status',1)->orderby('account_name','asc')->get();
            ...
            $data = $data_query->get();
            return view('backEnd.supplier-ledger.supplierledgerlist',compact('data','accounts','account_id'));
