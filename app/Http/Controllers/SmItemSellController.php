...
class SmItemSellController extends Controller
{
    ...
    public function itemSell(Request $request)
    {
        ...
        return view('backEnd.inventory.itemSell', compact('suppliers', 'items', 'paymentMethhods', 'roles', 'users'));
    }
    ...
    public function saveItemSellData(Request $request)
    {
        ...
        if ($results) {
            ...
            return redirect('item-sell-list')->with('message-success', '  Item has been Sold successfully');
        } else {
    ...
    public function editItemSell(Request $request, $id)
    {
        ...
        $paymentMethhods = SmPaymentMethhod::all();
        return view('backEnd.inventory.editItemSell', compact('editData', 'editDataChildren', 'roles', 'users', 'items', 'paymentMethhods', 'sections', 'studentClassSection', 'allStudentsSameClassSection', 'staffsByRole'));
    }
    ...
    public function UpdateItemSellData(Request $request)
    {
        ...
        if ($results) {
            ...
            return redirect('item-sell-list')->with('message-success', 'Item Sold has been updated successfully');
        } else {
            return redirect()->back()->with('message-danger', 'Something went wrong, please try again');
        }
    }
    ...
    public function saveItemSellPayment(Request $request)
    {
        ...
        if ($result) {
            return redirect()->back()->with('message-success', ' Payment has been Added successfully');
        } else {
            return redirect()->back()->with('message-danger', 'Something went wrong, please try again');
        }
    }
    ...
    public function itemIssueList(Request $request)
    {
        ...
        return view('backEnd.inventory.issueItemList', compact('issuedItems', 'roles', 'itemCat'));
    }
    ...
    public function saveItemIssueData(Request $request)
    {
        ...
        if (!empty($request->staff_id)) {
            ...
            return redirect()->back()->with('message-danger', 'Please Select a Staff Name for Issue Item.');
        }
        ...
        if ($results) {
            ...
            return redirect()->back()->with('message-success', 'New Item has been issued successfully');
        } else {
            if (ApiBaseMethod::checkUrl($request->fullUrl())) {
    ...
    public function returnItem(Request $request, $id)
    {
        ...
        if ($result) {
            ...
            return redirect()->back()->with('message-success', 'Item has been returned successfully');
        } else {
            if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                return ApiBaseMethod::sendError('Something went wrong, please try again.');
            }
    ...
    public function cancelItemSell($id)
    {
        ...
        if ($results) {
            ...
            return redirect()->back()->with('message-success', 'Sell Item  has been cancelled successfully');
        } else {
            return redirect()->back()->with('message-danger', 'Something went wrong, please try again');
        }
    }
