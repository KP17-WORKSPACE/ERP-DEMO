                ...
                <div class="col-lg-3 mb-2">
                    <div class="input-effect">
                        ...
                        <input
                            ...
                            value="{{ isset($openingstock) ? (!empty(@$openingstock->doc_number) ? @$openingstock->doc_number : old('doc_number')) : 'OPS-'.@App\SysHelper::get_new_maxid('sys_item_opening_stock', 'id')  }}" readonly>
...
$('#qty_total').text(t1);
$('#unitprice_total').text(t2.toFixed(2));
$('#value_total').text(t3.toFixed(2));
}
