            ...
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @else
                        @if(in_array(158, @$module_links) ||  Auth::user()->role_id == 1)
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'item-store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                        @endif
                        @endif
                        <div class="white-box">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 mb-20">
                                        <div class="input-effect">
                                            ...
                                            type="text" name="store_name" autocomplete="off" value="{{isset($editData)? @$editData->store_name : '' }}" placeholder="Store Name">
                                     ...
                                     <div class="col-lg-12 mb-20">
                                        <div class="input-effect">
                                            ...
                                            type="number" name="store_no" autocomplete="off" value="{{isset($editData)? @$editData->store_no : '' }}" placeholder="Number">
                                     ...
                                     <div class="col-lg-12 mb-20">
                                <div class="input-effect">
                                    <textarea class="primary-input form-control" cols="0" rows="4" name="description" placeholder="description" id="description">{{isset($editData) ? @$editData->description : ''}}</textarea>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        @if(in_array(159, @$module_links) ||  Auth::user()->role_id == 1)
                                        <a class="dropdown-item" href="{{url('item-store/'.@$value->id.'/edit')}}">@lang('lang.edit')</a>
                                        @endif
                                        @if(in_array(160, $module_links) ||  Auth::user()->role_id == 1)
