...
class SysCrmDealTrack extends Model
{
    protected $table = 'sys_crm_deal_track';
    ...
    public function receivablesApproval(){
        return $this->belongsTo('App\SysCrmDealTrackApprovalReceivables', 'deal_id', 'deal_id');

    }

    public function purcheaseApproval()
    {
        return $this->belongsTo('App\SysCrmDealTrackApprovalPurchease', 'deal_id', 'deal_id');
    }
    ...
    public function invoiceApproval()
    {
     ...
     public function deliveryApproval()
    {
        return $this->belongsTo('App\SysCrmDealTrackApprovalDelivery', 'deal_id', 'deal_id');
    }
}