...
class SysPurchaseReturnItemsSrlnoCart extends Model
{
    protected $table = 'sys_purchase_return_items_srlno_cart';
    protected $primaryKey = 'id';

    protected $fillable = [
        'id','session_id','prt_id','piv_id','part_no','part_number','srl_no','status'
    ];
