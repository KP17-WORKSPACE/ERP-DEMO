...
// deal track approval access end
    ...
    public static function lead_type_new($id){
         if($id==1){
            return '<span style="font-size:12px;padding:0.25em 0.4em;background-color:#d4edda">Reseller</span>';}
        else if($id==2){
            return '<span style="font-size:12px;padding:0.25em 0.4em;background-color:#d4edda">Enduser</span>';}
        else if($id==3){
            return '<span style="font-size:12px;padding:0.25em 0.4em;background-color:#d4edda">E-Commerce</span>';}
        else if($id==4){
            return '<span style="font-size:12px;padding:0.25em 0.4em;background-color:#d4edda">Project</span>';}
        else{
            return '';}
    }
                    ...
                    if($total[0] != "0.00" || $total[1] != "0.00"){
                        if($dt->group == 1 || $dt->group == 3){ // 1 Assets, 3 Expenses
                            if($dt->id == $purchase_return_account_id){
                                $sum=$total[0] + $total[1];
                                $retData .= "<tr class='collapse' id='collapse_sub_".$gid."'><td class='border pl-4 text-primary'>".$dt->account_name."</td><td class='pr-2 border text-right text-primary'>0.00</td><td class='pr-2 border text-right text-primary'>".SysHelper::minus_format(SysHelper::com_curr_format($total[1], 2, '.', ','))."</td><td class='pr-2 border text-right text-primary'>0.00</td><td class='pr-2 border text-right text-primary'>".SysHelper::minus_format(SysHelper::com_curr_format($total[0], 2, '.', ','))."</td><td class='pr-2 border text-right text-primary'>0.00</td><td class='pr-2 border text-right text-primary'>".SysHelper::minus_format(SysHelper::com_curr_format($sum, 2, '.', ','))."</td></tr>";
                            } else {                                
                                $sum=$total[0] + $total[1];
                                $t=0; $c=0; $s=0;
                                if($dt->group==1){
                            ...
                            $retData .= "<tr class='collapse' id='collapse_sub_".$gid."'><td class='border pl-4 text-primary'>".$dt->account_name."</td><td class='pr-2 border text-right text-primary'>".$t."</td><td class='pr-2 border text-right text-primary'>0.00</td><td class='pr-2 border text-right text-primary'>".$c."</td><td class='pr-2 border text-right text-primary'>0.00</td><td class='pr-2 border text-right text-primary'>".$s."</td><td class='pr-2 border text-right text-primary'>0.00</td></tr>";
                            }
                        }
