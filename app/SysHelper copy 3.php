...
//receivable outatsnding start
    public static function get_list_of_unadjusted($account_ids,$company) //kp
    {
...
/*
    ...
    public static function get_list_of_unadjusted_jv_to_jv($account_ids,$company) //kp
    {
         if($account_ids == null || empty($account_ids)){
    ...
    public static function get_list_of_unadjusted_pdc($account_ids,$company) //kp
    {
    ...
    public static function get_list_of_adjusted_pdc($account_ids,$company) //kp
    {
        try {
       ...
       public static function get_reserved_qty($stock_id,$part_no, $company_id = null)
    {
        try {
            ...
            $reserved_qty = DB::table('sys_reserve_stock as reserve')
                ...
                ->where('reserve.part_number', $part_no)
