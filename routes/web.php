...
use App\Http\Controllers\SmAdvanceloanController;
...
Route::group(['middleware' => ['XSS']], function () {
    ...
    Route::group(['middleware' => ['CheckDashboardMiddleware']], function () {
        ...
        Route::post('department-store-ajax', 'SmHumanDepartmentController@storeDepartmentAjax');
        Route::post('religion-store-ajax', 'SmReligionController@storeReligionAjax');
        ...
        Route::post('designation-store-ajax', 'SmDesignationController@storeDesignationAjax');

        // AJAX: get designations for a department
        Route::get('get-designations-by-department/{department}', 'SmDesignationController@getByDepartment')->name('designations.by_dept');
        // AJAX: get grade for a designation
        Route::get('designation/{id}/grade', 'SmDesignationController@getGrade')->name('designations.get_grade');
        // AJAX: get reporting managers whose grade is less than selected grade
        Route::get('hrms/reporting-managers', 'SmStaffController@getReportingManagersByGrade')->name('hrms.reporting_managers_by_grade');

        // Payment Terms
        Route::resource('payment-terms', 'SysPaymentTermsController');
        
        Route::post('payment-terms-store-ajax', 'SysPaymentTermsController@paymentTermsStoreAjax');
        // Currency Settings
        ...
        // brand import
        Route::get('brand-import', 'SysBrandController@import');
        Route::post('brand-import-list', 'SysBrandController@importList');
        Route::post('brand-import-data', 'SysBrandController@importData');
        Route::get('brand-import-clear', 'SysBrandController@importClear');
        // Modules
        ...
        Route::get('customers-pending/{id?}', 'SysCustomerController@customer_pending');
        ...
        Route::post('customer-update-deal-track', 'SysCustomerController@customerUpdateDealTrack');
        ...
        Route::get('restore-cust-suppl-doc/{id}', 'SysCustomerController@restore_cust_suppl_doc');
        ...
        //adil 
  Route::post('/company/warehouse/save-all', 'SysCompanyController@saveAllWarehouses')->name('company.warehouse.saveAll');


             Route::prefix('staff/resignation')->group(function () {
            // 👉 Show List
            Route::get('/', 'SmStaffController@resignationList')
            ->name('staff.resignation.list');
            // 👉 Show Add Form
            Route::get('/add', 'SmStaffController@createResignation')
            ->name('staff.resignation.add');
            // 👉 Show Edit Form
            Route::get('/edit/{id}', 'SmStaffController@editResignation')
            ->name('staff.resignation.edit');
            // 👉 Store Form Data
            Route::post('/store', 'SmStaffController@storeResignation')
            ->name('staff.resignation.store');
            ...
            Route::prefix('staff/compensation')->group(function () {
            // 👉 Show List
            Route::get('/', 'SmStaffController@compensationList')
            ->name('staff.compensation.list');
            // 👉 Create / Apply Compensation Change
            Route::get('/add', 'SmStaffController@compensationCreate')
            ->name('staff.compensation.create');
            // 👉 Store Compensation Change
            Route::post('/store', 'SmStaffController@compensationStore')
            ->name('staff.compensation.store');
            // 👉 View Details
            Route::get('/{id}', 'SmStaffController@compensationView')
            ->name('staff.compensation.view');
            });

        Route::post('/company/hr-policy/store', 'SysCompanyController@storeHrPolicies')->name('company.policy.store');

        Route::get('/company/hr-payroll-setting/{company_id}', 'SysCompanyController@getHrPayrollSetting')->name('company.hrpayroll.setting.get');

        Route::post('/company/hr-payroll-setting/store', 'SysCompanyController@storeHrPayrollSetting')->name('company.hrpayroll.setting.store');

        // Working shifts - create via AJAX
        Route::post('/company/working-shifts/store', 'SysCompanyController@storeWorkingShift')->name('company.workingshift.store');

        // Weekly offs - create via AJAX (uses session company_id)
        Route::post('/company/weekly-offs/store', 'SysCompanyController@storeWeeklyOff')->name('company.weeklyoff.store');


        Route::get('get-company-shift', 'SysCompanyController@getcompanyShiftandWeekOff')->name('company.getshift');

        Route::get('get-company-pdf-settings/{id?}', 'SysCompanyController@getPdfSettings')->name('company.getpdfsettings');


        // Company People (Owners, Sponsors, Contacts) session endpoints
        Route::post('/company/people/session/store', 'SysCompanyController@storePeopleSession');
        Route::post('/company/people/session/get', 'SysCompanyController@getPeopleSession');
        Route::post('/company/people/session/delete', 'SysCompanyController@deletePeopleSession');
        Route::post('/company/people/check-email', 'SysCompanyController@checkPeopleEmailAvailability')->name('company.people.checkEmail');
        Route::post('/company/check-code', 'SysCompanyController@checkCompanyCodeAvailability')->name('company.checkCode');
        Route::post('/company/people/save-all', 'SysCompanyController@saveAllPeople')->name('company.people.saveAll');

        Route::post('/company/compliance/session/store', 'SysCompanyController@storeComplianceDocumentSession');
        Route::post('/company/compliance/session/get', 'SysCompanyController@getComplianceDocumentSession');
        Route::post('/company/compliance/session/delete', 'SysCompanyController@deleteComplianceDocumentSession');
        Route::post('/company/compliance/save-all', 'SysCompanyController@saveAllComplianceDocuments')->name('company.compliance.saveAll');

        Route::get('add-supplier', 'SysSupplierController@addSupplier');
        Route::get('add-supplier-customer/{supplier_id}', 'SysSupplierController@addSupplierToCustomer');
        ...
        Route::get('customer-from-list/{id?}', 'SysCustomerController@customer_from_list');
        Route::get('customer-from-list-view/{id}', 'SysCustomerController@getCustomerFormDetails');
        ...
        Route::get('download-timeline-doc/{file_name}', function ($file_name = null) {
            ...
            Route::get('/company/{company_id}/documents', 'SysCompanyController@getDocuments')->name('company.documents.get');


        // staff directory
Route::post('onboard-employee/{id}/approve', 'SmOnboardEmployeeController@approveOnboardEmployee')->name('onboard-employee.approve');

        Route::get('onboarding-employee-list/{id?}', 'SmOnboardEmployeeController@onboardingEmployeeList');
        Route::get('onboarding-employee-view/{id?}', 'SmOnboardEmployeeController@onboardingEmployeeDetailsView');

        // Onboarding employee edit & update
        Route::get('onboarding-employee-edit/{id}', 'SmOnboardEmployeeController@edit')->name('onboarding-employee.edit');
        Route::post('onboarding-employee-update/{id}', 'SmOnboardEmployeeController@updateOnboardEmployee')->name('onboarding-employee.update');


        Route::get('staff-directory/{id?}', ['as' => 'staff_directory', 'uses' => 'SmStaffController@staffList']);
        ...
        Route::post('/hrms/staff/basic/update', 'SmStaffController@updateBasic')->name('staff.basic.update');
        Route::post('/hrms/staff/job/store', 'SmStaffController@storeJob')->name('staff.job.store');
        
        Route::post('/hrms/staff/education/store', 'SmStaffController@storeEducationSession')->name('staff.education.store');
        ...
        Route::get('staff-details/{id}', 'SmStaffController@details')->name('staff.details');
         Route::post('hrms/staff/attendance-leave/store', 'SmStaffController@attendenceLeave')->name('staff.attendance_leave.store');


          // Education Routes - Session based
        
        Route::post('/hrms/staff/education/delete', 'SmStaffController@deleteEducationSession')->name('staff.education.delete');

        Route::post('/hrms/staff/education/saveAll', 'SmStaffController@saveAllEducations')->name('staff.education.saveAll');
        

        // Experience Routes - Session based
        Route::post('/hrms/staff/experience/store', 'SmStaffController@storeExperienceSession')->name('staff.experience.store');
        Route::post('/hrms/staff/experience/delete', 'SmStaffController@deleteExperienceSession')->name('staff.experience.delete');
       
        Route::post('/hrms/staff/experience/saveAll', 'SmStaffController@saveAllExperiences')->name('staff.experience.saveAll');


        // Bank Routes - Session based
        Route::post('/hrms/staff/bank/store', 'SmStaffController@storeBankSession')->name('staff.bank.store');

        Route::post('/hrms/staff/bank/delete', 'SmStaffController@deleteBankSession')->name('staff.bank.delete');

        Route::post('/hrms/staff/bank/saveAll', 'SmStaffController@saveAllBanks')->name('staff.bank.saveAll');
        ...
        Route::get('get-sales-person-list', 'SmStaffController@getSalesPersonListByAjax');
        ...
        //Company
        // AJAX endpoint for immediate PDF asset uploads
        Route::post('company/upload-pdf-image', 'SysCompanyController@uploadPdfImage')->name('company.uploadPdfImage');
        // Delete a previously uploaded PDF image
        Route::post('company/delete-pdf-image', 'SysCompanyController@deletePdfImage')->name('company.deletePdfImage');
        // Set an uploaded PDF image as primary for the company and type
        Route::post('company/set-primary-pdf-image', 'SysCompanyController@setPrimaryPdfImage')->name('company.setPrimaryPdfImage');
        // Download an uploaded PDF image file
        Route::get('company/download-pdf-image/{id}', 'SysCompanyController@downloadPdfImage')->name('company.downloadPdfImage');
      ...
      Route::post('attendance/punch-in', 'SmStaffAttendanceController@punchIn')->name('attendance.punchIn');
    Route::post('attendance/punch-out', 'SmStaffAttendanceController@punchOut')->name('attendance.punchOut');
     Route::get('attendance/rectify-list', 'SmStaffAttendanceController@rectifyList')->name('attendance.rectifyList');
    Route::post('attendance/approval-action', 'SmStaffAttendanceController@approvalAction')
    ->name('attendance.approvalAction');
    
 Route::post('attendance/approve/{id}', 'SmStaffAttendanceController@approve')->name('attendance.approve');
    Route::post('attendance/reject/{id}', 'SmStaffAttendanceController@reject')->name('attendance.reject');
    Route::get('attendance/rectify-detail/{id}', 'SmStaffAttendanceController@rectifyDetail')
    ->name('attendance.rectifyDetail');
    


        Route::group(['prefix' => 'hrms', 'middleware' => ['auth']], function () {
        Route::get('attendance',        'SmStaffAttendanceController@index')->name('attendance.index');
        Route::get('attendance/{id?}',        'SmStaffAttendanceController@index')->name('attendance.index');
        Route::get('attendance/details/{staff_id}', 'SmStaffAttendanceController@details')->name('attendance.details');
        Route::post('attendance/rectify', 'SmStaffAttendanceController@rectify')->name('attendance.rectify');
        Route::get('attendance/create', 'Hrms\AttendanceCrudController@create')->name('attendance.create');
        Route::get('attendance/{id}/edit', 'Hrms\AttendanceCrudController@edit')->name('attendance.edit');
        Route::get('attendance/{id}/delete', 'Hrms\AttendanceCrudController@destroy')->name('attendance.delete');
        Route::get('todays-attendance', 'SmStaffAttendanceController@todays_attendance');

        // optional quick actions
        Route::get('attendance/{id}/mark-out', 'Hrms\AttendanceCrudController@markOut')->name('attendance.markOut');
    });
    

    Route::get('attendance/connect-and-fetch', 'SmStaffAttendanceSyncController@connectAndFetch')->name('attendance.connectAndFetch');


       Route::post('/toggle-code-setting', 'SysCompanyController@updateCodeSetting')->name('toggle.code.setting');

    Route::get('employee/loan-approvals', 'SmAdvanceloanController@approvalsList')
    ->name('employee.loans.approvals');

        Route::get('employee/loan-approvals/{id}/detail', 'SmAdvanceloanController@showDetail')
    ->name('employee.loans.detail');


    Route::post('employee/loans/approve/{id}', 'SmAdvanceloanController@approve')
...
Route::get('/industry', 'SmIndustryController@index');
    ...
    Route::post('industry-store-ajax', 'SmIndustryController@storeAjax');

    Route::get('/industry-search', 'SmIndustryController@search');

    Route::put('/industry/{id}', 'SmIndustryController@update');
    Route::delete('/industry/{id}', 'SmIndustryController@destroy');



    Route::get('/business-activity', 'SmBusinessActivityController@index');
    Route::post('/business-activity', 'SmBusinessActivityController@store');
    Route::post('business-activity-store-ajax', 'SmBusinessActivityController@storeAjax');

    Route::get('/business-activity-search', 'SmBusinessActivityController@searchBusinessActivity');


    Route::put('/business-activity/{id}', 'SmBusinessActivityController@update');
    Route::delete('/business-activity/{id}', 'SmBusinessActivityController@destroy');

        Route::post('/company/policy/session/store', 'SysCompanyController@storePolicySession');
        Route::post('/company/policy/session/get', 'SysCompanyController@getPolicySession');
        Route::post('/company/policy/session/delete', 'SysCompanyController@deletePolicySession');
        Route::post('/company/policy/save-all', 'SysCompanyController@saveAllPolicies')->name('company.policy.saveAll');

    Route::get('business-entity-type', 'SmBusinessEntityTypeController@index');
    Route::post('business-entity-type', 'SmBusinessEntityTypeController@store');
    Route::post('business-entity-type/update/{id}', 'SmBusinessEntityTypeController@update');
    Route::post('business-entity-type/delete/{id}', 'SmBusinessEntityTypeController@destroy');
    // AJAX store for business entity types used by company add modal
    Route::post('entity-type-store-ajax', 'SmBusinessEntityTypeController@storeAjax');
    Route::get('/get-business-sector/{industry_id}', 'SmBusinessEntityTypeController@getBusinessSector');
    
    Route::get('entity-type-search', 'SmBusinessEntityTypeController@search');
        ...
        Route::get('company-edit/{id}', ['as' => 'company-edit', 'uses' => 'SysCompanyController@companyEdit']);
        ...
        Route::post('set-company-id', 'SysCompanyController@set_company_id');
             ...
             Route::post('company/documents/session/store', 'SysCompanyController@storeDocumentSession');
             // Delete a people document from session
             Route::post('company/documents/session/delete', 'SysCompanyController@deleteDocumentSession');
       

         Route::post('/company/basic/store',       'SysCompanyController@storeBasic')->name('company.basic.store');
         Route::post('/company/basic/update/{id}', 'SysCompanyController@updateBasic')->name('company.basic.update');
        ...
        Route::post('/company/hr-policy/store',   'SysCompanyController@storeHrPolicies')->name('company.policy.store');
        Route::get('/company/hr-policy/list/{company_id}', 'SysCompanyController@getHrPolicies');
        Route::post('/company/docs/store', 'SysCompanyController@storeDocuments')->name('company.docs.store');
        Route::post('/company/setting/store', 'SysCompanyController@storeSetting')
        ->name('company.setting.store');


        Route::post('/company/banking/save-all', 'SysCompanyController@saveAllBanking')
        ->name('company.banking.saveAll');


        Route::get('/company/banking/check-session/{id}', 'SysCompanyController@checkBankingSession');


        Route::post('/company/bank/session/store', 'SysCompanyController@storeBankSession');
     ...
     Route::get('approvals/inbox', 'ApprovalController@index')->name('approvals.inbox');
        ...
        Route::get('/load-account-modal-paginated', 'SysChartofAccountsController@loadAccountModalPaginated');
        ...
        Route::post('chartofaccounts-move', ['as' => 'move', 'uses' => 'SysChartofAccountsController@move']);
        ...
        Route::post('account-move', 'SysChartofAccountsController@accountMove');
        Route::post('sub-account-move', 'SysChartofAccountsController@subAccountMove');
        ...
        Route::post('chartofaccounts-sub-move', ['as' => 'move-sub', 'uses' => 'SysChartofAccountsController@move_sub']);
        ...
        Route::get('chartofaccounts-opening-balance-search', ['as' => 'chartofaccounts-opening-balance-search', 'uses' => 'SysChartofAccountsController@openingBalanceSearch']);
        Route::get('chartofaccounts-opening-balance-details/{id}', ['as' => 'chartofaccounts-opening-balance-details', 'uses' => 'SysChartofAccountsController@openingBalanceDetails']);
        Route::post('chartofaccounts-opening-balance-update', ['as' => 'chartofaccounts-opening-balance-update', 'uses' => 'SysChartofAccountsController@openingBalanceUpdate']);
        ...
        Route::post('chequebook/store', 'ChequeBookController@store');
        Route::post('chequebook/update/{id}', 'ChequeBookController@update');
        Route::post('chequebook/delete/{id}', 'ChequeBookController@destroy');
        Route::post('chequebook/restore/{id}', 'ChequeBookController@restore');
        Route::get('api/chequebook-global-search', ['as' => 'api-chequebook-global-search', 'uses' => 'ChequeBookController@globalSearch']);
        ...
        Route::get('get_state_company', 'SysCountryStateListController@get_state_company');
        ...
        Route::get('get_city', 'SysCountryStateListController@get_city');
        Route::post('add-new-city','SysCountryStateListController@addNewCity')->name('modal.city.store');
        ...
        Route::get('generalledger-search', 'SysGeneralLedgerController@search');
          ...
          Route::get('receivable-outstanding-modal', ['as' => 'receivable-outstanding-modal', 'uses' => 'SysReceivableOutstandingController@indexModal']);
        Route::post('receivable-outstanding-modal', ['as' => 'receivable-outstanding-modal', 'uses' => 'SysReceivableOutstandingController@indexModal']);
        ...
        Route::get('customer-ageing-report', ['as' => 'customer-ageing-report', 'uses' => 'SysReceivableOutstandingController@CustomerAgeingReport']);
        Route::post('customer-ageing-report', ['as' => 'customer-ageing-report', 'uses' => 'SysReceivableOutstandingController@CustomerAgeingReport']);


        Route::get('supplier-ageing-report', ['as' => 'supplier-ageing-report', 'uses' => 'SysPayablesOutstandingController@SupplierAgeingReport']);
        Route::post('supplier-ageing-report', ['as' => 'supplier-ageing-report', 'uses' => 'SysPayablesOutstandingController@SupplierAgeingReport']);
        ...
        */
        ...
        //Receipts
        Route::get('receipt/{id}/attachments', ['as' => 'receipt-attachments', 'uses' => 'SysReceiptController@getReceiptAttachments']);
        Route::post('receipt/attachments/upload', ['as' => 'receipt-attachments-upload', 'uses' => 'SysReceiptController@uploadReceiptAttachments']);
        Route::delete('receipt/attachments/{id}/delete', ['as' => 'receipt-attachments-delete', 'uses' => 'SysReceiptController@deleteReceiptAttachment']);
        Route::get('receipt/attachments/{id}/download', ['as' => 'receipt-attachments-download', 'uses' => 'SysReceiptController@downloadReceiptAttachment']);
        ...
        Route::get('receipt-details-pdf/{id}', 'SysReceiptController@getDetailsPDF');
        ...
        Route::get('stl/{id}', 'SysSTLController@index');
        ...
        Route::get('payment-details-pdf/{id}', 'SysPaymentController@getDetailsPDF');


        Route::post('payment-store', ['as' => 'payment-store', 'uses' => 'SysPaymentController@store']);
        Route::post('payment-store-deal', ['as' => 'payment-store-deal', 'uses' => 'SysPaymentController@storePaymentDeal']);
        ...
        Route::get('api/chequebooks-by-bank/{bankId}', ['as' => 'api-chequebooks-by-bank', 'uses' => 'SysPaymentController@getChequebooksByBank']);
        Route::get('api/chequebook-used-numbers/{chequebookId}', ['as' => 'api-chequebook-used-numbers', 'uses' => 'SysPaymentController@getUsedChequeNumbersByChequebook']);
        Route::get('api/next-available-cheque/{bankId}', ['as' => 'api-next-available-cheque', 'uses' => 'SysPaymentController@getNextAvailableCheque']);
        Route::get('api/find-chequebook/{bankId}/{chequeNumber}', ['as' => 'api-find-chequebook', 'uses' => 'SysPaymentController@getChequebookIdByChequeNumber']);

        // Payment attachment routes
        Route::get('payment/{id}/attachments', ['as' => 'payment-attachments', 'uses' => 'SysPaymentController@getPaymentAttachments']);
        Route::post('payment/attachments/upload', ['as' => 'payment-attachments-upload', 'uses' => 'SysPaymentController@uploadPaymentAttachments']);
        Route::delete('payment/attachments/{id}/delete', ['as' => 'payment-attachments-delete', 'uses' => 'SysPaymentController@deletePaymentAttachment']);
        Route::get('payment/attachments/{id}/download', ['as' => 'payment-attachments-download', 'uses' => 'SysPaymentController@downloadPaymentAttachment']);
        ...
        Route::post('journalvoucher-save-prepaid-accrued', 'SysJournalVoucherController@savePrepaidAccrued');
        ...
        Route::post('update-payment-adjustment-list-jv', 'SysJournalVoucherController@journalvoucher_update_payment_adjestment_jv');
           ...
           //erp clear data
        Route::post('delete-data-by-table', 'SysDataDeleteController@delete_data_by_table');
        ...
        Route::post('delete-table-data', 'SysDataDeleteController@deleteTableData');
        ...
        //kunal
        Route::get('get-url-pi/{id}', 'SysURLController@get_url_purchase_invoice');
        Route::get('get-url-po/{id}', 'SysURLController@get_url_purchase_order');
        ...
        Route::get('get-url-customer-from-chart-of-accounts/{id}', 'SysURLController@get_customer_from_chart_of_accounts');
        ...
        Route::post('update-grn-license-key-cart', 'SysLicenseKeyController@update_grn_license_key_cart');
        ...
        Route::post('update-grn-license-key', 'SysLicenseKeyController@update_grn_license_key');
        ...
        Route::post('update-ops-license-key', 'SysLicenseKeyController@update_ops_license_key');
        Route::post('add-ops-license-key-excel', 'SysLicenseKeyController@add_ops_license_key_excel');

        Route::post('add-stkin-license-key', 'SysLicenseKeyController@add_stkin_license_key');
        Route::post('view-stkin-license-key', 'SysLicenseKeyController@view_stkin_license_key');
        Route::post('delete-stkin-license-key', 'SysLicenseKeyController@delete_stkin_license_key');
        Route::post('update-stkin-license-key', 'SysLicenseKeyController@update_stkin_license_key');
        Route::post('add-stkin-license-key-excel', 'SysLicenseKeyController@add_stkin_license_key_excel');
        ...
        Route::post('stock-out-get-dn-license-key', 'SysLicenseKeyController@stock_out_get_grn_license_key');
        Route::post('stock-out-update-dn-license-key', 'SysLicenseKeyController@stock_out_update_grn_license_key');
        ...
        Route::get('purchase-details-pdf/{id}', 'SysPurchaseOrderController@getDetailsPDF');
        ...
        Route::post('store-payments-from-purchase-order', 'SysPaymentController@storePaymentsFromPurchaseOrder');
        ...
        Route::post('purchase-order-create-gen-pdf', 'SysPurchaseOrderController@create_gen_PDF');
        Route::get('purchase-order-create-all-pdf/{deal_id}', 'SysPurchaseOrderController@create_all_PDF');
        ...
        Route::get('purchase-invoice-search', 'SysPurchaseInvoiceController@search')->name('purchase-invoice.search');
        //purchase-invoice
        Route::get('purchase-invoice/{id?}', 'SysPurchaseInvoiceController@index');
        ...
        Route::post('purchase-invoice-get-cfc-by-grn', 'SysPurchaseInvoiceController@getChargesByGrn');
        ...
        Route::get('purchase-return/{id}/download', 'SysPurchaseReturnController@download');
        ...
        Route::get('check-deal-code', 'SmItemStoreController@getDealIdByCode');
        ...
        Route::get('sales-invoice-pdf/{id}', 'SysSalesInvoiceNewController@getDetailsPDF');
        ...
        Route::get('sales-invoice-deal-track-create', 'SysSalesInvoiceNewController@create2');
        ...
        Route::get('sales-invoice-report-detail', ['as' => 'sales.invoice.report.detail', 'uses' => 'SysSalesInvoiceReportDetailController@index']);
        Route::post('sales-invoice-report-detail', 'SysSalesInvoiceReportDetailController@index');
        Route::get('sales-invoice-report-detail/{report_type}', ['as' => 'sales.invoice.report.detail.type', 'uses' => 'SysSalesInvoiceReportDetailController@index']);
        Route::get('sales-return-report-detail', ['as' => 'sales.return.report.detail', 'uses' => 'SysSalesReturnReportDetailController@index']);
        Route::post('sales-return-report-detail', 'SysSalesReturnReportDetailController@index');
        ...
        //delivery note
        Route::get('delivery-note/{id?}', ['as' => 'delivery-note', 'uses' => 'SysDeliveryNoteController@deliverynoteList']);
        ...
        Route::get('delivery-note-pdf/{id}', 'SysDeliveryNoteController@getDetailsPDF');
        ...
        Route::get(
            'delivery-note-add/{deal_id}', 
            'SysDeliveryNoteController@deliverynoteAdd2'
        )->name('deliverynote.add');
        ...
        Route::post('delivery-note-get-cfc-by-si', 'SysDeliveryNoteController@getChargesBySalesInvoice');
        ...
        Route::get('crm-deals-customer-addresses/{custId}', 'SysCrmLeadsController@getCustomerAddresses');
        ...
        Route::get('crm-deals-add', function () {
    return redirect('crm-deals/show?deal_action=add');
});

        Route::get('crm-deals-comments-restore/{id}', 'SysCrmDealsController@crmdealscommentsrestore');
        Route::get('crm-deals-create-quote/{id}', 'SysCrmDealsController@createquote');
        Route::get('crm-quote-create-quote/{id}', 'SysQuotationController@createquote');
        ...
        Route::post('crm-deal-track-recall', 'SysCrmDealsController@recallDealTrack');
        ...
        Route::post('crm-deal-track-approval-grn', 'SysCrmDealTrackController@crmdealtrackGRN');
...
Route::get('crm-reimbursement-request', 'SysCrmReimbursementRequest@index');
 ...
 Route::post('outstanding_comment_delete', 'SysReceivableOutstandingController@outstanding_comment_delete');
        ...
        Route::post('outstanding_comment_delete_payable', 'SysPayablesOutstandingController@outstanding_comment_delete_payable');
        ...
        Route::post('crm-deal-track-approval-purchase-required', 'SysCrmDealTrackController@crm_deal_track_approval_purchase_required');
        ...
        Route::post('crm-quote-update/{id}', 'SysQuotationController@updateQuote');
        ...
        Route::get('crm-quote-pdf/{id}', 'SysCrmQuoteController@get_deal_pdf_data');
        ...
        Route::post('quotation-store', 'SysQuotationController@storeQuote');
        ...
        Route::get('category-import', 'SmItemCategoryController@import');
        Route::post('category-import-list', 'SmItemCategoryController@importList');
        Route::post('category-import-data', 'SmItemCategoryController@importData');
        Route::get('category-import-clear', 'SmItemCategoryController@importClear');
        ...
        Route::get('item-store-import-clear', 'SmItemStoreController@item_store_import_clear');
            ...
            Route::get('item-store-import-delete/{id}', 'SmItemStoreController@item_store_import_delete');
         Route::post('packing-list-cart-excel-add', 'SysPackingListController@cart_add_excel');
        ...
        Route::post('inventory-brand-wise-report', 'SysStockLedgerController@inventory_report_brand_wise');
        Route::get('inventory-category-wise-report', 'SysStockLedgerController@inventory_report_category_wise');
        Route::post('inventory-category-wise-report', 'SysStockLedgerController@inventory_report_category_wise');
        Route::get('inventory-subcategory-wise-report', 'SysStockLedgerController@inventory_report_subcategory_wise');
        Route::post('inventory-subcategory-wise-report', 'SysStockLedgerController@inventory_report_subcategory_wise');
        Route::get('inventory-company-wise-report', 'SysStockLedgerController@inventory_report_company_wise');
        Route::post('inventory-company-wise-report', 'SysStockLedgerController@inventory_report_company_wise');
        Route::get('inventory-salesperson-wise-report', 'SysStockLedgerController@inventory_report_salesperson_wise');
        Route::post('inventory-salesperson-wise-report', 'SysStockLedgerController@inventory_report_salesperson_wise');
        Route::get('inventory-customer-wise-report', 'SysStockLedgerController@inventory_report_customer_wise');
        Route::post('inventory-customer-wise-report', 'SysStockLedgerController@inventory_report_customer_wise');
        Route::get('inventory-brand-report-detail/{partno}', 'SysStockLedgerController@inventory_report_brand_detail')->name('inventory-brand-report-detail');
        

        Route::get('stock-register-test', 'SmItemStoreController@stockregister_test');

        Route::post('store-reserve-qty', 'SmItemStoreController@storeReserveStock');
        Route::post('reserve-qty-deal', 'SysCrmDealsController@storeReserveStock');
        Route::get('get-reserved-qty', 'SmItemStoreController@getReservedQty');
        Route::get('get-reserved-stock-list', 'SmItemStoreController@getReservedStockList');
        Route::delete('delete-reserved-stock', 'SmItemStoreController@deleteReservedStock');
        Route::get('get-reserved-stock-detail', 'SmItemStoreController@getReservedStockDetail');
        Route::put('update-reserved-stock', 'SmItemStoreController@updateReservedStock');
        ...
        Route::get('customer-search', 'SysCustomerController@customerSearch')->name('customer-crm.search');
        Route::post('customer-search', 'SysCustomerController@customerSearchData');
        ...
        Route::get('book-close', 'SysBookCloseController@index');
       
        
        Route::get('book-close/{id}', 'SysBookCloseController@view');
        Route::get('book-close-edit/{id}', 'SysBookCloseController@edit');
        Route::post('book-close-data-update', 'SysBookCloseController@update');
        Route::post('book-close-data-update-all', 'SysBookCloseController@update_all');
        Route::delete('book-close-delete/{id}', 'SysBookCloseController@delete');

        Route::get('edit-denied', 'SysBookCloseController@edit_denied');
        
        Route::get('book-close-doc-number', 'SysBookCloseController@doc_index');
        Route::get('book-close-doc-edit/{id}', 'SysBookCloseController@doc_edit');
        Route::post('book-close-doc-update', 'SysBookCloseController@doc_update');
        Route::delete('book-close-doc-delete/{id}', 'SysBookCloseController@doc_delete');
...
Route::get('/notifications/pending', 'NotificationController@pending');
Route::post('/notifications/dismiss', 'NotificationController@dismiss');


Route::get('onboard-employee/{id}', 'SmOnboardEmployeeController@onboardEmployee');  
Route::post('save-onboarding-employee', 'SmOnboardEmployeeController@saveOnboardEmployee');
Route::get('onboarding-employee/thank-you', 'SmOnboardEmployeeController@thankYou')->name('onboarding.thank-you');
Route::get('get_state_employee', 'SysCountryStateListController@get_state');


Route::get('update-grade', 'SmDesignationController@updateGrade');  
