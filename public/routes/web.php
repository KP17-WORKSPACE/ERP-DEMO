...
Route::group(['middleware' => ['XSS']], function () {
    ...
    Route::group(['middleware' => ['CheckDashboardMiddleware']], function () {
        ...
        */
        ...
        //Receipts
        Route::get('receipt', ['as' => 'receipt', 'uses' => 'SysReceiptController@receiptList']);
        ...
        //Payments
        Route::get('payment', ['as' => 'payment', 'uses' => 'SysPaymentController@paymentList']);
        ...
        Route::get('goods-receipt-note-list', 'SysGRNController@view');
        ...
        //purchase-return
        Route::get('purchase-return', ['as' => 'purchase-return', 'uses' => 'SysPurchaseReturnController@purchasereturnList']);
        ...
        //sales-return
        Route::get('sales-return', ['as' => 'sales-return', 'uses' => 'SysSalesReturnController@salesreturnList']);
        ...
        Route::get('crm-deals/show', 'SysCrmDealsController@show');
 ...
 Route::get('crm-deals-create-quote/{id}', 'SysCrmDealsController@createquote');
        ...
        Route::get('crm-deals-quote/{id}/', 'SysCrmDealsController@createquote')->name('crm.deals.quote');;
        ...
        Route::get('crm-engineer-tracking', 'SysCrmEngineerTrackingController@index');
...
//crm-amc-service-list-req
        ...
        Route::get('crm-user-tasks/assigned-by-me/{status?}', 'SysCrmUserTaskController@assignedByMe');
        ...
        Route::get('customer-search', 'SysCustomerController@customer_search');
        Route::post('customer-search', 'SysCustomerController@customer_search');
