(function($) {
    ...
    $(document).ready(function() {
        ...
        $("#category_name").on('change', function() {
            ...
            $.ajax({
                ...
                data: formData,
                dataType: 'json',
                url: url + '/' + 'ajaxSubCategory',
                success: function(data) {
                    console.log(data);
                    var a = '';
                    $.each(data, function(i, item) {
                        if (item.length) {
                            $('#sectionSelectSubcategory').find('option').not(':first').remove();
                            $('#sectionSubcategoryDiv ul').find('li').not(':first').remove();

                            $.each(item, function(i, subCategory) {
                                $('#sectionSelectSubcategory').append($('<option>', {
                                    value: subCategory.id,
                                    text: subCategory.sub_category_name
                                }));

                                $("#sectionSubcategoryDiv ul").append("<li data-value='" + subCategory.id + "' class='option'>" + subCategory.sub_category_name + "</li>");
                            });
                        } else {
                            $('#sectionSubcategoryDiv .current').html('SECTION *');
                            $('#sectionSelectSubcategory').find('option').not(':first').remove();
                            $('#sectionSubcategoryDiv ul').find('li').not(':first').remove();
                        }
                    });
    ...
    $(document).ready(function() {
        $(".relationButton").on('click', function() {
            if ($(this).val() == "D") {
                ...
                $("#received-by").removeClass("hide");
                $("#received-by").addClass("show");
                ...
                $("#received-by").removeClass("show");
                $("#received-by").addClass("hide");
    ...
    $(document).ready(function() {
        ...
        $("#select_class_student_promote").on('change', function() {
            var url = $('#url').val();
    ...
    $(document).ready(function() {
        ...
        if ($('form#add-income-update select#payment_method').val() == "3") {
            $('form#add-income-update div#bankAccount').show(1000);
        } else {
            $('form#add-income-update div#bankAccount').hide(1000);
        }
    ...
    $(document).ready(function() {
        $("form#add-expense select#payment_method").on('change', function() {
            if ($(this).val() == "3") {
                $('form#add-expense div#bankAccount').show(1000);
            } else {
                $('form#add-expense div#bankAccount').hide(1000);
            }
        });
    });
    ...
    $(document).ready(function() {
        ...
        if ($('form#add-expense-update select#payment_method').val() == "3") {
            $('form#add-expense-update div#bankAccount').show(1000);
        } else {
            $('form#add-expense-update div#bankAccount').hide(1000);
        }
    ...
    $(document).on("keyup mouseup", "form#add-expense #amount", function(event) {
        ...
        $.ajax({
            ...
            data: formData,
            dataType: 'json',
            url: url + '/' + 'ajax-get-bank-balance',
            success: function(data) {

                if (parseInt($(this).val()) > data) {
                    alert("Amount can't bigger than account balance");
                    $(this).val($.trim($(this).val()).slice(0, -1));
                }
    ...
    $(document).on("keyup mouseup", "form#add-expense-update #amount", function(event) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                var balance = data + parseInt($('#edit_amount').val());
                if (parseInt($(this).val()) > balance) {
                    alert("Amount can't bigger than investment balance");
                    $(this).val($.trim($(this).val()).slice(0, -1));
                }
    ...
    $(document).ready(function() {
        $("#item_category_id_dev").on('change', function() {
            var url = $('#url').val();
            var formData = {
                id: $(this).val()
            };
    ...
    $("form#item-receive-form").on("submit", function() {
        ...
        $('form#item-receive-form select[name^="products"]').each(function() {
            if ($(this).val() == "") {
                i++;
                forFalse2++;
                forAll++;
        ...
        if (i > 0) {
            $('#itemError').html('The product fields are required');
        } else {
            $('#itemError').html('');
        }

        if (q > 0) {
            $('#quantityError').html('The product quantity fields are required');
        } else {
            $('#quantityError').html('');
        }
    ...
    $('#printCreditVoucher').on('click', function() {
    ...
    $("form#tender-create-form").on("submit", function() {
        var errors = [];

        if ($('#work_order_mode').val() == "equipment") {

            if ($('#work_order_mode').val() == "") {
                errors.push("Work Order Mode is ");
            }


            if ($('#tender_no').val() == "") {
                errors.push("Tender no is ");
            }

            if ($('#work_order_no').val() == "") {
                errors.push("Work order no is ");
            }

            if ($('#letter_no').val() == "") {
                errors.push("Letter no is ");
            }

            if ($('#customer').val() == "") {
                errors.push("Customer is ");
            }



            if ($('#Ebid_amount').val() == "") {
                errors.push("Bid amount is ");
            }


            var p = 0;

            $('form#tender-create-form select[name^="Eproducts"]').each(function() {
                if ($(this).val() == "") {
                    p++;
                    if (p == 1) {
                        errors.push("Products are");
                    }
            ...
            var u = 0;
            $('form#tender-create-form input[name^="Eunit_price"]').each(function() {
                if ($(this).val() == "" || $(this).val() == 0) {
                    u++;
                    if (u == 1) {
                        errors.push("Unit prices are");
                    }
                }
            });

            var q = 0;
            $('form#tender-create-form input[name^="Equantity"]').each(function() {
                if ($(this).val() == "" || $(this).val() == 0) {
                    q++;
                    if (q == 1) {
                        errors.push("Quantities are");
                    }
                }
            });
            ...
            $('form#tender-create-form select[name^="products"]').each(function() {
                if ($(this).val() == "") {
                    p++;
                    if (p == 1) {
                        errors.push("Products are");
            ...
            var u = 0;
            $('form#tender-create-form input[name^="unit_price"]').each(function() {
                if ($(this).val() == "" || $(this).val() == 0) {
                    u++;
                    if (u == 1) {
                        errors.push("Unit prices are");
            ...
            var q = 0;
            $('form#tender-create-form input[name^="quantity"]').each(function() {
                if ($(this).val() == "" || $(this).val() == 0) {
                    q++;
                    if (q == 1) {
                        errors.push("Quantities are");
        ...
        $.each(errors, function(key, value) {
            ...
            errorMessage += value + ' required' + '<br>';
        });
    ...
    $("#expense-head").on('change', function() {
        ...
        $.ajax({
            ...
            data: formData,
            dataType: 'json',
            url: url + '/' + 'get-sub-head',
            success: function(data) {
                console.log(data);

                $.each(data, function(i, item) {
                    if (item.length) {
                        $('#sub-head').find('option').not(':first').remove();
                        $('#sub-head-div ul').find('li').not(':first').remove();

                        $.each(item, function(i, subAccount) {
                            $('#sub-head').append($('<option>', {
                                value: subAccount.id,
                                text: subAccount.sub_head
                            }));

                            $("#sub-head-div ul").append("<li data-value='" + subAccount.id + "' class='option'>" + subAccount.sub_head + "</li>");
                        });
                    } else {
                        $('#sub-head-div .current').html('Sub Head *');
                        $('#sub-head').find('option').not(':first').remove();
                        $('#sub-head-div ul').find('li').not(':first').remove();
                    }
                });
    ...
    $("form#expired-tender-store").on("submit", function() {
        ...
        $(this).find('input[name^="company_name"]').each(function() {
            if ($(this).val() == "") {
                p++;
                if (p == 1) {
                    errors.push("Company fields are");
                }
        ...
        var u = 0;
        $(this).find('input[name^="bid_amount"]').each(function() {
            if ($(this).val() == "" || $(this).val() == 0) {
                u++;
                if (u == 1) {
                    errors.push("Bid amount fields are");
                }
            }
        });
    ...
    $(document).ready(function() {
        $('#payroll-payslip #bank_info').hide(1000);
        $('#payroll-payslip #cheque_info').hide(1000);
        $('#payroll-payslip #cash_info').hide(1000);
    });


    $("form#payroll-payslip #payment_mode").on('change', function() {

        if ($(this).val() == 2) {
            $('#payroll-payslip #bank_info').hide(1000);
            $('#payroll-payslip #cheque_info').show(1000);
            $('#payroll-payslip #cash_info').hide(1000);
        } else if ($(this).val() == 3) {
            $('#payroll-payslip #bank_info').show(1000);
            $('#payroll-payslip #cash_info').hide(1000);
            $('#payroll-payslip #cheque_info').hide(1000);
        } else if ($(this).val() == 1) {
            $('#payroll-payslip #cash_info').show(1000);
            $('#payroll-payslip #bank_info').hide(1000);
            $('#payroll-payslip #cheque_info').hide(1000);
        } else {
            $('#payroll-payslip #cash_info').hide(1000);
    ...
    $("form#payroll-payslip #accounts").on('change', function() {
        if ($(this).val() == "") {
    ...
    $(document).on("keyup mouseup", "form#fund-transfer #amount", function(event) {
        var investment_amount = parseInt($('#investment_amount').val());
        if (parseInt($(this).val()) > investment_amount) {
            alert("Amount can't bigger than account balance");
            $(this).val($.trim($(this).val()).slice(0, -1));
        }
    });
    ...
    (function() {
        $(document).ready(function() {
            $('.switch-input-tender-won').on('change', function() {
                var id = $(this).closest('tr').siblings().find('#id').val();
                var role = $(this).closest('tr').siblings().find('#role').val();
                ...
                $.ajax({
                    ...
                    data: formData,
                    dataType: 'json',
                    url: url + '/' + 'tender-work-order-status',
                    success: function(data) {
