...
function updatePopupGRNTotals() {
    ...
    $(".popupGRN tbody tr").not(".doc-header-row").each(function() {
        ...
        if ($checkbox.length === 0 || $checkbox.is(':checked')) {
            ...
            // Update value cell in the row (show value including VAT)
            $row.find('.value-cell').text(rowTotal.toFixed(2));
            
            // Update hidden inputs for when submitting
    ...
    $('#popup_total_qty').text(totalQty);
    $('#popup_total_price').text(totalPrice.toFixed(2));
    $('#popup_total_discount').text(totalDiscount.toFixed(2));
    $('#popup_total_value').text(grandTotal.toFixed(2));
}
...
$(document).on("click", "#addPoPendingINMAINTable", function () {
    ...
    rows.each(function () {
        ...
        <tr>
            ...
            <td class='jshide'>
                <input class='form-control text-end' type='text' 
                       name='taxableamount[]' value='${fin_taxableamount.toFixed(2)}' readonly/>
            </td>

            <td class='jshide'>
                <input class='form-control text-end' type='text' 
                       name='vatamount[]' value='${fin_vatamount.toFixed(2)}' readonly/>
            </td>

            <td class='jshide'>
                <input class='form-control text-end' type='text'
                       name='totalamount[]' value='${total_amount.toFixed(2)}' readonly/>
            </td>
