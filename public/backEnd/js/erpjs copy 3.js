...
$(document).on("click", "#addCtrlBankBookAdjest", function(event) {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $.each(response, function(key, value) {
                tr += '<tr>\
                        <td><input value="' + value.deal_id + '" class="form-control text-center" type="text" id="bi_deal_id_' + i + '" name="bi_deal_id[]" autocomplete="off" readonly></td>\
                        <td><input value="' + value.doc_number + '" class="form-control text-center row_ctrl" type="text" id="bi_doc_no_' + i + '" name="bi_doc_no[]" autocomplete="off" readonly></td>\
                        <td><input value="' + value.doc_date + '" class="form-control text-center" type="hidden" id="bi_doc_date_' + i + '" name="bi_doc_date[]" autocomplete="off" readonly><input value="' + get_format_date(value.doc_date) + '" class="form-control text-center" type="text" autocomplete="off" readonly></td>\
                        <td><input value="' + value.lpo_number + '" class="form-control text-center" type="text" id="bi_lpo_no_' + i + '" name="bi_lpo_no[]" autocomplete="off" readonly></td>\
                        <td><input value="' + formatAmount(value.total) + '" class="form-control text-end" type="decimal" id="bi_total_' + i + '" name="bi_total[]" autocomplete="off" min="0" readonly></td>\
                        <td><input value="' + formatAmount(value.paid) + '" class="form-control text-end" type="decimal" id="bi_paid_' + i + '" name="bi_paid[]" autocomplete="off" min="0" onchange="BankBookAdjestBalance(' + i + ')" readonly></td>\
                        <td><input value="' + formatAmount(value.balance) + '" class="form-control text-end" type="decimal" id="bi_balance_' + i + '" name="bi_balance[]" autocomplete="off" min="0" readonly></td>\
        ...
        success: function(response) {
            ...
            $.each(response, function(key, value) {
                tr += '<tr>\
                        ...
                        <td><input value="' + formatAmount(value.total) + '" class="form-control" type="decimal" id="bi_total_' + i + '" name="bi_total[]" autocomplete="off" min="0" readonly></td>\
                        <td><input value="' + formatAmount(value.paid) + '" class="form-control" type="decimal" id="bi_paid_' + i + '" name="bi_paid[]" autocomplete="off" min="0" onchange="BankBookAdjestBalance(' + i + ')" readonly></td>\
                        <td><input value="' + formatAmount(value.balance) + '" class="form-control" type="decimal" id="bi_balance_' + i + '" name="bi_balance[]" autocomplete="off" min="0" readonly></td>\
                        <td><input value="'+ formatAmount(value.bi_amount) +'" class="form-control tot_amt" step="any" type="decimal" id="bi_amount_' + i + '" name="bi_amount[]" autocomplete="off" min="0" onclick="get_set_amount(' + i + ')"></td>\
                        <td><input value="" class="form-control" type="text" id="bi_narration_' + i + '" name="bi_narration[]" autocomplete="off"></td>\
                    </tr>';
                outstamount += parseFloat(value.total);
                footer_total += parseFloat(value.total);
        ...
        success: function(response) {
            ...
            $.each(response, function(key, value) {
                tr += '<tr>\
                        ...
                        <td><input value="' + value.doc_date + '" class="form-control text-center" type="hidden" id="bi_doc_date_' + i + '" name="bi_doc_date[]" autocomplete="off" readonly><input value="' + get_format_date(value.doc_date) + '" class="form-control text-center" type="text" autocomplete="off" readonly></td>\
                        <td><input value="' + value.lpo_number + '" class="form-control" type="text" id="bi_lpo_no_' + i + '" name="bi_lpo_no[]" autocomplete="off" readonly></td>\
                        <td><input value="' + value.bill_number + '" class="form-control" type="text" id="bi_bill_number_' + i + '" name="bi_bill_number[]" autocomplete="off" readonly></td>\
                        <td><input value="' + formatAmount(value.total) + '" class="form-control text-end" type="decimal" id="bi_total_' + i + '" name="bi_total[]" autocomplete="off" min="0" readonly></td>\
                        <td><input value="' + formatAmount(value.paid) + '" class="form-control text-end" type="decimal" id="bi_paid_' + i + '" name="bi_paid[]" autocomplete="off" min="0" onchange="BankBookAdjestBalance(' + i + ')" readonly></td>\
                        <td><input value="' + formatAmount(value.balance) + '" class="form-control text-end" type="decimal" id="bi_balance_' + i + '" name="bi_balance[]" autocomplete="off" min="0" readonly></td>\
                        <td><input value="" class="form-control tot_amt text-end" type="decimal" step="any" id="bi_amount_' + i + '" name="bi_amount[]" autocomplete="off" min="0" onclick="get_set_amount(' + i + ')"></td>\
  ...
  $.ajax({ 
    ...
    success: function(data) {
        ...
        console.log("PO_ID", pin.id);
                ...
                if(pin.ref_company_id && !selected_ref_company.includes(pin.ref_company_id)) selected_ref_company.push(pin.ref_company_id);
...
$(document).on("click", "#addGRNPending", function () {
    ...
    let po_id  = $('#hd_pending_po_id').val();
                    ...
                    <tr>
                        ...
                        <td class="text-center no-toggle pe-0">
                            <input type="number" class="form-control border-0 text-center" 
                                ...
                                value="${parseInt(pin.tax)}" onchange="calc_change_new(this)">
                        </td>
                        ...
                        <td class="text-center no-toggle pe-0">
                            <input type="number" class="form-control border-0 text-center" 
                                ...
                                value="${pin.grn_qty}" onchange="calc_change_new(this)">
                        </td>

                        <td class="text-end no-toggle pe-0">
                            <input type="number" step="any" class="form-control border-0 text-end" 
                                name="unitprice[]" id="unitprice_${row}" 
                                value="${Number(pin.unitprice).toFixed(2)}" onchange="calc_change_new(this)">
                        </td>

                        <td class="text-end no-toggle pe-0">
                            <input type="number" step="any" class="form-control border-0 text-end" 
                                name="value[]" id="value_${row}" 
                        ...
                        <td class="text-end no-toggle pe-0">
                            <input type="number" step="any" class="form-control border-0 text-end" 
                                ...
                                value="${Number(pin.discount).toFixed(2)}" onchange="calc_change_new(this)">
                        </td>

                        <td class="text-end no-toggle pe-0">
                            <input type="number" step="any" class="form-control border-0 text-end" 
                                name="fright[]" id="fright_${row}" 
                                value="${Number(pin.fright).toFixed(2)}" onchange="calc_change_new(this)">
                        </td>

                        <td class="text-end no-toggle pe-0">
                            <input type="number" step="any" class="form-control border-0 text-end" 
                                name="customcharges[]" id="customcharges_${row}" 
                                value="${Number(pin.customcharges).toFixed(2)}" onchange="calc_change_new(this)">
                        </td>

                        <td class="text-end no-toggle pe-0">
                            <input type="number" step="any" class="form-control border-0 text-end" readonly
                      ...
                      $('#lpo_number').val(pin.lpo_number);
                        ...
                        console.log("deal id = ", pin.deal_id)
...
$(document).on("click", "#addGRNPendingINMAINTable", function () {
    ...
    $(".popupPI tbody tr").each(function () {
        ...
        let tax            = Number($(this).find("input[name='tax[]']").val()).toFixed(2);
        let qty            = Number($(this).find("input[name='qty[]']").val()).toFixed(2);
        let price          = Number($(this).find("input[name='unitprice[]']").val()).toFixed(2);
        let value          = Number($(this).find("input[name='value[]']").val()).toFixed(2);
        let discount       = Number($(this).find("input[name='discount[]']").val()).toFixed(2);
        let fright         = Number($(this).find("input[name='fright[]']").val()).toFixed(2);
        let customcharges  = Number($(this).find("input[name='customcharges[]']").val()).toFixed(2);
        let taxable        = Number($(this).find("input[name='taxableamount[]']").val()).toFixed(2);
        let vat            = Number($(this).find("input[name='vatamount[]']").val()).toFixed(2);
        let total          = Number($(this).find("input[name='totalamount[]']").val()).toFixed(2);
        ...
        let tr = `
            <tr>
                ...
                <td><input type="text" class="form-control text-center" 
                    name="sort_id[]" value="${newRowCount}" /></td>
                ...
                <td><input type="number" class="form-control text-center" step="1"
                    name="tax[]" value="${parseInt(tax)}"  onchange="calc_change_new(this)"></td>

                <td><input type="number" class="form-control text-center" step="1"
                    name="qty[]" value="${parseInt(qty)}" onchange="calc_change_new(this)"></td>
                ...
                <td><input type="text" class="form-control text-end"
                    name="value[]" value="${value}" readonly></td>
                ...
                <td><input type="text" class="form-control text-end"
                    name="fright[]" value="${fright}" 
                    onchange="calc_change_new(this)" onblur="formatCurrency(this)"></td>

                <td><input type="text" class="form-control text-end"
                    name="customcharges[]" value="${customcharges}" 
                    onchange="calc_change_new(this)" onblur="formatCurrency(this)"></td>

                <td><input type="text" class="form-control text-end"
                    name="taxableamount[]" value="${taxable}" readonly></td>

                <td><input type="text" class="form-control text-end"
                    name="vatamount[]" value="${vat}" readonly></td>

                <td><input type="text" class="form-control text-end"
                    name="totalamount[]" value="${total}" readonly></td>
                ...
                $.each(itemGroup, function (i, pin) {
                    ...
                    `;
                     ...
                     $('#pi_number').val(pin.doc_number);
                        ...
                        $('#salesman_name').val(pin.salesman_name).trigger('change');
