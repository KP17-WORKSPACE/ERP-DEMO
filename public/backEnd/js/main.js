(function($) {
    ...
    if ($('#dashboard_table_id, .school-table-data').length) {
        $('#dashboard_table_id, .school-table-data').DataTable({
            responsive: true,
            "searching": false,
            "ordering": false,
            paging: false,
    ...
    // $('dataTables_length select').addClass('nc_select');
    ...
    $('.add_competitor').on('click', function() {
        $('.add_competitor_hide').addClass('d-none');
        $('.modal-backdrop.show').addClass('backdrop_parent');
    });

    $('.backdrop_parent').on('click', function() {
        $('.backdrop_parent').hide();
        $('.backdrop_parent').addClass('d-none');
    });

    $('.tender_result_close').on('click', function() {
        $('.add_competitor_hide').removeClass('d-none');
