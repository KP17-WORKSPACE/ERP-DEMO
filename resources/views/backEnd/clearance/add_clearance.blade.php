...
<div class="tab-pane fade show active" id="purchase-order-1" role="tabpanel" aria-labelledby="purchase-order-1-tab">
    ...
    <div class="card mb-3">
        <div class="card-body">
            ...
            <div class="row ">
                {{-- <div class="col-lg-3">
                    <div class="invoice-details-left bg-white p-3 shadow-sm rounded">
                        <div class="business-info text-start">
                         
                            <h4 class="mb-2 fw-bold">Syscom FZE</h4>
                ...
                {{-- <div class="col-2">
                    ...
                    <div class="invoice-details-left bg-white  shadow-sm rounded">
                        <div class="business-info text-start">
                            
                            <h4 class="mb-0 fw-bold">Syscom FZE</h4>
                            <p class="mb-0 text-muted small">
                                RA08FD03<br>
                                Jebel Ali Freezone, PO Box 124402<br>
                                Dubai, UAE
                ...
                <div class="col-2 mb-3">
                    <div class="input-effect">
                        <label class="form-label">@lang('Doc')
                        ...
                        <div class="col">
                            <div class="input-effect">
                                ...
                                <input class="form-control date-picker" id="invoice_date" type="text"
                                    autocomplete="off" name="invoice_date" value="{{ date('d/m/Y') }}">
                ...
                <div class="col-2 mb-3">
                    <div class="input-effect">
                        ...
                        <input class="form-control" type="text" name="invoice_no" autocomplete="off" id="invoice_no"
                            value="@if (isset($invoice_no)) {{ $invoice_no }} @endif" required>
                    </div>
                </div>
                <div class="col-2 mb-3">
                ...
                <div class="col-4 mb-3">
                    <div class="input-effect">
                        <label class="form-label">@lang('Created')
                ...
                <div class="col-4 mb-3">
                    <div class="input-effect">
                        ...
                        @if (isset($customer_address))
                            {{ $customer_address->customername->name }}
                        @endif
                        </input>
                ...
                <div class="col-4 mb-3 ">
                    <div class="input-effect">
                        ...
                        @if (isset($customer_address))
                            {{ $customer_address->delivery_company }}
                        @endif
                        </input>
                        <span class="focus-border textarea"></span>
                    </div>
                ...
                <div class="col-2 mb-3">
                    <div class="input-effect">
                        ...
                        <input type="text" class="form-control" id="boe_no" name="boe_no" required>
                        <span class="focus-border textarea"></span>
                    </div>
                </div>
                <div class="col-2 mb-3">
                    <div class="input-effect">
                        ...
                        <select class="form-control" name="exit_point" id="exit_point">
                            ...
                            <option value="Jebel Ali Free Zone / Dubai Airport Free Zone" selected>Jebel Ali Free Zone
        ...
        <table class="table table-hover form-item-table" id="myTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input onchange="calc_change_new(this)" class="form-control text-center" type="text" name="weight[]" autocomplete="off">
                    </td>
