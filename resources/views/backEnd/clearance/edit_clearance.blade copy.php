                        ...
                        <div class="add-visitor">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 mb-10">
                                            <div class="input-effect">
                                                ...
                                                <input class="form-control"
                                                    type="text" name="doc_no" autocomplete="off" id="doc_no"
                                                    value="{{ $clearance->doc_no }}"
                                                    readonly>
                                        ...
                                        <div class="col-lg-4 mb-2">
                                            <div class="no-gutters input-right-icon">
                                                <div class="col">
                                                    <div class="input-effect">
                                                        <label class="txtlbl">@lang('Invoice') @lang('lang.date')</label>
                                                        <input class="form-control date-picker" id="invoice_date" type="text" autocomplete="off" name="invoice_date" value="{{@App/SysHelper::normalizeTodmY()}}" value="{{ date('Y-m-d', strtotime($clearance->invoice_date)) }}">
                                                        <span class="focus-border"></span>
                                        ...
                                        <div class="col-lg-4 mb-2">
                                            <div class="input-effect">
                                                <label class="txtlbl">Created By</label>
                                                <input class="form-control" type="text" name="createdby" autocomplete="off" id="createdby" value="{{ Auth::user()->full_name }}" readonly>
                                                <span class="focus-border"></span>
                                        ...
                                        <div class="col-lg-4 mb-2">
                                            <div class="input-effect">
                                                <label class="txtlbl">@lang('Invoice') @lang('Number')<span>*</span></label>
                                                <input class="form-control"
                                                    type="text" name="invoice_no" autocomplete="off" id="invoice_no"
                            ...
                            <div class="row mb-10">
                                <div class="col-lg-3">
                                    ...
                                    <textarea type="text" class="form-control" id="bill_to" name="bill_to" required>{{ $clearance->bill_to }}</textarea>
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <textarea type="text" class="form-control" id="ship_to" name="ship_to" required>{{ $clearance->ship_to }}</textarea>
                                        <span class="focus-border textarea"></span>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    ...
                                    <textarea type="text" class="form-control" id="ship_to_address" name="ship_to_address">{{ $clearance->ship_to_address }}</textarea>
                                        <span class="focus-border textarea"></span>
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="input-effect">
                                        ...
                                        <select class="form-control" name="payment_method[]" id="payment_method">
                                            ...
                                            <option value="Credit A/C*" <?php if($clearance->payment_method=='Credit A/C*') { ?> Selected <?php } ?>>Credit A/C*</option>
                                            <option value="Stan. G*" <?php if($clearance->payment_method=='Stan. G*') { ?> Selected <?php } ?>>Stan. G*</option>
                                ...
                                <div class="col-lg-2">
                                    <div class="input-effect">
                                        ...
                                        <select class="form-control" name="customer_bill_type[]" id="customer_bill_type">
                                            ...
                                            <option value="Import for Re-Export" <?php if($clearance->customer_bill_type=='Import for Re-Export') { ?> Selected <?php } ?>>Import for Re-Export</option>
                                            <option value="Temporary Exit" <?php if($clearance->customer_bill_type=='Temporary Exit') { ?> Selected <?php } ?>>Temporary Exit</option>
                                            <option value="Free Zone Internal Transfer"<?php if($clearance->customer_bill_type=='Free Zone Internal Transfer') { ?> Selected <?php } ?>>Free Zone Internal Transfer</option>
                                            <option value="Bill of Entry" <?php if($clearance->customer_bill_type=='Bill of Entry') { ?> Selected <?php } ?>>Bill of Entry</option>
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-3">
                                    ...
                                    <input type="text" class="form-control" id="free_zone_bill_no" name="free_zone_bill_no" required value="{{ $clearance->free_zone_bill_no }}">
                                        <span class="focus-border textarea"></span>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    ...
                                    <input type="text" class="form-control" id="goods_description" name="goods_description" required value="{{ $clearance->goods_description }}">
                                        <span class="focus-border textarea"></span>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    ...
                                    <input type="text" class="form-control" id="boe_no" name="boe_no" value="{{ $clearance->boe_no }}">
                                        <span class="focus-border textarea"></span>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="input-effect">
                                        ...
                                        <select class="form-control" name="exit_point" id="exit_point">
                                            <option value="Jebel Ali Free Zone" <?php if($clearance->exit_point=='Jebel Ali Free Zone') { ?> Selected <?php } ?>></option>
                                            <option value="Jebel Ali Free Zone / Dubai Airport Free Zone" <?php if($clearance->exit_point=='Jebel Ali Free Zone / Dubai Airport Free Zone') { ?> Selected <?php } ?> >Jebel Ali Free Zone / Dubai Airport Free Zone</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <input type="text" class="form-control" id="box_qty" name="box_qty" value="{{ $clearance->box_qty }}">
                                        <span class="focus-border textarea"></span>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    ...
                                    <input type="text" class="form-control" id="cbm" name="cbm" value="{{ $clearance->cbm }}">
                                        <span class="focus-border textarea"></span>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="input-effect">
                                        ...
                                        <select class="form-control" name="destination" id="destination">
                                            <option value="Jebel Ali Free Zone" <?php if($clearance->destination=='Jebel Ali Free Zone') { ?> Selected <?php } ?>>Jebel Ali Free Zone</option>
                                            ...
                                            <option value="Saudi Arabia" <?php if($clearance->destination=='Saudi Arabia') { ?> Selected <?php } ?>>Saudi Arabia</option>
                                            ...
                                            <option value="Dubai Silicon Oasis" <?php if($clearance->destination=='Dubai Silicon Oasis') { ?> Selected <?php } ?>>Dubai Silicon Oasis</option>
                            ...
                            <div class="equipment comon-status row mt-4 d-block">
                                <script>
                                    ...
                                    function add_rows() {
                                        ...
                                        $("#loading_bg").css("display", "block");
                                        var action = "{{ URL::to('add-clearance-items') }}";
                                        $.ajax({
                                            url: action,
                                            type: "POST",
                                            data: {
                                                        ...
                                                        for(var i=0; i<len; i++){
                                                            ...
                                                            getSelectedRows +="<tr>\
                                                                ...
                                                                if(dataResult['data'][i].clearance_id > 45){
                                                                    getSelectedRows +="<td class='text-right'>"+dataResult['data'][i].weight+" <input type='hidden' id='weight_"+dataResult['data'][i].id+"' value='"+dataResult['data'][i].weight+"' /><input type='hidden' id='pro_weight_"+dataResult['data'][i].id+"' value='"+dataResult['data'][i].weight/dataResult['data'][i].qty+"'></td>";
                                                                } else{
                                                                    getSelectedRows +="<td class='text-right'>"+dataResult['data'][i].weight+" <input type='hidden' id='weight_"+dataResult['data'][i].id+"' value='"+dataResult['data'][i].weight+"' /><input type='hidden' id='pro_weight_"+dataResult['data'][i].id+"' value='"+dataResult['data'][i].weight/dataResult['data'][i].qty+"'></td>";
                                    ...
                                    function row_update() {
                                        ...
                                        var action = "{{ URL::to('update-clearance-items') }}";
                                        $.ajax({
                                            url: action,
                                            type: "POST",
                                            data: {
                                    ...
                                    function row_delete(id) {
                                        ...
                                        $("#loading_bg").css("display", "block");
                                        var action = "{{ URL::to('delete-clearance-items') }}";
                                        $.ajax({
                                            url: action,
                                            type: "POST",
                                            data: {
                                ...
                                <table class="table table-bordered table-striped" id="clearance-table" width="100%" cellspacing="0">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input class="form-control" type="number" id="hscode" name="hscode" autocomplete="off" min="0">
                                            </td>
                                            <td>
                                                <input type="hidden" id="pro_weight">
                                                <input class="form-control" type="number" id="weight" name="weight" autocomplete="off" min="0">
                                            </td>
                                            <td>
...
<tr>
    ...
    <td class="text-right">{{ $dt->weight }}<input type="hidden" id="weight_{{ $i }}" value="{{ $dt->weight }}" /><input type="hidden" id="pro_weight_{{ $i }}" value="{{ $dt->weight/$dt->qty }}" /></td>
    @php $total_weight += $dt->weight; @endphp
    @else
    <td class="text-right">{{ $dt->weight }}<input type="hidden" id="weight_{{ $i }}" value="{{ $dt->weight }}" /><input type="hidden" id="pro_weight_{{ $i }}" value="{{ $dt->weight/$dt->qty }}" /></td>
    @php $total_weight += $dt->weight; @endphp
    @endif
        ...
        <a onclick="row_delete({{ $dt->id }})" class="btn-sm btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th></th>
                                            <th></th>
                                            <th class="text-right"><label id="weight_total">{{ $total_weight }}</label></th>
                                            <th class="text-center"><label id="qty_total">{{ $total[0]->qty1 }}</label></th>
                                            <th class="text-right"><label id="price_total">{{ $total[0]->price1 }}</label></th>
                                            <th class="text-right"><label id="totalprice_total">{{ $total[0]->totalprice1 }}</label></th>
                                        </tr>
                                        </tfoot>
                                </table>
...
$('#totalprice_total').text(t4.toFixed(@json(session('logged_session_data.decimal_point'))));
                                ...
                                <div class="equipment comon-status row mt-4 d-block" style="display:none !important;">
                                    <div class="col-lg-12 text-right">
...
<script>
    function add_attachment(){
        ...
        formData.append('doc_id', $('#clearance_id').val());
