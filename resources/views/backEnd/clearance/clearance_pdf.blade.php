    ...
    <td colspan="2"><br /></td>
            ...
            <table width="100%" cellpadding="0" cellspacing="0"  class="dttable">
                <tr>
                    ...
                    <td width="17%" class="subhd">Part No</td>
                    <td width="23%" class="subhd">Description</td>
                    <td width="8%" class="subhd">COO</td>
                    <td width="10%" class="subhd">HS Code</td>
                    <td width="9%" class="subhd">Weight</td>
                    <td width="5%" class="subhd">Qty</td>
                    <td width="11%"  class="text-right subhd">Unit Price</td>
                    <td width="12%"  class="text-right subhd">Amount</td>
                </tr>
            </table>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" class="dttable2">
                    <tr>
                        <td width="5%">{{ $i }}</td>
                        <td width="17%">{{ $val["partno"] }}</td>
                        <td width="23%">{{ $val["description"] }}</td>
                        <td width="8%">{{ $val["coo"] }}</td>
                        <td width="10%">{{ $val["hscode"] }}</td>
                        @if($cl->id > 45)
                        <td width="9%">{{ $val["weight"] }}</td>
                        @else
                        <td width="9%">{{ $val["weight"] }}</td>
                        @endif
                        <td width="5%">{{ $val["qty"] }}</td>
                        <td width="11%" class="text-right">{{ @App\SysHelper::com_curr_format($val["price"], 2, '.', ',') }}</td>
                        <td width="12%" class="text-right">{{ @App\SysHelper::com_curr_format($val["totalprice"], 2, '.', ',') }}</td>
                    </tr>
                </table>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" class="dttable2">
                <tr>
                    ...
                    @if($cl->id > 45)
                    <td width="9%">{{ $total_weight }}</td>
                    @else
                    <td width="9%">{{ $total[0]->weight1 }}</td>
                    @endif
                    <td width="5%">{{ $total[0]->qty1 }}</td>
                    <td width="11%" class="text-right">{{ @App\SysHelper::com_curr_format($total[0]->price1, 2, '.', ',') }}</td>
                    <td width="12%" class="text-right">{{ @App\SysHelper::com_curr_format($total[0]->totalprice1, 2, '.', ',') }}</td>
                </tr>
            </table>
            <br />
            <table width="100%" cellpadding="0" cellspacing="0">
...
<table width="100%" cellpadding="0" cellspacing="0"  class="dttable">
    <tr>
        ...
        <td width="5%" class="subhd">Qty</td>
        <td width="15%"  class="subhd text-right">Amount</td>
    </tr>
</table>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" class="dttable2">
        <tr>
            ...
            @endif
            <td width="5%">{{ $val["qty"] }}</td>
            <td width="15%" class="text-right">{{ @App\SysHelper::com_curr_format($val["totalprice"], 2, '.', ',') }}</td>
        </tr>
    </table>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" class="dttable2">
        ...
        <td width="15%" class="subhd text-right">{{ @App\SysHelper::com_curr_format($total[0]->totalprice1, 2, '.', ',') }}</td>
        </tr>
    </table>
