...
<body>
    ...
    <footer>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td style="border: none; width:30%; line-height: 20px;" align="center" valign="bottom">{{@$dn->createdby->full_name}}<br /><b class="bottom_b" style="font-size: 10px;">Prepared By</b>
          </td>
  ...
  @endif
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="58%" valign="top" style="line-height: 18px; padding-left: 0px;">Bill To,<br />
  ...
  <br />
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="" style="text-align: left; padding-left: -5px;">
      <tr>
