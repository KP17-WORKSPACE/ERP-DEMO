...
<head>
  ...
  <style>
    ...
    body{font-family: Verdana, sans-serif;  text-align: justify; font-size:12px; color:#555555; background-image: url('{!! asset("public/backEnd/img/".$company->pdf_watermark."") !!}');}
    th, td {padding: 5px 5px;}
    .tdd{border:dashed 1px #9e9e9e; border-width:0 0 1px 0;}
    b{font-size:14px;}
    main{margin:0px 0px 0px 0px; text-align: justify;}
    .m1 table { border: 0px solid #9e9e9e;  text-align: justify;}
    .m1 td { border: 1px solid #9e9e9e;  text-align: justify;}
    .tmc ol {padding: 0px; margin: 0px;}
    .bottom_b {font-size:12px; }
    .page-break { page-break-after: always; }
    .m-0{margin: 0px;}
    .p-0{padding: 0px;}
    .item-head-row {border: solid 1px #000000; border-width:1px 1px 1px 1px; text-align:justify;}
    .item-row {border: solid 1px #000000; border-width:0px 1px 1px 1px;  text-align:justify;}
    .first_set{line-height: 20px; padding-bottom: 10px; text-align:justify; }
    .second_set{line-height: 20px; padding-left: 20px; padding-bottom: 10px; text-align:justify;}
    .third_set{line-height: 20px; padding-left: 40px; padding-bottom: 10px; text-align:justify;}
    .forth_set{line-height: 20px; padding-left: 60px; padding-bottom: 10px; text-align:justify;}
...
<body>
  ...
  <main>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><u style="font-weight: bold; font-size: 13px;">Subject: Application for Supplier Payment Under Mudaraba Facility</u><br /></td>
      </tr>
      <tr>
        <td style="line-height: 20px;">
          This letter is a request for transferring the payment against {{ $tax_invoices }} {{ $invoices_no }} to {{ @$stl->vendor_name->account_name }} for {{ @$stl->currency_name->code }} {{ @App\SysHelper::com_curr_format(@$stl->amount_usd,'2','.',',') }} from our Mudaraba Financing facility. We are authorizing to deduct the bank charges related to this transaction from our {{ @$stl->bank_name->bank_name }} account {{ @$stl->bank_name->acc_no }}.<br />
        </td>
      </tr>
        ...
        <td>
          <table width="100%" border="1" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td>{{ @$stl->currency_name->code }} {{ @App\SysHelper::com_curr_format(@$stl->amount_usd,'2','.',',') }} / {{ $tax_invoices }}: {{ $invoices_no }}</td>
            </tr>
            <tr>
      ...
      <tr>
        <td><br /><br /><br /><b style="font-size: 11px;">For, {{ $company->company_name }}</b><br /><br /><br /><br /><br /></td>
      </tr>
      <tr>
        <td><br /><br /><b style="font-size: 11px;">{{ $stl->owner_name }}</b><br /></td>
      </tr>
  </table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td valign="top" style="line-height: 20px; text-align: center;"><br /><b style="font-size: 13px;">SCHEDULE 7<br />REQUEST FOR CAPITAL CONTRIBUTION</b><br /><br /></td>
  </tr>
  <tr>
  ...
  <tr>
    <td valign="top" style="line-height: 20px;"><br />Dear Sirs,<br />
      <b style="font-size: 11px;">Re:	Request For Capital Contribution</b><br />
      ...
      3)		Subject to Clause 6 of the Master Mudaraba Agreement and pursuant to the entry into the Relevant Investment Plan, we request you to make a contribution of {{ @$stl->currency_name->code }} {{ @App\SysHelper::com_curr_format(@$stl->amount_usd,'2','.',',') }} into the Relevant Mudaraba Account {{ @$stl->bank_name->acc_no }}
      </td>
  </tr>
  <tr>
    <td><br /><br /><b style="font-size: 11px;">By:<br /><br />{{ $stl->owner_name }} (as Mudarib)</b><br /></td>
  </tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td valign="top" style="line-height: 20px; text-align: center;"><br /><b style="font-size: 13px;">SCHEDULE 1<br />RELEVANT INVESTMENT PLAN</b><br /><br /></td>
  </tr>
  <tr>
    <td valign="top" style="line-height: 20px;">The Parties to the Agreement agree to the following Relevant Investment Plan:</td>
  </tr>
  <tr>
    <td valign="top" style="line-height: 20px;"><br /><b style="font-size: 13px;">1.	RELEVANT ACTIVITY</b><br /><br />
      ...
      <br /><b style="font-size: 13px;">2.	RELEVANT MUDARABA DETAILS</b><br /><br />
  ...
  <div class="footer2">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="50px" align="left">Document:- 3</td>
            <td width="50px" align="right">P.T.O</td>
        </tr>
    </table>
  </div>
      ...
      <div class="first_set">2.3.	Relevant Mudaraba Capital:			<b style="font-size: 11px;">{{ @$stl->currency_name->code }} {{ @App\SysHelper::com_curr_format(@$stl->amount_usd,'2','.',',') }}</b></div>

      <div class="first_set">2.4.	Relevant Company Contribution:			<b style="font-size: 11px;">AED 0</b></div>

        <div class="first_set">2.5.	Joint Contribution:				<b style="font-size: 11px;">{{ @$stl->currency_name->code }} {{ @App\SysHelper::com_curr_format(@$stl->amount_usd,'2','.',',') }}</b></div>
        ...
        <div class="second_set">2.6.1.	Relevant Mudaraba Capital:	100% </div>
          <div class="second_set">2.6.2.	Relevant Company Contribution:	 0% </div>
            ...
            <div class="first_set">____________________________________________</div>
...
<div class="page-break"></div>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
    <td valign="top" style="line-height: 20px; text-align: center;"><br /><b style="font-size: 13px;">SCHEDULE 1<br />RELEVENT INVESTMENT PLAN</b><br /><br /></td></tr>
          ...
          <tr><td>
            ...
            <div class="first_set">_______________________________________</div>
            <div class="first_set">(Signature)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(Stamp)</div>
            
            <div class="first_set"><b style="font-size: 11px;">{{@$stl->bank_name->bank_name}}</b></div>
            <div class="first_set">Represented by: <b style="font-size: 11px;">{{@$stl->bank_representative}}</b></div>


            <div class="first_set">_______________________________________</div>
            <div class="first_set">(Signature)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(Stamp)</div>
            <div class="first_set"><b style="font-size: 11px;">(as Mudarib)</b></div>
            <div class="first_set">Represented by : <b style="font-size: 11px;">{{@$stl->owner_name}}</b></div>
...
<div class="footer2">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
          <td width="50px" align="left">Document:- 5</td>
          <td width="50px" align="right">P.T.O</td>
      </tr>
  </table>
</div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td valign="top" style="line-height: 20px; text-align: center;"><br /><b style="font-size: 13px;">SCHEDULE 1<br />SUPPLEMENTAL PURCHASE UNDERTAKING</b><br /><br /></td>
  </tr>
  <tr>
    <td>
      ...
      <div class="first_set">2.	SUPPLEMENTAL PURCHASE UNDERTAKING</div>
      <div class="second_set">The Promissor hereby irrevocably undertakes, in relation to the subject Relevant Mudaraba, to purchase the rights, title, interests, benefits and entitlements in and to the Relevant Mudaraba Assets at the Relevant Exercise Price on the occurrence of the Exercise Event and upon the exercise of its right granted hereto to the Promissee.</div>
    </td>
  </tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr><td>
      ...
      <div class="first_set">3.	APPLICABILITY OF PROVISIONS</div>
        <div class="second_set">This Supplemental Purchase Undertaking is supplemental to, and should be read and construed as one document with, the Master Purchase Undertaking.  The provisions of Clauses 3 to 15 (inclusive) of the Master Purchase Undertaking shall apply mutatis mutandis to this Supplemental Purchase Undertaking.</div>
      
        <div class="first_set" style="text-align: center;"><b style="font-size: 11px;">THIS SUPPLEMENTAL PURCHASE UNDERTAKING HAS BEEN EXECUTED AS A DEED</b></div>
      
        
        <div class="first_set"><b style="font-size: 11px;">EXECUTED as a DEED by the authorized</b></div>
        <div class="first_set">Signatory(ies) of <b style="font-size: 11px;">{{ $company->company_name }}</b>  (the "Promissor"): </div>
            <div class="first_set">_______________________________________ Customer sign </div>
            
            <div class="first_set">Name of Signatory : <b style="font-size: 11px;">{{@$stl->owner_name}}</b></div>
...
<div class="footer2">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
          <td width="50px" align="left">Document:- 6</td>
          <td width="50px" align="right">P.T.O</td>
      </tr>
  </table>
</div>
...
@if (count($stl_items) > 0)
  @foreach ($stl_items as $index => $item)
    @if ($inv != $item->pi_inv_no)
      ...
      <!-- New invoice section -->
      <br />
      <div><b style="font-size: 11px;">Invoice {{ $item->pi_inv_no }}</b></div>
      <br />
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td class="item-head-row" style="width: 7%;">Sl.No</td>
          <td class="item-head-row" style="width: 30%;">Item Part Number</td>
          <td class="item-head-row" style="width: 50%;">Description of Goods</td>
          @if ($with_with_out == 1)
          <td class="item-head-row" style="width: 13%; text-align: right;">Amount</td>
          @endif
        </tr>
      </table>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td class="item-row" style="width: 7%;">{{ $index + 1 }}</td> <!-- Show 1-based index -->
