...
<body>
  ...
  <br />
          ...
          <td valign="top" style="line-height: 18px;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="m-0 p-0" align="right">{{@$pi->doc_number}}</td>
                  </tr>
                  <tr>
                    <td class="m-0 p-0" align="right">Date:</td>
                    <td class="m-0 p-0" align="right">{{date('d/m/Y', strtotime(@$pi->pi_date))}}</td>
                  </tr>
                  <tr>
                    <td class="m-0 p-0" align="right">Ref No:</td>
                    <td class="m-0 p-0" align="right">{{@$pi->lpo_number}}</td>
                  </tr>
                  <tr>
                    <td class="m-0 p-0" align="right">Ref Date:</td>
                    <td class="m-0 p-0" align="right">{{date('d/m/Y', strtotime(@$pi->lpo_date))}}</td>
                  </tr>
                  <tr>
                    <td class="m-0 p-0" align="right">Payment Terms:</td>
                    <td class="m-0 p-0" align="right">{{ $pi->paymentterms->title }} {{ $pi->payment_terms2 }}</td>
                  </tr>
            </table>
          </td>
        </tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="55%" valign="top" style="line-height: 18px;">Bill From,<br />
                <b style="font-size: 90%;">{{@$pi->accountname->account_name}}</b><br>
                {{@$contact_name}}<br />
                {{@$address}}<br>
                {{@$address2}}, {{@$city}}<br>
                {{@$state}}, {{@$country}}<br>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td>
              {{ $pi->currency_name->code }}  <?php echo ucwords(@App\SysHelper::convertAmountToWords(@App\SysHelper::com_curr_format($total_amount-$deal_discount_amount, 2, '.', ''),$pi->currency_name->r_code,$pi->currency_name->p_code));?>
            </td>
            <td style="width: 110px; text-align: left; font-weight: bold; border-bottom: solid 1px #2c2b6d;">Sub Total {{ $pi->currency_name->code }}</td>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td></td>
            <td style="width: 110px; text-align: left; font-weight: bold; border-bottom: solid 1px #2c2b6d;">Discount {{ $pi->currency_name->code }}</td>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td></td>
            <td style="width: 110px; text-align: left; font-weight: bold; border-bottom: solid 1px #2c2b6d;">Taxable Amt. {{ $pi->currency_name->code }}</td>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td></td>
            <td style="width: 110px; text-align: left; font-weight: bold; border-bottom: solid 1px #2c2b6d;">VAT Amount {{ $pi->currency_name->code }}</td>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td></td>
            <td style="width: 110px; text-align: left; font-weight: bold; border-bottom: solid 1px #2c2b6d;">Total Amount {{ $pi->currency_name->code }}</td>
