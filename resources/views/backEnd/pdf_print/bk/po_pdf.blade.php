...
<head>
  ...
  <style>
    ...
    footer {  position: fixed; left: 0px; bottom: -5px; right: 0px; height: 110px; vertical-align: bottom; background-color: white;  background-image: url('{!! asset("public/backEnd/img/".$company->pdf_watermark."") !!}'); }
...
<body>
  ...
  <br />
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="50%" valign="top" style="line-height: 17px;">
            <b>To,</b><br>
          ...
          <td style="line-height: 18px;" valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td class="m-0 p-0" align="right">Purchase Order No:</td>
                  <td class="m-0 p-0" align="right">{{@$po->doc_number}}</td>
                </tr>
                <tr>
                  <td class="m-0 p-0" align="right">Purchase Order Date:</td>
                  <td class="m-0 p-0" align="right">{{date('d/m/Y', strtotime(@$po->po_date))}}</td>
                </tr>
                <tr>
                  <td class="m-0 p-0" align="right">Delivery Date:</td>
                ...
                <tr>
                  ...
                  <td class="m-0 p-0" align="right">{{ @$des=App\SysPaymentTerms::getPaymentTermsName($po->payment_terms)}}</td>
                </tr>
            </table>
          </td>
        </tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="62%" valign="top" style="line-height: 18px;">Bill To,<br />
