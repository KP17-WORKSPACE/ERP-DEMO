          ...
          <td>
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="line-height: 18px;" >
              <tr>
                  ...
                  <td style="padding: 0px; margin: 0px;" align="right">{{@$grn->doc_number}}</td>
                </tr>
                <tr>
                  <td style="padding: 0px; margin: 0px;" align="right">Delivery Note Date:</td>
                  <td style="padding: 0px; margin: 0px;" align="right">{{date('d/m/Y', strtotime(@$grn->grn_date))}}</td>
                </tr>
                <tr>
                  <td style="padding: 0px; margin: 0px;" align="right">LPO Number:</td>
                  <td style="padding: 0px; margin: 0px;" align="right">{{@$grn->lpo_number}}</td>
                </tr>
                <tr>
                  <td style="padding: 0px; margin: 0px;" align="right">LPO Date:</td>
                  <td style="padding: 0px; margin: 0px;" align="right">{{date('d/m/Y', strtotime(@$grn->lpo_date))}}</td>
                </tr>
                <tr>
                  <td style="padding: 0px; margin: 0px;" align="right">Payment Terms:</td>
                  <td style="padding: 0px; margin: 0px;" align="right">{{ $grn->paymentterms->title }} {{ $grn->payment_terms2 }}</td>
                </tr>
          </table>
          </td>
        </tr>
