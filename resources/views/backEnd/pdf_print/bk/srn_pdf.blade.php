...
<body>
    <?php /*<header>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td align="right"><b style="font-size: 30px; font-weight: 400;">Sales Return / Credit Note</b></td>
            </tr>
        </table>
    ...
    <main class="m2">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td align="left"><img  src="{{asset(@$company->company_logo)}}" width="200px"/></td>
            <td align="right"><b style="font-size: 30px; font-weight: 400;">Sales Return</b></td>
        </tr>
    </table>
    <br />
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top" style="line-height: 18px;">
          ...
          {{@$address}}<br>
          {{@$address2}}<br>
          @if ($city !="") {{@$city}}, @endif @if ($state !="") {{@$state}}, @endif {{ $country }}<br>
          T: {{@$tel}}<br>
          E: {{@$email}}
        </td>
        <td>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                  <td class="m-0 p-0" align="right">Sales Return No:</td>
                  <td class="m-0 p-0" align="right">{{@$sr->doc_number}}</td>
                </tr>
                <tr>
                  <td class="m-0 p-0" align="right">Sales Return Date:</td>
                  <td class="m-0 p-0" align="right">{{date('d/m/Y', strtotime(@$sr->doc_date))}}</td>
                </tr>
                <tr>
                  <td class="m-0 p-0" align="right">DO No:</td>
                  <td class="m-0 p-0" align="right">{{@$sr->dn_doc_number}}</td>
                </tr>
                <tr>
                  <td class="m-0 p-0" align="right">Invoice No:</td>
                  <td class="m-0 p-0" align="right">{{ @$sr->si_doc_number }}</td>
                </tr>
                <tr>
                  <td class="m-0 p-0" align="right">Payment Terms:</td>
                  <td class="m-0 p-0" align="right">{{ $sr->paymentterms->title }} {{ $sr->payment_terms2 }}</td>
                </tr>
          </table>
        </td>
      </tr>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr class="item-head-row">
      ...
      <td class="item-row">
          ...
          {!! nl2br($item->product->description) !!}<br />
          {{ $item->serial_no  }}</td>
