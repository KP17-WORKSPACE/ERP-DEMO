    ...
    <?php /*<header>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td align="right" valign="top" style="padding: 0; margin: 0; vertical-align: top;"><b style="font-size: 30px; font-weight: 400;">Delivery Note</b></td>
            </tr>
        </table>
  ...
  <main class="m2">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
          ...
          <td align="right" valign="top" style="padding: 0; margin: 0; vertical-align: top; text-align: right;"><b style="font-size: 30px; font-weight: 400;">Payment Voucher</b></td>
      </tr>
  </table>
  <br />
    ...
    <br />
      ...
      <tr>
        ...
        <td style="line-height: 18px;">{{ $payment->cheque_bank_name }}</td>
      </tr>
      </table>
      @endif
    <br />
