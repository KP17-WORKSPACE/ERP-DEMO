        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td>
              ...
              <br >
تسعة ريالات وأربعمائة وأربعة وسبعون بيسة: {{ $si->currency_name->code }}  <?php echo ucwords(@App\SysHelper::convertAmountToWordsArabic(@App\SysHelper::com_curr_format($vat_amount-$deal_discount_vat_amount, 2, '.', ''),$si->currency_name->r_code,$si->currency_name->p_code));?>
            </td>
...
<div>
      ...
      <li>Bank details:- Bank Name: {{@$company->bank_name}}, Account Number: {{@$company->account_number}}</li>
            ...
            <td style="text-align: right;">
              <b dir="rtl">الشروط والأحكام</b>
              @if($company->id==8)
              <ul style="list-style: decimal; padding: 10px 0px 0px 15px; margin: 0px; font-size: 10px;" dir="rtl">
              ...
              @if($company->id==10)
              <ul style="list-style: decimal; padding: 10px 0px 0px 15px; margin: 0px; font-size: 10px;" dir="rtl">
  <li>ستبقى ملكية البضائع معنا حتى يتم استلام الدفعة كاملة.</li>
  <li>عناصر الصندوق المفتوح غير قابلة للإرجاع، وجميع مبيعات هذه العناصر نهائية.</li>
  <li>الضمان لا يشمل العناصر التي لا تحتوي على أرقام تسلسلية.</li>
  <li>الضمان لا يشمل الأضرار الناجمة عن تقلبات الطاقة.</li>
  <li>لتقديم مطالبة بالضمان، يُرجى التواصل مع مركز خدمة البائع المعني.</li>
</ul>
              @endif
          </td>
          </tr>
