...
<body>
    <main class="m2">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
              ...
              <td align="right" valign="top" style="padding: 0; margin: 0; vertical-align: top; text-align: right;"><b style="font-size: 30px; font-weight: 400;">Proforma Invoice</b><div style="text-align: right;padding-top: 10px;">TRN No: {{ $company->vat_number }}</div></td>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="62%" valign="top" style="line-height: 18px; padding-left: 10px;">Bill To,<br />
