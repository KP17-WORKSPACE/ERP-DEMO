  ...
  <?php /*
    <header>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td align="left" valign="top" style="padding: 0; margin: 0; vertical-align: top;"><img  src="{{asset(@$company->company_logo)}}" width="200px"/></td>
            <td align="right" valign="top" style="padding: 0; margin: 0; vertical-align: top;"><b style="font-size: 30px; font-weight: 400;">Sales Invoice</b></td>
        </tr>
    </table>
    </header>
    <footer>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <tr>
                    ...
                    <td style="padding: 0px; margin: 0px">: {{ $pi->paymentterms->title }} {{ $pi->payment_terms2 }}</td>
                  </tr>
            </table>
          </td>
        </tr>
