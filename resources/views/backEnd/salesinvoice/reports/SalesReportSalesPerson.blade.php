                ...
                <table id="long-list" class="table table-hover data-table" style="table-layout: fixed;width:100%">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="text-end">@lang('Rev Target')</th>
                                ...
                                @if ($toshow == 0)
                                    <tr onclick="view_in_ex_tr({{ $value['user_id'] }})"
                                        ...
                                        <td class="text-end">
                                            ...
                                            <?php $total_outstanding += $value['outstanding_balance'] ?? 0; ?>
                                        </td>
                    ...
                    <tfoot style="background: #7e7e7e; color: #ffffff;">
                        <thead onclick="view_in_ex_tr(0)">
                            ...
                            <th></th>
                            <th></th>
                            <th class="text-end">{{ @App\SysHelper::com_curr_format($total_outstanding, 2, '.', ',') }}</th>
                            <th></th>
                            <th></th>
                            <th></th>
                            <th></th>
