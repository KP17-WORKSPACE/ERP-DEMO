    ...
    <aside class="left-nav col-12" id="leftSidebar">
        ...
        <div class="long-list" id="filters-long">
            <div class="d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Sales Perfomance Report
                </h4>
            ...
            <div class="search-filter-container mt-1 mb-4 filter-field d-none border">
                ...
                <div class="card" style="width: 100%">
                    <div class="card-body">
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'sales-perfomance-report', 'method' => 'POST', 'id' => 'sales-perfomance-report']) }}
            ...
            <div class="table-responsive mb-4 mt-4">
                <table id="long-list" class="table table-hover data-table" style="table-layout: fixed;width:100%">
                    ...
                    <thead>
                        <tr>
                            <th>@lang('Name')</th>
                            <th class="text-center">@lang('No Of Invoices')</th>
                            <th class="text-end">@lang('Revenue')</th>
                            <th class="text-end">@lang('GP')</th>
                            <th class="text-end">@lang('GP%')</th>
                            <th class="text-end">@lang('Receivable Outstanding')</th>
                            <th class="text-end">@lang('FC on RO')</th>
                            <th class="text-end">@lang('Ageing Stock')</th>
                            <th class="text-end">@lang('Finance Cost')</th>
                            <th class="text-end">@lang('Incentive')</th>
                        </tr>
                    </thead>
                                ...
                                @if ($toshow == 0)
                                    <tr>
                                        ...
                                        <td><a class="" target="_blank"
                                                href="{{ url('sales-perfomance-invoice-report/' . $value['company_id'] . '/' . $ctrl_date . '/' . $ctrl_date2) }}">{{ @$value['full_name'] }}</a>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            @if ($value['dealcount'] > 0)
                                                <a class="border border-success text-success pr-2 pl-2" target="_blank"  href="{{ url('sales-perfomance-invoice-report/' . $value['company_id'] . '/' . $ctrl_date . '/' . $ctrl_date2) }}">{{ @$value['dealcount'] }}
                                        ...
                                        <td class="text-end">
                                            <a class="text-dark" target="_blank" href="{{ url('receivable-outstanding') }}">
                                                {{ @App\SysHelper::com_curr_format($value['outstanding_balance'] ?? 0, 2, '.', ',') }}
                                            </a>
                                        </td>
