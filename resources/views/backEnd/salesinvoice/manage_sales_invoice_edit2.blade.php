    ...
    <section class="sms-breadcrumb mb-40 white-box">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1> @lang('Sales Invoice')</h1>
                <div class="bc-pages">
                    <a href="{{ url('dashboard') }}">@lang('lang.dashboard')</a>
                    <a href="{{ url('sales-invoice') }}">@lang('Sales Invoice')</a>
                    <a href="{{ url('sales-invoice/create') }}" class="active">@lang('lang.create')</a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-9 col-md-9 col-sm-6 col-xs-12">
                    <div class="main-title">
                        <h3 class="mb-30">Create Sales Invoice</h3>
                    </div>
                </div>
                        ...
                        <div class="add-visitor">
                            <div class="row mb-0">
                                <div class="col-lg-12 text-right">
                                    ...
                                    <button class="primary-btn fix-gr-bg" data-toggle="tooltip" title="SI List" onclick="location.href='.';">
                            ...
                            <div class="white-box">
                                ...
                                <div class="add-visitor">
                                                ...
                                                <div class="col-lg-6 mb-10">
                                                    <div class="input-effect">
                                                        <input
                                                            ...
                                                            value="{{ isset($edit_si) ? (!empty(@$edit_si->doc_number) ? @$edit_si->doc_number : old('doc_number')) : sprintf('%03d', @App\SysSalesInvoice::max('id') + 1) }}"
                                                            readonly>
                                                    ...
                                                    <div class="no-gutters input-right-icon">
                                                        <div class="col">
                                                            <div class="input-effect">
                                                                ...
                                                                if(isset($edit_si) && !empty($edit_si->si_date) ){ @$value = date('m/d/Y', strtotime(@$edit_si->si_date)); }
                                                                else{ if(!empty(old('si_date'))){ @$value = old('si_date'); }else{ @$value = date('m/d/Y'); } }
                                                                @endphp
                                                                <input class="primary-input date" id="si_date" type="text"
                                                                    name="si_date" value="{{ @$value }}">
                                                                <label>@lang('SI') @lang('lang.date')</label>
                                                                <span class="focus-border"></span>
                                                                @if ($errors->has('si_date'))
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $errors->first('si_date') }}</strong>
                                                                    </span>
                                                                @endif
                                                            </div>
                                                        </div>
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach ($customer as $value)
                                                            <option value="{{ @$value->id }}"
                                                                {{ isset($edit_si) ? (!empty($edit_si->vendors) ? (@$edit_si->vendors == @$value->id ? 'selected' : '') : '') : '' }}>{{ @$value->account_name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-lg-6 mb-10">
                                                    <select
                                                        ...
                                                        @foreach ($currency as $value)
                                                            <option value="{{ @$value->id }}"
                                                                {{ isset($edit_si) ? (!empty(@$edit_si->currency) ? (@$edit_si->currency == @$value->id ? 'selected' : '') : '') : '' }}>
                                                                {{ @$value->code }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-lg-6 mb-10">
                                                    <div class="input-effect">
                                                        <input
                                                            ...
                                                            value="{{ isset($edit_si) ? (!empty(@$edit_si->narration) ? @$edit_si->narration : old('narration')) : old('narration') }}"
                                                            id="narration">
                                    ...
                                    <div class="row mb-10">
                                            ...
                                            <div class="no-gutters input-right-icon">
                                                <div class="col">
                                                    <div class="input-effect">
                                                        @php
                                                        $value = date('m/d/Y');
                                                        if(isset($edit_si) && !empty($edit_si->lpo_date) ){ @$value = date('m/d/Y', strtotime(@$edit_si->lpo_date)); }
                                                        else{ if(!empty(old('lpo_date'))){ @$value = old('lpo_date'); }else{ @$value = date('m/d/Y'); } }
                                                        @endphp
                                        ...
                                        <div class="col-lg-3 mb-10">
                                            <div class="input-effect">
                                                <input class="primary-input form-control {{ $errors->has('lpo_number') ? ' is-invalid' : '' }}"
                                                    ...
                                                    id="lpo_number"
                                                    value="{{ isset($edit_si) ? (!empty(@$edit_si->lpo_number) ? @$edit_si->lpo_number : old('lpo_number')) : '' }}">
                                        ...
                                        <div class="col-lg-3 mb-10">
                                            <div class="input-effect">
                                                <select class="niceSelect w-100 bb form-control {{ $errors->has('payment_terms') ? ' is-invalid' : '' }}" name="payment_terms" id="payment_terms" onchange="fn_payment_terms()">
                                                    ...
                                                    @endforeach
                                                    <option value="150" {{isset($edit_si)? !empty(@$edit_si->payment_terms)? @$edit_si->payment_terms==150 ? 'selected':'':'':''}}>Other</option>
                                                </select>
                                        ...
                                        <div class="col-lg-3 mb-10" id="div_payment_terms" @if(isset($edit_si)) @if(@$edit_si->payment_terms != 150) style="display: none;" @endif @endif >
                                            <div class="input-effect">
                                        ...
                                        <div class="col-lg-3 mb-10">
                                            <div class="input-effect">
                                                <input class="primary-input form-control {{ $errors->has('bill_number') ? ' is-invalid' : '' }}"
                                                    ...
                                                    id="bill_number"
                                                    value="{{ isset($edit_si) ? (!empty(@$edit_si->bill_number) ? @$edit_si->bill_number : old('bill_number')) : '' }}">
                                            ...
                                            <div class="no-gutters input-right-icon">
                                                <div class="col">
                                                    <div class="input-effect">
                                                        @php
                                                        $value = date('m/d/Y');
                                                        if(isset($edit_si) && !empty($edit_si->bill_date) ){ @$value = date('m/d/Y', strtotime(@$edit_si->bill_date)); }
                                                        else{ if(!empty(old('bill_date'))){ @$value = old('bill_date'); }else{ @$value = date('m/d/Y'); } }
                                                        @endphp
                                                        <input class="primary-input date" id="bill_date" type="text" name="bill_date" value="{{ @$value }}">
                                    ...
                                    <div class="row mb-10">
                                            ...
                                            <div class="input-effect">
                                                ...
                                                <select class="niceSelect w-100 bb form-control {{ $errors->has('supplier_type') ? ' is-invalid' : '' }}" name="supplier_type" id="supplier_type">
                                                    ...
                                                    @foreach($suppliertype as $value)
                                                            <option value="{{@$value->id}}" {{isset($edit_si)? !empty(@$edit_si->supplier_type)? @$edit_si->supplier_type==@$value->id ? 'selected':'':'':''}} >{{@$value->title}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="input-effect">
                                                <select class="niceSelect w-100 bb form-control {{ $errors->has('sales_type') ? ' is-invalid' : '' }}" name="sales_type" id="sales_type">
                                                    <option data-display="@lang('Sales Type') *" value="" >@lang('Sales Type') *</option>
                                                    <option value="Standard-Rated Sales" {{isset($edit_si)? !empty(@$edit_si->sales_type)? @$edit_si->sales_type=='Standard-Rated Sales' ? 'selected':'':'':''}} >Standard-Rated Sales</option>
                                                    <option value="Zero-Rated Sales" {{isset($edit_si)? !empty(@$edit_si->sales_type)? @$edit_si->sales_type=='Zero-Rated Sales' ? 'selected':'':'':''}} >Zero-Rated Sales</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="input-effect">
                                                <input type="text" class="primary-input form-control" 
                                                    name="supplier_country" value="{{ isset($edit_si) ? (!empty(@$edit_si->supplier_country) ? @$edit_si->supplier_country : '') : old('supplier_country') }}">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="input-effect">
                                                <input type="text" class="primary-input form-control" cols="0" rows="4"
                                                    name="supplier_state" value="{{ isset($edit_si) ? (!empty(@$edit_si->supplier_state) ? @$edit_si->supplier_state : '') : old('supplier_state') }}">
                                                    ...
                                                    <tr id="rowone{{$roid}}" onclick="fn_addRow({{$roid}})">
                                                        ...
                                                        <td>
                                                            <select class="w-100 sstxtbx" name="tax[]" id="tax_{{$roid}}" readonly="true" onchange="calc_change({{$roid}})">
                                                                <option value="{{round($company->net_vat)}}" {{isset($edit_si_items[$roid-1])? !empty(@$edit_si_items[$roid-1]->tax)? @$edit_si_items[$roid-1]->tax==@$value->id ? 'selected':'':'':''}} >VAT {{round($company->net_vat)}}%</option>
                                                                <option value="0" {{isset($edit_si_items[$roid-1])? !empty(@$edit_si_items[$roid-1]->tax)? @$edit_si_items[$roid-1]->tax==0 ? 'selected':'':'':''}} >None</option>
                                                            </select>
                                                        </td>
                                                        <td>
                                                            <input class="w-100 sstxtbx" type="number" id="qty_{{$roid}}" name="qty[]" autocomplete="off" min="0" onchange="calc_change({{$roid}})"
                                                            value="{{@$edit_si_items[$roid-1]->qty}}">
                                                        </td>
                                                        <td>
                                                            <input class="w-100 sstxtbx" type="number" id="unitprice_{{$roid}}" name="unitprice[]" autocomplete="off" min="0" onchange="calc_change({{$roid}})" value="{{@$edit_si_items[$roid-1]->unitprice}}">
                                                        </td>
                                                        <td>
                                                            <input class="w-100 sstxtbx" type="number" id="value_{{$roid}}" name="value[]" autocomplete="off" min="0" readonly value="{{@$edit_si_items[$roid-1]->value}}">
                                                        </td>
                                                        <td>
                                                            <input class="w-100 sstxtbx" type="number" id="discount_{{$roid}}" name="discount[]" autocomplete="off" min="0" onchange="calc_change({{$roid}})" value="{{@$edit_si_items[$roid-1]->discount}}">
                                                        </td>
                                                        <td>
                                                            <input class="w-100 sstxtbx" type="number" id="customcharges_{{$roid}}" name="customcharges[]" autocomplete="off" min="0" onchange="calc_change({{$roid}})" value="{{@$edit_si_items[$roid-1]->customcharges}}">
                                                        </td>
                                                        <td>
                                                            <input class="w-100 sstxtbx" type="number" id="taxableamount_{{$roid}}" name="taxableamount[]" autocomplete="off" min="0" readonly value="{{@$edit_si_items[$roid-1]->taxableamount}}">
                                                        </td>
                                                        <td>
                                                            <input class="w-100 sstxtbx" type="number" id="vatamount_{{$roid}}" name="vatamount[]" autocomplete="off" min="0" readonly value="{{@$edit_si_items[$roid-1]->vatamount}}">
                                                        </td>
                                                    </tr>
                                                    @endfor
                                                    <?php $roid--;?>
...
<script>
    ...
    function calc_change(id)
    {
        ...
        $('#value_'+id+'').val(fin_value.toFixed(2));
        ...
        $('#taxableamount_'+id+'').val(fin_taxableamount.toFixed(2));

        var fin_vatamount = ((unitprice * qty) + Number(customcharges) - Number(discount)) * ((Number(net_vat))/100);
        var vatamount = $('#vatamount_'+id+'').val(fin_vatamount.toFixed(2));
    }
                                        ...
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                <textarea class="primary-input form-control" cols="0" rows="4"
                                                    name="note">{{ isset($edit_si) ? (!empty(@$edit_si->note) ? @$edit_si->note : '') : old('description') }}</textarea>
