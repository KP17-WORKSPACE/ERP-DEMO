...
{{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'sales-invoice-store', 'method' => 'POST', 'id' => 'sales-invoice-create-form', 'novalidate' => true,]) }}
            ...
            <div class="row gap-rows">
                ...
                <div class="col-10 mb-2">
                    <div class="row">
                                    ...
                                    <select class="form-control js-example-basic-single" name="payment_terms"
                                        ...
                                        @foreach($paymentterms as $value)
                                            <option value="{{@$value->id}}" {{isset($edit) ? !empty(@$edit->payment_terms) ? @$edit->payment_terms == @$value->id ? 'selected' : '' : '' : ''}}
                                                @if(count($cart) > 0) @if($cart[0]->payment_terms == @$value->id) selected
                                                @endif @endif>{{@$value->title}}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="col-lg-3 mb-2">
                            <div class="input-effect">
                                <label class="form-label">@lang('Create Deal')</label>
                                <div class="form-group">
                ...
                <!-- <div class="col-lg-3 mb-2">
                    <div class="input-effect">
                        ...
                        <input type="text" class="form-control"
                            value="@if(isset($deal_det)) {{ $deal_det->delivery_company }} @endif" id="shipping_name"
                            name="shipping_name">
                    </div>
                </div> -->
                <!-- <div class="col-lg-3 mb-2">
                    <div class="input-effect">
                        ...
                        <input type="text" class="form-control"
                            value="@if(isset($deal_det)) {{ $deal_det->delivery_address }} @endif" id="shipping_address"
                        ...
                        <div id="sectionStateDiv">
                            <select class="form-control js-example-basic-single" name="customer_state" id="state">
                                ...
                                @foreach ($states as $key => $value)
                                    @if (isset($deal_cust))
                                        <option data-display="{{ $deal_cust->vatstate->name }}"
                                            value="{{ $deal_cust->vat_state }}" selected>
                                            {{ $deal_cust->vatstate->name }}
                                        </option>
                                    @else
                        ...
                        <div class="form-group">
                            <select class="form-control js-example-basic-single" name="customer_type"
                                ...
                                @foreach($customertype as $value)
                                    <option value="{{@$value->id}}" {{isset($deal_cust) ? !empty(@$deal_cust->customer_type) ? @$deal_cust->customer_type == @$value->id ? 'selected' : '' : '' : ''}}>{{@$value->title}}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            <select class="form-control js-example-basic-single" name="sale_type" id="sale_type">
                                ...
                                @foreach($saletype as $value)
                                    <option value="{{@$value->id}}" {{isset($deal_cust) ? !empty(@$deal_cust->sale_type) ? @$deal_cust->sale_type == @$value->id ? 'selected' : '' : '' : ''}}>{{@$value->title}}
                                    </option>
                                @endforeach
                            </select>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-auto">
                        ...
                        (<a href="{{ url('public/uploads/product_upload/si_items_sample_format.csv') }}"
                            ...
                            if(len > 0){
                               ...
                               var newCompanyId = dataResult['new_company_id'];
                                ...
                                for(var i=0; i<len; i++){
                                  ...
                                  if (newCompanyId) {
                                    $("#customer").val(newCompanyId).trigger('change.select2');
                                    get_pending_si_list();
                                }
