 ...
 <style>
    ...
    <div class="purchase-order-content-header d-flex align-items-center justify-content-between gap-2">
        <div class="d-flex align-items-center gap-2">
            ...
            @if(isset($si->deal_id))
                {!! App\SysHelper::deal_pipeline($si->deal_id) !!}
            @endif
        </div>
        <div class="purchase-order-content-header-right">

           <a class="btn btn-light text-dark" href="{{url('sales-invoice/'.$si->id.'?si_action=edit')}}">
                <i class="ico icon-outline-pen-2 text-success"></i> Edit
            </a>

            <a class="btn btn-light text-dark" href="{{url('sales-invoice/' . $si->id . '?si_action=add')}}">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="{{url('sales-invoice/'.$si->id.'/delete')}}"><i class="ico icon-outline-trash-bin-minimalistic text-danger"></i> Cancel SI</a></li>
                    <li><a class="dropdown-item" href="{{url('sales-invoice/'.$si->id.'/download/t')}}"><i class="ico icon-outline-document-medicine text-success"></i> Print</a></li>
                    
                    <li><a class="dropdown-item" href="{{url('sales-invoice/'.$si->id.'/download')}}"><i class="ico icon-outline-document-medicine text-success"></i> Download</a></li>
