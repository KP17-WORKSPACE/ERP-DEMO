...
@section('mainContent')
    ...
    <div class="container-fluid">
        <div class="d-sm-flex justify-content-between">
            <div class="mb-3">
                <h2 class="page-heading m-0">Bank Receipt</h2>
                <span class="page-label">Home - Bank Receipt</span>
            </div>
            <div>
                <a href="{{ url('bankreceipt-add') }}" type="button" class="btn btn-info"><i class="fa fa-plus"></i> New</a>
                <a href="{{ url('bankreceipt') }}" type="button" class="btn btn-info"><i class="fa fa-list"></i> List</a>
            </div>
        </div>
        
        <div class="card p-4 mb-2">
            @if(isset($editData))
            {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'bankreceipt-update/'. @$editData->id, 'method' => 'PUT', 'enctype' => 'multipart/form-data', 'id' => 'bankreceipt-create-form']) }}
            <input type="hidden" value="{{@$editData->id}}" name="cust_id">
            @else
            {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'bankreceipt-store', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'bankreceipt-create-form']) }}
            @endif
                                ...
                                <div class="no-gutters input-right-icon">
                                    <div class="col">
                                        <div class="input-effect">
                                            ...
                                            <input class="form-control" type="text" id="doc_number" name="doc_number" value="{{isset($editData)?@$editData->doc_number:'BR-'.sprintf('%03d', @App\SysBankReceipt::max('id') + 1) }}" readonly>
                                            <span class="focus-border"></span>
                            ...
                            <table class="table table-bordered table-striped" id="br-table" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <td>{{$roid}}</td>
                                        ...
                                        <td>
                                            <input class="form-control" type="number" id="amount_{{$roid}}" name="amount[]" autocomplete="off" min="0" value="{{@$editDataList[$roid-1]->credit_amount}}" onchange="calc_total()" onkeypress="cr_popup_fun({{$roid}})">
                                        </td>
                                        <td>
                ...
                <div class="row mt-40">
                    <div class="col-lg-12 text-center">
                        ...
                        <button class="btn btn-primary">
                            ...
                            @if(isset($editData)) @lang('lang.update') @else @lang('lang.add') @endif @lang('Bank Receipt')
                        </button>
                        @endif
                    </div>
                </div>
