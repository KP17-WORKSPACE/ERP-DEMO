...
<div class="purchase-order-content-header ">
                    ...
                    <div class="purchase-order-content-header-right">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{ url('receipt-add/creditcard') }}"><i
                                            class="ico icon-outline-bill-list text-success"></i> Receipts</a></li>
                                <li><a class="dropdown-item" href="{{ url('payment-add/creditcard') }}"><i
                                            class="ico icon-outline-bill-list text-success"></i> Payments</a></li>
                                <li><a class="dropdown-item" href="{{ url('journalvoucher-add/creditcard') }}"><i
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'creditcard', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                        <input type="hidden" name="url" id="url" value="{{ URL::to('/') }}">
                        <div class="row">
                            <div class="col-md-3 mb-20">
                                <div class="input-effect">
                                    <label>@lang('Select Credit Card')</label>
