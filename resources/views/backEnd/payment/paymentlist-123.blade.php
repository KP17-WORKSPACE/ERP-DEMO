                    ...
                    <button href="javascript:void(0)" class="nav-link data-item {{ $loop->first ? 'active' : '' }}" data-id="{{ $value->id }}">
                        ...
                        <div class="row w-100">
                            ...
                            <div class="col-4 text-end">
                                <div class="form-control-plaintext truncate-text">{{ @App\SysHelper::com_curr_format(abs(@$value->debit_amount - @$value->credit_amount),2,'.',',') }}</div>
                            </div>
                            <div class="col-12">
                                <label class="form-control-plaintext truncate-text">{{ @$value->account->account_code }} - {{ @$value->account->account_name }} -
                ...
                <tbody>
                    ...
                    <tr @if($value->status == 2) class="bg-dark" @endif @if(@$value->type==2) class="text-danger" @endif>
                        ...
                        <td class="text-center">
                            <a class="btn btn-light d-block" href="{{url('payment/'.$value->id.'/download')}}"><i class="ico icon-bold-download-minimalistic text-dark"
    ...
    <div class="content-container col-9">
        <div class="tab-content display-flex-tabs" id="purchaseOrderTabContent">
            ...
            <div class="" role="tabpanel" aria-labelledby="data-tab" id="data-details">
                ...
                @else
                <div onclick="window.location.href='{{ url('payment-add') }}'" class="container-fluid d-flex flex-column justify-content-center align-items-center"
