            ...
            <div class="row">
                ...
                <div class="col-8" style="text-align: right;">
                    ...
                    <div class="top-2-text">
                        <b>{{ 'QTO-' . sprintf('%03d', @App\SysHelper::get_new_maxid('sys_quotations', 'id')) }}</b><br />Doc
                        Number
                    </div>
                </div>
                {{-- <div class="bc-pages">
                                    ...
                                    <div class="no-gutters input-right-icon">
                                        <div class="col">
                                            <div class="input-effect">
                                                ...
                                                @endphp
                                                <input class="dynamicstxt w-100 primary-input date" id="customer_ref_date"
                            ...
                            <div class="col-lg-4">
                                <div class="boxed-formctrl">
                                    <div class="input-effect">
                                        ...
                                        <input class="dynamicstxt primary-input w-100 form-control" type="text" id="vat_type"
                                            name="vat_type" readonly
                                    ...
                                    <div class="input-effect">
                                        ...
                                        <input class="dynamicstxt primary-input w-100 form-control" type="text" id="vat_country"
                                            name="vat_country" readonly
                                    ...
                                    <div class="input-effect">
                                        <div class="input-effect" id="sectionStateDiv">
                                            ...
                                            <input class="dynamicstxt primary-input w-100 form-control" type="text" id="vat_state"
                                                name="vat_state" readonly
                                    ...
                                    <div class="input-effect">
                                        ...
                                        <input class="dynamicstxt primary-input w-100 form-control" type="text" id="vat_number"
                                            name="vat_number" readonly
                                    ...
                                    <tr id="rowone{{ $roid }}" onclick="fn_addRow({{ $roid }})">
                                        <td><select class="w-100 sstxtbx" name="part_number[]"
                                                ...
                                                @foreach ($items as $key => $value)
                                                    <option value="{{ @$value->id }}">{{ @$value->part_number }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </td>
