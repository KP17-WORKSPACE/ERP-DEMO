...
@if (isset($edit))
    {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'crm-quote-update/' . $edit->id, 'method' => 'POST', 'id' => 'crm-quote-form', 'novalidate' => true]) }}
@else
...
<div class="purchase-order-content-header sticky-top" style="background-color: #f7f8fd">
    <h4 class="purchase-order-content-header-left">
        ...
        @if(isset($quotationitems[0]->document_number))
        ({{ @$quotationitems[0]->document_number }})
        @else
        ({{ @App\SysHelper::getNextDealQuoteDocNo() }})
        @endif
    ...
    <div class="purchase-order-content-header-right">
        ...
        @else
        <input type="hidden" name="document_number" id="document_number" value="{{ @App\SysHelper::getNextDealQuoteDocNo() }}">
        @endif
...
<div class="tab-wrap mb-3">
    <ul class="nav nav-tabs" id="purchaseDetailsTabs" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="quote-fields-tab" data-bs-toggle="tab" data-bs-target="#quote-fields"
    ...
    <div class="tab-content mb-3" id="purchaseDetailsTabsContent">
        ...
        <div class="tab-pane fade show active" id="quote-fields" role="tabpanel" aria-labelledby="quote-fields-tab">
            ...
            <table class="table table-hover table-striped align-middle">
                <thead class="table-light">
                    <tr>
                        ...
                        <th style="width:80px">  
                            <a class="btn btn-sm btn-light text-center text-dark"  href="{{ url('crm-quote-create-quote/'.$edit->id ) }}" style="padding: 0px 8px 0px 8px;border-radius:4px">
                            ...
                            <td class="d-flex justify-content-start align-items-center gap-2">
                                ...
                                @if ($editcheck == 0)
                                    ...
                                    <a class="btn btn-sm btn-light  text-dark"
                                        href="{{ url('quotations/' . $edit->id . '?qn_action=edit&quote=' . $item->quote_id) }}">
