...
<div class="purchase-order-content-header sticky-top d-flex align-items-center justify-content-between gap-2" style="background-color: #f7f8fd">
    <div class="d-flex align-items-center gap-2">
        <h4 class="purchase-order-content-header-left">
            {{ $quotation->code }} ({{ @$quotationitems[0]->document_number }})
    ...
    @endphp
        <a class="btn btn-light text-dark btn-edit-deal" href="{{ url('quotations/' . $quotation->id . '?qn_action=edit') }}" data-deal-track-submitted="{{ $is_deal_track_submited ? 1 : 0 }}">
