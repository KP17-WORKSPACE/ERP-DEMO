                    ...
                    <div class="form-group"><select class="form-control" name="createdby" id="createdby">
                            ...
                            @foreach ($staff as $value)
                                <option disabled value="{{ @$value->user_id }}"
                                    @if ($value->user_id == Auth::user()->id) selected @endif>{{ @$value->full_name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                            ...
                            <div class="col-2">
                                ...
                                <div class="form-group">
                                    <input
                                        ...
                                        value="{{ isset($edit) ? (!empty(@$edit->lpo_date) ? @$edit->lpo_date : old('lpo_date')) : '' }}">
                                </div>
                            </div>
                            <div class="col-2">
