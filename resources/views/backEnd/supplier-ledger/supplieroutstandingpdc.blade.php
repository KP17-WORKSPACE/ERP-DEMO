    ...
    <?php try { ?>
        ...
        <div class="container-fluid">
            <div class="d-sm-flex justify-content-between">
                <div class="mb-3">
                    <h2 class="page-heading m-0">Supplier Outstanding - PDC</h2>
                    <span class="page-label">Home - Supplier Outstanding - PDC</span>
                </div>
                <div>
            ...
            <div class="card p-4 mb-2">
                {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'customer-outstanding-pdc', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
            ...
            <div class="card p-4">
                <table class="table" style="border: solid 1px #e3e6f0;">
                    <thead>
                      <tr>
                        <th class="border text-center" width="5%">Doc Date</th>
                        ...
                        <th class="border text-center" width="10%">Bill No</th>
                        ...
                        <th class="border text-center" width="10%">Payment Terms</th>
                          <th class="border text-center" width="10%">Cheque Date</th>
                      </tr>
                    </thead>
                    <tbody>
                        <tr>
