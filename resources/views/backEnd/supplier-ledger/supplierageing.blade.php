    ...
    <?php try { ?>
        ...
        <div class="container-fluid">
            <div class="d-sm-flex justify-content-between">
                <div class="mb-3">
                    <h2 class="page-heading m-0">Supplier Ageing</h2>
                    <span class="page-label">Home - Supplier Ageing</span>
                </div>
                <div>
            ...
            <div class="card p-4 mb-2" style="display: none;">
                {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'customer-ageing', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
            ...
            <div class="card p-4">
                <table class="table" style="border: solid 1px #e3e6f0;">
                    <thead>
                      <tr>
                          <th class="border text-center" width="20%">Account Name</th>
                          <th class="border text-center" width="10%">Balance</th>
                          <th class="border text-center" width="10%">Un Adjusted</th>
                          <th class="border text-center" width="10%">Net Balance</th>
                          <th class="border text-center" width="10%">0-29</th>
                          <th class="border text-center" width="10%">30-59</th>
                          <th class="border text-center" width="10%">60-89</th>
                          <th class="border text-center" width="10%">90-119</th>
                          <th class="border text-center" width="10%">>120</th>
                      </tr>
                    </thead>
                    <tbody>
                        <tr>
