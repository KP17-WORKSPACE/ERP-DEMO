<nav class="main-nav sidebar-new">
                ...
                <ul class="nav-list">
                    ...
                    <li class="nav-item {{ @App\SysHelper::isMenuOpen(['chartofaccounts','chartofaccounts-opening-balance','journalvoucher','cashbook','bankbook','stl-report'], 'active show-subnav') }}">
                        ...
                        <div class="subnav-menu" id="subnavAccounts">
                            ...
                            <div class="sub-nav-item {{ @App\SysHelper::isActiveRoute('chartofaccounts') }}">
                                <a href="{{ url('chartofaccounts') }}" class="sub-nav-link ">Chart of Accounts</a>
                            </div>

                            <div class="sub-nav-item {{ @App\SysHelper::isActiveRoute('chartofaccounts-opening-balance') }}">
                            ...
                            @if(count($crm->where('is_read',1)->where('module_link_id',60)) > 0 ||  Auth::user()->role_id == 1)
                                    <div class="sub-nav-item {{ @App\SysHelper::isActiveRoute('stl-report') }}">
                    ...
                    @if(count($crm->where('is_read',1)) > 0 ||  Auth::user()->role_id == 1)
                    <li class="nav-item {{ @App\SysHelper::isMenuOpen(['crm-leads/show','crm-deals','crm-deal-track-approval-list','crm-deal-track-status','crm-deals-sales-report-company','crm-deals-brand-sales-report-new'], 'active show-subnav') }}">
                        ...
                        <div class="subnav-menu" id="subnavCRM">
                            <div class="sub-nav-item {{ @App\SysHelper::isActiveRoute('crm-leads') }}">
                                ...
                                <div class="sub-nav-item {{ @App\SysHelper::isActiveRoute('crm-deals-sales-report-company') }}">
                                <a href="{{url('crm-deals-sales-report-company')}}"  class="sub-nav-link">Sales Report</a>
                                </div>
                                <div class="sub-nav-item {{ @App\SysHelper::isActiveRoute('crm-deals-brand-sales-report-new') }}">
                    ...
                    <?php $crm = $permissions->wherein('module_link_id',[30,31,32,33,34,61,62,66,67]);?>
                    <?php $service = $permissions->wherein('module_link_id',[53,54,55,57,58]);?>
                    @if(count($crm->where('is_read',1)) > 0 ||  Auth::user()->role_id == 1)
                    <li class="nav-item {{ @App\SysHelper::isMenuOpen(['company','staff-directory','crm-reimbursement-request'], 'active show-subnav') }}">
                        ...
                        <div class="subnav-menu" id="subnavHrms">
                            ...
                            <div class="sub-nav-item {{ @App\SysHelper::isActiveRoute('staff-directory') }}">
                               ...
                               @if(count($crm->where('is_read',1)->where('module_link_id',67)) > 0 ||  Auth::user()->role_id == 1)
                                <a href="{{ url('approvals/inbox') }}" target="_blank" class="sub-nav-link">Leave Requests</a>
                                @endif

                                
                                @if(count($crm->where('is_read',1)->where('module_link_id',62)) > 0 ||  Auth::user()->role_id == 1)
                                <a href="{{ url('company/policy') }}" target="_blank" class="sub-nav-link">Company Policy </a>
                                @endif

                                 @if(count($crm->where('is_read',1)->where('module_link_id',68)) > 0 )
                                <a href="{{ url('employee/leaves/') }}" target="_blank" class="sub-nav-link">Leaves </a>
                                @endif
                             ...
                             <div class="sub-nav-item {{ @App\SysHelper::isActiveRoute('crm-reimbursement-request') }}">
                                ...
                                <a href="{{ url('crm-reimbursement-request') }}"  class="sub-nav-link">Reimbursement Request</a>
                                @endif
                            </div>
                    ...
                    <li class="nav-item {{ @App\SysHelper::isMenuOpen(['crm-amc-list','crm-ps-track-service-list','crm-deal-support-list','crm-engineer-tracking','crm-amc-service-request-list','crm-ps-service-list-req','crm-deal-support-requested-list'], 'active show-subnav') }}">
                        ...
                        <div class="subnav-menu" id="subnavServiceDesk">
                            <div class="sub-nav-item {{ @App\SysHelper::isActiveRoute('crm-amc-list') }} {{ @App\SysHelper::isActiveRoute('crm-amc-service-request-list') }}">
                            ...
                            <div class="sub-nav-item {{ @App\SysHelper::isActiveRoute('crm-ps-track-service-list') }} {{ @App\SysHelper::isActiveRoute('crm-ps-service-list-req') }}">
                                @if(count($service->where('is_read',1)->where('module_link_id',54)) > 0 ||  Auth::user()->role_id == 1)
                                <a href="{{ url('crm-ps-track-service-list') }}"  class="sub-nav-link">Project Service Request</a>
                                @endif
                            </div>
                            <div class="sub-nav-item {{ @App\SysHelper::isActiveRoute('crm-deal-support-list') }} {{ @App\SysHelper::isActiveRoute('crm-deal-support-requested-list') }}">
                            ...
                            <div class="sub-nav-item {{ @App\SysHelper::isActiveRoute('crm-engineer-tracking') }}">
                                ...
                                <a href="{{ url('crm-engineer-tracking') }}"  class="sub-nav-link">Service Request List</a>
                                @endif
                            </div>
                    ...
                    <li class="nav-item {{ @App\SysHelper::isMenuOpen(['crm-user-tasks','user-todo-list','tasks-assigned-by-me'], 'active show-subnav') }}">
                        ...
                        <div class="subnav-menu" id="subnavDatabase">
                            <div class="sub-nav-item {{ @App\SysHelper::isActiveRoute('crm-user-tasks') }}  {{ @App\SysHelper::isActiveRoute('tasks-assigned-by-me') }}">
                    ...
                    @if(count($crm->where('is_read',1)) > 0 ||  Auth::user()->role_id == 1)
                    <li class="nav-item {{ @App\SysHelper::isMenuOpen(['suppliers','purchase-order','goods-receipt-note-list','purchase-invoice','purchase-return','payment','payables-outstanding','pi-adjustment-report'], 'active show-subnav') }}">
                        ...
                        <div class="subnav-menu" id="subnavPurchase">
                            ...
                            <div class="sub-nav-item {{ @App\SysHelper::isActiveRoute('payables-outstanding') }}">
                    ...
                    @if(count($crm->where('is_read',1)) > 0 ||  Auth::user()->role_id == 1)
                    <li class="nav-item {{ @App\SysHelper::isMenuOpen(['customers','quotations','proforma-invoice','sales-invoice','delivery-note','sales-return','receipt','receivable-outstanding','si-adjustment-report','clearance'], 'active show-subnav') }}">
                        ...
                        <div class="subnav-menu" id="subnavSales">
                            <div class="sub-nav-item {{ @App\SysHelper::isActiveRoute('customers') }}">
                                ...
                                <div class="sub-nav-item {{ @App\SysHelper::isActiveRoute('receivable-outstanding') }}">
                    ...
                    @if(count($crm->where('is_read',1)) > 0 ||  Auth::user()->role_id == 1)
                    <li class="nav-item {{ @App\SysHelper::isMenuOpen(['item-add','item-store/show','stock-register','stock-ledger','stock-in','stock-out','packing-list'], 'active show-subnav') }}">
                    ...
                    @if(count($crm->where('is_read',1)) > 0 ||  Auth::user()->role_id == 1)
                    <li class="nav-item {{ @App\SysHelper::isMenuOpen(['inventory-report','sales-invoice-report','generalledger','trial-balance','trading-account','profit-and-loss-account','balancesheet'], 'active show-subnav') }}">
                        ...
                        <div class="subnav-menu" id="subnavReports">
                            <div class="sub-nav-item {{ @App\SysHelper::isActiveRoute('inventory-report') }}">
                                ...
                                <a href="{{ url('profit-and-loss-account') }}"  class="sub-nav-link">Profit & Loss Account</a>
                                @endif
                                </div>
                    ...
                    @if (count($crm->where('is_read', 1)) > 0 || Auth::user()->role_id == 1)                    
                    <li class="nav-item {{ @App\SysHelper::isMenuOpen(['role','module','base-setup','daily-quotes','currency-settings','payment-terms','payment-cheque-print-template','shipping-add','vat-settings','accountgroup-add','general-settings','background-setting','backup-settings'], 'active show-subnav') }}">
