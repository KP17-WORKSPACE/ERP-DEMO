...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top">
                ...
                if (permission === 'granted') {
                    ...
                    navigator.serviceWorker.ready.then((sw) =>{
                        ...
                        sw.pushManager.subscribe({
                            ...
                            fetch("https://erp.venushrms.com/api/push-subscribe/"+{{ Auth::user()->id }}, {
                                method: "post",
    ...
    <div>
        <h2 class="page-heading m-0" style="font-size: 17px; font-weight: normal;"><span class=""><i class="fa fa-star text-warning" aria-hidden="true"></i> 
            {{ App\SysHelper::user_wish_text() }} <span style="font-size: 20px; font-weight: bold;">{{ Auth::user()->full_name }}!</span> Your dashboard says it&apos;s time to shine! <i class="fa fa-star text-warning" aria-hidden="true"></i></h2>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            ...
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" id="d_dropdown">
                ...
                <div style="max-height: 80vh;">
                    <div class="p-3">
                        @php $d_userlist = @App\SmStaff::select('user_id','full_name')->wherein('role_id',[3,5,27,4,6,29,8,9,10,26,28,31,32])->orderby('full_name','asc')->get(); @endphp
                        <select id="userSelect" class="form-control js-example-basic-single" onchange="get_d_company_list()">
                            <option value="">Select User</option>
                            @foreach($d_userlist as $list)
        ...
        <li class="nav-item dropdown no-arrow mx-1"><a class="nav-link" href="{{url('stock-search')}}" target="_blank" title="Stock Search" ><i class="fas fa-search fa-fw"></i></a></li>
        <!-- Nav Item - Alerts -->
        <li class="nav-item dropdown no-arrow mx-1">
            ...
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#" onclick="notification_read({{ $data->id }})">
                    <div class="mr-3">
                        @if (str_contains($data->message, 'eject'))
                        <div class="mr-3">
                ...
                <a class="dropdown-item text-center small text-gray-500" href="#" onclick="notification_read_all({{ Auth::user()->id }})" >Mark As Read</a>
            </div>
        </li>
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small text-capitalize">{{Auth::user()->full_name}}</span>
                @if (file_exists(@$profile_image))
                    <img class="img-profile rounded-circle" src="{{ file_exists(@$profile_image) ? asset($profile_image) : asset('public/uploads/staff/demo/staff.jpg') }}" alt="">
                @else
                    <img class="img-profile rounded-circle" src="{{ asset('/') }}public/uploads/staff/demo/staff.jpg" alt="">
                @endif
                {{--  <img class="img-profile rounded-circle" src="{{asset('public/admin-iroid/')}}/img/undraw_profile.svg">  --}}
            </a>
            <!-- Dropdown - User Information -->

            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                aria-labelledby="userDropdown">
                <a class="dropdown-item" href="{{route('viewStaff', Auth::user()->staff->id)}}">
                ...
                <a class="dropdown-item" href="{{ url('/crm-dashboard') }}">
