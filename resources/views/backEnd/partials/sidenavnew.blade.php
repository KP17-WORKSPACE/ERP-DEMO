<nav class="main-nav sidebar-new">
    ...
    <ul class="nav-list sidenav-list">
        ...
        @if (count($crm->where('is_read', 1)) > 0 || Auth::user()->role_id == 1)
            <li
                class="nav-item {{ @App\SysHelper::isMenuOpen(['chartofaccounts', 'chartofaccounts-opening-balance', 'journalvoucher', 'cashbook', 'bankbook', 'stl-report','accountgroupsub-add','accountgroupsub2-add','chartofaccounts-add','chartofaccounts-add-sub','stl-supplier-report','chequebook','book-close','book-close-doc-number'], 'active show-subnav') }}">
...
<!--                    
                    ...
                    <div class="sub-nav-item {{ @App\SysHelper::isActiveRoute('book-close') }}">
                    ...
                    <div class="sub-nav-item {{ @App\SysHelper::isActiveRoute('book-close-doc-number') }}">
            ...
            <li
                ...
                <div class="subnav-menu" id="subnavReports">
                    <div class="sub-nav-item {{ @App\SysHelper::isActiveRoute('inventory-report') }}">
                     ...
                     <div class="sub-nav-item {{ @App\SysHelper::isActiveRoute(['inventory-brand-report', 'inventory-brand-wise-report', 'inventory-category-wise-report', 'inventory-subcategory-wise-report', 'inventory-company-wise-report', 'inventory-salesperson-wise-report', 'inventory-brand-report-detail']) }}">
                        @if (count($crm->where('is_read', 1)->where('module_link_id', 62)) > 0 || Auth::user()->role_id == 1)
