<header class="main-header">
            ...
            <script>
                ...
                <a class="btn btn-light add-btn" title="Stock Ledger" href="{{url('stock-search')}}" target="_blank"><i class="ico icon-outline-notebook"></i></a>
                <a class="btn btn-light add-btn" title="Customer Search" href="{{url('customer-search')}}" target="_blank"><i class="ico icon-bold-users-group-two-rounded"></i></a>

                <button class="btn btn-light notification-unread"><i class="ico icon-outline-bell"></i></button>
                <div class="profile-dropdown">
                    <div class="profile-img">
                         @if (file_exists(@$profile_image))
                            <img src="{{ file_exists(@$profile_image) ? asset($profile_image) : asset('public/uploads/staff/demo/staff.jpg') }}" alt="" width="28px" height="28px">
                        @else
                            <img  src="{{ asset('public/design') }}/assets/images/profile.png" alt="" width="28px" height="28px">
                        @endif
                    ...
                    <div class="dropdown">
                        <button class="btn dropdown-toggle" type="button" data-bs-toggle="dropdown"
                            ...
                            <div class="dropdown-toggle-text">
                                ...
                                <div class="role">{{ session('logged_session_data.role_name') }}</div>
                            </div>
                        ...
                        <div class="dropdown-menu profile-dropdown-body py-4 px-3">
                            <div class="profile-content">
                                <img src="{{ asset('public/design') }}/assets/images/profile_img.png" alt="profile_img" class="profile-image">
                                <h4 class="profile_name">{{ Auth::user()->full_name }}</h4>
                               <div class="d-flex justify-content-center mb-3">
                                <div class="company-name">{{ session('logged_session_data.company_name') }}</div></div>
                                <div class="profile-second-section py-3">
                                    <h4 class="company-details-text mb-3">Company Details</h4>
                                    <div class="row">
                                        <div class="col-7">Designation:
                                            <h6 class="">{{ session('logged_session_data.designation_name') }}</h6>
                                            staff ID:
                                            <h6>{{ session('logged_session_data.staffid') }}</h6>
                                        </div>
                                        <div class="col-5">Departments:
                                            <h6>{{ session('logged_session_data.department_name') }}</h6>
                                            Date Of Joining:
                                            <h6>{{ session('logged_session_data.joining_date') }}</h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="profile-third-section py-3">
                                    ...
                                    <div class="contact-email">
                                        ...
                                        <h6>{{ session('logged_session_data.mobile') }}</h6>
                                    </div>
                                    <div class="contact-email">
                                ...
                                <div class="profile-last-section">
                                    <div>
                                        <a class="btn" href="{{route('viewStaff', Auth::user()->staff->id)}}">
                                            <i class="ico icon-outline-pen-2"></i>
                                        </a>
                                        <p class="button-text">Edit Profile</p>
                                    </div>
                                    <div>
                                        <a class="btn" href="{{url('change-password')}}">
            ...
            <div class="modal-dialog modal-sm" style="height: 149px !important; width:250px !important;"> 
              	<div class="modal-content">
					...
					<div class="modal-footer">
						<a type="button" class="btn btn-light add-btn ms-2" href="{{ route('logout')}}">
