                                ...
                                {{-- <button class="nav-link {{ $loop->first ? 'active' : '' }}" id="grn-tab" data-bs-toggle="tab" 
                                    ...
                                    <div class="row w-100">
                                        ...
                                        <div class="col-4 text-end">
                                            <div class="form-control-plaintext truncate-text" style="font-size: 11px">{{ @App\SysHelper::com_curr_format($value->amount,2,'.',',')}} {{ $value->currency_name->code }}</div>
                                        </div>
...
$('#short-list-items').append(ims);
                    ...
                    $('#short-list-items').html('<div class="p-2">No results found</div>');
                        ...
                        <div class="" role="tabpanel" aria-labelledby="data-tab" id="data-details">
                            @if(count($salesreturn) > 0)
                                @include('backEnd.salesreturn.sr_add')
                            @endif
                        </div>
                        @else                        
                        <div class="" role="tabpanel" aria-labelledby="data-tab" id="data-details">
