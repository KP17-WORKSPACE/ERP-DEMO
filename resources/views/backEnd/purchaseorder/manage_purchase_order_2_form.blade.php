        ...
        <div class="tab-content mb-3" id="purchaseDetailsTabsContent">
            <div class="tab-pane fade show active" id="extra-fields" role="tabpanel"
                ...
                <div class="row gap-rows">
                    ...
                    <div class="col-2" id="div_deal_id" style="display: ;">
                        <div class="input-effect">
                            <label class="dynamicslbl">@lang('Deal ID')*</label>
                            <input class="form-control" id="deal_id" type="text" name="deal_id" value="{{ App\SysHelper::get_code_from_dealid($deal_id) }}"
...
@if (count($cart) > 0)
    @foreach ($cart as $items)
        <tr>
            ...
            <td><textarea class="form-control" name="description[]" value="{{ $items->description }}" rows="1">{{ $items->description }}</textarea>
                    ...
                    <td><input type="text"  class="form-control text-center" name="tax[]" value="{{ number_format($items->tax, 0) }}"
                    ...
                    <td><input class="form-control text-end" type="text" name="unitprice[]" value="{{ @App\SysHelper::com_curr_format($items->unitprice,2,'.',',') }}"
                    ...
                    <td><input class="form-control text-end" type="text" name="vatamount[]" autocomplete="off" value="{{ @App\SysHelper::com_curr_format($items->vatamount,2,'.',',') }}"
                            min="0" readonly></td>
                    <td><input class="form-control text-end" type="text" name="totalamount[]" autocomplete="off" value="{{ @App\SysHelper::com_curr_format($items->taxableamount + $items->vatamount,2,'.',',') }}"
                            min="0" readonly></td>
        ...
        function get_vat(id) {
            ...
            $.ajax({
                ...
                success: function(dataResult) {
                    console.log("data-result",dataResult['data']);
