<div class="modal-header">
    <div class="d-flex align-items-center gap-2">
        <h4 class="modal-title" id="po-doc-number">{{ $po->doc_number }}</h4>
        @if(isset($po->deal_id))
    ...
    <div class="d-flex align-items-center gap-2">
        <form method="GET" action="{{ url('purchase-order', @$po->id) }}">
            ...
            <button type="submit" name="po_action" value="edit" class="btn btn-light" style="font-size:12px;padding:0px 7px !important;min-height:19px">
                    <i class="ico icon-outline-pen-2 text-success" style="font-size:15px"></i> Edit
                </button>
            </form>

            <form method="GET" action="{{ url('purchase-order') }}">
                <button type="submit" name="po_action" value="add" class="btn btn-light" style="font-size:12px;padding:0px 7px !important;min-height:19px">
            ...
            <div class="dropdown">
                <button class="btn btn-light dropdown-toggle syscom-dropdown-toggle" type="button" style="font-size:12px;padding:0px 7px !important;min-height:19px"
                ...
                <ul class="dropdown-menu" style="">
                    ...
                    <li><a class="dropdown-item d-flex align-items-center" href="{{ url('purchase-order/' . @$po->id . '/delete') }}"><i
                                class="ico icon-outline-trash-bin-minimalistic text-danger title-15 me-2"></i>
                            Delete</a></li>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 0px; margin: 0px">:
                                                {{ date('d/m/Y', strtotime(@$po->po_date)) }}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td
                                                ...
                                                Payment Terms</td>
                                            <td style="padding: 0px; margin: 0px;font-size:12px">:
                                                {{ @$des = App\SysPaymentTerms::getPaymentTermsName($po->payment_terms) }}
                                            </td>
                                        </tr>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td class="item-row">
                                            ...
                                            <span style="font-size:11px;">{!! nl2br($item->description) !!}</span>
                                        </td>
...
<br>
                        ...
                        <footer>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td style="width: 30%; border: none; font-size: 10px;" align="left"
                                        valign="bottom">{{ @$po->createdby->full_name }}<br /><b
                                            class="bottom_b">Prepared By</b></td>
                                    <td style="width: 40%; border: none; font-size: 10px;" align="center"
                                        valign="bottom"><br /><br />This document is computer generated Signature is
                                        not
                                        required</td>
                                    <td style="width: 30%; border: none; font-size: 10px;" align="right"
                                        valign="bottom">{{ @$company->company_name }} <br /><br /><br /><br /><b
                                            class="bottom_b">Authorised Signature</b></td>
                                </tr>
                                <tr>
    ...
    {{-- attachment start --}}
   {{-- attachment start--}}
<div class="modal fade" id="attachment_popup_win" data-bs-backdrop="false" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" style="width:45rem">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Attachments</h4>
						<button type="button" class="btn-close" id="closeAttachModal" aria-label="Close"></button>
                </div>
                <div class="modal-body m-0 p-0">
   ...
   <script>
    ...
    $("#closeAttachModal").on("click", function () {
