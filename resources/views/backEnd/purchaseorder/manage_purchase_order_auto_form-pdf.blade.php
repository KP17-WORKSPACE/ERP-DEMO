    ...
    <div class="tab-wrap mb-3">
        ...
        <div class="tab-content mb-3" id="purchaseDetailsTabsContent">
            <div class="tab-pane fade show active" id="extra-fields" role="tabpanel"
                ...
                <div class="row gap-rows">
                    ...
                    <div class="col-2">
                        ...
                        <div class="form-group">
                            <select class="form-control js-example-basic-single" name="ref_company_id" id="ref_company_id">
                            <option value="">-Select-</option>
            ...
            <div class="tab-pane fade" id="vat-details" role="tabpanel" aria-labelledby="vat-details-tab">
                <div class="row row-cols-5 gap-rows">
    ...
    @foreach ($deal_cart_items as $items)
        <tr>
            ...
            <td><textarea class="form-control" name="description[]" rows="1">{{ $items->productname->description }}</textarea>
                    ...
                    <td><input class="form-control text-end" type="text" name="unitprice[]" step="any" value="{{ @$items->unitprice }}"
                            autocomplete="off" min="0" onchange="calc_change_new(this)" onblur="formatCurrency(this)"></td>
                    <td><input class="form-control text-end" type="text" name="value[]" autocomplete="off" value="{{ @$items->value }}"
                            min="0" readonly>
                    </td>
                    <td><input class="form-control text-end" type="text" name="discount[]" autocomplete="off" value="{{ @$items->discount }}"
                            step="0.01" min="0" value="" onchange="calc_change_new(this)" onblur="formatCurrency(this)"></td>
                    <td><input class="form-control text-end" type="text" name="fright[]" autocomplete="off" value="{{ @$items->fright }}"
                            step="0.01" min="0" value="" onchange="calc_change_new(this)" onblur="formatCurrency(this)"></td>
                    <td><input class="form-control text-end" type="text" name="customcharges[]" value="{{ @$items->customcharges }}"
                            autocomplete="off" step="0.01" min="0" value=""
                            onchange="calc_change_new(this)"></td>
                    <td><input class="form-control text-end" type="text" name="taxableamount[]" value="{{ @$items->taxableamount }}"
   ...
   <script>
             $(document).ready(function() {
                 ...
                 $('.modal').on('shown.bs.modal', function() {
                  ...
                  $('.modal').on('shown.bs.modal', function() {
                     $(this).find('.js-account-select').each(function() {
                         $(this).select2({
                             dropdownParent: $(this).closest('.modal'),
                             width: '100%'
                         });
                  ...
                  $('.modal').on('shown.bs.modal', function() {
                     $(this).find('.js-product-select').each(function() {
                         $(this).select2({
                             dropdownParent: $(this).closest('.modal'),
                             width: '100%'
                         });
