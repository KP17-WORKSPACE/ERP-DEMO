<style>
    ...
    <div class="purchase-order-content-header d-flex align-items-center justify-content-between gap-2">
        <div class="d-flex align-items-center gap-2">
            ...
            @if(isset($dn->deal_id))
                {!! App\SysHelper::deal_pipeline($dn->deal_id) !!}
            @endif
        </div>
        <div class="purchase-order-content-header-right">
             <a class="btn btn-light text-dark" href="{{url('delivery-note/'.$dn->id.'?di_action=edit')}}">
                <i class="ico icon-outline-pen-2 text-success"></i> Edit
            </a>
            <a class="btn btn-light text-dark" href="{{url('delivery-note/'.$dn->id.'?di_action=add')}}">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="{{url('delivery-note/'.$dn->id.'/delete')}}"><i class="ico icon-outline-trash-bin-minimalistic text-danger"></i> Cancel DN</a></li>
                  
                    <li><a class="dropdown-item" href="{{url('delivery-note/'.$dn->id.'/download/t')}}"><i class="ico icon-outline-document-medicine text-success"></i> Print</a></li>
                   
                    <li><a class="dropdown-item" href="{{url('delivery-note/'.$dn->id.'/download')}}"><i class="ico icon-outline-document-medicine text-success"></i> Download</a></li>
  ...
  <br />
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr style="background: #2c2b6d; color: #ffffff;">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
        <td style="width: 10px; border-bottom: solid 1px #2c2b6d;">{{$i}} <?php $i++;?></td>
        <td style="width: 550px; border-bottom: solid 1px #2c2b6d; font-size: 10px;">
            ...
            <span style="width:auto; font-size: 8.5px; padding: 2px; margin-top:5px; font-weight: bold; font-style: italic;">{{ preg_replace('/\s*,\s*/', ', ', $item->serial_no)  }}</span></td>
        ...
        <tr>
          ...
          <td style="border-bottom: solid 1px #2c2b6d; text-align: center; font-weight: bold;width:58px">{{ $qty }}</td>
        </tr>
      </table>
      <br /><br />
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
