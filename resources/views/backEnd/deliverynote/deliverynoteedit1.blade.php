    ...
    <?php try { ?>
        <div class="container-fluid">
            <div class="d-sm-flex justify-content-between">
                <div class="mb-3">
                    <h2 class="page-heading m-0">Delivery Note Edit</h2>
                ...
                <div>
                    ...
                    <a href="{{ url('delivery-note/'.$edit->id.'/view') }}" type="button" class="btn btn-warning"><i class="fa fa-list"></i> View</a>
                    <!-- Input with Search -->
            ...
            {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'delivery-note-update/'.$edit->id, 'method' => 'PUT', 'enctype' => 'multipart/form-data', 'id' =>  'delivery-note-create-form']) }}
            ...
            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <div class="input-effect">
                                                ...
                                                <input class="form-control" type="text" name="doc_number" autocomplete="off" id="doc_number" value="{{ $edit->doc_number }}">
                        ...
                        <div id="item_add_row">
                            ...
                            <table class="table table-bordered table-striped" id="table_id" width="100%" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-control vat" type="number" id="vat" autocomplete="off" min="0" value="{{ @App\SysHelper::com_curr_format($select_cart[0]->tax, 2, '.', '')}}" onchange="add_calc_change_new()">
                                        </td>
                                        <td>
                                            <input class="form-control" type="number" id="qty" autocomplete="off" min="0" onchange="add_calc_change_new()">
                                        </td>
                                        <td>
                            ...
                            <table class="table table-bordered table-striped" id="DelNoteList_table" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    @php $i=0; @endphp
                                        ...
                                        //$vatamount = @App\SysHelper::com_curr_format(($taxamount)*$cart->vatamount/100, 2, '.', '');
                                        ...
                                        $totalamount = $taxamount+$cart->vatamount;
                                        ...
                                        @endphp
                                        <tr>
                                            <td><input class="form-control" type="text" id="part_number_{{ $i }}" name="part_number[]" value="{{ $cart->partno }}" readonly>
                                            ...
                                            <td><input class="form-control" type="number" id="tax_{{ $i }}" name="tax[]" autocomplete="off" min="0" value="{{ @App\SysHelper::com_curr_format($cart->tax, 2, '.', '') }}" onchange="calc_change({{ $i }})"></td>
                                            <td><input class="form-control qty" type="number" id="qty_{{ $i }}" name="qty[]" autocomplete="off" min="0" value="{{ $cart->qty }}" onchange="calc_change({{ $i }})" onkeydown="return set_license_key_po(event, {{ $i }}, {{ $cart->product_type }}, this)"></td>
                                            ...
                                            <td>
                                                <input type="hidden" id="product_type_{{ $i }}" value="{{ $cart->product_type }}" />
                                                <input type="hidden" id="cart_item_id_{{ $i }}" value="{{ $cart->id }}" />
                                                <a onclick="return edit_row({{ $i }})" class="btn-sm btn-primary"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                                <a onclick="return delete_row({{ $cart->id }},{{ $cart->part_number }})" class="btn-sm btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                            </td>    
                                        </tr>
                                        @php $i++; @endphp
                                        @endforeach                                        
                                    ...
                                    <script>
                                        ...
                                        function row_add() {
                                            if($('#sales_man').val() == "") { $('#sales_man').focus(); return false; }
                                            $("#loading_bg").css("display", "block");
                                            var itm_id = $('#cart_item_id').val();
                                            var dln_id = $('#dln_id').val();
                                            var part_number = $('#part_number_new').val();
                                            ...
                                            var action = "{{ URL::to('delivery-note-item-add') }}";
                                            $.ajax({
                                                url: action,
                                                type: "POST",
                                                data: {
                ...
                <div class="row mt-4">
                    <div class="col-lg-12 text-right">
                        ...
                        <button class="btn btn-warning" name="btnSubmit" id="btnSubmit">
                            @lang('Update Delivery Note')
                        </button>
                    </div>
                </div>
    </div>
...
<!-- Modal License Key-->
    ...
    <script>
        ...
        function get_license_key(part_id){
            $("#loading_bg").css("display", "block");
            var action = "{{ URL::to('dn-get-dln-license-key') }}";
            $.ajax({
                url: action,
                type: "POST",
                data: {
        ...
        function set_license_key(){
            $("#loading_bg").css("display", "block");
            var action = "{{ URL::to('dn-update-dln-license-key') }}";
...
<div class="modal fade" id="modalDiscount" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            ...
            {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'add-delivery-note-items-cart-discount', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
            ...
            <div class="modal-footer">
                <input type="hidden" name="discount_amount_dn_id" value="{{ @$edit->id }}"/>                    
    ...
    <div class="modal fade" id="ModalChangeCurrancy" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'delivery-note-update-currency', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
