...
<div class="container-fluid">
    <div class="d-sm-flex justify-content-between">
        <div class="mb-3">
            <h2 class="page-heading m-0">Excess Stock Edit (Stock In)</h2>
            <span class="page-label">Home - Excess Stock Edit (Stock In)</span>
        </div>
        <div>
            <a href="{{ url('stock-in/show') }}" class="btn btn-primary"><i class="fa fa-list"></i> List</a>
            <a href="{{ url('stock-in/'.$edit->id.'/view') }}" type="button" class="btn btn-warning"><i class="fa fa-list"></i> View</a>
            <!-- Input with Search -->
                                    ...
                                    <div class="row mt-40">
                                        <div class="col-lg-12 text-center">
                                            <button type="submit" class="btn btn-primary" id="btnSubmit">
                                                <span class="ti-check"></span>Update Stock In</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
