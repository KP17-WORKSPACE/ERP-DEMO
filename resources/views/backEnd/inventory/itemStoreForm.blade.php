...
@section('mainContent')
    ...
    <aside class="left-nav col-12" id="leftSidebar">
        ...
        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'item-store', 'method' => 'POST', 'id' => 'item-store']) }}
                        ...
                        <div class="col-1-5">
                            ...
                            <div class="form-group">
                                <input type="text" id="doc_number" name="doc_number" class="form-control" readonly
                                    value="{{ isset($openingstock) ? (!empty(@$openingstock->doc_number) ? @$openingstock->doc_number : old('doc_number')) : @App\SysHelper::get_new_code('sys_item_opening_stock', 'OP', 'doc_number') }}" />
                            </div>
                        </div>
                        ...
                        <div class="col-1-5">
                            ...
                            @php
                                ...
                                if (isset($openingstock) && !empty($openingstock->bill_date)) {
                                    $value = date('Y-m-d', strtotime(@$openingstock->bill_date));
                                }
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input class="form-control text-center" data-enter-skip type="text" name="qty[]" autocomplete="off"
                                    min="0" onchange="calc_change_new(this)"
                            ...
                            <td><input class="form-control text-start" type="text" name="narration[]" autocomplete="off">
                            </td>
    ...
    <div class="modal  fade" id="ModalExcelQuote" data-bs-backdrop="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-lg" style="height: 464px !important;">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="poexcelimport">License Excel Import</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body m-0 p-0">
                    <div class="card mb-0 mt-0">
    ...
    <script>
        ...
        $(document).on("keydown", 'input[name="description[]"], input[name="qty[]"], input[name="unitprice[]"], input[name="refno[]"], input[name="narration[]"]', function(e) {
            if (e.key === "Enter") {
                let row = $(this).closest("tr"); // current row
                let name = $(this).attr("name");

                if (name === "qty[]") {
                    // For license products, Enter should open the license key modal.
        ...
        $('#item-store').on('keypress', function(e) {
