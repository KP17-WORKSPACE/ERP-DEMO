        ...
        <div class="long-list" id="filters-long">
            ...
            <div class="search-filter-container mt-1 mb-4 filter-field d-none border">
                <div class="card" style="width: 100%">
                    <div class="card-body">
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'inventory-category-wise-report', 'method' => 'POST', 'id' => 'inventory-category-wise-report']) }}
                        <div class="row">
            ...
            <div class="table-responsive mb-4 mt-4">
                <table id="long-list" class="table table-hover data-table" style="table-layout: fixed;width:100%">
                    ...
                    <tbody>
                        ...
                        @endphp
                        @forelse($category_report_rows as $row)
                            @php
                            ...
                            <tr>
                                ...
                                <td><a href="{{ $partWiseUrl }}">{{ $row->category_name }}</a></td>
