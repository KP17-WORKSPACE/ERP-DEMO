{{--
    Builds a single line title: "Base - Context1 - Context2" using hyphens (no brackets).
    Pass only the collections / control values that exist on the current page.
--}}
@php
...
@endphp
    ...
    <span class=" m-0">{{ $reportPageHeading }}</span>
