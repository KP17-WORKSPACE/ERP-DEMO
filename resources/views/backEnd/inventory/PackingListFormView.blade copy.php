...
<div class="container-fluid">
    <div class="d-sm-flex justify-content-between">
        <div class="mb-3">
            <h2 class="page-heading m-0">Packing List View</h2>
            <span class="page-label">Home - Packing View</span>
        </div>
        <div>
            <a href="{{ url('packing-list/show') }}" class="btn btn-primary"><i class="fa fa-list"></i> List</a>
            <a href="{{ url('packing-list/'.$edit->id.'/edit') }}" type="button" class="btn btn-warning"><i class="fa fa-list"></i> Edit</a>
            <!-- Input with Search -->
