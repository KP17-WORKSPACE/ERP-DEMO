...
<div class="container-fluid">
    <div class="d-sm-flex justify-content-between">
        <div class="mb-3">
            <h2 class="page-heading m-0">Shortage Stock (Stock Out)</h2>
            <span class="page-label">Home - Shortage Stock (Stock Out)</span>
        </div>
        <div>
                                                ...
                                                <div class="col-lg-3 mb-10">
                                                    <div class="input-effect">
                                                        ...
                                                        <input class="form-control {{ $errors->has('part_number') ? ' is-invalid' : '' }}"
                                                            ...
                                                            value="{{ @App\SysHelper::get_new_code('sys_stock_out','SH' ,'doc_number') }}" required>
                                                    </div>
                                                </div>
                                        ...
                                        <table class="table table-bordered table-striped" id="table_id" width="100%" cellspacing="0">
                                            <thead>
                                                ...
                                                function add_rows() {
                                                    ...
                                                    var action = "{{ URL::to('stock-out-cart-add') }}";
                                                    $.ajax({
                                                        url: action,
                                                        type: "POST",
                                                        data: {
                                                ...
                                                function row_update() {
                                                    ...
                                                    var action = "{{ URL::to('stock-out-cart-update') }}";
                                                    $.ajax({
                                                        url: action,
                                                        type: "POST",
                                                        data: {
                                                ...
                                                function row_delete(id) {
                                                    ...
                                                    $("#loading_bg").css("display", "block");
                                                    var action = "{{ URL::to('stock-out-cart-delete') }}";
                                                    $.ajax({
                                                        url: action,
                                                        type: "POST",
                                                        data: {
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                                ...
                                (<a href="{{ url('public/uploads/product_upload/stock_out_sample_format.csv') }}" target="_blank">Sample File</a>)
                        </div>
