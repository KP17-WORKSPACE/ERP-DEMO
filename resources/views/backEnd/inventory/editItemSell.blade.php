...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.edit') @lang('lang.Sell_Details')</h1>
            <div class="bc-pages">
                <a href="{{url('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('lang.inventory')</a>
                <a href="{{url('item-sell-list')}}">@lang('lang.Item_Sell_list')</a>
                <a href="#">@lang('lang.edit') @lang('lang.Sell_Details')</a>
            </div>
        </div>
    </div>
</section>
...
<div class="container-fluid p-0">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="main-title">
                    <h3 class="mb-30">
                        @lang('lang.edit') @lang('lang.Sell_Details')
                    </h3>
                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 mb-20">
                                        <div class="input-effect">
                                            ...
                                            <label>@lang('lang.reference') @lang('lang.no_') <span></span> </label>
                                    ...
                                    <div class="col-lg-12 no-gutters input-right-icon mb-30">
                                        <div class="col">
                                            <div class="input-effect">
                                                ...
                                                <label>@lang('lang.Sell') @lang('lang.date') <span></span> </label>
                                                <span class="focus-border"></span>
            ...
            <div class="col-lg-9">
              ...
              <div class="row">
                <div class="col-lg-4 no-gutters">
                    <div class="main-title">
                        <h3 class="mb-30">@lang('lang.Item') @lang('lang.sale')</h3>
                    </div>
                </div>
                   ...
                   <table class="table" id="productTable">
                    <thead>
                      <tr>
                          ...
                          <th>@lang('lang.sale') @lang('lang.price')</th>
                          <th>@lang('lang.quantity')</th>
                          <th>@lang('lang.sub') @lang('lang.total')</th>
                        ...
                        <td>
                            ...
                            <td>
                                <div class="input-effect">
                                    ...
                                    type="text" name="total[]" id="total{{$i}}" autocomplete="off" value="{{isset($editDataChildren)? @App\SysHelper::com_curr_format( (float) @$editDataValue->sub_total, 2, '.', '') : '' }}">
                        ...
                        <tfoot>
                            <tr>
                               ...
                               <th>
                                   ...
                                   value="{{ @App\SysHelper::com_curr_format( (float) $grand_total, 2, '.', '') }}"
                                   />

                                   <input type="hidden" class="form-control" id="subTotalValue" name="subTotalValue" value="{{ @App\SysHelper::com_curr_format( (float) @$grand_total, 2, '.', '') }}"/>
   ...
   <div class="row mt-30">
    ...
    <div class="col-lg-4 mt-30-md">
       <div class="col-lg-12">
        <div class="input-effect">
            <input class="primary-input" type="text" value="{{isset($editData)? @App\SysHelper::com_curr_format( (float) @$editData->total_due, 2, '.', '') : '' }}" id="totalDue" readonly>
...
<div class="col-lg-3">
  <select class="niceSelect w-100 bb form-control" name="payment_method" id="payment_method">
    <option data-display="Select Payment Method" value="">@lang('lang.select_a_payment_gateway') </option>
