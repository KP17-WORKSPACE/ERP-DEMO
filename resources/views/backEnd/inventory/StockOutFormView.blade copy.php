...
<div class="container-fluid">
    <div class="d-sm-flex justify-content-between">
        <div class="mb-3">
            <h2 class="page-heading m-0">Shortage Stock View (Stock Out)</h2>
            <span class="page-label">Home - Shortage Stock View (Stock Out)</span>
        </div>
        <div>
            <a href="{{ url('stock-out/show') }}" class="btn btn-primary"><i class="fa fa-list"></i> List</a>
            <a href="{{ url('stock-out/'.$edit->id.'/edit') }}" type="button" class="btn btn-warning"><i class="fa fa-list"></i> Edit</a>
            <!-- Input with Search -->
