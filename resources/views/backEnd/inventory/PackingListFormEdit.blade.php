...
{{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'packing-list/' . $edit->id, 'method' => 'PUT', 'id' => 'packing-list']) }}
...
<div class="tab-pane fade show active" id="purchase-order-1" role="tabpanel" aria-labelledby="purchase-order-1-tab">
    <div class="purchase-order-content-header d-flex align-items-center justify-content-between mb-1 gap-2">
        ...
        <div class="purchase-order-content-header-right d-flex align-items-center justify-content-end gap-2">
            ...
            <a class="btn btn-light" href="{{ url('packing-list/' . @$edit->id . '?packing_action=add') }}">
        ...
        <div class="card-body">
            <div class="row gap-rows">
                ...
                <div class="col-2">
                    ...
                    <input type="text" class="form-control" value="{{ $edit->refno }}" name="refno"
                        id="refno" required>
                </div>
                ...
                <div class="col-1-5">
                    ...
                    {{-- @php
                        $value = \Carbon\Carbon::parse($edit->refdate)->format('d/m/Y');
                    @endphp --}}

                    <div class="form-group">
                        <input type="text" id="refdate" name="refdate" class="form-control date-picker"
                            value="{{ @App\SysHelper::normalizeToDmy(@$edit->refdate) }}" />
                    </div>
                </div>
                ...
                <div class="col-3">
                    ...
                    <input type="text" readonly class="form-control" value="{{ $edit->createdby->full_name }}"
        ...
        <table class="table table-hover form-item-table" id="myTable">
            ...
            <tbody>
                ...
                @if (count($edit_items) > 0)
                    ...
                    @foreach ($edit_items as $dt)
                        <tr>
                            ...
                            <td><input class="form-control text-end" value="{{$dt->boxno}}" type="text" name="box_no[]"></td>


                            <td><input class="form-control text-center" value="{{$dt->qty}}" type="text" name="qty[]"
                                    autocomplete="off" min="0" onchange="calc_change_new(this)"></td>

                            <td><input class="form-control text-end" type="text" value="{{$dt->coo}}" name="coo[]"></td>
                            <td><input class="form-control text-end" type="text" value="{{$dt->hscode}}" name="hscode[]"></td>
                            <td><input class="form-control text-end " type="text" value="{{$dt->weight}}" name="weight[]"></td>
                            <td><input class="form-control text-start" type="text"  value="{{$dt->dimension}}" name="dimension[]"></td>
                        </tr>
                        @php
                            $i++;
                        @endphp
                ...
                <tr>
                    ...
                    <td><input class="form-control text-start" type="text" name="dimension[]"></td>
