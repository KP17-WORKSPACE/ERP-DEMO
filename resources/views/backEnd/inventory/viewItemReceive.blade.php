                            ...
                            <div class="offset-lg-4 col-lg-4">
                                <div class="invoice-details-right">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <p>{{(isset($viewData)) ? date('jS M, Y', strtotime(@$viewData->receive_date)) : ''}}</p>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                    ...
                                    <span class="primary-btn fix-gr-bg large mt-30">${{(isset($viewData)) ? @App\SysHelper::com_curr_format( (float) @$viewData->grand_total, 2, '.', '') : ''}}</span>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="d-table table-responsive custom-table" cellspacing="0" width="100%">
                                    ...
                                    @foreach($editDataChildren as $value)
                                        <tr>
                                            ...
                                            <td>{{@App\SysHelper::com_curr_format( (float) @$value->unit_price, 2, '.', '')}} </td>
                                            <td>{{@App\SysHelper::com_curr_format( (float) @$value->sub_total, 2, '.', '')}}</td>
                                        </tr>
                                    ...
                                    @endif
                                        ...
                                        <tr>
                                            ...
                                            <td>{{@App\SysHelper::com_curr_format( (float) @$sub_totals, 2, '.', '')}}</td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td></td>
                                            ...
                                            <td class="fw-600">
                                            {{(isset($viewData)) ? @App\SysHelper::com_curr_format( (float) @$viewData->total_paid, 2, '.', '') : ''}}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            ...
                                            <td class="fw-600">
                                            {{(isset($viewData)) ? @App\SysHelper::com_curr_format( (float) @$viewData->total_due, 2, '.', '') : ''}}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            ...
                                            {{(isset($viewData)) ? @App\SysHelper::com_curr_format( (float) @$viewData->grand_total, 2, '.', '') : ''}}
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
