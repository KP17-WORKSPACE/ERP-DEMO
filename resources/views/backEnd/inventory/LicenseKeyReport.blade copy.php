...
<div class="container-fluid">
    <div class="d-sm-flex justify-content-between">
        <div class="mb-3">
            <h2 class="page-heading m-0">License Key Report</h2>
            <span class="page-label">Home - License Key Report</span>
        </div>
        <div>
    ...
    <style>
        .show-hide {width:150px; text-overflow: ellipsis; white-space: nowrap; overflow: hidden;}
        .show-hide.expanded { white-space: normal; overflow: visible; }
    </style>
<script>
    ...
    <div class="card p-4 mb-2">
        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'license-key-report', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                ...
                <table class="table table-bordered table-striped" width="100%" cellspacing="0">
                    <thead>                        
                        <tr>
                            ...
                            <th style=" color: #000000;">@lang('Account Name')</th>
                            <th style=" color: #000000;">@lang('Reference Name')</th>
