                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-2 mb-10">
                                                    <div class="input-effect">
                                                        ...
                                                        <input class="form-control {{ $errors->has('part_number') ? ' is-invalid' : '' }}"
                                                            ...
                                                            value="{{ @App\SysHelper::get_new_code('sys_packing_list','PK' ,'doc_number') }}" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-2 mb-10">
                                                    <div class="input-effect">
                                                        ...
                                                        <input class="form-control {{ $errors->has('part_number') ? ' is-invalid' : '' }}"
                                                            type="date" name="refdate" autocomplete="off" id="refdate" 
                                                             required>
                                                    </div>
                                                </div>
                                        ...
                                        <table class="table table-bordered table-striped" id="table_id" width="100%" cellspacing="0">
                                            <thead>
                                                ...
                                                function add_rows() {
                                                    ...
                                                    $("#loading_bg").css("display", "block");
                                                    var action = "{{ URL::to('packing-list-cart-add') }}";
                                                    $.ajax({
                                                        url: action,
                                                        type: "POST",
                                                        data: {
                                                ...
                                                function row_update() {
                                                    ...
                                                    var action = "{{ URL::to('packing-list-cart-update') }}";
                                                    $.ajax({
                                                        url: action,
                                                        type: "POST",
                                                        data: {
                                                ...
                                                function row_delete(id) {
                                                    ...
                                                    $("#loading_bg").css("display", "block");
                                                    var action = "{{ URL::to('packing-list-cart-delete') }}";
                                                    $.ajax({
                                                        url: action,
                                                        type: "POST",
                                                        data: {
                                        ...
                                        <table class="table table-bordered table-striped" id="po-table" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $dt->coo }} <input type="hidden" id="serialno_{{ $dt->id }}" value="{{ $dt->coo }}" /></td>
                                                    <td>{{ $dt->hscode }} <input type="hidden" id="narration_{{ $dt->id }}" value="{{ $dt->hscode }}" /></td>
                                                    <td>{{ $dt->weight }} <input type="hidden" id="narration_{{ $dt->id }}" value="{{ $dt->weight }}" /></td>
                                                    <td>{{ $dt->dimension }} <input type="hidden" id="narration_{{ $dt->id }}" value="{{ $dt->dimension }}" /></td>
                                                    <td>
