...
<div class="container-fluid">
    <div class="d-sm-flex justify-content-between">
        <div class="mb-3">
            <h2 class="page-heading m-0">Import Excess Stock (Stock In)</h2>
            <span class="page-label">Home - Import Excess Stock (Stock In)</span>
        </div>
        <div>
            <a href="{{ url('stock-in/show') }}" class="btn btn-primary"><i class="fa fa-plus"></i> List</a>
            <a href="{{ url('stock-in-import') }}" class="btn btn-info"><i class="fa fa-plus"></i> Import</a>
        </div>
    </div>
    <div class="card shadow mb-4">
        <div class="card-body">
            <div class="row">
                <div class="col-lg-12">
                    {{ Form::open(['class' => 'form-horizontal','url' => 'stock-in-import-list', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                            ...
                            <div class="row mb-10">
                                ...
                                <div class="col-lg-2">
                                    <div class="input-effect">
                                        ...
                                        @if (count($data)>0)
                                        <a href="{{ url('stock-in-import-clear') }}" class="btn btn-info mt-2">Clear Data</a> @endif
                                    </div>
                                </div>
                            </div>                            
                        </div>
                ...
                <div class="col-lg-12 text-center">
                    {{ Form::open(['class' => 'form-horizontal','url' => 'stock-in-import-data', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                        @if (session()->has('message-success'))
                            <div class="alert alert-success mb-20">
                                {{ session()->get('message-success') }}
                            </div>
