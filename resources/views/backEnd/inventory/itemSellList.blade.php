                    ...
                    <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ date('jS M, Y', strtotime(@$value->sell_date)) }}</td>
                                
                                <td>{{@App\SysHelper::com_curr_format( (float) @$value->grand_total, 2, '.', '')}}</td>
                                <td>{{@$value->total_quantity}}</td>
                                <td>{{@App\SysHelper::com_curr_format( (float) @$value->total_paid, 2, '.', '')}}</td>
                                <td>{{@App\SysHelper::com_curr_format( (float) @$value->total_due, 2, '.', '')}}</td>
                                <td>
                                            ...
                                            @endif
                                             ...
                                             @if(@$value->paid_status != 'P')
                                              ...
                                              @endif
                                                ...
                                                <a class="dropdown-item deleteUrl" data-modal-size="modal-md" title="Delete Sold Item" href="{{url('delete-item-receive-view', @$value->id)}}">@lang('lang.delete')</a>
                                                @endif
                                                @endif
