...
<div class="container-fluid">
    <div class="d-sm-flex justify-content-between">
        <div class="mb-3">
            <h2 class="page-heading m-0">Excess Stock View (Stock In)</h2>
            <span class="page-label">Home - Excess Stock View (Stock In)</span>
        </div>
        <div>
            <a href="{{ url('stock-in/show') }}" class="btn btn-primary"><i class="fa fa-list"></i> List</a>
            <a href="{{ url('stock-in/'.$edit->id.'/edit') }}" type="button" class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>
            <!-- Input with Search -->
            ...
            <script>
                const baseUrl = "{{ url('get-edit-url-stock-in') }}";                
                            ...
                            <div class="white-box">
                                ...
                                <div class="add-visitor">
                                    ...
                                    <div class="equipment comon-status row d-block">
                                        ...
                                        <table class="table table-bordered table-striped" id="table_id" width="100%" cellspacing="0" style="display: none;">
                                            <thead>
                                                <tr>
                                                ...
                                                function add_rows() {
                                                    ...
                                                    var action = "{{ URL::to('stock-in-items-add') }}";
                                                    $.ajax({
                                                        url: action,
                                                        type: "POST",
                                                        data: {
                                                ...
                                                function row_update() {
                                                    ...
                                                    var action = "{{ URL::to('stock-in-items-update') }}";
                                                    $.ajax({
                                                        url: action,
                                                        type: "POST",
                                                        data: {
                                                ...
                                                function row_delete(id) {
                                                    ...
                                                    $("#loading_bg").css("display", "block");
                                                    var action = "{{ URL::to('stock-in-items-delete') }}";
                                                    $.ajax({
                                                        url: action,
                                                        type: "POST",
                                                        data: {
