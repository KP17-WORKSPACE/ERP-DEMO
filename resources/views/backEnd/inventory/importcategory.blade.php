...
@section('mainContent')
    ...
    <div class="content-container col-9">
        <div class="tab-content display-flex-tabs" id="categoryImportTabContent">
            <div class="tab-pane fade show active" id="category-import-1" role="tabpanel" aria-labelledby="category-import-1-tab">
                <div class="purchase-order-content-header">
                    <h4 class="purchase-order-content-header-left mt-2">Import Category</h4>
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                {{ Form::open(['class' => 'form-horizontal', 'url' => 'category-import-list', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-3 mb-2">
                                                <div class="input-effect">
                                                    <label class="txtlbl">Choose File <span>*.xlsx, *.xls, *.csv</span> (<a href="{{ url('public/uploads/category_upload/category_import_sample_file.csv') }}" target="_blank">Sample File</a>)</label>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="input-effect d-flex gap-2" style="margin-top: 12px">
                                                    ...
                                                    @if (count($data) > 0)
                                                        <a href="{{ url('category-import-clear') }}" class="btn btn-light mt-2">Clear Data</a>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        @if (count($data) > 0)
                                            @foreach ($data as $value)
                                                @php
                                                    $name = trim(@$value['category_name']);
                                                    $isDuplicate = in_array(mb_strtolower($name), $existingCategories);
                                                @endphp
                                                <tr @if($isDuplicate) class="bg-warning" @endif>
                                                    <td>{{ $name }}</td>
                                                </tr>
                                            @endforeach
                                        @endif
                            ...
                            @if (count($data) > 0)
                                <div class="col-lg-12 text-center">
                                    {{ Form::open(['class' => 'form-horizontal', 'url' => 'category-import-data', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
