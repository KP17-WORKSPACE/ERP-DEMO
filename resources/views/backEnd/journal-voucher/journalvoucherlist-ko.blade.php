        ...
        <h4 class="mb-2">Journal Voucher</h4>
                    ...
                    @foreach ($journalvoucher as $value)
                        <li class="nav-item w-100" role="presentation">
                            <button href="javascript:void(0)" class="nav-link data-item {{ $id == $value->id ? 'active' : '' }}"
                                data-id="{{ $value->id }}">
                    ...
                    @if (isset($journalvoucher))
                        @foreach ($journalvoucher as $value)
                            <tr @if ($value->status == 2) class="bg-dark" @endif
                                ...
                                <td>
                                    <div class="truncate-text" style="max-width:500px;">
                                    {{ @$value->narration }}</div>
                                </td>
                                <td class="text-end">
