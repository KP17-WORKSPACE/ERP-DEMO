...
@section('mainContent')
    ...
    <div class="container-fluid">
        <div class="d-sm-flex justify-content-between">
            <div class="mb-3">
                <h2 class="page-heading m-0">Short Term Loan View (STL)</h2>
                <span class="page-label">Home - Short Term Loan View (STL)</span>
            </div>
            <div>
                {{-- <a href="{{ url('#') }}" target="_blank" type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Attachment</a> --}}
                <a href="{{ url('stl-add') }}" target="_blank" type="button" class="btn btn-info"><i class="fa fa-plus"></i> New</a>
                <a href="{{ url('stl') }}" type="button" class="btn btn-info"><i class="fa fa-list"></i> List</a>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 mb-2">
                            <div class="input-effect">
                                <label class="txtlbl">Doc Number<span>*</span></label>
                                <input
                                    class="form-control"
                        ...
                        <div class="col-lg-3 mb-2">
                            <div class="no-gutters input-right-icon">
                                <div class="col">
                                    <div class="input-effect">
                                        <label class="txtlbl">Doc Date</label>
                                        <input class="form-control" id="doc_date" type="date" autocomplete="off" name="doc_date" value="{{ $edit->doc_date }}" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 mb-2">
                            <label class="txtlbl">@lang('Bank') <span>*</span></label>
                        ...
                        <div class="col-lg-2 mb-2">
                            <div class="no-gutters input-right-icon">
                                <div class="col">
                                    <div class="input-effect">
                                        <label class="txtlbl">Exchange Rate</label>
                        ...
                        <div class="col-lg-2 mb-2">
                            <div class="no-gutters input-right-icon">
                                <div class="col">
                                    <div class="input-effect">
                                        <label class="txtlbl">Amount in USD</label>
                        ...
                        <div class="col-lg-2 mb-2">
                            <div class="no-gutters input-right-icon">
                                <div class="col">
                                    <div class="input-effect">
                                        <label class="txtlbl" id="amt_txt">Amount in {{ $currency_code }}</label>
                        ...
                        <div class="col-lg-2 mb-2">
                            <div class="no-gutters input-right-icon">
                                <div class="col">
                                    <div class="input-effect">
                                        <label class="txtlbl">Syscom Representative</label>
                        ...
                        <div class="col-lg-2 mb-2">
                            <div class="no-gutters input-right-icon">
                                <div class="col">
                                    <div class="input-effect">
                                        <label class="txtlbl">Bank Representative</label>
                        ...
                        <div class="col-lg-4 mb-2">
                            <label class="txtlbl">@lang('Vendor Name') <span>*</span></label>
                        ...
                        <div class="col-lg-3 mb-2">
                            <label class="txtlbl">@lang('Payment Type') <span>*</span></label>
...
TT Value to "+vend.trim()+" to be "+curr.trim()+" "+usd.trim()+" as per below details";
                        ...
                        <div class="col-lg-3 mb-2">
                            <label class="txtlbl">@lang('PI / PI') <span>*</span></label>
                            <select class="form-control" name="pi_no" id="pi_no" onchange="get_pending_list()" required>
                                ...
                                <option value="2" @if("2"==$edit->pi_no) selected @endif>Performa Invoice</option>
                            </select>
                        </div>
                        <div class="col-lg-2 mb-2">
                            <div class="no-gutters input-right-icon">
                                <div class="col">
                                    <div class="input-effect">
                                        <label class="txtlbl">Submission Date</label>
                                        <input class="form-control" id="submition_date" type="date" autocomplete="off" name="submition_date" value="{{ $edit->submition_date }}" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 mb-2" id="div_partial_remarks" style="display: none;">
                            <div class="no-gutters input-right-icon">
                                <div class="col">
                                    <div class="input-effect">
                                        <label class="txtlbl">Remarks (Partial Payment)</label>
                        ...
                        <div class="col-lg-9 mb-2">
                            <div class="no-gutters input-right-icon">
                                <div class="col">
                                    <div class="input-effect">
                                        <label class="txtlbl">Narration</label>
                        ...
                        <div class="col-lg-3 mb-2">
                            <label class="txtlbl">@lang('With / Without Amount') <span>*</span></label>
    ...
    <div class="row">
        <div class="col-lg-12"><br /><b>List of Purchase Invoice</b><hr /></div>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="table-striped">
                
                <table  id='table_id_stl_' class='mt-2 display school-table' cellspacing='0' width='100%' style='border: solid 1px #f2f2f2;'>
                @if(count($edit_items)>0)
                <thead><tr><th class='mt-2'></th><th><span id='table_id_stl_docno_{{ $edit_items[0]->id }}'></span></th><th>{{ $edit_items[0]->pi_inv_no }}&nbsp;|&nbsp;{{ $edit_items[0]->bill_no }}</th><th></th><th></th></tr>
                ...
                <tbody>
                    @php $i=1; @endphp
                @foreach($edit_items as $items)
                <tr><td style='width: 50px;'>{{ $i }}</td>
            ...
            @endif
                ...
                {{-- <table id="table_id_stl" class="display school-table" cellspacing="0"width="100%">
                    <thead>
                        <tr>
    ...
    <div class="row">
        <div class="col-lg-12">
            <table class="table-striped" style="width: 350px;">
                <tr><td style="width: 130px;">&nbsp;Value of Hardware</td><td class="text-right"><label class="mt-1" id="total_hardware">0.00</label></td></tr>
                <tr><td>&nbsp;Value of Licence</td><td class="text-right"><label class="mt-1" id="total_license">0.00</label></td></tr>
                <tr><td>&nbsp;<b>Total</b></td><td class="text-right"><label class="mt-1 font-weight-bold" id="total_hl">0.00</label></td></tr>
            </table>
        </div>
    </div>
                        ...
                        if(len > 0){
                            ...
                            for(var i=0; i<len; i++){
                                    ...
                                    var innerHtml =
                                        ...
                                        "'> <label for='pending_pi_" + i + "'> " + doc_number +
                                        "</label><br />";
                                    ...
                                    var innerTable =
                                        ...
                                        <thead><tr><th class='mt-2'></th><th><span id='table_id_stl_docno_"+id+"'></span></th><th><span id='table_id_stl_billno_"+id+"'></span>&nbsp;|&nbsp;<span id='table_id_stl_awbno_"+id+"'></span>&nbsp;|&nbsp;<span id='table_id_stl_boeno_"+id+"'></span></th><th></th><th><a class='btn-sm btn-danger' onclick='deleteTable(this)'>Remove</a></th></tr>\
                                                ...
                                                <tfoot><tr><th></th><th></th><th></th><th class='text-right'><span id='table_id_total_"+id+"'></span></th></tr></tfoot></table>";
                ...
                if (file && file.name.endsWith(".xlsx")) {
                    ...
                    reader.onload = function(event) {
                        ...
                        for (var i = 1; i < jsonData.length; i++) { // Skip the header row
                            ...
                            // Amount (Cell 3)
                            row.append('<td><input class="form-control text-right cl_'+(i-1)+'" type="text" name="amount[]" value="' + formatAmount(rowData[1]) + '" placeholder="Amount" onchange="set_total2('+id+')"></td>');
