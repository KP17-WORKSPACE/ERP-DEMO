    ...
    <div class="container-fluid p-0">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'price-book/show', 'method' => 'POST', 'id' => 'crm-deals-search']) }}
                <div class="row">
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-2">
                        <div class="input-effect mt-2"><br />
                            <button type="submit" class="primary-btn fix-gr-bg" id="btnSubmit"><i class="fa fa-search" aria-hidden="true"></i> Find</button>
                        </div>
                    </div>
                </div>
                {{ Form::close() }}
                        ...
                        <table id="table_custom" class="display school-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{@$value->r_price}} {{@$value->code}}</td>
                                    <td>{{@$value->e_price}} {{@$value->code}}</td>
                                    <td>
                                        @if(@$value->status==1)
                                    ...
                                    <td>
                                        ...
                                        <a class="dropdown-item" href="{{url('price-book/'.$value->pid.'/'.$value->id.'/edit')}}">@lang('Edit')</a>
                                        @endif
                                    </td>
                                </tr>
