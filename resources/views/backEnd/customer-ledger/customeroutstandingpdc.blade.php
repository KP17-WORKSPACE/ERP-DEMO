    ...
    <?php try { ?>
        ...
        <div class="container-fluid">
            <div class="d-sm-flex justify-content-between">
                <div class="mb-3">
                    <h2 class="page-heading m-0">Customer Outstanding - PDC</h2>
                    <span class="page-label">Home - Customer Outstanding - PDC</span>
                </div>
                <div>
                ...
                <table class="table" style="border: solid 1px #e3e6f0;">
                    <thead>
                      <tr>
                          ...
                          <th class="border text-center" width="10%">LPO Date</th>
