    ...
    <?php try { ?>
        ...
        <div class="container-fluid">
            <div class="d-sm-flex justify-content-between">
                <div class="mb-3">
                    <h2 class="page-heading m-0">Customer Outstanding</h2>
                    <span class="page-label">Home - Customer Outstanding</span>
                </div>
                <div>
            ...
            <div class="card p-4 mb-2">
                {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'customer-outstanding', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
            ...
            <div class="card p-4">
                <table class="table" style="border: solid 1px #e3e6f0;">
                    <thead>
                      <tr>
                          <th class="border text-center" width="10%">Doc Date</th>
                          <th class="border text-center" width="5%">Doc No</th>
                          <th class="border text-center" width="10%">LPO No</th>
                          <th class="border text-center" width="5%">LPO Date</th>
                          <th class="border text-center" width="10%">Amount</th>
                          <th class="border text-center" width="10%">Adjustments</th>
                          <th class="border text-center" width="10%">Inv Balance</th>
                          <th class="border text-center" width="10%">Total Balance</th>
                          <th class="border text-center" width="10%">Salesman</th>
                          <th class="border text-center" width="10%">Payment Terms</th>
                          <th class="border text-center" width="10%">Due Date</th>
                      </tr>
                    </thead>
                    <tbody>
                        <tr>
