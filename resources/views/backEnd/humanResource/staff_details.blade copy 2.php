        ...
        <div class="tab-pane fade" id="tab-job" role="tabpanel" aria-labelledby="tab-job-tab">
                ...
                <div class="col-10">
                    <div class="row row-cols-5">
                        ...
                        <div class="col mb-3">
                            ...
                            <div class="form-control-plaintext truncate-text-custom">
                                {{ ucwords(str_replace('_', ' ', optional($job)->employment_type ?: $employee->employment_type ?: '—')) }}
                            </div>
                        </div>
                ...
                <div class="col-10">
                    <div class="row row-cols-5">
                        <div class="col">
                            ...
                            <div class="form-control-plaintext truncate-text-custom">
                                {{ optional($job)->work_location ?: '—' }}</div>
                        </div>

                        <div class="col">
                            <label class="form-label">Work Hours:</label>
                            <div class="form-control-plaintext truncate-text-custom">
                                {{ optional($job)->work_hours ?: '—' }}</div>
                        </div>
                ...
                <div class="col-10">
                    <div class="row row-cols-5">
                        ...
                        <div class="col">
                            ...
                            <div class="form-control-plaintext truncate-text-custom">
                                {{ optional($job)->other_benefits ?: '—' }}</div>
                        </div>
            ...
            @if ($user_role == 'Sales')
                @php
                    ...
                    $brandsArr = [];
                    if ($brandsRaw) {
                        if (is_array($brandsRaw)) {
                            $brandsArr = $brandsRaw;
                        } elseif (is_string($brandsRaw)) {
                            $brandsArr = array_filter(array_map('trim', explode(',', $brandsRaw)));
                        }
                    }
                    ...
                    if (!empty($brandsArr)) {
                        if (in_array('all', $brandsArr)) {
                            ...
                            $ids = array_values(
                                array_filter($brandsArr, function ($v) {
                                    return is_numeric($v);
                                }),
                            );
                            if (!empty($ids)) {
                            ...
                            <div class="form-control-plaintext truncate-text-custom">
                                @if (optional($job)->att_resume)
                                    <a href="{{ asset('storage/app/public/' . $job->att_resume) }}"
                                        target="_blank">{{ basename(optional($job)->att_resume) }}</a>
                                @else
                                    <span class="text-muted">—</span>
                                @endif
                            </div>
                            ...
                            <div class="form-control-plaintext truncate-text-custom">
                                @if (optional($job)->att_offer_letter)
                                    <a href="{{ asset('storage/app/public/' . $job->att_offer_letter) }}"
                                        target="_blank">{{ basename(optional($job)->att_offer_letter) }}</a>
                                @else
                                    <span class="text-muted">—</span>
                                @endif
                            </div>
                        ...
                        <div class="col">
                            ...
                            <div class="form-control-plaintext truncate-text-custom">
                                @if (optional($job)->att_signed_contract)
                                    <a class=""
                                        href="{{ asset('storage/app/public/' . optional($job)->att_signed_contract) }}"
                                        target="_blank">{{ basename(optional($job)->att_signed_contract) }}</a>
                                @else
                                    <span class="text-muted">—</span>
                                @endif
                            </div>
