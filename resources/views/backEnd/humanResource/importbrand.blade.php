...
@section('mainContent')
    ...
    <div class="content-container col-9">
        <div class="tab-content display-flex-tabs" id="brandImportTabContent">
            <div class="tab-pane fade show active" id="brand-import-1" role="tabpanel" aria-labelledby="brand-import-1-tab">
                <div class="purchase-order-content-header">
                    <h4 class="purchase-order-content-header-left mt-2">Import Brands</h4>
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                {{ Form::open(['class' => 'form-horizontal', 'url' => 'brand-import-list', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-3 mb-2">
                                                <div class="input-effect">
                                                    <label class="txtlbl">Choose File <span>*.xlsx, *.xls, *.csv</span> (<a href="{{ url('public/uploads/brand_upload/brand_import_sample_file.csv') }}" target="_blank">Sample File</a>)</label>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="input-effect d-flex gap-2" style="margin-top: 12px">
                                                    ...
                                                    @if (count($data) > 0)
                                                        <a href="{{ url('brand-import-clear') }}" class="btn btn-light mt-2">Clear Data</a>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-12 " id="long-list" style="overflow: scroll;">
                                <table class="table table-hover" cellspacing="0">
                                    ...
                                    <tbody>
                                        @php
                                            $existingBrands = collect($brands)->pluck('title')->map(function ($t) {
                                        ...
                                        @if (count($data) > 0)
                                            @foreach ($data as $value)
                                                @php
                                                    ...
                                                    $isDuplicate = in_array(mb_strtolower($title), $existingBrands);
                                                @endphp
                            ...
                            @if (count($data) > 0)
                                <div class="col-lg-12 text-center">
                                    {{ Form::open(['class' => 'form-horizontal', 'url' => 'brand-import-data', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
