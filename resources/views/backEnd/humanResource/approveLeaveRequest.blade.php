                    ...
                    <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{date('jS M, Y', strtotime(@$apply_leave->leave_from))}}</td>
                                <td>{{date('jS M, Y', strtotime(@$apply_leave->leave_to))}}</td>
                                <td>{{date('jS M, Y', strtotime(@$apply_leave->apply_date))}}</td>
                                <td>
                                    ...
                                    <button class="btn primary-btn small fix-gr-bg">@lang('lang.approved')</button>
                                    @endif
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a data-modal-size="modal-lg" title="View/Edit Leave Details" class="dropdown-item modalLink" href="{{url('view-leave-details-approve', @$apply_leave->id)}}">@lang('lang.view')/@lang('lang.edit')</a>
                                            @endif
