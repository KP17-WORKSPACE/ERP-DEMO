                    ...
                    <div class="white-box">
                        <div class="single-meta mt-20">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="value text-left">
                                        AKST{{sprintf("%03d", @$staffDetails->staff_no)}}
                                ...
                                <div class="col-lg-2 col-md-9 d-flex">
                        ...
                        <div class="single-meta">
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-md-6">
                                    <span class="ml-20 value">
                                    {{App\User::NumberToBangladeshiTakaFormat(@$unsettled_amount)}}
                                    </span>
                                </div>
                            ...
                            <tr class="d-block">
                                <td width="100%" class="pr-30 d-block">
                                    <div class="input-effect mt-10">
                                        ...
                                        <label for="basicSalary">@lang('lang.basic_salary')</label>
                                        <span class="focus-border"></span>
                                    </div>
                                </td>
                            </tr>
                            <tr class="d-block">
                                <td width="100%" class="pr-30 d-block">
                                    <div class="input-effect mt-30">
                                        ...
                                        <label for="total_earnings" id="earnings_label">@lang('lang.earning')</label>
                                        <span class="focus-border"></span>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr class="d-block">
                                <td width="100%" class="pr-30 d-block">
                                    <div class="input-effect mt-30">
                                        ...
                                        <label for="gross_salary">@lang('lang.gross_salary')</label>
                                        <span class="focus-border"></span>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr class="d-block">
                                <td width="100%" class="pr-30 d-block">
                                    <div class="input-effect mt-30 mb-30">
                                        ...
                                        <label for="net_salary">@lang('lang.net_salary')</label>
                                        <span class="focus-border"></span>
