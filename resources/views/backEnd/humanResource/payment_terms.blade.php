            ...
            <div class="" role="tabpanel" aria-labelledby="data-tab" id="data-details">
                <div class="purchase-order-content-header">
                    ...
                    <div class="purchase-order-content-header-right">
                        <a class="btn btn-light text-dark" href="{{ url('payment-terms') }}">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="row">
                                    <div class="col-lg-12">
                                        @if (isset($editmode))
                                            {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'payment-terms/' . @$editmode->id, 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
                                        @else
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="input-effect">
                                                            <label class="txtlbl">@lang('Payment Terms') @lang('lang.title')
                                                                <span>*</span></label>
                                                            <input class="form-control" type="text" name="title"
                                                                autocomplete="off"
                                                                value="{{ isset($editmode) ? @$editmode->title : '' }}">
                                            ...
                                            <tbody>
                                                @foreach ($paymentterms as $paymentterm)
                                                    ...
                                                    <div class="modal side-panel fade"
                                                        id="deleteDesignationModal{{ @$paymentterm->id }}"
