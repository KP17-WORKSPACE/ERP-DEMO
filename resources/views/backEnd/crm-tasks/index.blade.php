...
@section('mainContent')
    ...
    <script>
        ...
        function list_style_new() {
            ...
            if (!isFullList) {
                ...
                localStorage.setItem('listViewTasks', 'long');
            } else {
                ...
                localStorage.setItem('listViewTasks', 'short');
        ...
        document.addEventListener('DOMContentLoaded', () => {
            const savedView = localStorage.getItem('listViewTasks');
            if (savedView === 'long') {
                ...
                <div class="search-filter-container mb-0">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" style="">
                            ...
                            <li>
                                <a href="{{ url('crm-user-tasks/pending') }}"
                            ...
                            <li>
                                <a href="{{ url('crm-user-tasks/completed') }}"
                                    class="dropdown-item d-flex align-items-center"><i
                            ...
                            <li>
                                <a href="{{ url('tasks-assigned-by-me/all') }}"
                                    class="dropdown-item d-flex align-items-center"><i
                                        class="ico icon-outline-document-text text-success title-15 me-2"></i> Assigned by
                                    Me
                        ...
                        <li class="nav-item w-100" role="presentation">
                            <button class="nav-link task-item {{ $active_id == $item->id ? 'active' : '' }}"
                                ...
                                <div class="row w-100">
                                    ...
                                    <div class="col-4">
                                        <div class="form-control-plaintext" style="font-size: 11px">{{ @$item->task_id }}</div>
                                    </div>
                ...
                <table id="long-list" class="table table-hover d-none data-table" style="table-layout: fixed;width:100%">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="width: 120px;">@lang('Assigned By')
                            </th>
                            ...
                            <th class="text-center" style="width: 60px;"> <i class="ico icon-bold-paperclip"></i> </th>
                        ...
                        @foreach ($assigned_tasks as $value)
                            <tr class="main-row" onclick="toggleDetails({{ $value->id }})" style="cursor: pointer;">
                                ...
                                <td class="text-center" onclick="event.stopPropagation();">
                                  ...
                                  <td class="text-center" onclick="event.stopPropagation();">
                                    @php
                                        $attachments = $value->taskitems()->whereNotNull('attachment')->get();
                                    @endphp
        ...
        <div class="tab-content display-flex-tabs" id="purchaseOrderTabContent">
            ...
            <script>
                $(document).ready(function() {
                    $(document).on('click', '.task-item', function() {
                        ...
                        var newUrl =
                            "{{ url('crm-user-tasks') }}@if ($current_status)/{{ $current_status }}@endif/" +
                            id;
                        window.history.pushState({
                            path: newUrl
                        }, '', newUrl);

                        var action = "{{ URL::to('crm-user-tasks-details') }}/" + id;
                        $('#loading_bg').show();
            ...
            <div class="" role="tabpanel" aria-labelledby="po-tab" id="po-details">
                @if (!empty($selectedTask) && is_array($selectedTask))
                    @include('backEnd.crm-tasks.viewtask', $selectedTask)
                @else
                    <div data-bs-toggle="modal" data-bs-target="#ModalAddNewTask"
                        ...
                        <div class="text-center mb-4">
                            ...
                            <h1 class="fw-bold mt-3" style="cursor:pointer" data-bs-toggle="modal"
                                data-bs-target="#ModalAddNewTask"> Assign Task</h1>
    ...
    <div class="modal side-panel fade" id="ModalTaskUpdate" data-bs-backdrop="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-lg" style="top: 10%">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="editModalLabel">Update Progress (<span class="font-weight-600"
                            id="modal_task_id_text"></span>)
                    </h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body m-0 p-0">
    ...
    <div class="modal  fade" id="ModalTaskComments" data-bs-backdrop="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-lg" style="top: 10%">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button id="submitComment" class="btn btn-sm btn-light"> <i class="ico icon-bold-plain text-success"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#document_number').on('input', function() {
                ...
                $.ajax({
                    url: "{{ route('crm-user-tasks.search') }}",
                    type: "GET",
                    data: {
                        query: query
                    },
                        ...
                        if (data.length > 0) {
                            ...
                            <button class="nav-link task-item"
                                ...
                                <div class="row w-100">
                                    ...
                                    <div class="col-4">
                                        <div class="form-control-plaintext" style="font-size: 11px">${record.task_id}</div>
                                    </div>
                                    <div class="col-4 text-center">
                                        <div class="form-control-plaintext" style="font-size: 11px">
