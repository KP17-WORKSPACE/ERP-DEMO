...
<div class="purchase-order-content-header">
    ...
    <div class="purchase-order-content-header-right">
        ...
        <button type="button" class="btn btn-light btn-comments-view comment-btn-wrapper"
            data-task-id="{{ $task->id }}" data-task-item-taskid="{{ $task->task_id }}">

            <i class="ico icon-outline-chat-round-dots" aria-hidden="true" style="font-size: 16px"></i>
            Comments
...
<div class="card mb-3">
    <div class="card-body">
        ...
        <div class="d-flex align-items-center mb-3">
            <div class="font-weight-600 title-15 me-3"> {{ $task->task_title }} 
        ...
        <div class="row">
            ...
            <div class="col-2 mb-3">
                ...
                <div class="form-control-plaintext"> {{ $task->assignedby->full_name }}
                </div>
            </div>
            ...
            <div class="col-1-5 mb-3">
                ...
                <div class="form-control-plaintext"> <a target="_blank" class="btn-sm text-dark btn-light"
