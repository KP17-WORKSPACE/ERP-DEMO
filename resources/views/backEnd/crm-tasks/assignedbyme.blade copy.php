        ...
        <div class="d-sm-flex justify-content-between">
            <div class="mb-3">
                <h2 class="page-heading m-0">
                    ...
                    @else
                        Tasks Assigned By Me ({{ $taskCounts->completed_count + $taskCounts->pending_count }})
                    @endif
                </h2>
                <span class="page-label">Home - Tasks Assigned by Me</span>
            </div>
            <div>
                ...
                <a class="btn btn-danger" target="_blank" href="{{ url('crm-user-tasks/assigned-by-me/pending') }}">Pending
                    Tasks
                    ({{ $taskCounts->pending_count ?? 0 }})</a>

                <a class="btn btn-success" target="_blank"
                    href="{{ url('crm-user-tasks/assigned-by-me/completed') }}">Completed Tasks
                    ({{ $taskCounts->completed_count ?? 0 }})</a>
                <a class="btn btn-info" target="_blank" href="{{ url('crm-user-tasks') }}">My Tasks
                    ({{ $taskCounts_assigned_to->completed_count_assigned_to + $taskCounts_assigned_to->pending_count_assigned_to }})</a>
                            ...
                            @foreach ($assigned_tasks as $value)
                                <tr class="main-row" onclick="toggleDetails({{ $value->id }})" style="cursor: pointer;">
                                    ...
                                    <td onclick="event.stopPropagation();">
                                        ...
                                        <a type="button" class="btn-sm btn-info update-status-btn"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="status_s" class="control-label">
                            <i class="fa fa-line-chart text-success"></i> Update Status <span class="text-danger">*</span>
                        </label>
