...
@section('mainContent')
    ...
    <div class="content-container col-9 page-chart-of-accounts">
        ...
        <div class="purchase-order-content-header-right">
            ...
            <input type="text" class="form-control w-25 rounded" id="smart_search" name="smart_search" placeholder="Search..." />
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item d-flex align-items-center" data-bs-toggle="modal"
                            data-bs-target="#groupModal"><i
                                class="ico title-15 icon-outline-add-square me-2 text-success"></i> Group</a></li>
                    <li><a class="dropdown-item d-flex align-items-center" data-bs-toggle="modal"
                            data-bs-target="#subgroupModal"><i
                                class="ico title-15 icon-outline-add-square me-2 text-success"></i> Sub Group</a></li>
                    <li><a class="dropdown-item d-flex align-items-center" data-bs-toggle="modal"
                            data-bs-target="#accountModal"><i
                                class="ico title-15 icon-outline-add-square me-2 text-success"></i> Account</a></li>
                    <li><a class="dropdown-item d-flex align-items-center" data-bs-toggle="modal"
                            data-bs-target="#accountSubModal"><i
                                class="ico title-15 icon-outline-add-square me-2 text-success"></i> Sub Account</a></li>
                    <li><a class="dropdown-item d-flex align-items-center" data-bs-toggle="modal"
                            data-bs-target="#accountSubEmployeeModal"><i
                                class="ico title-15 icon-outline-add-square me-2 text-success"></i> Employee Account</a>
                    </li>
                </ul>
            </div>
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item d-flex align-items-center"
                            href="{{ url('chartofaccounts-opening-balance') }}"><i
                                class="ico icon-outline-document-text title-15 me-2"></i> Opening Balance</a></li>
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                      ...
                      <li><span class="dropdown-header ">Merge</span></li>

                    @if (Auth::user()->role_id == 1 || Auth::user()->role_id == 2 || Auth::user()->role_id == 27)
                                <li><a class="dropdown-item d-flex align-items-center" data-bs-toggle="modal"
                                        data-bs-target="#ModalMergeAccount"><i
                                            class="ico icon-outline-link-square title-15 me-2"></i> Account Merge</a></li>
                                <li><a class="dropdown-item d-flex align-items-center" data-bs-toggle="modal"
                                        data-bs-target="#ModalMergeSubAccount"><i
                                            class="ico icon-outline-link-square title-15 me-2"></i> Sub Account Merge</a>
                                </li>
                    @endif

                     
                    <li><span class="dropdown-header">Move</span></li>
                    ...
                    @if (Auth::user()->role_id == 1 || Auth::user()->role_id == 2 || Auth::user()->role_id == 27)
                                ...
                                <li><a class="dropdown-item d-flex align-items-center"
                                        href="{{ url('chartofaccounts-add-sub') }}"><i
                                            class="ico icon-outline-move-to-folder title-15 me-2"></i> Sub Account Move</a>
                                </li>
                ...
                @foreach ($accountgroup as $g)
                    ...
                    <div class="tab-pane fade" id="group{{ $g->id }}">
                        <div class="d-flex justify-content-between align-items-center px-2 py-1 border-bottom">
                            ...
                            <button type="button" class="btn btn-sm group-table">
                ...
                @foreach ($accountgroup as $g)
                    ...
                    @foreach ($subs as $s)
                        ...
                        <div class="tab-pane fade" id="sub{{ $s->id }}">
                            <h6 class="px-2 py-1 border-bottom text-center">
                                {{-- {{ $s->title }} --}} Sub Groups
                            </h6>
                            <ul class="list-group">
                                @foreach ($subs2 as $s2)
                            ...
                            <div class="tab-pane fade" id="sub2{{ $s2->id }}">
                                ...
                                <ul class="list-group">
                                    @foreach ($account as $a)
                                        <li class="list-group-item truncate-text-custom accounts d-flex justify-content-between align-items-center @if ($a->status != 1) inactive @endif"
                                            onclick="selectItem(this,'.accounts'); showLayer(5, 'acc{{ $a->id }}')">
                                            <span class="truncate-text-custom">{{ $a->account_code }} -
                                                {{ $a->account_name }}</span>
                                            <i style="font-size: 16px" class="ico icon-outline-alt-arrow-right"></i>
                        ...
                        @foreach ($subs2 as $s2)
                            ...
                            @foreach ($accounts as $a)
                                ...
                                <div class="tab-pane fade" id="acc{{ $a->id }}">
                                    <h6 class="px-2 py-1 border-bottom text-center">
                                        {{-- {{ $a->account_name }} --}} Sub Accounts
                                    </h6>
                                    <ul class="list-group">
                                        @foreach ($subacc as $sa)
                                            <li class="list-group-item @if ($sa->status != 1) inactive @endif">
                                                <span class="truncate-text-custom"> {{ $sa->account_code }} -
                                                    {{ $sa->account_name }} </span>
                                            </li>
                                        @endforeach
                                        @if ($subacc->isEmpty())
