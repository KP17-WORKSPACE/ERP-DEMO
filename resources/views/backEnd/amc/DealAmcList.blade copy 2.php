    ...
    <div class="short-list" id="filters-short">
        ...
        <div class="search-filter-container mb-4">
            <div class="input-group flex-nowrap">
                <input type="text" name="search_amc_id" id="search_amc" class="form-control" placeholder="Document No"
                    aria-label="Search" aria-describedby="addon-wrapping" value="{{ $ctrl_amc_id }}">
            </div>
    ...
    <div class="long-list  d-none" id="filters-long">
        <div class="d-flex align-items-center justify-content-between">
            ...
            <div class="search-filter-container mb-0">
                ...
                <input type="text" id="tableSearch" class="form-control" style="font-size:13px; width: 350px; 
                        top: 12px;
                        right: 120px;" placeholder="Search">
                        ...
                        <li>
                            <a href="{{ url('crm-amc-service-request-list') }}"
                                class="dropdown-item d-flex align-items-center"><i
                                    class="ico icon-outline-document-text text-success title-15 me-2"></i> Request List</a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="search-filter-container mt-1 mb-4 filter-field d-none border">
            ...
            <div class="card" style="width:100%">
                <div class="card-body">
                    ...
                    {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'crm-amc-list', 'method' =>
                    'POST', 'id' => 'crm-amc-list']) }}
                    <div class="row">
                        ...
                        <div class="col-1-5 mb-2 filter-field d-none">
                            ...
                            <input class="form-control date-picker" type="text" autocomplete="off" name="search_to_date"
                                id="search_to_date" value="{{ $ctrl_date2 }}">
                        </div>
            ...
            <table id="long-list" class="table table-hover d-none data-table" style="table-layout: fixed;width:100%">
                ...
                <thead class="text-center">
                    <tr>
                        ...
                        <th class="text-start" width="130px">@lang('Sales Person')</th>
                        <th width="150px">@lang('AMC Track')</th>
                        <th width="100px">@lang('Invoicing')</th>
                        <th class="text-start" width="200px">@lang('Description')</th>
                ...
                <tbody>
                    ...
                    <tr @if (@$value->is_delete == 1) class="bg-dark" @endif>
                        <td class="text-center"><a href="{{ url('crm-amc-list/' . @$value->id) }}" target="_blank">{{
                                @$value->doc_number }}</a></td>
                        <td class="text-center"><a href="{{ url('get-url-deal-track/' . @$value->deal_code->code) }}"
                                target="_blank">{{ @$value->deal_code->code }}</a></td>
                        <td class="text-center">{{ date('d/m/Y', strtotime(@$value->date)) }}</td>
                        <td>{{ @$value->custname->name }}</td>

                        @if ($value->end_date < date('Y-m-d')) <td class="text-danger text-center">
                            ...
                            <td>
                                ...
                                <input type="hidden" id="location_{{ @$value->id }}" value="{{ $loc }}" />
                            ...
                            <td>
                                <div class="d-flex justify-content-start align-items-center gap-1">
                                    ...
                                    <a class="btn-sm btn btn-light" onclick="edit_service_request({{ $value->id }})"><i
                                    ...
                                    <a class="btn btn-m btn-light text-dark"
                                        ...
                                        title="Add Request"><i style="font-size: 16px;"
                                            class="ico icon-outline-add-square text-success" aria-hidden="true"></i>
                                        Req</a>
...
<div class="modal side-panel fade" id="AddAmcModal" data-bs-backdrop="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-lg" style="height: 400px !important;left: 31%">
        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'crm-amc-add', 'method' => 'POST',
                    ...
                    <div class="card-body">
                        <div class="row gap-rows">
                            ...
                            <div class="col-3">
                                ...
                                <select class="form-control js-example-basic-single" type="text" name="sales_person"
                                    id="sales_person" required>
                                    <option value="">-Select-</option>
...
<div class="modal side-panel fade" style="z-index: 2050;" id="descriptionModal" data-bs-backdrop="false" tabindex="-1"
    aria-labelledby="editModalLabel" aria-hidden="true">
...
<div class="modal side-panel fade" id="ModalAddNewAMCEdit" data-bs-backdrop="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-lg" style="height: 600px !important;left: 31%">
        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'crm-amc-update', 'method' => 'POST',
        'enctype' => 'multipart/form-data']) }}

        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="editModalLabel">Edit (<span id="edit_doc_number"></span>)</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body m-0 p-0">
                <div class="card mb-0 mt-0">
                    <div class="card-body">
                        <div class="row gap-rows">
                            ...
                            <div class="col-3">
                                <label for="" class="form-label">Date</label>
                                <input type="text" id="date_edit" class="form-control date-picker" name="date">
                            </div>
                            ...
                            <div class="col-3">
                                <label for="" class="form-label">Contact Person</label>
                                <input id="contact_person_edit" class="form-control" type="text" name="contact_person"
                                    required>
                            </div>

                            <div class="col-3">
                                <label for="" class="form-label">Mobile No</label>
                                <input id="mobile_no_edit" class="form-control" type="text" name="mobile_no" required>
                            </div>
                            ...
                            <div class="col-3">
                                <label for="" class="form-label">End Date</label>
                                <input id="end_date_edit" class="form-control date-picker" type="text" name="end_date">
                            </div>

                            <div class="col-3">
                                <label for="" class="form-label">Invoicing</label>
                                <div class="form-group">
                                    <select id="invoice_edit" class="form-control" type="text" name="invoice" required>
                                        <option value="">-Select-</option>
                                        <option value="Monthly">Monthly</option>
                                        <option value="Quarterly">Quarterly</option>
                                        <option value="Half Yearly">Half Yearly</option>
                            ...
                            <div class="col-3">
                                <label for="" class="form-label">Amount</label>
                                <input id="amount_edit" class="form-control" type="number" step="any" name="amount"
                                    required>
                            </div>

                            <div class="col-3">
                                <label for="" class="form-label">Sales Person</label>
                                <select id="sales_person_edit" class="form-control js-example-basic-single" type="text"
                                    name="sales_person" required>
                                    <option value="">-Select-</option>
                                    @if (count($salesperson) > 0)
                                    @foreach ($salesperson as $dt)
                                    <option value="{{ $dt->user_id }}">{{ $dt->full_name }}</option>
                            ...
                            <div class="col-3 mt-3">
                                <div class="form-group">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" style="margin-top: 0.25rem;" id="amc_expired"
                                                name="amc_expired" value="1">
                                            <span class="form-check-label" for="is_expired">
                            ...
                            <div class="col-9">
                                <div id="expired_comment_wrapper" style="display: none;">
                                    ...
                                    <textarea class="form-control" name="expired_comment" id="expired_comment"
...
<div class="modal  fade" id="ModalAddServiceRequest" data-bs-backdrop="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-lg" style="top: 10%">
        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'crm-amc-add-service-request', 'method'
        => 'POST', 'enctype' => 'multipart/form-data']) }}

        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="editModalLabel">Add Request (<span id="add_req_docnumber"></span>)</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body m-0 p-0">
                <div class="card mb-0 mt-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><input type="text" class="form-control serial text-center"
                                                        value="1"></td>
                                                <td><input type="text" name="scope_of_work[]" class="form-control task"
