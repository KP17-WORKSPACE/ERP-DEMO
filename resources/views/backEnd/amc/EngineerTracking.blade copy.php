                                ...
                                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>@if($dt->work_date != null) {{date('d/m/Y', strtotime($dt->work_date ))}} @elseif($dt->service_date != null) {{date('d/m/Y', strtotime($dt->service_date ))}}  @endif</td>
                                            <td>@if($dt->work_time_from != null) {{date('h:i A', strtotime($dt->work_time_from ))}} @elseif($dt->service_time != null)  {{date('h:i A', strtotime($dt->service_time ))}} @endif</td>
