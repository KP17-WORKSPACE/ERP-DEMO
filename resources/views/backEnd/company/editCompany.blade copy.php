                                                        ...
                                                        <div id="collapseOwners" class="accordion-collapse collapse"
                                                            ...
                                                            <div class="accordion-body">
                                                                <div id="ownerWrapper">
                                                                    ...
                                                                    <div id="ownerWrapper">
                                                                        @php $ownerCount = is_array($owners ?? []) ? count($owners) : ($owners ? $owners->count() : 0); @endphp

                                                                        @if (!empty($owners) && (is_array($owners) || $owners instanceof \Illuminate\Support\Collection))
                                                        ...
                                                        <div id="collapseCompanySetting"
                                                            ...
                                                            <div class="accordion-body">
                                                                <div class="row gy-2">
                                                                    ...
                                                                    {{-- Other Code --}}
                                                                    <div class="col-lg-2">
                                                                        <label class="form-label mb-1">All Code <span
                                                                                class="text-danger">*</span></label>
                                                        ...
                                                        <table class="table table-hover data-table" id="long-list"
                                                            ...
                                                            <tbody id="warehouseTableBody">
                                                                <tr class="no-warehouse-row">
                                                                    <td colspan="13" class="text-center text-muted">No
                    ...
                    $(document).on('click', '#bankSaveBtn', function(e) {
                        ...
                        if (editingBankIndex >= 0 && typeof banks[editingBankIndex] !== 'undefined') {
                            ...
                            if ($row.length) {
                                ...
                                $row.find('td').eq(6).text(currency);
                            ...
                            row.append($('<td class="text-center">').text(currency));
                    ...
                    $(document).on('click', '#saveWarehouseBtn', function(e) {
                        ...
                        if (editingWarehouseIndex >= 0 && typeof warehouses[editingWarehouseIndex] !== 'undefined') {
                            ...
                            if ($row.length) {
                                ...
                                $row.find('td').eq(6).text([contact_salutation, contact_first_name, contact_last_name,
                                    contact_mobile
                                ].filter(Boolean).join(' ').trim());
                                $row.find('td').eq(7).text(fire_safety_compliance_status || '—');
                                $row.find('td').eq(8).text(fire_noc_certificate_number || '—');
                                $row.find('td').eq(9).text(fire_noc_expiry_date || '—');
                                $row.find('td').eq(10).text(safety_equipment_available || '—');
                                $row.find('td').eq(11).text(last_safety_inspection_date || '—');
                                $row.find('td').eq(12).text($newEntry.data('existing-file-names') || '—');
                            }
                        } else {
                            ...
                            row.append($('<td>').text([contact_salutation, contact_first_name, contact_last_name,
                                contact_mobile
                            ].filter(Boolean).join(' ').trim()));
