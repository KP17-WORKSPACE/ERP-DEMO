...
@section('mainContent')
    ...
    <div class="content-container col-12">
        <div class="tab-content display-flex-tabs" id="purchaseOrderTabContent">
            ...
            <form id="companyAllForm" novalidate action="{{ route('company.basic.update', $company->id) }}" method="POST"
                enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="company_id" id="company_id" value="{{ old('company_id', $company->id) }}">
                <!-- DATA DETAILS -->
                <div role="tabpanel" aria-labelledby="data-tab" id="data-details" class="tab-pane show active">
                    <div class="purchase-order-content-header sticky-top" style="background-color: #f7f8fd">
                        <h4 class="purchase-order-content-header-left">Edit (COM - {{ $company->id }})
                            ...
                            <div class="row gy-3">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="company_name"
                                            id="company_name" value="{{ old('company_name', $company->company_name) }}">
                                    ...
                                    <div class="input-effect">
                                        ...
                                        <select name="business_entity_type_id"
                                            ...
                                            @foreach ($entities as $ent)
                                                <option value="{{ $ent->id }}"
                                                    {{ old('business_entity_type_id', $company->business_entity_type_id) == $ent->id ? 'selected' : '' }}>
                                                    {{ $ent->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-2 mt-n1">
                                    <div class="input-effect">
                                        ...
                                        <select name="business_sector_id" id="business_sector_id"
                                            ...
                                            @if (!empty($businessSectors) && isset($company->industry_type_id))
                                                @foreach ($businessSectors->where('industry_id', $company->industry_type_id) as $bs)
                                                    <option value="{{ $bs->id }}"
                                                        {{ (string) old('business_sector_id', $company->business_sector_id ?? '') === (string) $bs->id ? 'selected' : '' }}>
                                                        {{ $bs->name }}</option>
                                                @endforeach
                                            @endif

                                            {{-- If company has a sector that is not part of the current list (mismatched or legacy), include it as a selected fallback --}}
                                            @if (isset($company->business_sector_id) &&
                                                    $company->business_sector_id &&
                                                    (!isset($company->industry_type_id) || !$businessSectors->contains('id', $company->business_sector_id)))
                                                @php $selSector = \App\SmBusinessActivity::find($company->business_sector_id); @endphp
                                                @if ($selSector)
                                                    <option value="{{ $selSector->id }}" selected>{{ $selSector->name }}
                                                    </option>
                                                @endif
                                            @endif
                                        </select>
                                ...
                                <div class="col-1-5">
                                    ...
                                    <input type="text" name="date_of_incorporation"
                                        ...
                                        value="{{ old('date_of_incorporation', @App\SysHelper::normalizeToDmy($company->date_of_incorporation)) }}">
                                </div>
                                ...
                                <div class="col-1-5">
                                    ...
                                    <select name="company_type" id="company_type"
                                        ...
                                        <option value="parent"
                                            {{ old('company_type', $company->company_type) == 'parent' ? 'selected' : '' }}>
                                            Parent</option>
                                        <option value="subsidiary"
                                            {{ old('company_type', $company->company_type) == 'subsidiary' ? 'selected' : '' }}>
                                            Group
                                        </option>
                                        <option value="branch"
                                            {{ old('company_type', $company->company_type) == 'branch' ? 'selected' : '' }}>
                                            Branch</option>
                                        <option value="sub_branch"
                                            {{ old('company_type', $company->company_type) == 'sub_branch' ? 'selected' : '' }}>
                                            Sub Branch
                                        </option>
                                    </select>
                                    ...
                                    <label class="form-label mb-1 d-flex justify-content-between align-items-center">
                                        ...
                                        @if ($company->company_logo)
                                            <small class="text-muted">
                                                <a href="{{ asset('public/' . $company->company_logo) }}"
                                ...
                                <div class="col-lg-2">
                                    <label class="form-label mb-1 d-flex justify-content-between align-items-center">
                                        ...
                                        @if ($company->digital_stamp)
                                            <small class="text-muted">
                                                <a href="{{ asset('public/' . $company->digital_stamp) }}"
                                                    target="_blank">View</a>
                                            </small>
                                        @endif
                                    </label>
                                ...
                                <div class="col-lg-2 mb-4">
                                    <label class="form-label mb-1 d-flex justify-content-between align-items-center">
                                        ...
                                        @if ($company->company_profile)
                                            <small class="text-muted">
                                                <a href="{{ asset('public/' . $company->company_profile) }}"
                                                    target="_blank">View</a>
                                            </small>
                                        @endif
                                    </label>
                                                            ...
                                                            <div class="accordion-body">
                                                                <div id="ownerWrapper">
                                                                    ...
                                                                    <div id="ownerWrapper">
                                                                        ...
                                                                        @foreach ($ownersData as $i => $owner)
                                                                                <div
                                                                                    class="ownerRow row gy-2 p-2 mb-2 border rounded">
                                                                                    <input type="hidden" name="owners[{{ $i }}][id]" value="{{ $owner->id ?? $owner['id'] ?? '' }}">
                                                                                    <div class="col-lg-1">
                                                                                        <label>Salutation</label>
                                                                                        <select
                                                                                            name="owners[{{ $i }}][salutation]"
                                                                                            class="form-select form-select-sm js-example-basic-single">
                                                                                            <option value="">Select
                                                                                            </option>
                                                                                            @foreach (['Mr', 'Mrs', 'Miss', 'Ms', 'Dr'] as $sal)
                                                                                                <option
                                                                                                    value="{{ $sal }}"
                                                                                                    {{ isset($owner['salutation']) && $owner['salutation'] == $sal ? 'selected' : '' }}>
                                                                                                    {{ $sal }}
                                                                                                </option>
                                                                                            @endforeach
                                                                                        </select>
                                                                                    ...
                                                                                    <div class="col-1-5">
                                                                                        <div class="input-effect">
                                                                                            <label
                                                                                                class="form-label"><span>@lang('Designation')</span></label>
                                                                                            <select
                                                                                                class="form-select form-select-sm js-example-basic-single"
                                                                                                name="owners[{{ $i }}][designation_id]"
                                                                                                id="designation_id_{{ $i }}">
                                                                                                <option value="">
                                                                                                    Select</option>
                                                                                                @foreach ($designations as $key => $value)
                                                                                                    <option
                                                                                                        value="{{ $value->id }}"
                                                                                                        {{ (isset($owner['designation']) && $owner['designation'] == $value->id) || (isset($owner['designation_id']) && $owner['designation_id'] == $value->id) ? 'selected' : '' }}>
                                                                                                        {{ $value->title }}
                                                                                                    </option>
                                                                                                @endforeach
                                                                                            </select>
                                                                                    ...
                                                                                    <div class="col-lg-1">
                                                                                        <label>Share %</label>
                                                                                        <input type="number"
                                                                                            name="owners[{{ $i }}][share_percentage]"
                                                                                            class="form-control form-control-sm"
                                                                                            min="0" max="100"
                                                                                    ...
                                                                                    <div class="col-lg-12">
                                                                                        <div id="owner-documents-{{ $i }}"
                                                                                            class="mt-2 owner-documents-container"
                                                                                            style="{{ !empty($owner['documents']) && count($owner['documents']) ? '' : 'display:none' }}">




                                                                                            {{-- Hidden doc entries for server-rendered documents --}}
                                                                                            @if (!empty($owner['documents']))
                                                                                                @foreach ($owner['documents'] as $j => $doc)
                                                                                                    <div class="owner-doc-entry"
                                                                                                        data-file-id="{{ $doc['id'] }}">
                                                                                                        <input
                                                                                                            type="hidden"
                                                                                                            name="owners[{{ $i }}][documents][{{ $j }}][name]"
                                                                                                            value="{{ $doc['document_name'] ?? '' }}">
                                                                                                        <input
                                                                                                            type="hidden"
                                                                                                            name="owners[{{ $i }}][documents][{{ $j }}][number]"
                                                                                                            value="{{ $doc['document_no'] ?? '' }}">
                                                                                                        <input
                                                                                                            type="hidden"
                                                                                                            name="owners[{{ $i }}][documents][{{ $j }}][issue_date]"
                                                                                                            value="{{ @App\SysHelper::normalizeToDmy($doc['issue_date']) ?? '' }}">
                                                                                                        <input
                                                                                                            type="hidden"
                                                                                                            name="owners[{{ $i }}][documents][{{ $j }}][expiry_date]"
                                                                                                            value="{{ @App\SysHelper::normalizeToDmy($doc['expiry_date']) ?? '' }}">
                                                                                                        @if (!empty($doc['attachment']))
                                                                                                            <input
                                                                                                                type="hidden"
                                                                                                                name="owners[{{ $i }}][documents][{{ $j }}][attachment]"
                                                                        ...
                                                                        {{-- Blank row at the end for adding a new owner --}}
                                                                        {{-- <div
                                                                            class="ownerRow row gy-2 p-2 mb-2 border rounded">
                                                                            <div class="col-lg-1">
                                                                                <label>Salutation</label>
                                                                                <select
                                                                                    name="owners[{{ $ownerCount }}][salutation]"
                                                                                    class="form-select form-select-sm js-example-basic-single">
                                                                                    <option value="">Select</option>
                                                                                    @foreach (['Mr', 'Mrs', 'Miss', 'Ms', 'Dr'] as $sal)
                                                                                        <option
                                                                            ...
                                                                            <div class="col-1-5">
                                                                                <label>First Name</label>
                                                                                <input type="text"
                                                                                    name="owners[{{ $ownerCount }}][first_name]"
                                                                                    class="form-control form-control-sm"
                                                                                    value="">
                                                                            </div>
                                                                            <div class="col-1-5">
                                                                                <label>Last Name</label>
                                                                                <input type="text"
                                                                                    name="owners[{{ $ownerCount }}][last_name]"
                                                                                    class="form-control form-control-sm"
                                                                                    value="">
                                                                            </div>
                                                                            <div class="col-1-5">
                                                                            ...
                                                                            <div class="col-1-5">
                                                                                <div class="input-effect">
                                                                                    ...
                                                                                    <select
                                                                                        class="form-select form-select-sm js-example-basic-single"
                                                                                        name="owners[{{ $ownerCount }}][designation_id]"
                                                                                        id="designation_id_new">
                                                                                        <option value="">Select
                                                                                        </option>
                                                                                        @foreach ($designations as $key => $value)
                                                                                            <option
                                                                            ...
                                                                            <div class="col-lg-12">
                                                                                <div id="owner-documents-{{ $ownerCount }}"
                                                                                    class="mt-2 owner-documents-container"
                                                                                    style="display:none">
                                                                                    <small class="text-muted">Added
                                                                                        Documents:</small>
                                                                                    <div class="owner-doc-list">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div> --}}
                                                        ...
                                                        <div id="collapseSponsors" class="accordion-collapse collapse"
                                                            ...
                                                            <div class="accordion-body">
                                                                <div id="sponsorWrapper">
                                                                    ...
                                                                    @foreach ($sponsorsData as $index => $sponsor)
                                                                        <div
                                                                            class="sponsorRow row gy-2 p-2 mb-2 border rounded">
                                                                            <div class="col-lg-1">
                                                                                <label>Salutation</label>
                                                                                <select
                                                                                    name="sponsors[{{ $index }}][salutation]"
                                                                                    class="form-select form-select-sm js-example-basic-single">
                                                                                    <option value="">Select</option>
                                                                                    @foreach (['Mr', 'Mrs', 'Miss', 'Ms', 'Dr'] as $sal)
                                                                                        <option
                                                                                            value="{{ $sal }}"
                                                                                            {{ isset($sponsor['salutation']) && $sponsor['salutation'] == $sal ? 'selected' : '' }}>
                                                                                            {{ $sal }}</option>
                                                                                    @endforeach
                                                                                </select>
                                                                            </div>
                                                                            <div class="col-lg-2">
                                                                                <label>First Name</label>
                                                                                <input type="text"
                                                                                    name="sponsors[{{ $index }}][first_name]"
                                                                                    class="form-control form-control-sm"
                                                                            ...
                                                                            <div class="col-lg-12">
                                                                                <div id="sponsor-documents-{{ $index }}"
                                                                                    class="mt-2 sponsor-documents-container"
                                                                                    style="{{ !empty($sponsor['documents']) && count($sponsor['documents']) ? '' : 'display:none' }}">


                                                                                    {{-- Hidden doc entries for server-rendered documents --}}
                                                                                    @if (!empty($sponsor['documents']))
                                                                                        @foreach ($sponsor['documents'] as $j => $doc)
                                                                                            <div class="sponsor-doc-entry"
                                                                                                data-file-id="{{ $doc['id'] }}">
                                                                                                <input type="hidden"
                                                                                                    name="sponsors[{{ $index }}][documents][{{ $j }}][name]"
                                                                                                    value="{{ $doc['document_name'] ?? '' }}">
                                                                                                <input type="hidden"
                                                                                                    name="sponsors[{{ $index }}][documents][{{ $j }}][number]"
                                                                                                    value="{{ $doc['document_no'] ?? '' }}">
                                                                                                <input type="hidden"
                                                                                                    name="sponsors[{{ $index }}][documents][{{ $j }}][issue_date]"
                                                                                                    value="{{ @App\SysHelper::normalizeToDmy($doc['issue_date']) ?? '' }}">
                                                                                                <input type="hidden"
                                                                                                    name="sponsors[{{ $index }}][documents][{{ $j }}][expiry_date]"
                                                                                                    value="{{ @App\SysHelper::normalizeToDmy($doc['expiry_date']) ?? '' }}">
                                                                                                @if (!empty($doc['attachment']))
                                                                                                    <input type="hidden"
                                                                                                        name="sponsors[{{ $index }}][documents][{{ $j }}][attachment]"
                                                                                                        value="{{ $doc['attachment'] }}">
                                                                                                @endif
                                                                                            </div>
                                                                                        @endforeach
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="col-lg-1">
                                                                                ...
                                                                                <select
                                                                                    ...
                                                                                    @foreach (['Mr', 'Mrs', 'Miss', 'Ms', 'Dr'] as $sal)
                                                                                        <option
                                                                                            value="{{ $sal }}"
                                                                                            {{ isset($contact['salutation']) && $contact['salutation'] == $sal ? 'selected' : '' }}>
                                                                                            {{ $sal }}</option>
                                                                                    @endforeach
                                                                                </select>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-lg-2">
                                                                                <div class="input-effect">
                                                                                    ...
                                                                                    <select
                                                                                        class="form-select form-select-sm js-example-basic-single"
                                                                                        name="contacts[{{ $index }}][designation_id]">
                                                                                        <option value="">Select</option>
                                                                                        @foreach ($designations as $key => $value)
                                                                                            @php
                                                                                            ...
                                                                                            <option value="{{ $value->id }}"
                                                                                                {{ (string) $selectedContactDesignation === (string) $value->id ? 'selected' : '' }}>
                                                                                                {{ $value->title }}
                                                                                            </option>
                                                                                        @endforeach
                                                                                    </select>
                                                                            ...
                                                                            <div class="col-lg-12">
                                                                                <div id="contact-documents-{{ $index }}"
                                                                                    class="mt-2 contact-documents-container"
                                                                                    style="{{ !empty($contact['documents']) && count($contact['documents']) ? '' : 'display:none' }}">


                                                                                    {{-- Hidden doc entries for server-rendered documents --}}
                                                                                    @if (!empty($contact['documents']))
                                                                                        @foreach ($contact['documents'] as $j => $doc)
                                                                                            <div class="contact-doc-entry"
                                                                                                data-file-id="{{ $doc['id'] }}">
                                                                                                <input type="hidden"
                                                                                                    name="contacts[{{ $index }}][documents][{{ $j }}][name]"
                                                                                                    value="{{ $doc['document_name'] ?? '' }}">
                                                                                                <input type="hidden"
                                                                                                    name="contacts[{{ $index }}][documents][{{ $j }}][number]"
                                                                                                    value="{{ $doc['document_no'] ?? '' }}">
                                                                                                <input type="hidden"
                                                                                                    name="contacts[{{ $index }}][documents][{{ $j }}][issue_date]"
                                                                                                    value="{{ @App\SysHelper::normalizeToDmy($doc['issue_date']) ?? '' }}">
                                                                                                <input type="hidden"
                                                                                                    name="contacts[{{ $index }}][documents][{{ $j }}][expiry_date]"
                                                                                                    value="{{ @App\SysHelper::normalizeToDmy($doc['expiry_date']) ?? '' }}">
                                                                                                @if (!empty($doc['attachment']))
                                                                                                    <input type="hidden"
                                                                                                        name="contacts[{{ $index }}][documents][{{ $j }}][attachment]"
                                                                                                        value="{{ $doc['attachment'] }}">
                                                                                                @endif
                                                                                            </div>
                                                                                        @endforeach
                                                                ...
                                                                <div class="row gy-2">
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        ...
                                                                        <select name="currency" id="settingCurrency"
                                                                            ...
                                                                            @foreach ($currency as $c)
                                                                                <option value="{{ $c->code }}"
                                                                                    @if ($c->code == optional($company->settings)->currency) selected @endif
                                                                    ...
                                                                    <div class="col-lg-1">
                                                                        ...
                                                                        <input type="text" name="currency_symbol"
                                                                            ...
                                                                            readonly
                                                                            value="{{ old('currency_symbol', optional($company->settings)->currency_symbol ?? '') }}">
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-1">
                                                                        ...
                                                                        <input type="number" name="currency_digit"
                                                                            min="0" max="4"
                                                                            class="form-control form-control-sm setting-input"
                                                                            value="{{ old('currency_digit', optional($company->settings)->currency_digit ?? 2) }}">
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-1">
                                                                        ...
                                                                        <input type="text" name="r_code"
                                                                            ...
                                                                            class="form-control form-control-sm setting-input"
                                                                            readonly
                                                                            value="{{ old('r_code', optional($company->settings)->r_code ?? '') }}">
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-1">
                                                                        ...
                                                                        <input type="text" name="p_code"
                                                                            ...
                                                                            class="form-control form-control-sm setting-input"
                                                                            readonly
                                                                            value="{{ old('p_code', optional($company->settings)->p_code ?? '') }}">
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        ...
                                                                        <input type="text" name="book_closed"
                                                                            ...
                                                                            value="{{ old('book_closed', @App\SysHelper::normalizeToDmy(optional($company->settings)->book_closed ?? '')) }}">
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        ...
                                                                        <input type="text" name="sales_code"
                                                                            ...
                                                                            value="{{ old('sales_code', optional($company->settings)->sales_code ?? '') }}">
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        ...
                                                                        <input type="text" name="other_code"
                                                                            class="form-control form-control-sm setting-input text-uppercase"
                                                                            value="{{ old('other_code', optional($company->settings)->other_code ?? '') }}">
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        ...
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input setting-input"
                                                                                ...
                                                                                value="1"
                                                                                {{ old('is_customer_code', optional($company->settings)->is_customer_code ?? false) ? 'checked' : '' }}>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        ...
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input setting-input"
                                                                                ...
                                                                                value="1"
                                                                                {{ old('is_supplier_code', optional($company->settings)->is_supplier_code ?? false) ? 'checked' : '' }}>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        ...
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input setting-input"
                                                                                ...
                                                                                value="1"
                                                                                {{ old('is_account_code', optional($company->settings)->is_account_code ?? false) ? 'checked' : '' }}>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        ...
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input setting-input"
                                                                                ...
                                                                                value="1"
                                                                                {{ old('is_subaccount_code', optional($company->settings)->is_subaccount_code ?? false) ? 'checked' : '' }}>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div class="row gy-2">
                                                        ...
                                                        <div class="col-lg-2">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm"
                                                                ...
                                                                value="{{ old('trade_license_no', optional($company->compliance)->trade_license_no ?? '') }}">
                                                        ...
                                                        <div class="col-lg-2">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('license_issue_date', @App\SysHelper::normalizeToDmy(optional($company->compliance)->license_issue_date ?? '')) }}">
                                                            <small class="text-danger error"
                                                        ...
                                                        <div class="col-lg-2">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('license_expiry_date', @App\SysHelper::normalizeToDmy(optional($company->compliance)->license_expiry_date ?? '')) }}">
                                                            <small class="text-danger error"
                                                        ...
                                                        <div class="col-lg-2">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm"
                                                                ...
                                                                value="{{ old('issuing_authority', optional($company->compliance)->issuing_authority ?? '') }}">
                                                            <small class="text-danger error"
                                                        ...
                                                        <div class="col-lg-2">
                                                            ...
                                                            <select
                                                                ...
                                                                <option value="">Select</option>
                                                                <option value="vat"
                                                                    {{ old('tax_applicable', optional($company->compliance)->tax_applicable ?? '') == 'vat' ? 'selected' : '' }}>
                                                                    VAT</option>
                                                                <option value="ct"
                                                                    {{ old('tax_applicable', optional($company->compliance)->tax_applicable ?? '') == 'ct' ? 'selected' : '' }}>
                                                                    CT</option>
                                                                <option value="both"
                                                                    {{ old('tax_applicable', optional($company->compliance)->tax_applicable ?? '') == 'both' ? 'selected' : '' }}>
                                                                    Both (CT/VAT)</option>
                                                                <option value="none"
                                                                    {{ old('tax_applicable', optional($company->compliance)->tax_applicable ?? '') == 'none' ? 'selected' : '' }}>
                                                    ...
                                                    <div class="row gy-2 mt-2 vat-section ">
                                                        <div class="col-lg-2">
                                                            ...
                                                            <input type="text" name="vat_registration_number"
                                                                class="form-control form-control-sm"
                                                                value="{{ old('vat_registration_number', optional($company->compliance)->vat_registration_number ?? '') }}">
                                                        </div>
                                                        <div class="col-lg-2">
                                                            <label class="form-label mb-1">VAT %</label>
                                                            <input type="number" step="0.01" name="vat_percentage"
                                                                class="form-control form-control-sm"
                                                                value="{{ old('vat_percentage', optional($company->compliance)->vat_percentage ?? '') }}">
                                                        </div>
                                                        <div class="col-lg-2">
                                                            <label class="form-label mb-1">VAT Registration Date</label>
                                                            <input type="text" name="vat_date"
                                                                class="form-control form-control-sm date-picker"
                                                                value="{{ old('vat_date', @App\SysHelper::normalizeToDmy(optional($company->compliance)->vat_date ?? '')) }}">
                                                        </div>
                                                        <div class="col-lg-2">
                                                            <label class="form-label mb-1">VAT Issuing Authority</label>
                                                            <input type="text" name="vat_issuing_authority"
                                                                class="form-control form-control-sm"
                                                                value="{{ old('vat_issuing_authority', optional($company->compliance)->vat_issuing_authority ?? '') }}">
                                                        </div>
                                                        <div class="col-lg-2">
                                                    ...
                                                    <div class="row gy-2 mt-2 ct-section">
                                                        <div class="col-lg-2">
                                                            ...
                                                            <input type="text" name="corporate_tax_number"
                                                                class="form-control form-control-sm"
                                                                value="{{ old('corporate_tax_number', optional($company->compliance)->corporate_tax_number ?? '') }}">
                                                        </div>
                                                        <div class="col-lg-2">
                                                            <label class="form-label mb-1">CT %</label>
                                                            <input type="text" name="corporate_tax_vat"
                                                                class="form-control form-control-sm"
                                                                value="{{ old('corporate_tax_vat', optional($company->compliance)->corporate_tax_vat ?? '') }}">
                                                        </div>
                                                        <div class="col-lg-2">
                                                            <label class="form-label mb-1">CT Registration Date</label>
                                                            <input type="text" name="corporate_tax_date"
                                                                class="form-control form-control-sm date-picker"
                                                                value="{{ old('corporate_tax_date', @App\SysHelper::normalizeToDmy(optional($company->compliance)->corporate_tax_date ?? '')) }}">
                                                        </div>
                                                        <div class="col-lg-2">
                                                            <label class="form-label mb-1">CT Issuing Authority</label>
                                                            <input type="text" name="ct_issuing_authority"
                                                                class="form-control form-control-sm"
                                                                value="{{ old('ct_issuing_authority', optional($company->compliance)->corporate_issuing_authority ?? '') }}">
                                                        </div>
                                                        <div class="col-lg-2">
                                                ...
                                                <div id="non-uae-compliance-section" class="">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            @if (isset($compliance_items) && $compliance_items && $compliance_items->count())
                                                                <div id="compliance-documents-container" class="d-none">
                                                                    @foreach ($compliance_items as $i => $c)
                                                                        <div class="compliance-doc-entry d-none"
                                                                            data-file-id="{{ $c->id }}">
                                                                            <input type="hidden"
                                                                                name="compliance_documents[{{ $i }}][document_number]"
                                                                                value="{{ $c->document_number ?? '' }}">
                                                                            <input type="hidden"
                                                                                name="compliance_documents[{{ $i }}][issue_date]"
                                                                                value="{{ @App\SysHelper::normalizeToDmy($c->document_date ?? '') }}">
                                                                            <input type="hidden"
                                                                                name="compliance_documents[{{ $i }}][expiry_date]"
                                                                                value="{{ @App\SysHelper::normalizeToDmy($c->expiry_date ?? '') }}">
                                                                            <input type="hidden"
                                                                                name="compliance_documents[{{ $i }}][issuing_authority]"
                                                                                value="{{ $c->document_name ?? '' }}">
                                                                            <input type="hidden"
                                                                                name="compliance_documents[{{ $i }}][attachment]"
                                                                                value="{{ $c->attachment_file ?? '' }}">
                                                                        </div>
                                                                    @endforeach
                                                                </div>
                                                            @endif
                                                            ...
                                                            @if (optional($company)->banking && optional($company)->banking->count())
                                                                <div id="banks-container" class="d-none">
                                                                    @foreach ($company->banking as $i => $bank)
                                                                        <div class="bank-entry d-none"
                                                                            data-bank-index="{{ $i }}"
                                                                            data-bank-id="{{ $bank->id }}"
                                                                            data-file-id="{{ $bank->id }}"
                                                                            data-existing-file-name="{{ basename($bank->bank_letter ?? ($bank->finance_letter ?? '')) }}"
                                                                            data-existing-file-path="{{ $bank->bank_letter ?? ($bank->finance_letter ?? '') }}"
                                                                            data-existing-account-code="{{ optional($bank->AccountsBank)->account_code ?? \App\SysChartofAccounts::where('company_bank_id', $bank->id)->value('account_code') ?? '' }}"
                                                                            data-currency-text="{{ optional($currency->firstWhere('id', $bank->currency))->code ?? (optional($bank->currencyDetails)->code ?? '') }}">
                                                                            <input type="hidden"
                                                                                name="banks[{{ $i }}][bank_name]"
                                                                                value="{{ $bank->bank_name ?? '' }}">
                                                                                   <input type="hidden"
                                                                                name="banks[{{ $i }}][account_name]"
                                                                            ...
                                                                            <input type="hidden"
                                                                                name="banks[{{ $i }}][finance_code]"
                                                                                value="{{ $bank->finance_code ?? '' }}">
                                                                            <input type="hidden"
                                                                                name="banks[{{ $i }}][currency]"
                                                                                value="{{ $bank->currency ?? (optional($bank->currencyDetails)->code ?? '') }}">
                                                                            <input type="hidden"
                                                                                name="banks[{{ $i }}][id]"
                                                                                value="{{ $bank->id ?? '' }}">
                                                                            <input type="hidden"
                                                                                name="banks[{{ $i }}][account_code]"
                                                                                value="{{ optional($bank->AccountsBank)->account_code ?? \App\SysChartofAccounts::where('company_bank_id', $bank->id)->value('account_code') ?? '' }}">
                                                                            <input type="hidden"
                                                                                name="banks[{{ $i }}][bank_letter]"
                                                                                value="{{ $bank->bank_letter ?? '' }}">
                                                                            @php
                                                                                ...
                                                                                $ct = $chartAccountId
                                                                                    ...
                                                                                    : null;
                                                                            @endphp
                                                                            <input type="hidden" name="banks[{{ $i }}][cheque_company_top]"   value="{{ $ct->company_top  ?? '285px' }}">
                                                                            <input type="hidden" name="banks[{{ $i }}][cheque_company_left]"  value="{{ $ct->company_left ?? '425px' }}">
                                                                            <input type="hidden" name="banks[{{ $i }}][cheque_date_top]"      value="{{ $ct->date_top     ?? '220px' }}">
                                                                            <input type="hidden" name="banks[{{ $i }}][cheque_date_left]"     value="{{ $ct->date_left    ?? '836px' }}">
                                                                            <input type="hidden" name="banks[{{ $i }}][cheque_amount_w_top]"  value="{{ $ct->amount_w_top ?? '316px' }}">
                                                                            <input type="hidden" name="banks[{{ $i }}][cheque_amount_w_left]" value="{{ $ct->amount_w_left ?? '326px' }}">
                                                                            <input type="hidden" name="banks[{{ $i }}][cheque_amount_top]"    value="{{ $ct->amount_top   ?? '355px' }}">
                                                                            <input type="hidden" name="banks[{{ $i }}][cheque_amount_left]"   value="{{ $ct->amount_left  ?? '834px' }}">
                                                                            <input type="hidden" name="banks[{{ $i }}][cheque_font_size]"     value="{{ $ct->font_size    ?? '13px'  }}">
                                                                        </div>
                                                                    @endforeach
                                                                </div>
                                                            @endif

                                                            {{-- Server-rendered existing warehouse entries (hidden) --}}
                                                            @if (optional($company)->warehouses && optional($company)->warehouses->count())
                                                                <div id="warehouses-container" class="d-none">
                                                                    @foreach ($company->warehouses as $i => $w)
                                                                        @php
                                                                        ...
                                                                        <div class="warehouse-entry d-none"
                                                                            data-warehouse-index="{{ $i }}"
                                                                            data-warehouse-id="{{ $w->id }}"
                                                                            data-file-id="{{ $w->id }}"
                                                                            data-existing-file-names="{{ $docNames }}"
                                                                            data-existing-file-paths='{{ $docJson }}'>
                                                                            <!-- Persist DB id so backend recognizes existing warehouses on submit -->
                                                                            <input type="hidden" name="warehouses[{{ $i }}][id]" value="{{ $w->id ?? '' }}">
                                                                            <input type="hidden"
                                                                                name="warehouses[{{ $i }}][warehouse_code]"
                                                                                value="{{ $w->document_number ?? '' }}">
                                                                            <input type="hidden"
                                                                                name="warehouses[{{ $i }}][warehouse_name]"
                                                                                value="{{ $w->warehouse_name ?? '' }}">
                                                                            <input type="hidden"
                                                                                name="warehouses[{{ $i }}][warehouse_area]"
                                                                                value="{{ $w->warehouse_area ?? '' }}">
                                                                            <input type="hidden"
                                                                                name="warehouses[{{ $i }}][warehouse_city]"
                                                                                value="{{ $w->warehouse_city ?? '' }}">
                                                                            <input type="hidden"
                                                                                name="warehouses[{{ $i }}][warehouse_building_name]"
                                                                                value="{{ $w->warehouse_building_name ?? '' }}">
                                                                            <input type="hidden"
                                                                                name="warehouses[{{ $i }}][warehouse_flat_office_no]"
                                                                                value="{{ $w->warehouse_flat_office_no ?? '' }}">
                                                                            <input type="hidden"
                                                                                name="warehouses[{{ $i }}][warehouse_country]"
                                                                                value="{{ $w->warehouse_country ?? '' }}">
                                                                            <input type="hidden"
                                                                                name="warehouses[{{ $i }}][warehouse_state]"
                                                                                value="{{ $w->warehouse_state ?? '' }}">
                                                                            <input type="hidden"
                                                                                name="warehouses[{{ $i }}][contact_person_name]"
                                                                                value="{{ $w->contact_person_id ?? ($w->contactPerson->id ?? '') }}">
                                                                            <input type="hidden"
                                                                                name="warehouses[{{ $i }}][contact_person_name_text]"
                                                                                value="{{ optional($w->contactPerson)->first_name ?? '' }} {{ optional($w->contactPerson)->last_name ?? '' }}">
                                                                            {{-- <input type="hidden"
                                                                                name="warehouses[{{ $i }}][contact_first_name]"
                                                                                value="{{ $w->contact_first_name ?? '' }}">
                                                                            <input type="hidden"
                                                                                name="warehouses[{{ $i }}][contact_last_name]"
                                                                                value="{{ $w->contact_last_name ?? '' }}"> --}}
                                                                            <input type="hidden"
                                                                                name="warehouses[{{ $i }}][safety_equipment_available]"
                                                                                value="{{ $w->safety_equipment_available ?? '' }}">
                                                                            <input type="hidden"
                                                                                name="warehouses[{{ $i }}][contact_mobile]"
                                                                                value="{{ $w->contact_mobile ?? '' }}">
                                                                            <input type="hidden"
                                                                                name="warehouses[{{ $i }}][contact_email]"
                                                                                value="{{ $w->contact_email ?? '' }}">
                                                                            <input type="hidden"
                                                                                name="warehouses[{{ $i }}][contact_designation]"
                                                                                value="{{ $w->contact_designation ?? '' }}">
                                                                            <input type="hidden"
                                                                                name="warehouses[{{ $i }}][fire_safety_compliance_status]"
                                                                                value="{{ $w->fire_safety_compliance_status ?? '' }}">
                                                                            <input type="hidden"
                                                                                name="warehouses[{{ $i }}][fire_noc_certificate_number]"
                                                                                value="{{ $w->fire_noc_certificate_number ?? '' }}">
                                                                            <input type="hidden"
                                                                                name="warehouses[{{ $i }}][fire_noc_expiry_date]"
                                                                                value="{{ $w->fire_noc_expiry_date ?? '' }}">
                                                                            <input type="hidden"
                                                                                name="warehouses[{{ $i }}][last_safety_inspection_date]"
                                                                                value="{{ $w->last_safety_inspection_date ?? '' }}">
                                                                            <input type="hidden"
                                                                                name="warehouses[{{ $i }}][contact_documents]"
                                                                                value='{{ $docJson }}'>
                                                                        </div>
                                                                    @endforeach
                                                                </div>
                                                            ...
                                                            {{-- Server-rendered existing HR policies (hidden) --}}
                                                            @if (optional($company)->hrPolicies && optional($company->hrPolicies)->count())
                                                                <div id="policies-container" class="d-none">
                                                                    @foreach ($company->hrPolicies as $i => $p)
                                                                        <div class="policy-entry d-none"
                                                                            data-policy-index="{{ $i }}"
                                                                            data-file-id="{{ $p->id }}"
                                                                            data-existing-file-name="{{ basename($p->policy_file ?? '') }}">
                                                                            <input type="hidden"
                                                                                name="policies[{{ $i }}][policy_date]"
                                                                                value="{{ @App\SysHelper::normalizeToDmy($p->policy_date ?? '') }}">
                                                                            <input type="hidden"
                                                                                name="policies[{{ $i }}][policy_name]"
                                                                                value="{{ $p->policy_name ?? '' }}">
                                                                            <input type="hidden"
                                                                                name="policies[{{ $i }}][policy_valid]"
                                                                                value="{{ @App\SysHelper::normalizeToDmy($p->policy_valid ?? '') }}">
                                                                            <input type="hidden"
                                                                                name="policies[{{ $i }}][view_to_employees]"
                                                                                value="{{ $p->view_to_employees ?? '1' }}">
                                                                            <input type="hidden"
                                                                                name="policies[{{ $i }}][policy_details]"
                                                                                value="{{ $p->policy_details ?? '' }}">
                                                                            <input type="hidden"
                                                                                name="policies[{{ $i }}][policy_file]"
                                                                                value="{{ $p->policy_file ?? '' }}">
                                                                        </div>
                                                                    @endforeach
                                                                </div>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover data-table" id="long-list"
                                                        ...
                                                        <tbody id="bankTableBody">
                                                            @if (optional($company)->banking && optional($company->banking)->count())
                                                                @foreach ($company->banking as $i => $b)
                                                                    <tr class="bank-row"
                                                                        data-bank-index="{{ $i }}">
                                                                        <td>{{ optional($b->AccountsBank)->account_code ?? @App\SysChartofAccounts::where('company_bank_id', $b->id)->value('account_code') ?? '' }}</td>
                                                                        <td>{{ $b->bank_name ?? '' }}</td>
                                                                        ...
                                                                        <td class="text-center">
                                                                            {{ optional($b->currencyDetails)->name ?? '' }}
                                                                        </td>
                                                                        <td>
                                                                ...
                                                                @if (optional($company)->warehouses && optional($company)->warehouses->count())
                                                                    @foreach ($company->warehouses as $i => $w)
                                                                        ...
                                                                        <tr class="warehouse-row"
                                                                            data-warehouse-index="{{ $i }}">
                                                                            <td>{{ $w->document_number ?? '' }}</td>
                                                                            <td>{{ $w->warehouse_name ?? '' }}</td>
                                                                            <td>{{ collect([$w->warehouse_building_name, $w->warehouse_area])->filter()->implode(', ') }}
                                                                            </td>
                                                                            <td>{{ $w->warehouse_city ?? '—' }}</td>
                                                                            <td>{{ $w->warehouse_country ?? '—' }}</td>
                                                                            <td>{{ $w->warehouse_state ?? '—' }}</td>
                                                                            @php
                                                                                $cpFull = trim(
                                                                            ...
                                                                            @endphp
                                                                            <td>{{ $cpFull ?: ($cpFallback ?: '—') }}</td>
                                                                            <td class="text-center">
                                                                                {{ $w->fire_safety_compliance_status ?? '—' }}
                                                                            </td>
                                                                            <td>{{ $w->fire_noc_certificate_number ?? '—' }}
                                                                            </td>
                                                                            <td>{{ @App\SysHelper::normalizeToDmy($w->fire_noc_expiry_date ?? '') ?: '—' }}
                                                                            </td>
                                                                            <td>{{ $w->safety_equipment_available ?? '—' }}
                                                                            </td>
                                                                            <td>{{ @App\SysHelper::normalizeToDmy($w->last_safety_inspection_date ?? '') ?: '—' }}
                                                                            </td>
                                                                            <td>
                                                                                @if ($docs && count($docs))
                                                                                    @foreach ($docs as $d)
                                                                                        ...
                                                                                        <div><a href="{{ $href }}"
                                                                                                target="_blank"
                                                                                                rel="noopener noreferrer">{{ basename($d) }}</a>
                                                                                        </div>
                                                                                    @endforeach
                                                                                @else
                                                                                    &mdash;
                                                                            ...
                                                                            <td
                                                                                ...
                                                                                <button type="button"
                                                                                    class="btn btn-sm btn-light me-1"
                                                                                    onclick="openWarehouseModal({{ $i }})"><i
                                                                                        class="ico ico icon-outline-pen-2 text-dark"
                                                                                        style="font-size:16px"></i></button>
                                                                                <button type="button"
                                                                                    class="btn btn-sm btn-light btn-delete-warehouse"
                                                                                    onclick="removeWarehouseByIndex({{ $i }})"><i
                                                                                        class="ico icon-outline-trash-bin-minimalistic text-dark"
                                                                                        style="font-size: 16px;"></i></button>
                                                                            </td>
                                                                        </tr>
                                                ...
                                                <div class="row gy-2 mb-4">
                                                    ...
                                                    {{-- <div class="col-lg-2">
                                                        <label class="form-label mb-1 hr-payroll-labels">Leave Policy
                                                            Type</label>
                                                        @php $lp = old('leave_policy_type', optional($company->hrpayrollsettings)->leave_policy_type ?? '') @endphp
                                                        <select
                                                            class="form-select form-select-sm setting-input js-example-basic-single"
                                                            name="leave_policy_type">
                                                            <option value="">Select</option>
                                                            <option value="default" {{ $lp == 'default' ? 'selected' : '' }}>Default</option>
                                                            <option value="custom" {{ $lp == 'custom' ? 'selected' : '' }}>Custom</option>
                                                        </select>
                                                    </div> --}}
                                                    ...
                                                    <div class="col-lg-2">
                                                        ...
                                                        <input type="number"
                                                            class="form-control form-control-sm setting-input"
                                                            name="annual_leave"
                                                            value="{{ old('annual_leave', optional($company->hrpayrollsettings)->annual_leave_cl_sl ?? '') }}">
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2">
                                                        ...
                                                        <input type="number"
                                                            class="form-control form-control-sm setting-input"
                                                            name="sick_leave"
                                                            value="{{ old('sick_leave', optional($company->hrpayrollsettings)->sick_leave_sl ?? '') }}">
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2">
                                                        ...
                                                        <input type="number"
                                                            class="form-control form-control-sm setting-input"
                                                            name="casual_leave"
                                                            value="{{ old('casual_leave', optional($company->hrpayrollsettings)->casual_leave_cl ?? '') }}">
                                                    </div>

                                                    <div class="col-lg-2">
                                                        <label class="form-label mb-1 hr-payroll-labels">Comp-Off
                                                            Allowed</label>
                                                        @php $compOff = old('comp_off_allowed', optional($company->hrpayrollsettings)->comp_off_allowed ?? '') @endphp
                                                        <select
                                                            class="form-select form-select-sm setting-input js-example-basic-single"
                                                            name="comp_off_allowed">
                                                            <option value="">Select</option>
                                                            <option value="yes"
                                                                {{ $compOff === 'yes' || $compOff == 1 ? 'selected' : '' }}>
                                                                Yes</option>
                                                            <option value="no"
                                                                {{ $compOff === 'no' || $compOff == 0 ? 'selected' : '' }}>
                                                                No</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2">
                                                        <label class="form-label mb-1 hr-payroll-labels">Carry Forward
                                                            Unused Leaves</label>
                                                        @php $carry = old('carry_forward', optional($company->hrpayrollsettings)->carry_forward_unused_leaves ?? '') @endphp
                                                        <select
                                                            class="form-select form-select-sm setting-input js-example-basic-single"
                                                            name="carry_forward" id="carry_forward">
                                                            <option value="">Select</option>
                                                            <option value="yes"
                                                                {{ $carry === 'yes' || $carry == 1 ? 'selected' : '' }}>
                                                                Yes</option>
                                                            <option value="no"
                                                                {{ $carry === 'no' || $carry == 0 ? 'selected' : '' }}>
                                                                No</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2 d-none" id="maxCarryWrap">
                                                        ...
                                                        <input type="number"
                                                            ...
                                                            value="{{ old('max_carry_forward', optional($company->hrpayrollsettings)->max_carry_forward_days ?? '') }}">

                                                    </div>
                                                    <div class="col-lg-2">
                                                        <label class="form-label mb-1 hr-payroll-labels">Encashable
                                                            Leaves</label>
                                                        @php $encash = old('leave_encashment', optional($company->hrpayrollsettings)->encashable_leaves ?? '') @endphp
                                                        <select
                                                            class="form-select form-select-sm setting-input js-example-basic-single"
                                                            name="leave_encashment">
                                                            <option value="">Select</option>
                                                            <option value="yes"
                                                                {{ $encash === 'yes' || $encash == 1 ? 'selected' : '' }}>
                                                                Yes</option>
                                                            <option value="no"
                                                                {{ $encash === 'no' || $encash == 0 ? 'selected' : '' }}>
                                                                No</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row gy-2 mb-4">
                                                    ...
                                                    {{-- <div class="col-lg-2">
                                                        <label class="form-label mb-1 hr-payroll-labels">Attendance
                                                            Policy</label>
                                                        @php $attendance = old('attendance_policy', optional($company->hrpayrollsettings)->attendance_policy ?? '') @endphp
                                                        <select
                                                            class="form-select form-select-sm setting-input js-example-basic-single"
                                                            name="attendance_policy">
                                                            <option value="">Select</option>
                                                            <option value="standard"
                                                                {{ $attendance == 'standard' ? 'selected' : '' }}>Standard
                                                            </option>
                                                            <option value="flexible"
                                                                {{ $attendance == 'flexible' ? 'selected' : '' }}>Flexible
                                                            </option>
                                                            <option value="strict"
                                                                {{ $attendance == 'strict' ? 'selected' : '' }}>Strict
                                                            </option>
                                                        </select>
                                                    </div> --}}
                                                    ...
                                                    <div class="col-lg-2">
                                                        ...
                                                        <input type="number" step="0.1"
                                                            ...
                                                            value="{{ old('min_working_hours', optional($company->hrpayrollsettings)->minimum_working_hours ?? '') }}">
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2">
                                                        ...
                                                        <input type="number"
                                                            class="form-control form-control-sm setting-input"
                                                            name="grace_period"
                                                            value="{{ old('grace_period', optional($company->hrpayrollsettings)->grace_period_minutes ?? '') }}">
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2">
                                                        ...
                                                        <input type="number" step="0.1"
                                                            class="form-control form-control-sm setting-input"
                                                            name="half_day_after"
                                                            value="{{ old('half_day_after', optional($company->hrpayrollsettings)->half_day_after_hours ?? '') }}">
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2">
                                                        ...
                                                        <input type="number" step="0.1"
                                                            ...
                                                            value="{{ old('absent_below_hours', optional($company->hrpayrollsettings)->absent_if_hours_below ?? '') }}">
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2">
                                                        ...
                                                        <input type="number"
                                                            ...
                                                            value="{{ old('late_mark_allowed', optional($company->hrpayrollsettings)->late_mark_count_allowed ?? '') }}">
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2">
                                                        ...
                                                        <input type="number"
                                                            ...
                                                            value="{{ old('late_mark_halfday', optional($company->hrpayrollsettings)->consecutive_late_to_halfday ?? '') }}">
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2">
                                                        ...
                                                        <input type="number"
                                                            ...
                                                            value="{{ old('auto_absent_after', optional($company->hrpayrollsettings)->auto_mark_absent_after_days ?? '') }}">
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2">
                                                        ...
                                                        <div id="workingShiftsHiddenInputs">
                                                            @if (isset($company) && $company->workingShifts)
                                                                @foreach ($company->workingShifts as $shift)
                                                                    <input type="hidden"
                                                                        name="working_shifts[{{ $loop->index }}][shift_name]"
                                                                        value="{{ $shift->shift_name }}">
                                                                    <input type="hidden"
                                                                        name="working_shifts[{{ $loop->index }}][start_time]"
                                                                        value="{{ $shift->start_time }}">
                                                                    <input type="hidden"
                                                                        name="working_shifts[{{ $loop->index }}][end_time]"
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach ($working_shifts as $shift)
                                                                <option value="{{ $shift->id }}"
                                                                    @if ($company->shift_id == $shift->id) selected @endif>
                                                                    {{ $shift->shift_name }}
...
@endphp
    ...
    {{-- Master options --}}
    @foreach ($masterWeeklyOffs as $option)
        <option value="{{ $option }}"
            {{ in_array($option, $selectedWeeklyOffs) ? 'selected' : '' }}>
            {{ $option }}
        </option>
    @endforeach

    {{-- Extra DB options not in master list --}}
    @foreach ($selectedWeeklyOffs as $dbOption)
        @if (!in_array($dbOption, $masterWeeklyOffs))
            <option value="{{ $dbOption }}" selected>
                {{ $dbOption }}
            </option>
        @endif
    @endforeach
                                                ...
                                                <div class="row gy-2 mb-4">
                                                    ...
                                                    <div class="col-lg-2">
                                                        ...
                                                        <input type="text" name="hr_wps_establishment_id"
                                                            class="form-control form-control-sm setting-input"
                                                            value="{{ old('hr_wps_establishment_id', optional($company->hrpayrollsettings)->wps_establishment_id ?? '') }}">
                                                    </div>
                                    ...
                                    $banks = @App\SysCompanyBanking::where('company_id', $company->id)->wherein('id', $wpsBanks)->get();
                                                      ...
                                                      <select name="hr_wps_bank[]" id="hr_wps_bank" multiple
                                                            ...
                                                            <option value="{{ $bank->bank_name }}_{{ $bank->id }}" selected>{{ $bank->bank_name }}</option>
                                                    ...
                                                    <div class="col-lg-2">
                                                        ...
                                                        <input type="text" name="hr_wps_salary_file_code"
                                                            class="form-control form-control-sm setting-input"
                                                            value="{{ old('hr_wps_salary_file_code', optional($company->hrpayrollsettings)->wps_salary_file_code ?? '') }}">
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2">
                                                        ...
                                                        @php $cycle = old('hr_payroll_cycle', optional($company->hrpayrollsettings)->payroll_cycle ?? '') @endphp
                                                        <select name="hr_payroll_cycle"
                                                            ...
                                                            <option value="bi-weekly"
                                                                {{ $cycle == 'bi-weekly' ? 'selected' : '' }}>
                                                                Bi-Weekly
                                                            </option>
                                                            <option value="weekly"
                                                                {{ $cycle == 'weekly' ? 'selected' : '' }}>
                                                                Weekly
                                                            </option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2">
                                                        <label class="form-label mb-1 hr-payroll-labels">Payroll Start
                                                            Date</label>
                                                        @php $pstart = old('hr_payroll_start', optional($company->hrpayrollsettings)->payroll_start_day ?? '') @endphp
                                                    ...
                                                    <div class="col-lg-2">
                                                        <label class="form-label mb-1 hr-payroll-labels">Payroll End
                                                            Date</label>
                                                        @php $pend = old('hr_payroll_end', optional($company->hrpayrollsettings)->payroll_end_day ?? '') @endphp
                                                    ...
                                                    <div class="col-lg-2">
                                                        ...
                                                        @php $gratuity = old('hr_gratuity_method', optional($company->hrpayrollsettings)->gratuity_calculation_method ?? '') @endphp
                                                        <select name="hr_gratuity_method"
                                                            class="form-select form-select-sm setting-input js-example-basic-single">
                                                            <option value="">Select</option>
                                                            <option value="basic_salary"
                                                                {{ $gratuity == 'basic_salary' ? 'selected' : '' }}>
                                                                Basic Salary
                                                            </option>
                                                            <option value="gross_salary"
                                                                {{ $gratuity == 'gross_salary' ? 'selected' : '' }}>
                                                                Gross Salary
                                                            </option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table id="documentationTable" class="table table-hover"
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text"
                                                                            ...
                                                                            placeholder=""
                                                                            value="{{ old('establishment_number', optional($company->documents)->establishment_number ?? '') }}">
                                                                    </td>
                                                                    <td>
                                                                        <input name="establishment_date"
                                                                            class="form-control form-control-sm date-picker doc-input text-center"
                                                                            value="{{ old('establishment_date', @App\SysHelper::normalizeToDmy(optional($company->documents)->establishment_start_date ?? '')) }}">
                                                                    </td>
                                                                    <td>
                                                                        <input name="establishment_expiry"
                                                                            class="form-control form-control-sm date-picker doc-input text-center"
                                                                            value="{{ old('establishment_expiry', @App\SysHelper::normalizeToDmy(optional($company->documents)->establishment_expiry ?? '')) }}">
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text" name="immigration_number"
                                                                            class="form-control form-control-sm doc-input text-center"
                                                                            placeholder=""
                                                                            value="{{ old('immigration_number', optional(optional($company)->documents)->immigration_number) }}">
                                                                    </td>
                                                                    <td>
                                                                        <input name="immigration_date"
                                                                            class="form-control form-control-sm date-picker doc-input text-center"
                                                                            value="{{ old('immigration_date', @App\SysHelper::normalizeToDmy(optional($company->documents)->immigration_start_date ?? '')) }}">
                                                                    </td>
                                                                    <td>
                                                                        <input name="immigration_expiry"
                                                                            class="form-control form-control-sm date-picker doc-input text-center"
                                                                            value="{{ old('immigration_expiry', @App\SysHelper::normalizeToDmy(optional($company->documents)->immigration_expiry ?? '')) }}">
                                                                    </td>
                                                                    <td class="d-flex align-items-center gap-2">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text" name="labour_number"
                                                                            class="form-control form-control-sm doc-input text-center"
                                                                            placeholder=""
                                                                            value="{{ old('labour_number', optional($company->documents)->labour_number ?? '') }}">
                                                                    </td>
                                                                    <td>
                                                                        <input name="labour_date"
                                                                            class="form-control form-control-sm date-picker doc-input text-center"
                                                                            value="{{ old('labour_date', @App\SysHelper::normalizeToDmy(optional($company->documents)->labour_start_date ?? '')) }}">
                                                                    </td>
                                                                    <td>
                                                                        <input name="labour_expiry"
                                                                            class="form-control form-control-sm date-picker doc-input text-center"
                                                                            value="{{ old('labour_expiry', @App\SysHelper::normalizeToDmy(optional($company->documents)->labour_expiry ?? '')) }}">
                                                                    </td>
                                                                    <td class="d-flex align-items-center gap-2">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text" name="chamber_number"
                                                                            class="form-control form-control-sm doc-input text-center"
                                                                            placeholder=""
                                                                            value="{{ old('chamber_number', optional($company->documents)->chamber_number ?? '') }}">
                                                                    </td>
                                                                    <td>
                                                                        <input name="chamber_date"
                                                                            class="form-control form-control-sm date-picker doc-input text-center"
                                                                            value="{{ old('chamber_date', @App\SysHelper::normalizeToDmy(optional($company->documents)->chamber_start_date ?? '')) }}">
                                                                    </td>
                                                                    <td>
                                                                        <input name="chamber_expiry"
                                                                            class="form-control form-control-sm date-picker doc-input text-center"
                                                                            value="{{ old('chamber_expiry', @App\SysHelper::normalizeToDmy(optional($company->documents)->chamber_expiry ?? '')) }}">
                                                                    </td>
                                                                    <td class="d-flex align-items-center gap-2">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text"
                                                                            ...
                                                                            class="form-control form-control-sm doc-input text-center"
                                                                            placeholder=""
                                                                            value="{{ old('insurance_certificate_number', optional($company->documents)->insurance_certificate_number ?? '') }}">
                                                                    </td>
                                                                    <td>
                                                                        <input name="insurance_certificate_date"
                                                                            class="form-control form-control-sm date-picker doc-input text-center"
                                                                            value="{{ old('insurance_certificate_date', @App\SysHelper::normalizeToDmy(optional($company->documents)->insurance_start_date ?? '')) }}">
                                                                    </td>
                                                                    <td>
                                                                        <input name="insurance_certificate_expiry"
                                                                            class="form-control form-control-sm date-picker doc-input text-center"
                                                                            value="{{ old('insurance_certificate_expiry', @App\SysHelper::normalizeToDmy(optional($company->documents)->insurance_certificate_expiry ?? '')) }}">
                                                                    </td>
                                                                    <td class="d-flex align-items-center gap-2">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text" name="moa_aoa_number"
                                                                            class="form-control form-control-sm doc-input text-center"
                                                                            placeholder=""
                                                                            value="{{ old('moa_aoa_number', optional($company->documents)->moa_aoa_number ?? '') }}">
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <input name="moa_aoa_expiry"
                                                                            class="form-control form-control-sm date-picker doc-input text-center"
                                                                            value="{{ old('moa_aoa_expiry', @App\SysHelper::normalizeToDmy(optional($company->documents)->moa_aoa_expiry ?? '')) }}">
                                                                    </td>
                                                                    <td class="d-flex align-items-center gap-2">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text"
                                                                            ...
                                                                            class="form-control form-control-sm doc-input text-center"
                                                                            placeholder=""
                                                                            value="{{ old('board_resolution_number', optional($company->documents)->board_resolution_number ?? '') }}">
                                                                    </td>
                                                                    <td>
                                                                        {{-- Not used, but keep for consistency --}}
                                                                    </td>
                                                                    <td>
                                                                        <input name="board_resolution_expiry"
                                                                            class="form-control form-control-sm date-picker doc-input text-center"
                                                                            value="{{ old('board_resolution_expiry', @App\SysHelper::normalizeToDmy(optional($company->documents)->board_resolution_expiry ?? '')) }}">
                                                                    </td>
                                                                    <td class="d-flex align-items-center gap-2">
                                                                        <input type="file"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text" name="poa_number"
                                                                            class="form-control form-control-sm doc-input text-center"
                                                                            placeholder=""
                                                                            value="{{ old('poa_number', optional($company->documents)->poa_number ?? '') }}">
                                                                    </td>
                                                                    <td>
                                                                        {{-- Not used, but keep for consistency --}}
                                                                    </td>
                                                                    <td>
                                                                        <input name="poa_expiry"
                                                                            class="form-control form-control-sm date-picker doc-input text-center"
                                                                            value="{{ old('poa_expiry', @App\SysHelper::normalizeToDmy(optional($company->documents)->poa_expiry ?? '')) }}">
                                                                    </td>
                                                                    <td class="d-flex align-items-center gap-2">
                                                                ...
                                                                @if (!empty($uaeItems) && count($uaeItems) > 0)
                                                                    @foreach ($uaeItems as $i => $d)
                                                                        @php
                                                                            $name = is_array($d)
                                                                                ? $d['name'] ?? ''
                                                                                : $d->document_name ?? '';
                                                                        ...
                                                                        <tr class="dynamic-doc-row"
                                                                            ...
                                                                            <td>
                                                                                <input type="text"
                                                                                    name="uae_documents[{{ $i }}][name]"
                                                                                    class="form-control form-control-sm doc-input"
                                                                                    value="{{ $name }}">
                                                                            </td>
                                                                            <td>
                                                                                <input type="text"
                                                                                    name="uae_documents[{{ $i }}][number]"
                                                                                    class="form-control form-control-sm doc-input text-center"
                                                                                    value="{{ $number }}">
                                                                            </td>
                                                                            <td>
                                                                                <input type="text"
                                                                                    name="uae_documents[{{ $i }}][date]"
                                                                                    class="form-control form-control-sm date-picker doc-input flatpickr-input"
                                                                                    value="{{ $date }}">
                                                                            </td>
                                                                            <td>
                                                                                <input type="text"
                                                                                    name="uae_documents[{{ $i }}][expiry]"
                                                                                    class="form-control form-control-sm date-picker doc-input flatpickr-input"
                                                                                    value="{{ $expiry }}">
                                                                            </td>
                                                                            <td>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table id="nonUaeDocumentationTable" class="table table-hover"
                                                            ...
                                                            <tbody>
                                                                ...
                                                                @if (!empty($nonItems) && count($nonItems) > 0)
                                                                    @foreach ($nonItems as $i => $d)
                                                                        @php
                                                                            $name = is_array($d)
                                                                                ? $d['name'] ?? ''
                                                                                : $d->document_name ?? '';
                                                                        ...
                                                                        <tr class="dynamic-doc-row"
                                                                            ...
                                                                            <td>
                                                                                <input type="text"
                                                                                    name="non_uae_documents[{{ $i }}][name]"
                                                                                    class="form-control form-control-sm doc-input"
                                                                                    value="{{ $name }}">
                                                                            </td>
                                                                            <td>
                                                                                <input type="text"
                                                                                    name="non_uae_documents[{{ $i }}][number]"
                                                                                    class="form-control form-control-sm doc-input text-center"
                                                                                    value="{{ $number }}">
                                                                            </td>
                                                                            <td>
                                                                                <input type="text"
                                                                                    name="non_uae_documents[{{ $i }}][date]"
                                                                                    class="form-control form-control-sm date-picker doc-input flatpickr-input"
                                                                                    value="{{ $date }}">
                                                                            </td>
                                                                            <td>
                                                                                <input type="text"
                                                                                    name="non_uae_documents[{{ $i }}][expiry]"
                                                                                    class="form-control form-control-sm date-picker doc-input flatpickr-input"
                                                                                    value="{{ $expiry }}">
                                                                            </td>
                                                                            <td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div style="width:918px; height:605px; border:solid 1px #2e2e2e;">
                            <div id="ct_div_company">{{ $company->trade_name ?? '' }}</div>
                            <div id="ct_div_date">{{ \Carbon\Carbon::now()->format('d/m/Y') }}</div>
                        ...
                        <div class="modal-body row gy-2">
                                ...
                                <select name="contact_person_name" id="contact_person_name"  onchange="applySelectedContactPersonDetails()"
                                    ...
                                    @foreach ($staffs_list as $staff)
                                        <option value="{{ $staff->id }}"
                                            ...
                                            data-designation-id="{{ $staff->designation_id ?? '' }}"
                                            data-address="{{ $staff->current_address ?? ($staff->permanent_address ?? '') }}">{{ $staff->first_name }}
                            ...
                            <div class="col-lg-2">
                                ...
                                <select class="form-select form-select-sm js-example-basic-single warehouse-input"
                                    ...
                                    @foreach ($w_designations as $key => $value)
                                        <option value="{{ $value->id }}"
                                            @if (old('designation_id') == $value->id) selected @endif
                                            @if (34 == $value->id) selected @endif>
                                            {{ $value->title }}
                                        </option>
                                    @endforeach
            ...
            <script>
                (function() {
                    ...
                    (function initPeopleEmailAvailability() {
                        var checkUrl = @json(route('company.people.checkEmail'));
                        var inFlight = {};
                        var cache = {};
                    ...
                    (function initCompanyCodeUniqueness() {
                        var checkUrl = @json(route('company.checkCode'));
                        ...
                        var pageCompanyId = @json(old('company_id', $company->id));
                    ...
                    var warehouseContactStaffMap = @json($warehouse_contact_staff_map ?? []);
                    var warehouseStateMap = @json(collect($state ?? [])->mapWithKeys(function($s){ return [(string)($s->id ?? '') => ($s->name ?? '')]; }));
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover mt-3" id="long-list">
                                ...
                                <tbody id="shiftTableBody">
                                    @forelse ($company->workingShifts ?? [] as $shift)
                                        <tr class="shift-row" data-shift-index="{{ $loop->index }}">
        ...
        <script>
            $(function() {
                let shiftIndex =
                    "{{ isset($company) && $company->workingShifts ? count($company->workingShifts) : 0 }}";
