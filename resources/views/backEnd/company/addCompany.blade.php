...
@section('mainContent')
  ...
  <li>
                                                                ...
                                                                <div id="ownerWrapper">
                                                                    ...
                                                                    <div class="ownerRow row gy-2 p-2 mb-2 border rounded">
                                                                        <div class="col-lg-1">
                                                                            ...
                                                                            <select name="owners[0][salutation]"
                                                                                class="form-select form-select-sm js-example-basic-single">
                                                                                <option value="">Select</option>
                                                                        ...
                                                                        <div class="col-1-5">
                                                                            ...
                                                                            <input type="text"
                                                                                name="owners[0][last_name]"
                                                                                class="form-control form-control-sm"
                                                                                value="">
                                                                        </div>
                                                                        <div class="col-1-5">
                                                                            <label>Mobile</label>
                                                                            <input type="text" name="owners[0][mobile]"
                                                                                class="form-control form-control-sm"
                                                                                value="">
                                                                        </div>
                                                                        <div class="col-1-5">
                                                                            <label>Email</label>
                                                                            <input type="email" name="owners[0][email]"
                                                                                class="form-control form-control-sm"
                                                                                value="">
                                                                        </div>
                                                                        <div class="col-1-5">
                                                                                ...
                                                                                <select
                                                                                    ...
                                                                                    @foreach ($designations as $key => $value)
                                                                                        <option
                                                                                            ...
                                                                                            @if (150 == $value->id) selected @endif>
                                                                                            {{ $value->title }}
                                                                                        </option>
                                                                                    @endforeach
                                                                        ...
                                                                        <div class="col-lg-1">
                                                                            <label>Share %</label>
                                                                            <input type="number"
                                                                                name="owners[0][share_percentage]"
                                                                                class="form-control form-control-sm"
                                                                                min="0" max="100"
                                                                                value="" placeholder="0">
                                                                        </div>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="col-lg-2">
                                                                            <div class="input-effect">
                                                                                ...
                                                                                <select
                                                                                    class="form-select form-select-sm js-example-basic-single"
                                                                                    name="contacts[0][designation_id]">
                                                                                    <option value="">Select</option>
                                                                                    @foreach ($designations as $key => $value)
                                                                                        <option value="{{ $value->id }}"
                                                                                            {{ old('contacts.0.designation_id') == $value->id ? 'selected' : '' }}>
                                                                                            {{ $value->title }}
                                                                                        </option>
                                                                                    @endforeach
                                                                                </select>
                                                    ...
                                                    <table class="table table-hover data-table" id="long-list"
                                                        ...
                                                        <tbody id="bankTableBody">
                                                            ...
                                                            <tr class="no-bank-row">
                                                                <td colspan="10" class="text-center text-muted">No
                                                                    banks added yet.</td>
                                                            </tr>
                                            ...
                                            <div class="tab-pane fade" id="hrms-info" role="tabpanel"
                                                ...
                                                <div class="row gy-2 mb-4">
                                                    ...
                                                    <div class="col-lg-2">
                                                        ...
                                                        <div id="workingShiftsHiddenInputs"></div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        {{-- @php
                                                            $weekly_offs = @App\WeeklyOff::all();
                                                        @endphp --}}
                                                        <select name="hr_weekly_off[]" id="weeklyoff_select"
                                                            class="form-select form-select-sm setting-input js-example-basic-single"
                                                            multiple>


                                                            <option value="Monday (All)">
                                                                Monday (All)
                                                            </option>
                                                            <option value="1 & 3 Monday (Only 1 & 3)">
                                                                1 & 3 Monday (Only 1 & 3)
                                                            </option>
                                                            <option value="2 & 4 Monday (Only 2 & 4)">
                                                                2 & 4 Monday (Only 2 & 4)
                                                            </option>
                                                            <option value="Tuesday (All)">
                                                                Tuesday (All)
                                                            </option>
                                                            <option value="1 & 3 Tuesday (Only 1 & 3)">
                                                                1 & 3 Tuesday (Only 1 & 3)
                                                            </option>
                                                            <option value="2 & 4 Tuesday (Only 2 & 4)">
                                                                2 & 4 Tuesday (Only 2 & 4)
                                                            </option>
                                                            <option value="Wednesday (All)">
                                                                Wednesday (All)
                                                            </option>
                                                            <option value="1 & 3 Wednesday (Only 1 & 3)">
                                                                1 & 3 Wednesday (Only 1 & 3)
                                                            </option>
                                                            <option value="2 & 4 Wednesday (Only 2 & 4)">
                                                                2 & 4 Wednesday (Only 2 & 4)
                                                            </option>
                                                            <option value="Thursday (All)">
                                                                Thursday (All)
                                                            </option>
                                                            <option value="1 & 3 Thursday (Only 1 & 3)">
                                                                1 & 3 Thursday (Only 1 & 3)
                                                            </option>
                                                            <option value="2 & 4 Thursday (Only 2 & 4)">
                                                                2 & 4 Thursday (Only 2 & 4)
                                                            </option>
                                                            <option value="Friday (All)">
                                                                Friday (All)
                                                            </option>
                                                            <option value="1 & 3 Friday (Only 1 & 3)">
                                                                1 & 3 Friday (Only 1 & 3)
                                                            </option>
                                                            <option value="2 & 4 Friday (Only 2 & 4)">
                                                                2 & 4 Friday (Only 2 & 4)
                                                            </option>
                                                            <option value="Saturday (All)">
                                                                Saturday (All)
                                                            </option>
                                                            <option value="1 & 3 Saturday (Only 1 & 3)">
                                                                1 & 3 Saturday (Only 1 & 3)
                                                            </option>
                                                            <option value="2 & 4 Saturday (Only 2 & 4)">
                                                                2 & 4 Saturday (Only 2 & 4)
                                                            </option>
                                                            <option value="Sunday (All)">
                                                                Sunday (All)
                                                            </option>
                                                            <option value="1 & 3 Sunday (Only 1 & 3)">
                                                                1 & 3 Sunday (Only 1 & 3)
                                                            </option>
                                                            <option value="2 & 4 Sunday (Only 2 & 4)">
                                                                2 & 4 Sunday (Only 2 & 4)
                                                            </option>

                                                            {{-- @forelse ($weekly_offs as $weekly_off)
                                                                <option value="{{ $weekly_off->id }}">
                                                                    {{ $weekly_off->name }}
                                                                </option>
                                                            @empty
                                                            @endforelse --}}
            ...
            <div class="modal-dialog modal-sm draggable">
                <div class="modal-content">
                    ...
                    <div class="modal-body pt-3">
                        ...
                        <div id="entityTypeSuggestions" class="list-group d-none"
                            style="
        position: fixed;
        z-index: 9999;
        max-height: 200px;
     ...
     ">
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#entity_type_name').on('input', function() {
                    clearTimeout(typingTimer);

                    const val = $(this).val().trim();
                    existingExactMatch = false;

                    if (val.length < 2) {
                        $('#entityTypeSuggestions').addClass('d-none').empty();
                        return;
                    }

                    typingTimer = setTimeout(() => {
                        $.get("{{ url('entity-type-search') }}", {
                            q: val
                        }, function(res) {

                            const box = $('#entityTypeSuggestions');
                            box.empty();
                            ...
                            res.forEach(item => {
                                if (item.name.toLowerCase() === val.toLowerCase()) {
                                    existingExactMatch = true;
                                }

                                box.append(`
                        <button type="button"
                            class="list-group-item list-group-item-action entity-suggestion">
                            ${item.name}
                        </button>
                    `);
                            });
                ...
                /* Click suggestion */
                $(document).on('click', '.entity-suggestion', function() {
                    $('#entity_type_name').val($(this).text().trim());
                    $('#entityTypeSuggestions').addClass('d-none').empty();
                });

                /* Save */
                $('#saveEntityType').on('click', function() {
                    if (existingExactMatch) {
                        toastr.warning('This entity type already exists');
                        return;
                    }

                    // 🔽 keep your existing AJAX save logic here
                });

                /* Optional: hide suggestions when modal closes */
                $('#entityTypeAddModal').on('hidden.bs.modal', function() {
            ...
            <div class="modal-dialog modal-xl" style="max-width:980px;">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div style="width:918px; height:605px; border:solid 1px #2e2e2e; position:relative;">
                            <div id="ct_div_company">{{ old('company_name', '') }}</div>
                        ...
                        <div class="modal-body row gy-2">
                            ...
                            <div class="col-2">
                                ...
                                <select name="contact_person_name" id="contact_person_name"
                                    class="form-select form-select-sm warehouse-input js-example-basic-single" onchange="applySelectedContactPersonDetails()">
                                    ...
                                    @foreach ($staffs_list as $staff)
                                        <option value="{{ $staff->id }}"
                                            ...
                                            data-state = "{{ $staff->current_state ?? '' }}"
                                            data-country="{{ $staff->current_country ?? '' }}"
            ...
            <script>
                (function() {
                    ...
                    (function initCompanyCodeUniqueness() {
                        ...
                        // On create this will be blank; kept for consistency with edit page.
                        var pageCompanyId = @json(old('company_id', ''));
                    ...
                    function readChequeTemplateFromEntry($e) {
                        var getVal = function(k) {
                            var inp = $e.find('input[name$="[' + k + ']"]').first();
                    ...
                    function resetChequeTemplateStatus() {
                    ...
                    function openChequeTemplateModal() {
                        ...
                        var companyText = ($('#company_name').val() || '').trim();
                        if (companyText) {
                            $('#ct_div_company').text(companyText);
                        }
                    ...
                    function openBankModal(editIndex = -1) {
                        ...
                        if (editingBankIndex >= 0 && typeof banks[editingBankIndex] !== 'undefined') {
                            ...
                            if ($entry.length) {
                                ...
                                var ctLoaded = readChequeTemplateFromEntry($entry);
                                currentBankChequeTemplate = ctLoaded;
                                var isDefault = (ctLoaded.company_top === _ctDefaults.company_top &&
                                    ctLoaded.company_left === _ctDefaults.company_left &&
                                    ctLoaded.date_top === _ctDefaults.date_top &&
                                    ctLoaded.date_left === _ctDefaults.date_left &&
                                    ctLoaded.amount_w_top === _ctDefaults.amount_w_top &&
                                    ctLoaded.amount_w_left === _ctDefaults.amount_w_left &&
                                    ctLoaded.amount_top === _ctDefaults.amount_top &&
                                    ctLoaded.amount_left === _ctDefaults.amount_left &&
                                    ctLoaded.font_size === _ctDefaults.font_size);
                    ...
                    $(document).on('click', '#bankSaveBtn', function(e) {
                        ...
                        if (editingBankIndex >= 0 && typeof banks[editingBankIndex] !== 'undefined') {
                            ...
                            if ($row.length) {
                                ...
                                $row.find('td').eq(1).text(account_name);
                                $row.find('td').eq(2).text(branch_name);
                                $row.find('td').eq(3).text(account_number);
                                $row.find('td').eq(4).text(iban_number);
                                $row.find('td').eq(5).text(swift_code);
                                $row.find('td').eq(6).text(finance_code);
                                $row.find('td').eq(7).text(getCurrencyTextForValue(currency));

                                var newLetter = $newEntry.data('existing-file-name') || '—';
                                $row.find('td').eq(8).text(newLetter);
                            ...
                            if ($select.length) {
                                ...
                                // append new option with data-bank-index to help reindexing later
                                $select.append($('<option>', {
                                    value: optVal,
                                    text: bank_name,
                                    'data-bank-index': bankIndex
                                }));
                                if ($select.hasClass('js-example-basic-single')) $select.trigger('change.select2');
                    ...
                    function removeBankByIndex(index) {
                        ...
                        var selectedNames = new Set((prevSelected || []).map(function(s) {
                        ...
                        if ($selectToRebuild.length) {
                            ...
                            if ($selectToRebuild.hasClass('js-example-basic-single')) $selectToRebuild.trigger(
                            'change.select2');
                            else $selectToRebuild.trigger('change');
                        }

                        if ($('#bankTableBody').find('.bank-row').length === 0) {
                            $('#bankTableBody').append(
                                '<tr class="no-bank-row"><td colspan="10" class="text-center text-muted">No banks added yet.</td></tr>'
                            );
                        }
                    }
                    ...
                    function loadExistingBanks() {
                        ...
                        $container.find('.bank-entry').each(function(i) {
                            ...
                            banks.push({
                                ...
                                cheque_template: readChequeTemplateFromEntry($e)
                            });
                    ...
                    function copyCompanyAddressToWarehouseForm() {
                        ...
                        if (companyState) {
                            ...
                            var stateSetter = setInterval(function() {
                                var $matches = $('#warehouse_state option').filter(function() {
                                    var value = ($(this).val() || '').toString();
                                    var text = ($(this).text() || '').trim();
                                    return value === companyState.toString() || text === companyState.toString();
                                });
                                if ($matches.length || tries > 10) {
                                    if ($matches.length) {
                                        $('#warehouse_state').val($matches.first().val()).trigger('change');
                                        window.pendingWarehouseState = '';
                                    } else {
                                        $('#warehouse_state').val(companyState).trigger('change');
    ...
    if (mapped) {
        ...
        var mCountry = ((mapped.country || '') + '').trim();
        var mState = ((mapped.state || '') + '').trim();
        ...
        if (mCountry) $('#warehouse_country').val(mCountry).trigger('change');
        if (mState) $('#warehouse_state').val(mState).trigger('change');
        return;
    }
    ...
    if (address) $('#contact_address').val(address);
                    ...
                    $(document).on('click', '#saveWarehouseBtn', function(e) {
                        ...
                        if (editingWarehouseIndex >= 0 && typeof warehouses[editingWarehouseIndex] !== 'undefined') {
                            ...
                            if ($row.length) {
                                ...
                                var cpText = contact_person_text || $newEntry.data('contact_person_text') || $oldEntry
                                    .data('contact_person_text') || (contact_person_id ? ($(
                                        ...
                                        .text() || '').trim() : '');
                                var contactPersonDisplay = cpText || [contact_salutation, contact_first_name,
                                    contact_last_name, contact_mobile
                            ...
                            var cpTextNew = contact_person_text || (contact_person_id ? ($(
                                ...
                                '').trim() : '');
                            var contactPersonDisplayNew = cpTextNew || [contact_salutation, contact_first_name,
                                contact_last_name, contact_mobile
                            ].filter(Boolean).join(' ').trim();
                    ...
                    $(document).on('select2:select', '#contact_person_name', function() {
                        console.log("121212122")
    applySelectedContactPersonDetails();
});
                
$(document).on('change', '#contact_person_name', function() {
    applySelectedContactPersonDetails();
});
                    ...
                    function loadExistingWarehouses() {
                        ...
                        $container.find('.warehouse-entry').each(function(i) {
                            ...
                            row.append($('<td>').text(warehouse_country || '—'));
                            row.append($('<td>').text(warehouse_state || '—'));
                            var contactDisplay = contact_person_text || [contact_salutation, contact_first_name,
                                contact_last_name, contact_mobile
                            ].filter(Boolean).join(' ').trim();
        ...
        `);
                    ...
                    row.find('.btn-delete-shift').on('click', function() {
                        ...
                        // If no shifts left, show no-shift row
                        if ($('#shiftTableBody').find('.shift-row').length === 0) {
            ...
            <div class="modal-dialog modal-sm draggable">
                <div class="modal-content">
                    ...
                    <div class="modal-body pt-3">
                        ...
                        <div id="industryTypeSuggestions" class="list-group d-none"
                            style="
        position: fixed;
        z-index: 9999;
        max-height: 200px;
     ...
     ">
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#industry_type_name').on('input', function() {
                    clearTimeout(typingTimer);
                    ...
                    if (val.length < 2) {
                        $('#industryTypeSuggestions').addClass('d-none').empty();
                        return;
                    }

                    typingTimer = setTimeout(() => {
                        $.get("{{ url('industry-search') }}", {
                            q: val
                        }, function(res) {

                            const box = $('#industryTypeSuggestions');
                            box.empty();
                            ...
                            res.forEach(item => {
                                ...
                                box.append(`
                        <button type="button"
                            class="list-group-item list-group-item-action industry-suggestion">
                            ${item.name}
                        </button>
                    `);
                            });
                ...
                /* Click suggestion */
                $(document).on('click', '.industry-suggestion', function() {
                    $('#industry_type_name').val($(this).text().trim());
                    $('#industryTypeSuggestions').addClass('d-none').empty();
                });

                /* Save */
                $('#saveIndustryType').on('click', function() {
                    if (existingExactMatch) {
                        toastr.warning('This Industry already exists');
                        return;
                    }
                ...
                /* Optional: hide suggestions when modal closes */
                $('#industryTypeAddModal').on('hidden.bs.modal', function() {
        ...
        <script>
            $(document).ready(function() {
                ...
                $(document).on('mousedown', function(e) {
                    const $box = $('#industryTypeSuggestions');
                    const $input = $('#industry_type_name');
            ...
            <div class="modal-dialog modal-sm draggable">
                <div class="modal-content">
                    ...
                    <div class="modal-body pt-3">
                        ...
                        <div id="businessSectorSuggestions" class="list-group d-none"
                            style="
        position: fixed;
        z-index: 9999;
        max-height: 200px;
     ...
     ">
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#business_sector_name').on('input', function() {
                    clearTimeout(typingTimer);
                    ...
                    if (val.length < 2) {
                        $('#businessSectorSuggestions').addClass('d-none').empty();
                        return;
                    }

                    typingTimer = setTimeout(() => {
                        $.get("{{ url('business-activity-search') }}", {
                            q: val
                        }, function(res) {

                            const box = $('#businessSectorSuggestions');
                            box.empty();
                            ...
                            res.forEach(item => {
                                ...
                                box.append(`
                        <button type="button"
                            class="list-group-item list-group-item-action business-sector-suggestion">
                            ${item.name}
                        </button>
                    `);
                            });
                ...
                /* Click suggestion */
                $(document).on('click', '.business-sector-suggestion', function() {
                    $('#business_sector_name').val($(this).text().trim());
                    $('#businessSectorSuggestions').addClass('d-none').empty();
                });

                /* Save */
                $('#saveBusinessSector').on('click', function() {
                    if (existingExactMatch) {
                        toastr.warning('This Business Sector already exists');
                        return;
                    }
                ...
                /* Optional: hide suggestions when modal closes */
                $('#businessSectorAddModal').on('hidden.bs.modal', function() {
                    $('#business_sector_name').val('');
                    $('#businessSectorSuggestions').addClass('d-none').empty();
                    existingExactMatch = false;
                });
        ...
        <script>
            $(document).ready(function() {
                ...
                $(document).on('mousedown', function(e) {
                    const $box = $('#businessSectorSuggestions');
                    const $input = $('#business_sector_name');
        ...
        <script>
            $(document).ready(function() {
                ...
                $('input').each(function() {
                    ...
                    if (name.match(
                            /email|account_name|mobile|phone|password|other_code|iban_number|swift_code|currency|docs\[joining\]\[passport_visa\]\[number\]|docs\[joining\]\[iban_letter\]\[number\]|docs\[joining\]\[prof_certs\]\[number\]|docs\[joining\]\[academic\]\[number\]/
                        )) return;
        ...
        <script>
            $(document).ready(function() {
                ...
                $country.on('change', function() {
                    ...
                    window.pendingWarehouseState = state.val() || '';
