...
<div id="uae-compliance-section" class="{{ $selected_country == '231' ? '' : 'd-none' }}">
    <div class="row gy-2 mt-2">
        ...
        <div class="col-lg-2">
            ...
            <input type="text" class="form-control form-control-sm date-picker" name="license_issue_date"
        ...
        <div class="col-lg-2">
            ...
            <input type="text" class="form-control form-control-sm date-picker" name="license_expiry_date"
        ...
        <div class="col-lg-2">
            ...
            @if (!empty($company->compliance->business_license_upload))
                <a href="{{ asset('storage/' . $company->compliance->business_license_upload) }}" target="_blank"
                    class="mt-1 d-block">View Existing File</a>
            @endif
    ...
    <div class="row gy-2 mt-2 vat-section {{ in_array($tax_applicable_value, ['vat', 'both']) ? '' : 'd-none' }}">
        ...
        <div class="col-lg-2">
            ...
            @if (!empty($company->compliance->vat_certificate))
                <a href="{{ asset('storage/' . $company->compliance->vat_certificate) }}" target="_blank"
                    class="mt-1 d-block">View Existing File</a>
            @endif
        </div>
    </div>
    ...
    <div class="row gy-2 mt-2 ct-section {{ in_array($tax_applicable_value, ['ct', 'both']) ? '' : 'd-none' }}">
        ...
        <div class="col-lg-2">
            ...
            @if (!empty($company->compliance->corporate_tax_certificate))
                <a href="{{ asset('storage/' . $company->compliance->corporate_tax_certificate) }}" target="_blank"
                    class="mt-1 d-block">View Existing File</a>
            @endif
        </div>
    </div>
...
<div id="non-uae-compliance-section"
    class="{{ $selected_country != '231' && $selected_country != '' ? '' : 'd-none' }}">
    <div class="row gy-2 mt-2">
        <div class="col-12">
...
<script>
    ...
    function initializeComplianceDocuments() {
        ...
        $.post('{{ url('company/compliance/session/get') }}', {
            _token: '{{ csrf_token() }}'
        }, function(resp) {
...
<div class="modal fade" id="complianceDocumentModal" tabindex="-1" aria-labelledby="complianceDocumentModalLabel"
    aria-hidden="true">
