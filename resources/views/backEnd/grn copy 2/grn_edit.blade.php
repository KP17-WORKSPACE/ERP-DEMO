             ...
             <div class="dropdown">
                            ...
                            <div class="card mb-3">
                                ...
                                readonly>
                                        ...
                                        <div class="col-2">
                                            ...
                                            <input class="form-control date-picker" id="grn_date" type="date" autocomplete="off" name="grn_date" value="{{ @$value }}">
                                            </div>
                                        </div>
                                        <div class="col-2">
                                ...
                                @foreach ($currency as $value)
                                    ...
                                    @if($grn->currency_id == $value->id) selected @endif>
                                        {{ @$value->code }}
                                    </option>
                                @endforeach
                            </select>
                                ...
                                @foreach ($staff as $value)
                                    <option disabled value="{{ @$value->user_id }}" @if($value->user_id == @$grn->created_by) selected @endif>{{ @$value->full_name }}</option>
                                @endforeach
                            </select>
                                            </div>
                                        </div>
                ...
                <div class="col-2 mb-2">
                    <div class="input-effect">
                        ...
                        <div id="plist" style="width: 100%; height: 80px; border: solid 1px #dfe1d7; border-radius: 5px; padding: 5px 5px; overflow-y: scroll;"></div>
                ...
                <div class="col-10 mb-2">
                                ...
                                <table class="table table-hover form-item-table" id="myTable">
                                    <thead>                                                            
                                        <tr>
                                            ...
                                            <th class="resizable text-center" width="150px">@lang('Part No')<div class="resizer"></div></th>
                                            ...
                                            <th class="resizable text-center" width="80px" scope="col" >Dis <a class="icon icon-outline-book" data-bs-toggle="modal" data-bs-target="#discountModal"></a><div class="resizer"></div></th>
                                            <th class="resizable text-center" width="80px" scope="col" >Freight <a class="icon icon-outline-book" data-bs-toggle="modal" data-bs-target="#freightModal"></a><div class="resizer"></div></th>
                                            <th class="resizable text-center" width="80px" scope="col" >Custom <a class="icon icon-outline-book" data-bs-toggle="modal" data-bs-target="#customModal"></a><div class="resizer"></div></th>
                                            ...
                                            <th class="resizable text-center" width="100px">@lang('Serial No')<div class="resizer"></div></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                    ...
                    @if (count($grn_items)>0)
                        ...
                        <tr>
                            <td><input type="text" class="form-control" name="sort_id[]" value="{{ $i }}" />
                                <input type="hidden" id="product_type[]" value="{{ $items->product_type }}" />
                                <input type="hidden" name="item_po_id[]" value="{{ $items->po_id }}" />
                                <input type="hidden" name="part_number_txt[]" value="{{ $items->part_number }}" />
                            </td>
                            <td>
                        ...
                        @endif
                            ...
                            <td><input type="text" class="form-control" name="tax[]" value="{{ number_format($items->tax ?? 0,2,'.','') }}" onchange="calc_change_new(this)"/></td>
                            <td><input type="text" class="form-control" name="qty[]" value="{{ $items->qty }}"  onkeypress="set_license_key_po({{ $i }})" onchange="calc_change_new(this)"/></td>
                    ...
                    @endif
                    <tr>
                                            <td><input type="text" class="form-control" name="sort_id[]" value="{{ count($grn_items)+1 }}" /></td>
                                            <td class="noborder">
                                                <select class="form-control noborder " name="part_number[]">
                                                </select>
