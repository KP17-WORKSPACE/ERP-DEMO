                ...
                <div class="row gap-rows">
                    ...
                    <div class="col-2 mb-2">
                        <div class="input-effect">
                            ...
                            <a data-modal-size="modal-md" data-target="#pi_pending_popup_win" id="addPIPending"
                                data-toggle="modal"></a>
                    ...
                    <div class="col-10 mb-2">
                        <div class="row gap-rows">
                            ...
                            <div class="col-2">
                                ...
                                <div class="form-group">
                                    <input class="form-control" type="text" name="pi_number" autocomplete="off"
                                        id="pi_number" value="" readonly>
                                </div>
                            </div>
                            <div class="col-2">
                                ...
                                <div class="form-group">
                                    <input class="form-control date-picker" id="pi_date" type="text" autocomplete="off"
                                        name="pi_date" value="{{ $value_date }}" style="margin-top: 0px" readonly>
                                </div>
                            </div>
                            <div class="col-2">
                            ...
                            <div class="col-2">
                                ...
                                <div class="form-group">
                                    <input class="form-control date-picker" id="lpo_date" type="text" autocomplete="off"
                                        name="lpo_date" value="{{ $value_date }}" style="margin-top:0px;">
                                </div>
                            </div>
                            <div class="col-2">
        ...
        <table class="table table-hover form-item-table" id="myTable">
            <thead>
                <tr>
                    ...
                    <th class="resizable text-center" width="50px">@lang('PI Qty')<div class="resizer"></div>
                    </th>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <input class="form-control text-center" type="number" name="pi_qty[]" autocomplete="off"
                            readonly="true">
        ...
        function get_pi_list(id) {
            ...
            $.ajax({
                ...
                success: function(dataResult) {
                    ...
                    if (len > 0) {
                        ...
                        for (var i = 0; i < len; i++) {
                            ...
                            var option = "<option value='" + id + "'>" + doc_number +
                                "</option>";
                            var innerHtml =
                                "<input type='radio' onclick='popup_pi_pending(" + id + ")' id='pending_pi_" +
                                i + "' name='pending_pi' value='" + doc_number + "'><label for='pending_pi_" +
                                i + "'> " + doc_number + "</label><br />";
                    ...
                    var innerHtml =
                        "<input type='radio' onclick='without_pi(0)' id='pending_po_0' name='pending_po' value='0'> <label for='pending_po_0'> Without PI</label><br />";
                    $("#plist").append(innerHtml);
                    $("#loading_bg").css("display", "none");
                }
            });
    ...
    <button id="btnModalAdjustmentNew" data-bs-toggle="modal" data-bs-target="#adjustmentModal"></button>
    <div class="modal side-panel fade" id="adjustmentModal" data-bs-backdrop="false" tabindex="-1"
        aria-labelledby="editModalLabel" aria-hidden="true">
                ...
                success: function(dataResult) {
                    ...
                    if (len > 0) {
                        for (var i = 0; i < len; i++) {
                            ...
                            tblrow += "<tr>";
                            tblrow +=
                                "<td><input type='text' class='form-control' name='adj_doc_date[]' id='adj_doc_date_" +
                                i + "' value='" + get_format_date(dataResult['data'][i].doc_date) +
                                "' readonly /></td>";

                            tblrow +=
                                "<td><input type='text' class='form-control' name='adj_pi_no[]' id='adj_pi_no_" +
                                i + "' value='" + dataResult['data'][i].doc_number + "' readonly /></td>";
                            tblrow +=
                                "<td><input type='text' class='form-control' name='adj_total[]' id='adj_total_" +
                                i + "' value='" + dataResult['data'][i].total_amount + "' readonly /></td>";

                            if (paid_amount == 0) {
                                tblrow +=
                                    "<td><input type='text' class='form-control class_adj_paid' name='adj_paid[]' id='adj_paid_" +
                                    i + "' value='" + paid_amount + "' onclick='get_set_amount(" + i +
                                    ")' required/></td>";
                            } else {
                                if (dataResult['data'][i].adj_status == 5) {
                                    ...
                                    tblrow +=
                                        "<td><input type='text' class='form-control class_adj_paid' name='adj_paid2[]' id='adj_paid_" +
                                        i + "' value='" + paid_amount + "' onclick='get_set_amount(" + i +
                                        ")' required readonly /></td><input type='hidden' name='adj_paid[]' value='0'/>";
                                }
                            }


                            tblrow +=
                                "<td><input type='text' class='form-control' name='adj_balance[]' id='adj_balance_" +
                                i + "' value='" + balance_amount + "' readonly /></td>";
                            tblrow += "</tr>";
