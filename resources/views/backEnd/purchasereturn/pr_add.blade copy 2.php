                ...
                <div class="col-10 mb-2">
                    <div class="row gap-rows">
                        ...
                        <div class="col-2">
                            ...
                            <div class="form-group">
                                <input class="form-control" id="pi_date" type="date" autocomplete="off" name="pi_date" value="{{ date('Y-m-d') }}" style="margin-top: 0px" readonly>
                            </div>
                        </div>
                        <div class="col-2">
                                ...
                                <table class="table table-hover form-item-table" id="myTable">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>                                                                    
                                                <input class="form-control" type="number" name="pi_qty[]" autocomplete="off" readonly="true">
