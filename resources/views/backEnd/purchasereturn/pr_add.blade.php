    ...
    <div class="purchase-order-content-header">
        <h4 class="purchase-order-content-header-left">
            New ({{ isset($edit) ? (!empty(@$edit->title) ? @$edit->title : old('doc_number')) : @App\SysHelper::get_new_code('sys_purchase_return','PR' ,'doc_number') }})
        </h4>
            ...
            <button type="submit" class="btn btn-light">
             ...
             <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><button class="dropdown-item" type="button" onclick="get_adjustment_list()"><i class="ico icon-outline-calculator-minimalistic text-warning"></i> Adjustment</button></li>
                </ul>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="row gap-rows">
                                        <div class="col-4">
                                            ...
                                            <div class="form-group">
                                                <select class="form-control js-account-select" name="vendors" id="vendors" onchange="get_pending_grn_list()">
                                                <option value=""></option>
                                ...
                                <input
                                    ...
                                    readonly>
                                        ...
                                        <div class="col-2">
                                            ...
                                            <div class="form-group">
                                            @php     $value =  \Carbon\Carbon::parse(now())->format('d/m/Y') ; @endphp
                                        <input class="form-control date-picker" id="doc_date" type="text" autocomplete="off" name="doc_date" value="{{ @$value }}" style="margin-top: 0px">
                                            </div>
                                        </div>
                                        <div class="col-2">
                ...
                <div class="col-10 mb-2">
                    <div class="row gap-rows">
                        ...
                        <div class="col-2">
                            ...
                            <div class="form-group">
                                <input class="form-control" type="text" name="pi_number" autocomplete="off" id="pi_number" value="" readonly>
                            </div>
                        </div>
                        <div class="col-2">
                           ...
                           <div class="col-2">
                                ...
                                <input class="form-control date-picker" id="bill_date" type="text" autocomplete="off"
                                    name="bill_date" value="{{ @$value_date }}" required >
                                                </div>
                                            </div>
                        <div class="col-2">
                        ...
                        <div class="col-2">
                                     ...
                                     <div class="form-group">
                                         ...
                                         <select class="form-control js-example-basic-single" required name="debit_note" id="debit_note">
                                            ...
                                            <option value="PR" selected>Purchase Return</option>
                                ...
                                <table class="table table-hover form-item-table" id="myTable">
                                    <thead>                                                            
                                        <tr>
                                            ...
                                            <th class="resizable text-center" width="50px">@lang('PI Qty')<div class="resizer"></div></th>
                                            ...
                                            <th class="resizable text-center" width="80px">@lang('SRL No')<div class="resizer"></div></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>                                                                    
                                                <input class="form-control text-center" type="number" name="pi_qty[]" autocomplete="off" readonly="true">
                                            ...
                                            <td><input class="form-control text-center" type="number" name="qty[]" autocomplete="off" min="0" onchange="calc_change_new(this)" onkeydown="return set_license_key_normal(event, this)"></td>
...
{{-- Models  --}}
    ...
    {{-- Modal PO --}}
<div class="modal  fade" id="po_pending_popup_win" data-bs-backdrop="false" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl draggable modal-dialog-scrollable" style="top: 50px;left: 285px;width:1055px">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body p-0">
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-lg-12 p-0">
                                    <div class="">
                                        <table  class="table table-hover popupPR" id="long-list" style="table-layout: fixed;width:100%">
                                            <thead>
                                                <tr >
                                                    ...
                                                    <th style="width:80px">@lang('Description')</th>
                                                     <th style="width:30px" class="text-center">@lang('PI Qty')</th>
                     ...
                     <div class="modal-footer d-flex justify-content-center p-0">
                            ...
                            <button type="submit" class="btn btn-light add-btn ms-2" id="btnAddPIRows">
...
<script>
    ...
    <div class="modal side-panel fade" id="ModalLicenseKey" data-bs-backdrop="false" tabindex="-1"
        ...
        <button id="btnModalAdjustmentNew" data-bs-toggle="modal" data-bs-target="#adjustmentModal" class="d-none"></button>
...
$(document).ready(function() {
    $('#adjustmentForm').on('submit', function(e) {
        ...
        // AJAX submission
        $.ajax({
            url: "{{ url('purchase-return-add-adjestment3') }}", // Replace with your actual route
            type: "POST",
            data: formData,
            success: function(response) {
                // Handle success response
                alert('Adjustment saved successfully.');
                $('#adjustmentModal').modal('hide'); // Hide modal if using Bootstrap
            },
            error: function(xhr) {
                // Handle errors
    ...
    <script>
                ...
                success: function(dataResult) {
                    ...
                    if (len > 0) {
                        for (var i = 0; i < len; i++) {
                            ...
                            var isSelected = prId > 0 ? (Number(row.status) === 2 && Number(row.purchase_return_id) === prId) : (Number(row.purchase_return_id) === -1);
                            if (isSelected) {
                                selectedCount++;
                            }
                            ...
                            getSelectedRows += "<tr class='text-center' data-lk-status=\"" + (row.status != null ? row.status : '') + "\">\
        ...
        function set_license_key() {
            ...
            if (prId > 0) {
                requestData.pr_id = prId;
                requestData.keep_pr_key_ids = keepPrKeyIds.join(',');
            }
        ...
        $(function() {
            ...
            $('#purchase-return-store').on('submit.licenseQtyValidation', function(e) {
