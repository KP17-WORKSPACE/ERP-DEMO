    ...
    <div class="container-fluid">
        <div class="d-sm-flex justify-content-between">
            ...
            <div>
                ...
                <a href="{{ url('customers') }}" type="button" class="btn btn-info">Customer List</a>
                                ...
                                <img height="100" width="100" src="{{ file_exists(@$value->staff_photo) ? asset($value->staff_photo) : asset('public/uploads/staff/demo/staff.png') }}" alt="">
                                    ...
                                    <td>
                                        <a class="btn-sm btn-info"
                                            href="{{ url('view-customer') }}/{{ @$value->id }}"><i class="fa fa-eye"
                                                aria-hidden="true"></i></a>

                                        <a class="btn-sm btn-primary" href="{{ url('customer-edit', $value->id) }}"><i
