          ...
          <div class="tab-pane fade" id="payment-details" role="tabpanel" aria-labelledby="payment-details-tab">
            ...
            <div class="col-md-6">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-8"><input class="form-control" type="number" value="{{ $editData->credit_limit }}"  name="credit_limit" required></div>
                </div>
                <div class="row mt-2">
                ...
                <table class="table table-bordered table-striped" width="100%" cellspacing="0">
                    @if (count($editDoc)>0)
                        ...
                        <tr>
                            ...
                            <td><a class="btn-sm btn-light" href="{{asset('public/uploads/cust-suppl/')}}/{{ $doc->doc_file }}" target="_blank"> Download</a>
                            <a class="btn-sm btn-light " href="{{url('delete-cust-suppl-doc/'.$doc->id)}}">  <i class="ico icon-outline-trash-bin-minimalistic text-dark"
