...
{{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'customer-store', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'customer-save-form-edit', 'novalidate' => true]) }}
...
<div class="tab-wrap mb-3">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-8"><select class="form-control js-example-basic-single" name="customer_type" id="customer_type"
                                required>
                                <option data-display="" value=""></option>
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-8"><select class="form-control js-example-basic-single" name="sale_type" id="sale_type" required>
                                <option data-display="" value=""></option>
   ...
   <!-- Hidden inputs for existing docs so they are included in form request -->
                                        <input type="hidden" name="existing_doc_id[]" value="{{ $doc->id }}" />
                                        <input type="hidden" name="existing_doc_file[]" value="{{ $doc->doc_file }}" />
                                        <input type="hidden" name="doc_name[]" value="{{ $doc->doc_name }}" />
                                        <input type="hidden" name="doc_exp_date[]" value="{{ $doc->doc_exp_date ? date('Y-m-d', strtotime($doc->doc_exp_date)) : '' }}" />
                                        <input type="hidden" name="existing_doc_deleted[]" value="{{ $doc->deleted_at ? 1 : 0 }}" />
