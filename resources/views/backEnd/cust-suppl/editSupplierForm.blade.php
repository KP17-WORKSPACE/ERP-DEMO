            ...
            <div class="row gap-rows">
                ...
                <div class="col-4">
                    ...
                    <input class="form-control" type="text" name="customer_name_display" id="customer_name_display"
                        placeholder="Supplier Display Name" required
                        value="{{ isset($editData) ? @$editData->customer_name_display : '' }}">
                </div>
                            ...
                            <div class="row g-0 border rounded overflow-hidden">
                                ...
                                <div class="col-md-2 border-end">
                                    <div class="form-group">
                                        <select class="form-control select2 rounded-0 border-0 h-100" id="salutation"
                                            name="salutation">
                            ...
                            @if (count($designation) > 0)
                                @foreach ($designation as $val)
                                    <option value="{{ $val->title }}"
                                        @if ($editData->designation == $val->title) selected @endif>{{ $val->title }}</option>
                                @endforeach
                            @endif
                        </select>
                        {{-- <i class="ico icon-outline-alt-arrow-down dropdown-toggle-ico"></i> --}}
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-8"><select class="form-control" name="supplier_type" id="supplier_type"
                                required>
                                <option data-display="" value=""></option>
                                @foreach ($supplier_type as $key => $value)
                                    <option value="{{ @$value->id }}"
                                        @if ($value->id == $editData->supplier_type) selected @endif>{{ @$value->title }}
                                    </option>
                                @endforeach
                            </select></div>
                    </div>
                    <div class="row mt-2">
                        ...
                        <div class="col-md-8"><select class="form-control" name="purchase_type" id="purchase_type"
                                required>
                                <option data-display="" value=""></option>
                                @foreach ($purchase_type as $key => $value)
                                    <option value="{{ @$value->id }}"
                                        @if ($value->id == $editData->purchase_type) selected @endif>{{ @$value->title }}
                                    </option>
                                @endforeach
                            </select></div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="row mt-2">
                        ...
                        <div class="col-md-8"><select class="form-control js-example-basic-single"
                                ...
                                <option value="">Select</option>
                                <option value="Cash" @if ($editData->transaction_type == 'Cash') selected @endif>Cash
                                </option>
...
<div class="card mb-3">
    <div class="card-body">
        ...
        @if (count($excisting_list) > 0)
            ...
            <table class="table table-bordered table-hover" id="long-list" style="table-layout: fixed;width:100%">
                <thead>
                        ...
                        <td>
                            <div class="d-flex justify-content-center align-items-center">
                                <a class="btn btn-light"
                                    href="{{ url('supplier-form-details/' . $list->id . '/merge/' . $editData->id . '') }}"
                                    onclick="return confirm('Are you sure you want to merge this item?');"> <i class="ico icon-outline-link-square  me-2"></i> Merge</a>
                            </div>
                        </td>
                    </tr>
                @endforeach
