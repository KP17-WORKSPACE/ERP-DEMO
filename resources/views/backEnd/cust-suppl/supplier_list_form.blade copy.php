...
<div class="container-fluid">
    <div class="d-sm-flex justify-content-between">
        <div class="mb-3">
            <h2 class="page-heading m-0">Supplier Pending List</h2>
            <span class="page-label">Home - Supplier Pending List</span>
        </div>
        <div>
            <input type="hidden" name="copy_url" id="copy_url" value="{{ url('supplier-from/'.session('logged_session_data.company_id')) }}" />
    ...
    <div class="collapse" id="collapseExample">
        ...
        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'suppliers', 'method' => 'POST', 'id' => 'crm-deals-search']) }}
            <div class="row">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a class="text-dark">
                                <div style="width:250px; text-overflow: ellipsis; white-space: nowrap; overflow: hidden;">{{@$value->name}}</div></a>
                            </td>                                        
                            <td>
                                {{@$value->first_name}}
                            </td>
                            ...
                            <td>
                                <a class="btn-sm btn-primary" href="{{url('supplier-form-edit', $value->id)}}"><i class="fa fa-edit" aria-hidden="true"></i></a>                                
                                <a class="btn-sm btn-danger"  href="{{url('supplier-form-delete', $value->id)}}" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash" aria-hidden="true"></i></a>
                            </td>
                        </tr>
