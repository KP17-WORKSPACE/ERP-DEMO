    ...
    <script>
        ...
        function list_style_new() {
            ...
            if (!isFullList) {
                ...
                localStorage.setItem('listViewCustomerPendingList', 'long');
            } else {
                ...
                localStorage.setItem('listViewCustomerPendingList', 'short');
        ...
        document.addEventListener('DOMContentLoaded', () => {
            const savedView = localStorage.getItem('listViewCustomerPendingList');
            if (savedView === 'long') {
                        ...
                        <ul class="dropdown-menu" style="">
                            ...
                            <li>
                                <a href="{{ url('customers') }}"
                                    class="dropdown-item d-flex align-items-center text-success"><i
                                        class="ico icon-outline-document-text text-success title-15 me-2"></i>Customers
                                </a>
                            </li>
                                ...
                                <div class="row w-100">
                                    <div class="col-4">
                                        <div class="form-control-plaintext">
                                            ...
                                            @else
                                                @if (App\SysHelper::get_company_status(
                                                        $value->vat_country,
                    ...
                    <tbody>
                        ...
                        @foreach ($customer as $value)
                            <tr>
                                ...
                                <td class="cust-item" data-id="{{ @$value->id }}" onclick="list_style_new()"><a>
                                ...
                                <td>
                                    ...
                                    <div class="d-flex justify-content-center align-items-center gap-1">
                                        <a  href="{{ url('customers/' . $value->id . '?customer_action=edit') }}"
                                            onclick="setCustomerListStyle()" class="btn btn-sm btn-light" title="Comments">
                                            <i class="ico icon-outline-pen-2" style="font-size: 16px;"></i>
                                        </a>


                                        <script>
function setCustomerListStyle() {
    console.log("clicked")
    // Store value before navigating
    localStorage.setItem('listViewCustomerList', 'short');
}
</script>
            ...
            <script>
                $(document).ready(function() {
                    $(document).on('click', '.cust-item', function() {
                        ...
                        var newUrl = "{{ url('customers-pending') }}/" + id;
