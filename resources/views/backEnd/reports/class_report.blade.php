                            ...
                            <div class="col-lg-8">
                                <div class="single-meta">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4">
                                            <div class="value text-left text-uppercase">
                                                @lang('lang.collection')({{@$currency_symbol}})
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4">
                                            <div class="value text-left text-uppercase">
                                                @lang('lang.due')({{@$currency_symbol}})
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="single-meta">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4">
                                            <div class="name text-left">
                                                {{@App\SysHelper::com_curr_format(@$total_collection, 2)}}<input type="hidden" id="total_collection" name="total_collection" value="{{@$total_collection}}">
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4">
                                            <div class="name text-left">
                                                {{@App\SysHelper::com_curr_format(@$total_assign - @$total_collection, 2)}}<input type="hidden" id="total_assign" name="total_assign" value="{{@$total_assign}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
