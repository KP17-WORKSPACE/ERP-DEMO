    ...
    $.ajax({
        ...
        success: function(dataResult) {
            ...
            dataResult.forEach((re) => {
                ...
                let customItems = re.comment.split("\n");
                ...
                $("#mydiv").append(
                    "<p class='text-end m-0'><i>" 
                    + re.username + " | On "
                    + new Date(re.created_at).toLocaleDateString('en-US') + " "
                    + new Date(re.created_at).toLocaleTimeString('en-US')
                    + "</i></p><hr class='mt-0'>"
                );
...
<div style="display:flex; justify-content:space-between; align-items:center; width:100%;">
    ...
    {{ Form::open(['class'=>'m-0','url'=>'generalledger','target'=>'_blank','method'=>'POST']) }}
            ...
            <button class="btn btn-light p-1">
                <i class="ico icon-outline-notebook text-success" data-bs-popover="popover"
        ...
        <a class="btn-badge btn btn-light p-1"
           data-id="{{@$aname->id}}"
           data-cust="{{ @$cust_det }}"
           href="#"
           id="crmajax"
           ...
           data-bs-popover="popover"
            ...
            <i class="ico icon-outline-chat-round-line text-primary"></i>
        </a>
        ...
        <a href="#"
           ...
           onclick="download_outstanding({{ $aname->id }})">
            <i class="ico icon-outline-download-square text-danger"></i>
        </a>
                ...
                <table class="table sub_table data-table" id="long-list" style="border: solid 1px #e3e6f0; width:100%; table-layout:fixed;">
                    <thead>
                        <!-- <tr>
                        <td colspan="10">&nbsp;</td>
                        <td colspan="2">
                      ...
                      <tr>
                          <th class="border text-center" style="width:5%">Doc Date</th>
                          <th class="border text-center" style="width:7%">Doc No</th>
                          <th class="border text-center" style="width:6%">LPO No</th>
                          <th class="border text-center" style="width:5%">Deal ID</th>
                          <th class="border text-center" style="width:6%">Amount</th>
                          <th class="border text-center" style="width:6%">Adjustments</th>
                          <th class="border text-center" style="width:6%">Balance</th>
                          <th class="border text-center" style="width:6%">Total Balance</th>
                          <th class="border text-center hidecol_{{ $aname->id }}" style="width:6%">Receipt Date</th>
                          <th class="border text-center hidecol_{{ $aname->id }}" style="width:6%">Doc Number</th>
                          <th class="border text-center" style="width:9%">Sales Person</th>
                          <th class="border text-center" style="width:6%">Payment Terms</th>
                          <th class="border text-center" style="width:5%">Due Date</th>
                          <th class="border text-center" style="width:4%">Over Due</th>
			  <th class="border text-center" style="width:5%">0-30</th>
			  <th class="border text-center" style="width:5%">31-60</th>
			  <th class="border text-center" style="width:5%">61-90</th>
			  <th class="border text-center" style="width:5%">>90</th>
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td class="border text-center hidecol_{{ $aname->id }}">@foreach(explode(',', rtrim($doc_number, ',')) as $doc)
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-12">
                        <div class="no-gutters input-right-icon">
                            <div class="col">
                                <div class="input-effect">
                                    <label class="form-label">@lang('Follow-up Date')<span></span></label>
