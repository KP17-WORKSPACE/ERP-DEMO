...
<?php try { ?>
    <div class="container-fluid">
        <div class="d-sm-flex justify-content-between">
            <div class="mb-3">
                <h2 class="page-heading m-0">AMC Table List</h2>
                <span class="page-label">Home - AMC Table List</span>
            </div>
            <div>
                ...
                <a data-id="{{@$value->id}}" class=" btn btn-primary" style="cursor: pointer;" data-toggle="modal" data-target="#ModalDealAdd" title="Click to Fullfill">
                                        Add </a>
                <a type="button" href="{{ url('crm-amc-list-req') }}" class="btn btn-primary"><i class="fa fa-filter mr-1"></i>Requested List</a>
