            ...
            <button type="submit" class="btn btn-light">
             ...
             <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item" data-modal-size="modal-md" data-bs-target="#ModalQuoteList" data-bs-toggle="modal"><i class="ico icon-outline-document-medicine text-success"></i> Quotation</a></li>

                    <li><button type="button" class="dropdown-item" data-modal-size="modal-md" data-bs-target="#ModalNote" data-bs-toggle="modal"><i class="ico icon-outline-calculator-minimalistic text-warning"></i> Internal Note</button></li>
                    <li><button type="button" class="dropdown-item" data-modal-size="modal-md" data-bs-target="#ModalAddress" data-bs-toggle="modal"><i class="ico icon-outline-calculator-minimalistic text-warning"></i> Delivery Location</button></li>
                    ...
                    @if(App\SysHelper::set_track($edit->id)==1)
                            ...
                            @else
                            <li><a type="button" class="dropdown-item" href="{{url('crm-deal-track/'.$edit->id.'/view')}}"><i class="ico icon-outline-calculator-minimalistic text-warning"></i> View Deal Track</a></li>                          
...
<span class="font-weight-bold">Internal Note</span>
        ...
        <div class="modal side-panel fade" id="ModalAddress" data-bs-backdrop="false" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
              	<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title" id="editModalLabel">Delivery Location /Address</h4>
						<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
					</div>
    ...
    <!-- Modal Deal Track-->
 <div class="modal side-panel fade" id="ModalDealTrack" data-bs-backdrop="false" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">                    
                    <h4 class="modal-title" id="exampleModalLabel">Deal Track (Deal ID - {{ $edit->deal_code->code }})</h4>
						<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                ...
                <div class="modal-body">
                            ...
                            <div class="no-gutters input-right-icon">
                                <div class="col">
                                    <div class="input-effect">
                                        ...
                                        <input class="form-control date-picker" id="delivery_date" type="text" autocomplete="off" required name="delivery_date" value="{{ @App\SysHelper::normalizeToDmy($delivery_date)  }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 mb-3">
                            <div class="input-effect ">
                                <label class="form-label">Purchase Required<span></span></label><br />
                                <div class="form-control">
                        ...
                        <div class="col-lg-3 mb-3">
                            <div class="input-effect">
                                <label class="form-label">Partial Delivery<span></span></label><br />
                                <div class="form-control">
                        ...
                        <div class="col-lg-3 mb-3">
                            <div class="input-effect">
                                <label class="form-label">Professional Service<span></span></label><br />
                                <div class="form-control">
                        ...
                        <div class="col-lg-3 mb-3" id="technical_div" style="display: none;">
                            <div class="input-effect">
                                <label class="form-label">Professional Service Note<span></span></label><br />
                    ...
                    <div class="row">
                        <div class="col-lg-3 mb-2">
                            <div class="input-effect ">
                                <label class="form-label">Purchase Approval<span></span></label><br />
                                <div class="form-control">
                        ...
                        <div class="col-lg-3 mb-2">
                            <div class="input-effect ">
                                <label class="form-label">Invoice Approval<span></span></label><br />
                                <div class="form-control">
                        ...
                        <div class="col-lg-3 mb-2">
                            <div class="input-effect ">
                                <label class="form-label">Delivery Approval<span></span></label><br />
                                <div class="form-control">
                        ...
                        <div class="col-lg-3 mb-2">
                            <div class="input-effect ">
                                <label class="form-label">Receivables Approval<span></span></label><br />
                                <div class="form-control">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-light add-btn ms-2" value="save" name="btnSubmit" id="btnSubmit"><span class="ti-check"></span><i class="ico icon-outline-bookmark-opened text-success"></i> Save</button>
                    <button type="submit" class="btn btn-light add-btn ms-2" value="approve" name="btnSubmit" id="btnSubmit"><span class="ti-check"></span><i class="ico icon-outline-bookmark-opened text-success"></i> Submit For Approval</button>
                </div>
                {{ Form::close() }}
                @endif
            </div>
 ...
 <div class="modal side-panel fade" id="ModalDealTrackEdit" data-bs-backdrop="false" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">                    
                    <h4 class="modal-title" id="exampleModalLabel">Edit Deal Track (Deal ID - {{ $edit->deal_code->code }})</h4>
						<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
    ...
    <!-- Modal Quote List-->
        <div class="modal side-panel fade" id="ModalQuoteList" data-bs-backdrop="false" tabindex="-1" aria-labelledby="ModalQuoteList" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel">Quote Revisions</h4>
						<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <?php 
        $editcheck = App\SysHelper::deal_edit_disable($edit->id); ?>
                ...
                <tr>
                    <td>
                    <b>Quote No: {{ $edit->deal_code->code }} - {{ $item->quote_id }} </b></td>
                    <td>
                    <a class="btn btn-light pt-0 pb-0 ml-3" href="{{url('crm-quote/'.$edit->id.'/download/'.$item->quote_id)}}">Download</a></td>
                    
                    @if($editcheck==0)
                    <td>
                        <a class="btn btn-light pt-0 pb-0 ml-3" href="{{ url('crm-deals/' . $edit->id . '/edit/'.$item->quote_id) }}">Edit</a></td>
                        <td>
                        <a class="btn btn-light pt-0 pb-0 ml-3" href="{{url('crm-quote/'.$edit->id.'/createcopy/'.$item->quote_id)}}">Create Copy</a></td>
                    @endif
                    <td>
                    @if ($item->quote_id != $edit->quote_id)                                
                        @if($editcheck==0)    
                            <a class="btn btn-light pt-0 pb-0 ml-3" href="{{url('crm-quote/'.$edit->id.'/setprimary/'.$item->quote_id)}}">Set as Final Quote</a>
                        @endif
                    @else
