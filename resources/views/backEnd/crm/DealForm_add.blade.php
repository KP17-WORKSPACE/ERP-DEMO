...
<input type="hidden" name="net_vat" id="net_vat" value="0">
    ...
    <div class="purchase-order-content-header sticky-top" style="background-color: #f7f8fd">
        <h4 class="purchase-order-content-header-left">
            ...
            New (<span class="font-weight-600" id="new_code">{{ App\SysHelper::get_new_code_lead('sys_crm_deals', 'DL', 'code', session('logged_session_data.company_id')) }}</span>)
        </h4>
                                    ...
                                    <div class="row gap-rows">
                                         ...
                                         <div class="col-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <option value="{{ @$value->id }}" @if(@$ctrl_cust_id == $value->id) selected @endif>{{ trim(@$value->name) }}@if (@App\SysHelper::getCompanyCodeSettings()['is_customer_code'] == 1) ({{ trim(@$value->code) }})@endif</option>
                                                @endforeach
                                            </select>
                                            </div>
                                        </div>
                                         ...
                                         <div class="col-2">
                                            ...
                                            <div class="form-group">
                                    <input class="form-control capitalize-title" type="text" name="deal_name" autocomplete="off" id="deal_name" value="{{ isset($edit) ? (!empty(@$edit->deal_name) ? @$edit->deal_name : old('deal_name')) : old('deal_name') }}" required>
                                            </div>
                                        </div>
         ...
         //$value = @App\SysHelper::normalizeToDmy(@$value);
                            ...
                            <div class="tab-wrap mb-3">
                                ...
                                <div class="tab-content mb-3" id="purchaseDetailsTabsContent">
                                        ...
                                        <div class="row gap-rows">
                                            ...
                                            <div class="col-lg-2 mb-2">
                                                <div class="input-effect">
                                                    ...
                                                    <input class="form-control capitalize-title" type="text" name="cust_name" autocomplete="off" id="cust_name" value="{{ isset($edit) ? (!empty(@$edit->cust_name) ? @$edit->cust_name : old('cust_name')) : old('cust_name') }}" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-2 mb-2">
                                                <div class="input-effect">
                                                    <label class="form-label">Designation</label>
                                                   <input class="form-control capitalize-title" type="text" name="designation" autocomplete="off" id="designation" value="{{ isset($edit) ? (!empty(@$edit->designation) ? @$edit->designation : old('designation')) : old('designation') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2 mb-2">
                                                <div class="input-effect">
                                                  ...
                                                  <input class="form-control" type="text" name="cust_email" autocomplete="off" id="cust_email" value="{{ isset($edit) ? (!empty(@$edit->cust_email) ? @$edit->cust_email : old('cust_email')) : old('cust_email') }}" data-bs-toggle="modal" data-bs-target="#EmailModal">
                                                </div>
                                            </div>
                                            <div class="col-lg-2 mb-2">
                                                <div class="input-effect">
                                                    <label class="form-label">Address<span></span></label>
                                                    <input class="form-control capitalize-title" type="text" name="address" data-bs-toggle="modal" data-bs-target="#AddressModal" autocomplete="off" id="address" value="{{ isset($edit) ? (!empty(@$edit->address) ? @$edit->address : old('address')) : old('address') }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-2 mb-2">
                                                <div class="input-effect">
                                            ...
                                            <div class="col-lg-2">
                                                <div class="input-effect">
                                                    ...
                                                    <div class="form-group">
                                                         <input class="form-control text-end" type="number" step="any" name="deal_value" autocomplete="off" id="deal_value" value="{{ isset($edit) ? (!empty(@$edit->deal_value) ? @App\SysHelper::currancy_format_deal_no($edit->deal_value, $edit->company_id) : old('deal_value')) : old('deal_value') }}">
                                                    </div>
                                    ...
                                    <input class="form-control" data-bs-toggle="modal" value="@if(isset($edit)) {{$edit->note}} @endif" data-bs-target="#NoteModal" name="note" rows="3" autocomplete="off" id="note">
                                                </div>
                                            </div>
                            ...
                            <div class="deal-list-content-header">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="text-end float-end">
                                                <input type="hidden" name="quotation_generated" id="quotation_generated" value="{{ count($cart) > 0 ? 1 : 0 }}">
                                ...
                                {{-- class="collapse multi-collapse" id="generate-quotation" --}}
                                            <div id="generate-quotation" style="height: {{ count($cart) > 0 ? 'auto' : '0px' }}; overflow: hidden; transition: all 0.5s ease;">
                                 ...
                                 <table class="table table-hover form-item-table" id="myTable">
                                    <thead>                                                            
                                        <tr>
                                            ...
                                            <th class="resizable text-center" width="250px">@lang('Part No') <a class="icon icon-outline-book text-dark" data-bs-toggle="modal" data-bs-target="#addproductModal"></a><div class="resizer"></div></th>
                                            <th class="resizable text-center" width="250px">@lang('Description')<div class="resizer"></div></th>
                                            <th class="resizable text-center" width="65px">@lang('Cost')<div class="resizer"></div></th>
                                            <th class="resizable text-center" width="65px">@lang('Tax')<div class="resizer"></div></th>
                                            <th class="resizable text-center" width="40px">@lang('Qty')<div class="resizer"></div></th>
                                    ...
                                    @if (isset($cart) && count($cart) > 0)
                                        ...
                                        @foreach ($cart as $cart_items)
                                         ...
                                         <tr>
                                            ...
                                            <td>                                                                    
                                                <input class="form-control text-end" type="text" name="cost[]" autocomplete="off" value="{{ number_format($cart_items->cost, 2) }}" onchange="calc_change_new(this)" onblur="formatCurrency(this)">
                                            ...
                                            <td><input type="number" class="form-control text-center" name="tax[]" value="{{$cart_items->vat}}" onchange="calc_change_new(this)" ></td>
                                            <td><input class="form-control text-center" type="number" name="qty[]" autocomplete="off" min="0" onchange="calc_change_new(this)" value="{{$cart_items->qty}}"></td>
                                            <td><input class="form-control text-end" type="text" name="unitprice[]" step="any" value="{{number_format($cart_items->price, 2)}}" autocomplete="off" min="0" onchange="calc_change_new(this)" onblur="formatCurrency(this)"></td>
                                            <td><input class="form-control text-end" type="text" name="value[]" autocomplete="off" min="0" readonly></td>
                                            <td><input class="form-control text-end" type="text" step="Any" name="discount[]" value="{{number_format($cart_items->discount, 2)}}" autocomplete="off" min="0" onchange="calc_change_new(this)" onblur="formatCurrency(this)"></td>
