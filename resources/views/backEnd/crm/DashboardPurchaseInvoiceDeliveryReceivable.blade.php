    ...
    <aside class="left-nav col-12" id="leftSidebar">
        ...
        <div class="long-list" id="filters-long">
            <div class="d-flex  justify-content-between ">
                <!-- Left: Heading -->
                <h4 class="mb-0">Accounts, Billing, Logistic Dashboard</h4>
                        ...
                        <table class="table table-nowrap table-centered mb-0 table-striped2 table-hover"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $top->ownername->full_name }}</td>
                                    <td>{{ date('d/m/Y', strtotime($top->date)) }}</td>
                                    <td> <span class="badge bg-warning py-1 px-2">Pending</span></td>
                                </tr>
                                @endforeach
                                @endif
                            </tbody>
                        ...
                        <table class="table table-nowrap table-centered mb-0 table-striped2 table-hover"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> 
                                        @if($top->delivery==3)
                                        <span class="badge bg-success py-1 px-2">Out For Delivery</span>
                                        @endif                    
                                        @if($top->delivery==4)
                                        <span class="badge bg-warning py-1 px-2">Pending For Delivery</span>
                                        @endif
                                    </td>
                                </tr>
                                @endforeach
