...
<div class="purchase-order-content-header">
    ...
    <div class="purchase-order-content-header-right">
        ...
        <button type="button" onclick="add_professional_services_request({{ $support->id }})" class="btn btn-light">
            <i class="ico icon-outline-add-square text-success"></i> Request
        </button>


        <button type="submit" onclick="edit_professional_services_request({{ $support->id }})" class="btn btn-light">
