    ...
    <aside class="left-nav col-12" id="leftSidebar">
        ...
        <div class="left-nav-list">
            ...
            <div class="row mt-3">
                ...
                @if (session('logged_session_data.company_id') == 1 &&
                    ...
                    <div class="col-lg-8 mb-3">
                        <div class="card p-4 max-height">
                            ...
                            <div>
                                <table class="table table-nowrap table-centered mb-0 table-hover" id="long-list" style="table-layout: fixed;width:100%">
                                    <thead>
                                        <tr>
                                            <th>Company</th>
                                            <th>Target GP</th>
                        ...
                        <div class="col-lg-3 mb-4">
                            <div class="card shadow h-100">
                                ...
                                <div class="p-2">
                                    ...
                                    <h2><a href="{{ url('crm-deals-sales-report') }}">{{ $sales_revenue[1] }}</a></h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 mb-4">
                            <div class="card shadow h-100">
                                ...
                                <div class="p-2">
                                    ...
                                    <h2><a href="{{ url('crm-deals-sales-report') }}">{{ $sales_revenue[0] }}</a></h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 mb-4">
                ...
                <div class="mb-4 @if (session('logged_session_data.company_id') == 0) col-lg-7 @else col-lg-7 @endif ">

                    <div class="card shadow h-100">
                        <div class="card-header">
                            <h6 class="card-head ">Sales Perfomance</h6>
                        </div>
                        ...
                        @if (session('logged_session_data.company_id') == 0)
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="text-center">
                                        <div class="d-inline-block d-flex justify-content-center ">
                                            <div class="text-center mb-2 rounded__box d-flex align-items-center justify-content-center"
                                        ...
                                        <div class="d-inline-block d-flex justify-content-center ">
                                            <div class="text-center mb-2 rounded__box d-flex align-items-center justify-content-center"
                                                ...
                                                <a href="#" onclick="sales_click('forcast')">
                                                    <div class="text-xs font-weight-bold text-info text-uppercase">Forcast
                                                    </div>
                                                    <div class="mb-0 font-weight-bold text-gray-800 font-card-large"
                                                        id="forcast">{{ $sales[1] }}</div>
                                                </a>
                                            </div>
                                        </div>
                                        Lost : <span class="mb-0 font-weight-bold text-gray-800 font-card-medium"
                                            id="lost">{{ $sales[2] }}</span><br /><br />
                                    </div>
                                </div>
                                <div class="col-lg-7" style="padding-right: 30px;">
                                    ...
                                    <table class="table table-nowrap table-centered mb-0  sales_tab table-hover" id="long-list" style="table-layout: fixed;width:100%">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($com_list as $list)
                                                ...
                                                <tr>
                                                    <td style="text-align: left;"><i>{{ $list->company_name }}</i></td>
                                                    <td>{{ $data[0] }}</td>
                                                    <td>{{ $data[1] }}</td>
                                                </tr>
                                            @endforeach
                        ...
                        @else
                            <div class="text-left p-2">
                                <table class="table table-nowrap table-centered mb-0 table-striped2 table-hover" id="long-list" style="table-layout: fixed;width:100%">
                                    <thead>
                                        <tr>
                                            <th>Sales Person</th>
                                            <th>Revenue</th>
                                    ...
                                    <tbody>
                                        @if (count($sales_person) > 0)
                                            @foreach ($sales_person as $top)
                                                @if (Auth::user()->id == 36)
                                                    <?php $user_id_arr = [36, 25, 51, 31, 27]; ?>
                                                    @if (in_array($top->user_id, $user_id_arr))
                                                        <?php $rev = @App\Http\Controllers\SysCrmReportController::get_total_sales_revenue([$top->user_id], 'm', session('logged_session_data.company_id')); ?>
                                                        <?php $gp = @App\Http\Controllers\SysCrmReportController::get_total_target_gp([$top->user_id], 'm', session('logged_session_data.company_id')); ?>
                                                        <?php $proc = @App\Http\Controllers\SysCrmReportController::get_total_on_process([$top->user_id], 'm', session('logged_session_data.company_id')); ?>
                                                        <?php $forc = @App\Http\Controllers\SysCrmReportController::get_total_forcast([$top->user_id], 'm', session('logged_session_data.company_id')); ?>
                                                        <tr>
                                                            <td><a>{{ $top['full_name'] }}</a></td>
                                                            <td>{{ $rev[0] }}</td>
                                                            <td>{{ $gp[0] }}</td>
                                                            <td>{{ $proc }}</td>
                                                            <td>{{ $forc }}</td>
                ...
                <div class="mb-4 col-lg-5">
                    ...
                    <div class="card shadow h-100">
                        <div class="card-header">
                            <h6 class="card-head ">On Process Service</h6>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <table class="table table-nowrap table-centered mb-0 table-striped2 table-hover" id="long-list" style="table-layout: fixed;width:100%">
                                    <thead>
                                        <tr>
                                            <th width="25%">Support Engineer</th>
                                            <th width="15%">Date</th>
                                    ...
                                    <tbody>
                                        @if (count($onprocess_service_list) > 0)
                                            @foreach ($onprocess_service_list as $top)
                                                <?php
                                                $engin = $engi->wherein('user_id', $top->engineer)->pluck('full_name');
                                                $cleanedString = str_replace(['[', ']', '"'], '', $engin);
                                                ?>
                                                <tr>
                                                    <td><a>{{ $cleanedString }}</a></td>
                                                    <td>{{ date('d/m/Y', strtotime($top->service_date)) }}</td>
                                                    <td>{{ $top->custname->name }}</td>
                                                    <td>{{ $top->location_of_work }}</td>
                                                </tr>
                                            @endforeach
                                        @endif
                                    </tbody>
                ...
                <div class="col-lg-6 mb-3">
                    <div class="card p-4 max-height">
                        ...
                        <option value="y">This Year</option>
                            ...
                            <h6 class="card-head">Sales Target This Month</h6>
                            <hr>
                        </div>
                            ...
                            @foreach ($sales_target as $top)
                                <div>
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        $total_sales = @App\SysHelper::get_total_revenue_all_by_user([$top->user_id], date('Y-m-01'), date('Y-m-t'), [$top->company_id], []);
                                        
                                        $tp = 0;
                                        if (!empty($top->revenue_target_monthly) && $top->revenue_target_monthly != 0) {
                                            $tp = round((($total_sales[0] ?: 0) / $top->revenue_target_monthly) * 100, 0);
                                        }
                                        $tpcolor = 'bg-danger';
                                        if ($tp < 40) {
                                            $tpcolor = 'bg-danger';
                                        ...
                                        <p class="mb-1 font-semibold">
                                            {{ @App\SysHelper::com_curr_format($total_sales[0], 2, '.', ',') }}AED /
                                            {{ @App\SysHelper::com_curr_format($top->revenue_target_monthly, 2, '.', ',') }}AED
                                        </p>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <select class="form-control form-card-select" id="filter_date_service">
                                            <option value="m" @if ($_SESSION['page_date_id'] == 'm') selected @endif>
                                                Monthly</option>
                                            <option value="pm" @if ($_SESSION['page_date_id'] == 'pm') selected @endif>
                                                Previous Month</option>
                                            <option value="d" @if ($_SESSION['page_date_id'] == 'd') selected @endif>Day
                                            </option>
                                            <option value="q" @if ($_SESSION['page_date_id'] == 'q') selected @endif>
                                                Quarterly</option>
                                            <option value="pq" @if ($_SESSION['page_date_id'] == 'pq') selected @endif>
                                                Previous Quarter</option>
                                            <option value="y" @if ($_SESSION['page_date_id'] == 'y') selected @endif>This
                                                Year</option>
                                        </select>
                                    </div>
                                    <div class="col-md-8">
                                        <select class="form-control form-card-select" id="filter_company_service">
                                            ...
                                            @foreach ($com_list as $list)
                                                <option value="{{ $list->id }}"
                                                    @if (session('logged_session_data.company_id') == $list->id) selected @endif>
                            ...
                            <div class="d-inline-block d-flex justify-content-center ">
                                <div class="text-center mb-2 rounded__box d-flex align-items-center justify-content-center"
                                    ...
                                    <a href="#" onclick="service_click('service_revenue')">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase">Revenue</div>
                                        <div class="mb-0 font-weight-bold text-gray-800 font-card-large"
                                            id="service_revenue">{{ $service[0] }}</div>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="d-inline-block d-flex justify-content-center ">
                                <div class="text-center mb-2 rounded__box d-flex align-items-center justify-content-center"
                                    ...
                                    <a href="#" onclick="service_click('service_forcast')">
                                        <div class="text-xs font-weight-bold text-info text-uppercase">Forcast</div>
                                        <div class="mb-0 font-weight-bold text-gray-800 font-card-large"
                                            id="service_forcast">{{ $service[1] }}</div>
                                    </a>
                                </div>
                            </div>
                            <script>
                                    ...
                                    <div class="mt-4 text-left small">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <a href="#" onclick="deal_click('project')"><i class="fas fa-circle"
                                                    style="color: #4e51df;"></i> Project</a> <a
                                                href="{{ url('crm-deal/project') }}"
                                                id="deal_project">{{ $deals_type_project }}</a>
                                        </div>
                                        <hr class="my-2">
                                        <div class="d-flex justify-content-between">
                                            <a href="#" onclick="deal_click('channel')"><i class="fas fa-circle"
                                                    style="color: #704edf;"></i> Channel</a> <a
                                                href="{{ url('crm-deal/channel') }}"
                                                id="deal_channel">{{ $deals_type_channel }}</a>
                                        </div>
                                        <hr class="my-2">
                                        <div class="d-flex justify-content-between">
                                            <a href="#" onclick="deal_click('corporate')"><i class="fas fa-circle"
                                                    style="color: #4e73df;"></i> Corporate</a> <a
                                                href="{{ url('crm-deal/corporate') }}"
                                                id="deal_corporate">{{ $deals_type_corporate }}</a>
                                        </div>
                                        <script>
                                                    ...
                                                    data: {
                                                        ...
                                                        datasets: [{
                                                            data: [{{ $total_leads_new }}, {{ $total_leads_qualified }},
                                                                {{ $total_leads_unqualified }}, {{ $leads_type_project }},
                                                                {{ $leads_type_channel }}, {{ $leads_type_corporate }}
                                                            ],
                                    ...
                                    <div class="mt-4 text-left small">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <a href="#" onclick="lead_click('project')"><i class="fas fa-circle"
                                                ...
                                                id="lead_project">{{ $leads_type_project }}</a>
                                        </div>
                                        <hr class="my-2">
                                        <div class="d-flex justify-content-between">
                                            <a href="#" onclick="lead_click('channel')"><i class="fas fa-circle"
                                                ...
                                                id="lead_channel">{{ $leads_type_channel }}</a>
                                        </div>
                                        <hr class="my-2">
                                        <div class="d-flex justify-content-between">
                                            <a href="#" onclick="lead_click('corporate')"><i class="fas fa-circle"
                                                ...
                                                id="lead_corporate">{{ $leads_type_corporate }}</a>
                                        </div>
                                        <script>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div
                                                            ...
                                                            <?php try {?>{{ $top->customername->name }}<?php } catch (\Exception $e) { }?>
                                                        </div>
                                                    </td>
                                                    <td>{{ $top->ownername->full_name }}</td>
                                                    <td>{{ date('d/m/Y', strtotime($top->date)) }}</td>
                                                    <td> <span
                                                            class="badge bg-secondary rejected py-1 px-2">{!! App\SysHelper::get_deal_status_log(
                                                                $top->accounts,
                                                                $top->sales,
                                                                $top->purchease,
                                                                $top->invoice,
                                        ...
                                        @if (count($order_in_process) > 0)
                                            @foreach ($order_in_process as $top)
                                                <tr>
                                                    ...
                                                    <td>{{ date('d/m/Y', strtotime($top->date)) }}</td>
                                                    <td> <span
                                                            class="rejected badge bg-secondary py-1 px-2">{!! App\SysHelper::get_deal_status_log(
                                                                $top->accounts,
                                                                $top->sales,
                                                                $top->purchease,
                                                                $top->invoice,
                                        ...
                                        <div class="text-center">
                                            <div class="d-inline-block d-flex justify-content-center ">
                                                <div class="text-center mb-2 rounded__box d-flex align-items-center justify-content-center"
                                                    ...
                                                    <div class="mb-0 font-weight-bold text-gray-800 font-card-large">
                                                        <span id="spanD"
                                                            style="display: none;">{{ $abc[0] }}</span>
                                                        <span id="spanM">{{ $abc[1] }}</span>
                                                        <span id="spanY"
                                                            style="display: none;">{{ $abc[2] }}</span>
                                                        <span id="spanQ"
                                                            style="display: none;">{{ $abc[3] }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="col-md-6 mt-4">
                    <div class="card p-3 shadow">
                        ...
                        <div class="card-body pt-0  max-height">
                            <div class="table-responsive table-bordered">
                                <table class="table table-nowrap table-centered mb-0 table-striped2table-hover" id="long-list" style="table-layout: fixed;width:100%">
                                    <thead>
                                        <tr>
                                            <th>Deal</th>
                                            <th>Company</th>
                ...
                <div class="col-md-6 mt-4">
                    <div class="card p-3 shadow">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ url('crm-deal-track-list/paymentpendingafterreminder') }}"
                                            ...
                                            @foreach ($dealsbyclosedate as $top)
                                                <tr>
                                                    <td><a href="{{ url('crm-deals/' . $top->id . '/view') }}"
                                                            title="View Deal Track"
                                                            class="text-dark">{{ $top->id }}</a></td>
                                                    <td>
                                                        <div
                                                            style="width:150px; text-overflow: ellipsis; white-space: nowrap; overflow: hidden;">
                                                            <?php try {?>{{ $top->deal_name }}<?php } catch (\Exception $e) { }?>
                                                        </div>
                                                    </td>
                                                    <td>{{ $top->ownername->full_name }}</td>
                            ...
                            @if (Auth::user()->role_id == 1)
                                <div class="col-lg-2 col-md-4 col-sm-4">
                                    <div class="p-4 text-center">
                                        <div class="img__wrap">
                                            <img src="{{ asset('public/admin-iroid/') }}/img/bl-allied.png"
                                                width="70">
                                        </div>
                                        <div class="txt__wrap">
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-4">
                                    <div class="p-4 text-center">
                                        <div class="img__wrap">
                                            <img src="{{ asset('public/admin-iroid/') }}/img/bl-avaya.png"
                                                width="70">
                                        </div>
                                        <div class="txt__wrap">
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-4">
                                    <div class="p-4 text-center">
                                        <div class="img__wrap">
                                            <img src="{{ asset('public/admin-iroid/') }}/img/bl-cisco.png"
                                                width="70">
                                        </div>
                                        <div class="txt__wrap">
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-4">
                                    <div class="p-4 text-center">
                                        <div class="img__wrap">
                                            <img src="{{ asset('public/admin-iroid/') }}/img/bl-fortinet.png"
                                                width="70">
                                        </div>
                                        <div class="txt__wrap">
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-4">
                                    <div class="p-4 text-center">
                                        <div class="img__wrap">
                                            <img src="{{ asset('public/admin-iroid/') }}/img/bl-huawei.png"
                                                width="70">
                                        </div>
                                        <div class="txt__wrap">
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-4">
                                    <div class="p-4 text-center">
                                        <div class="img__wrap">
                                            <img src="{{ asset('public/admin-iroid/') }}/img/bl-linksys.png"
                                                width="70">
                                        </div>
                                        <div class="txt__wrap">
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-4">
                                    <div class="p-4 text-center">
                                        <div class="img__wrap">
                                            <img src="{{ asset('public/admin-iroid/') }}/img/bl-netgear.png"
                                                width="70">
                                        </div>
                                        <div class="txt__wrap">
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-4">
                                    <div class="p-4 text-center">
                                        <div class="img__wrap">
                                            <img src="{{ asset('public/admin-iroid/') }}/img/bl-sonicwall.png"
                                                width="70">
                                        </div>
                                        <div class="txt__wrap">
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-4">
                                    <div class="p-4 text-center">
                                        <div class="img__wrap">
                                            <img src="{{ asset('public/admin-iroid/') }}/img/bl-ubiquiti.png"
                                                width="70">
                                        </div>
                                        <div class="txt__wrap">
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-4">
                                    <div class="p-4 text-center">
                                        <div class="img__wrap">
                                            <img src="{{ asset('public/admin-iroid/') }}/img/bl-seceon.png"
                                                width="70">
                                        </div>
                                        <div class="txt__wrap">
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-4">
                                    <div class="p-4 text-center">
                                        <div class="img__wrap">
                                            <img src="{{ asset('public/admin-iroid/') }}/img/bl-apphaz.png"
                                                width="70">
                                        </div>
                                        <div class="txt__wrap">
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-4">
                                    <div class="p-4 text-center">
                                        <div class="img__wrap">
                                            <img src="{{ asset('public/admin-iroid/') }}/img/bl-sisa.png"
                                                width="70">
                                        </div>
                                        <div class="txt__wrap">
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-4">
                                    <div class="p-4 text-center">
                                        <div class="img__wrap">
                                            <img src="{{ asset('public/admin-iroid/') }}/img/bl-securden.png"
                                                width="70">
                                        </div>
                                        <div class="txt__wrap">
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-4">
                                    <div class="p-4 text-center">
                                        <div class="img__wrap">
                                            <img src="{{ asset('public/admin-iroid/') }}/img/bl-xcitium.png"
                                                width="70">
                                        </div>
                                        <div class="txt__wrap">
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-4">
                                    <div class="p-4 text-center">
                                        <div class="img__wrap">
                                            <img src="{{ asset('public/admin-iroid/') }}/img/bl-instasafe.png"
                                                width="70">
                                        </div>
                                        <div class="txt__wrap">
                    ...
                    <div class="card icon__card__home p-4 ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-4">
                                <div class="p-4 text-center">
                                    <div class="img__wrap">
                                        <img src="{{ asset('public/admin-iroid/') }}/img/bl-aruba-in.png"
                                            width="70">
                                    </div>
                                    <div class="txt__wrap">
