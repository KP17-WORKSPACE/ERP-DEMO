...
<?php try { ?>
    ...
    <div class="container-fluid mb-4">
        <div class="d-flex justify-content-between align-items-center">
            <div class="mb-3">
                <h2 class="page-heading m-0">Edit Quote (Deal ID - {{ $edit->deal_code->code }}) / Quote No {{ $quote_id }}</h2>
        ...
        <div class="row">
        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'crm-quote-update', 'method' => 'POST', 'id' => 'crm-quote-update']) }}
                <div class="modal-body">
                    <div class="row">
                        <input type="hidden" name="cust_id" id="cust_id" value="{{ $edit->cust_id }}" />
                        <input type="hidden" id="deal_id" name="deal_id" value="{{ $edit->id }}">
                        <input type="hidden" name="quote_id" id="quote_id" value="{{ $edit->quote_id }}" />
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control js-example-basic-single" name="company_id" id="company_id" required>
                                    ...
                                    @foreach ($companylist as $value)
                                        <option value="{{ @$value->id }}" @if($value->id == $company_id) selected @endif>{{ @$value->company_name }} - {{ @$value->city }}</option>
                                    @endforeach
                                </select>
                                <script>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <a class="btn-sm btn-danger" data-toggle="modal" data-target="#ModalChangeCurrancy">Change Currancy</a>
                            </div>
                        </div>
...
3. In case of non-availability of quote products {{ $edit->companyname->company_name }} reserved the rights to supply a functionally similar or better product.</textarea>
                                @else
                                <textarea class="form-control" rows="3" id="terms_and_condition" autocomplete="off" name="terms_and_condition">{{ $edit->terms_and_condition }}</textarea>
                                @endif
                            </div>
                        </div>
                    </div>
                        ...
                        <thead>
                            ...
                            <tr>
                                <td><input type="checkbox" checked hidden>
                                    <input type="hidden" id="max_sort_id" value="{{ $quotationitems->max('sort_id') }}" />
                                ...
                                <td>                                    
                                    @foreach ($items as $key => $value)
                                            <input type="hidden" id="txt_desc_{{ @$value->id }}" value="{{ @$value->description }}" />
                                    @endforeach
                                    ...
                                    <textarea class="form-control" type="text" id="description_new" style="height: 35px;" name="description[]" autocomplete="off" onclick="fn_description()"></textarea>
                                    <a id="btn_description" data-toggle="modal" data-target="#exampleModal"></a>
                                    <script>
                                        function fn_description(){
                                            $('#description_new_edit').html($('#description_new').val());
                                            $('#btn_description').click();
                                        }
                                        function fn_description_add(){
                                            $('#description_new').val($('#description_new_edit').val());
                                            $('#btn_description_close').click();
                                        }
                                    </script>
                                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <textarea class="form-control w-100" id="description_new_edit" rows="6"></textarea>
                                            </div>
                                            <div class="modal-footer">
                                              <button type="button" id="btn_description_close" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                              <button type="button" class="btn btn-primary" onclick="fn_description_add()">Change</button>
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                               ...
                               <script>
                                        ...
                                        //             console.log("btn_add_row keyup enmter called")
                                        //             $('#btn_add_row').click();
                                        //         }
                                        //     }
                                        // });
                                        ...
                                        // Handle +10% logic on blur (after typing is done)
                                        // $(document).on('blur', '.add_unitprice', function () {
                                        //     const $unitInput = $(this);
                                        //     const $row = $unitInput.closest('tr');
                                        //     const $costInput = $row.find('.add_cost');
                                        ...
                                        //             // Trigger onchange/calc_change_new after calculation
                            ...
                            function ddl_part_change_new() {
                                ...
                                $('#description_new').val($('#txt_desc_'+selOpt).val());
                            ...
                            function calc_change_new(id) {
                                console.log('calc_change_new called')
                            ...
                            function add_rows() {
                                ...
                                var action = "{{ URL::to('crm-quote-add-items') }}";
                                $.ajax({
                                    url: action,
                                    type: "POST",
                                    data: {
                            ...
                            function row_update() {
                                ...
                                if($("#delivery_date").val() == ""){
                                    $("#delivery_date").focus(); return false;
                                }
                                $("#loading_bg").css("display", "block");
                                var action = "{{ URL::to('crm-quote-update-items') }}";
                                $.ajax({
                                    url: action,
                                    type: "POST",
                                    data: {
                    ...
                    <table class="table table-bordered table-striped" id="po-table" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-right"style="width:70px;"><a style="cursor: pointer;" class="text-danger float-right" data-toggle="modal" data-target="#modalDiscount">Discount</a></th>
                                ...
                                <th class="text-right"style="width:75px;"></th>
                            </tr>
                        </thead>
                        <tbody>
                            <script>
                            ...
                            <tr>
                                <td>
                                    <input type="text" class="form-control" name="sort_id[]" value="{{ $dt->sort_id }}">
                                    <input type="hidden" class="form-control" name="item_id[]" value="{{ $dt->id }}">
                                </td>
                                ...
                                <td>
                                    ...
                                    <div id="desc_{{ $dt->id }}" onclick="toggle_tool_tip({{ $dt->id }})" style="width:350px; text-overflow: ellipsis; white-space: nowrap; overflow: hidden;">{!! (($dt->description)) !!}
                                    </div> 
                                ...
                                <td class="text-center">{{ $dt->qty }} <input type="hidden" id="qty_{{ $dt->id }}" value="{{ $dt->qty }}" /></td>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" id="deal_ref_id_{{ $dt->id }}" value="{{ $dt->deal }}" />
                                    <a onclick="row_edit({{ $dt->id }})" class="btn-sm btn-primary"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                    <a href="{{ url('crm-quote/'.$dt->id.'/delete') }}" class="btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                </td>
                                </tr>
                            @endforeach                            
                            @endif
                        ...
                        <tfoot>
                            <tr class="bg-light">
                                ...
                                <td></td>
                                <td class="font-weight-bold text-center"><label id="qty_total">{{ $quotationitems->sum('qty') }}</label></td>
                            ...
                            <tr class="bg-light">
                                ...
                                <td colspan="1" class="text-right">
                                    <input type="number" class="form-control text-right" id="deal_discount" name="deal_discount" step="any" placeholder="Aditional Discount" value="{{ @App\SysHelper::com_curr_format($edit->deal_discount,2,'.','') }}" />
                                </td>
                                <td></td>
                            </tr>
                        </tfoot>
...
$('#shipping_contact_no').focus();
                    ...
                    <tr id="fright_row_1">
                        ...
                        <td>
                            <input class="form-control" type="number" id="cfc_amount_1" name="cfc_amount[]"
                                autocomplete="off" min="0" onchange="cfc_amount_change(1)" value="{{ isset($edit_cfc[0]) ? (!empty(@$edit_cfc[0]->amount) ? @$edit_cfc[0]->amount : old('')) : old('') }}" step="any" >
                        </td>
                        <td>
                    ...
                    <tr style="display: none;" id="fright_row_2">
                        ...
                        <td>
                            <input class="form-control" type="number" id="cfc_amount_2" name="cfc_amount[]"
                                autocomplete="off" min="0" onchange="cfc_amount_change(2)" value="{{ isset($edit_cfc[1]) ? (!empty(@$edit_cfc[1]->amount) ? @$edit_cfc[1]->amount : old('')) : old('') }}" step="any" >
                        </td>
                        <td>
                    ...
                    <td>
                        ...
                        <td>
                            <input class="form-control" type="number" id="cfc_amount_3" name="cfc_amount[]"
                                autocomplete="off" min="0" onchange="cfc_amount_change(3)" value="{{ isset($edit_cfc[2]) ? (!empty(@$edit_cfc[2]->amount) ? @$edit_cfc[2]->amount : old('')) : old('') }}" step="any" >
                        </td>
                        <td>
                    ...
                    <td>
                        ...
                        <td>
                            <input class="form-control" type="number" id="cfc_amount_4" name="cfc_amount[]"
                                autocomplete="off" min="0" onchange="cfc_amount_change(4)" value="{{ isset($edit_cfc[3]) ? (!empty(@$edit_cfc[3]->amount) ? @$edit_cfc[3]->amount : old('')) : old('') }}" step="any" >
                        </td>
                        <td>
                    ...
                    <td>
                        ...
                        <td>
                            <input class="form-control" type="number" id="cfc_amount_5" name="cfc_amount[]"
                                autocomplete="off" min="0" onchange="cfc_amount_change(5)" value="{{ isset($edit_cfc[4]) ? (!empty(@$edit_cfc[4]->amount) ? @$edit_cfc[3]->amount : old('')) : old('') }}"  step="any" >
                        </td>
                        <td>
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-warning" name="submit" value="GQ">Update Quote</button>
        </div>
        {{ Form::close() }}
    ...
    <div class="modal fade" id="modalDiscount" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                ...
                {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'crm-quote-update-discount', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                ...
                <div class="modal-footer">
                    <input type="hidden" name="discount_amount_deal_id" value="{{ @$edit->id }}"/>
                    <input type="hidden" name="discount_amount_quote_id" value="{{ @$edit->quote_id }}"/>
    ...
    <div class="modal fade" id="ModalExcelQuote" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document" style="max-width: 1200px;">
            <div class="modal-content">
                ...
                {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'crm-quote-upload-excel-quote-edit', 'method' => 'POST', 'id' => 'crm-quote-upload-excel-cart']) }}
