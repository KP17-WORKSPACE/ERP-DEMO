                    ...
                    <table class="table table-bordered table-striped" id="table_id" width="100%" cellspacing="0">
                        <thead>
                            ...
                            <tr>
                                                ...
                                                $(document).ready(function(){
                                                 ...
                                                 $('#part_number').keyup(function(){
                                                    ...
                                                    if(query.length >= 3) {
                                                        ...
                                                        $('#part_number_list').fadeOut(); // Optional: hide suggestions if less than 3 chars
                                                    }
                                                });
                                ...
                                <td>                                    
                                    ...
                                    <script>
                                        function fn_description(){
                                            $('#description_new_edit').val($('#description_new').val());
                                ...
                                <td>
                                    <input class="form-control" type="number" id="cost" name="cost[]" step="any" autocomplete="off" min="0">
                                </td>
                                <td>
                                    ...
                                    <select class="form-control" name="net_vat[]" id="net_vat" onchange="calc_change_new()">
                                            <option value="{{ $edit->customername->vat_percentage }}">{{ $edit->customername->vat_percentage }}%</option>
                                ...
                                <td>
                                    <input class="form-control" type="number" id="unitprice" name="unitprice[]" step="any" autocomplete="off" min="0" onchange="calc_change_new()">
                                </td>
                                <td>
