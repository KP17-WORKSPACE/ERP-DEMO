                                        ...
                                        <div class="row gap-rows">
                                            ...
                                            <div class="col-lg-2 mb-2">
                                                <div class="input-effect">
                                                    ...
                                                    <input class="form-control" type="text" name="address" data-bs-toggle="modal" data-bs-target="#AddressModal" autocomplete="off" id="address" value="{{ isset($edit) ? (!empty(@$edit->address) ? @$edit->address : old('address')) : old('address') }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-2 mb-2">
                                                <div class="input-effect">
                                            ...
                                            <div class="form-group">
                                                <select class="form-control js-example-basic-single" name="currency_id" id="currency_id" >
                                                    ...
                                                    @foreach ($currencylist as $value)
                                                        <option value="{{ @$value->id }}" @if($deal_company->currency_id == $value->id) selected @endif>{{ @$value->code }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>                                     
                                 ...
                                 <table class="table table-hover form-item-table" id="myTable">
                                    <thead>                                                            
                                        <tr>
                                            ...
                                            <th class="resizable text-center" width="150px">@lang('Description')<div class="resizer"></div></th>
                                            ...
                                            <th class="resizable text-center" width="65px">@lang('Qty')<div class="resizer"></div></th>
                                    ...
                                    @if (isset($cart) && count($cart) > 0)
                                        ...
                                        @foreach ($cart as $cart_items)
                                         ...
                                         <tr>
                                            ...
                                            <td>                                                                    
                                                <input class="form-control text-end" type="text" name="cost[]" autocomplete="off" value="{{$cart_items->cost}}" onchange="calc_change_new(this)" onblur="formatCurrency(this)">
                                            ...
                                            <td><input class="form-control text-end" type="text" name="unitprice[]" step="any" value="{{$cart_items->price}}" autocomplete="off" min="0" onchange="calc_change_new(this)" onblur="formatCurrency(this)"></td>
                                            <td><input class="form-control text-end" type="text" name="value[]" autocomplete="off" min="0" readonly></td>
                                            <td><input class="form-control text-end" type="text" step="Any" name="discount[]" value="{{$cart_items->discount}}" autocomplete="off" min="0" onchange="calc_change_new(this)" onblur="formatCurrency(this)"></td>
