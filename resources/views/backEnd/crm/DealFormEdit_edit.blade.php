...
<div class="purchase-order-content-header sticky-top" style="background-color: #f7f8fd">
    <h4 class="purchase-order-content-header-left">
        Edit - {{ $edit->code }}    @if($edit->stage == 4) 
...
<div class="card mb-3">
    ...
    font-size: 10px;
                ...
                <div class="col-lg-2">
                    <div class="input-effect">
                        ...
                        <div class="input-group">
                            <span class="input-group-text" id="deal_value_currency">{{ $dealCurrencyCode }}</span>
            ...
            <div class="col-2 ">
                ...
                <div class="input-group">
                    <span class="input-group-text" id="deal_profit_currency">{{ $dealCurrencyCode }}</span>
...
@endphp
                ...
                <div class="col mb-2">
                    <div class="input-effect">
                        ...
                        <input class="form-control capitalize-title" name="note" rows="3" autocomplete="off" id="note" data-bs-toggle="modal" value="@if(isset($edit)) {{$edit->note}} @endif" data-bs-target="#NoteModal">
                                ...
                                <select class="form-control js-example-basic-single" name="delivery_company"
                                    ...
                                    <!-- @if($selectedVendor)
                                        <option value="{{ $selectedVendor->id }}"
                                            {{ !empty($edit->delivery_company) && $edit->delivery_company == $selectedVendor->id ? 'selected' : '' }}>
                                            {{ $selectedVendor->name }}
                                        </option>
                                    @endif -->

                                    @foreach ($supplier_v_c ?? [] as $index => $value)
                                        <option value="{{ $value->id }}"
                                            {{ !empty($edit->delivery_company) && $edit->delivery_company == $value->id ? 'selected' : '' }}>
                                            {{ $value->name }}
                                        </option>
                                    @endforeach
                         ...
                         <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <input class="form-control capitalize-title" type="text" id="delivery_area1" name="delivery_area1"
                                    value="{{ old('delivery_area1', @$edit->delivery_area ?? (@$addressbook->area ?? '')) }}"
                                    >
                            </div>
                        </div>
                           ...
                           <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <input class="form-control capitalize-title" type="text" id="delivery_building" name="delivery_building"
                                    value="{{ old('delivery_building', @$edit->delivery_building ?? (@$addressbook->building ?? '')) }}"
                                    >
                            </div>
                        </div>
                          ...
                          <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <input class="form-control capitalize-title" type="text" id="delivery_flat_office_no" name="delivery_flat_office_no"
                                    value="{{ old('delivery_flat_office_no', @$edit->delivery_flat_office_no ?? (@$addressbook->flat_office_no ?? '')) }}"
                                    >
                            </div>
                        </div>
...
@$quote_no = App\SysCrmQuoteItems::select('quote_id', 'document_number')
    ...
    ->get();
        ...
        {{-- {{ dd($quotationitems->where('product_type', 2)->count()) }} --}}
...
{{-- 
    ...
    @endphp
                                    <p class="font-weight-600" style="background-color: #deebe1;margin-bottom: 3px">Device Serial ({{ $count_serial }})</p>
                            ...
                            <div class="modal-content">
                                ...
                                {{-- <div class="col-5-custom mb-3">
                                 ...
                                 <div class="col-5-custom mb-3">
                                            ...
                                            <div class="input-effect" data-bs-toggle="modal" data-bs-target="#reserve_qty_popup">
                                                ...
                                                <div class="form-control d-flex align-items-center">
                                                    <input class="form-check-input ml-2 me-2 mt-0 no-dim" type="checkbox" @if ($reserve_stock->isNotEmpty()) checked @endif disabled data-bs-toggle="modal" data-bs-target="#reserve_qty_popup" value="1" id="reserve_qty"
                                                        name="reserve_qty">
                                ...
                                <div class="col-5-custom mb-3">
                                 ...
                                 @if (count($quotationitems) > 0)
                                        ...
                                        @if($quotationitems->contains('product_type', 3))
...
{{-- 
                                ...
                                <input type="hidden" id="special_instruction1" value="{{ $special_instruction }}">
                            </div>
                        </div>
...
@endif
  ...
  <div class="col-5-custom mb-3" id="technical_div2" style="display: none;">
                                        ...
                                        <input type="hidden" id="special_instruction" value="{{ $edit_special_instruction }}">
        ...
        <div class="tab-pane fade" id="internal-fields" role="tabpanel" aria-labelledby="internal-fields-tab">
            ...
            <div id="scrollBox"  style="max-height: 12rem; overflow-y: auto;">
                    ...
                    @if ($internalRemarks !== '')
                        ...
                        <div class="card mb-2">
                            <div class="card-body">
                                <div class="fw-semibold" style="font-size:11px">{!! nl2br(e($internalRemarks)) !!}</div>
                            </div>
                        </div>
                    @endif
                    @if ($internalSpecialInstructions !== '')
                        <b>Special Instructions :- </b>
                        <div class="card mb-2">
                            <div class="card-body">
                                <div class="fw-semibold" style="font-size:11px">{!! nl2br(e($internalSpecialInstructions)) !!}</div>
                            </div>
                        </div>
                    @endif
                            ...
                            <div class="modal side-panel fade" id="ViewNotesModal" data-bs-backdrop="false" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                                        ...
                                        <div class="card mb-2">
                                            <div class="card-body">
                                                <div class="fw-semibold" style="font-size:12px">
                                                    <b>Remarks :- </b>{!! nl2br(e($internalRemarks)) !!}
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                                    @if ($internalSpecialInstructions !== '')
                                        <div class="card mb-2">
                                            <div class="card-body">
                                                <div class="fw-semibold" style="font-size:12px">
                                                    <b>Special Instructions :- </b>{!! nl2br(e($internalSpecialInstructions)) !!}
                                                </div>
                                            </div>
                                        </div>
                                    @endif
...
<div class="modal side-panel  fade" id="reserve_qty_popup" data-bs-backdrop="false" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg draggable">
                <div class="modal-content">
                    ...
                    <div class="modal-body p-0">
                            ...
                            {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'reserve-qty-deal', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                                    ...
                                    <div class="">
                                        <table  class="table table-hover" id="long-list" style="table-layout: fixed;width:100%">
                                            <thead>
                                                <tr>
                                                    <th style="width:60px">@lang('Part No')</th>
                                                    <th style="width:70px">@lang('Description')</th>
                                                    <th style="width:20px" class="text-center">@lang('Qty')</th>
                                                    <th style="width:20px" class="text-center">@lang('Bal Qty')</th>
                                                    <th style="width:20px" class="text-center">@lang('Res. Qty')</th>
                                                    <th style="width:20px" class="text-center">@lang('Avl Qty')</th>
                                                    <th style="width:30px" class="text-center">@lang('Reserve')</th>
                                                    <th style="width:30px" class="text-center">@lang('Res. Date')</th>
                                            ...
                                            <tbody>
                                                ...
                                                @if (count($quotationitems) > 0)
                                                    ...
                                                    <td class="text-center no-toggle">{{ @$item->qty }}</td>
                ...
                ->first();
                                        ...
                                        @endphp
                                                    ...
                                                    <td class="text-center no-toggle">{{ @$stocklist->balance_qty ?? 0}}</td>
                                                    <td class="text-center no-toggle" 
                                      data-stock='@json(@$stocklist)'
                                    data-balance="{{ @$stocklist->balance_qty }}"
 ...
 <td class="text-center no-toggle">{{ @$avl_qty }}</td>
                                                ...
                                                @endphp
                                                    ...
                                                    <td class="no-toggle"><input type="number" name="qty[]" class="form-control text-center border-0" placeholder="Max: {{ @$item->qty }}" value="{{ @$r_stock->reserve_qty }}" max="{{ @$item->qty }}" /></td>
                                                    ...
                                                    <td class="no-toggle"><input type="text" data-min-date="{{ date('d/m/Y') }}" name="reserve_date[]" class="form-control text-center border-0 date-picker-no-past" placeholder="" value="{{ $finalDate }}" /></td>
                                                    ...
                                                    {{-- <td class="text-end">{{ number_format(@$item->price, 2) }}</td> --}}
                                                        ...
                                                        $vatAmount = $taxable * ($vatPerc / 100);
                                                        $rowTotal = $taxable + $vatAmount; --}}
                                                 
                                                    {{-- <td class="text-end">{{ number_format(@$item->price * @$item->qty, 2) }}</td> --}}
                                                  </tr>
                                                <input type="hidden" name="reserve_stock_id[]" value="{{ @$item->product_id }}" />
                                                <input type="hidden" name="reserve_part_number[]" value="{{ @$item->productname->part_number }}" />
                        ...
                        <div class="modal-footer d-flex justify-content-center p-0">
                            <input type="hidden" name="req_deal_id" value="{{ @$edit->id }}" />
                                  <input type="hidden" name="reserve_customer_id" value="{{ @$edit->cust_id }}" />
                                    <input type="hidden" name="reserve_sales_person_id" value="{{ @$edit->owner }}" />
                            <button type="submit" class="btn btn-light add-btn ms-2">
...
<script>
 ...
 <script>
    ...
    $(document).ready(function () {
        ...
        var _custAddressMap = {};
        var selectedDeliveryAddressId = @json(old('delivery_address_select', $edit->delivery_address_select ?? ''));
        ...
        function fetchCustomerAddresses(custId) {
            ...
            if (!custId) return;
            $.ajax({
                url: "{{ URL::to('crm-deals-customer-addresses') }}/" + custId,
                type: "GET",
                cache: false,
                success: function(response) {
