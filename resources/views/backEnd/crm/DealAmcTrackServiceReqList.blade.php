...
<?php try { ?>
    <div class="container-fluid">
        <div class="d-sm-flex justify-content-between">
            <div class="mb-3">
                <h2 class="page-heading m-0">Professional Service Requests


</h2>
                <span class="page-label">Home - Professional Service Requests
        ...
        <div class="collapse" id="collapseExample">
            <div class="card shadow mb-4 p-4">
                ...
                {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'crm-amc-track-service-list', 'method' => 'POST', 'id' => 'crm-amc-search']) }}
                <div class="row">
