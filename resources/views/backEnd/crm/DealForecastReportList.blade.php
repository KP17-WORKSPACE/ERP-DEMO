...
<div class="container-fluid">
    <div class="d-sm-flex justify-content-between">
        <div class="mb-3">
            <h2 class="page-heading m-0">Forecast Report by User</h2>
            <span class="page-label">Home - Forecast Report by User</span>
        </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        @php $aed=@App\SysHelper::get_aed_amount_new($value->deal_currency,$value->deal_value);
                                        $deal_profit=@App\SysHelper::get_aed_amount_new($value->deal_currency,$value->deal_profit);@endphp
