...
<div class="container-fluid">
    <div class="d-sm-flex justify-content-between">
        <div class="mb-3">
            <h2 class="page-heading m-0">Sales Report GP</h2>
            <span class="page-label">Home - Sales Report GP</span>
        </div>
    </div>
    <div>
                    <div class="card shadow mb-4 p-4">
                        
                    {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'crm-deals-sales-report-gp', 'method' => 'POST', 'id' => 'crm-deals-sales-report-gp']) }}
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-right">@lang('Target')</th>
                                            <th class="text-right">@lang('Achived')</th>
                                            <th>@lang('Percentage')</th>
                                            <th class="text-right">@lang('Balance')</th>
                                            <th class="text-right">@lang('Revenue')</th>
                                            <th class="text-right">@lang('1 Month')</th>
                                            <th class="text-right">@lang('2 Month')</th>
                                            <th class="text-right">@lang('3 Month')</th>
                                            <th style="width: 80px;" class="text-right">Detail</th>
                                        </tr>
                                    </thead>
                                    ...
                                    <tbody>
                                        ...
                                        if($value["role_id"] == 1 || $value["role_id"] == 2){
                                            if($value["dealcount"] == "0" && $value["forcast"]=="0.00"){ $toshow=1; }
                                        }                                        
                                        ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">{{ @$value["revenue"][1] }} <?php  $total_gp += @$value["revenue"][1];  ?> </td>
                                    ...
                                    <td>
                                        ...
                                        try {
                                            ...
                                            $tp = round($total_sales / $top_target * 100,0);
                                            $tpcolor="bg-danger";
                                    ...
                                    <td class="text-right">
                                        ...
                                        <a href="{{url('crm-deals-sales-report-list/'.$value["user_id"].'/'.$ctrl_company.'/'.$ctrl_date.'/'.$ctrl_date2)}}" target="_blank" class="bg-info text-white p-2">View Detail</a>
                                        @endif
                                    </td>
                                </tr>
                                @endif
