...
{{--  Sales Performance Selecter-----------------------  --}}
        ...
        @if(session('logged_session_data.company_id') == 100 && (Auth::user()->id == 1 || Auth::user()->id == 2 || Auth::user()->id == 3 || Auth::user()->id == 15))
            ...
            <div class="card p-4 max-height">
                ...
                <div>
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        if($top->revenue_target_monthly == 0){
                            $tp=0;
                        } else {
                    ...
                    <div class="table-responsive table-bordered">
                        <table class="table table-nowrap table-centered mb-0 table-striped2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><a href="{{url('crm-deal-track/'.$top->deal_id.'/view')}}" title="View Deal Track" class="text-dark">{{ $top->deal_id }}</a></td>
                                    {{-- <td><div style="width:150px; text-overflow: ellipsis; white-space: nowrap; overflow: hidden;">{{ $top->customername->name }}</div></td> --}}
                                    {{-- <td>{{ $top->ownername->full_name }}</td> --}}
                                    <td></td>
                                    <td></td>
                                    <td>{{ date('d/m/Y', strtotime($top->date)) }}</td>
