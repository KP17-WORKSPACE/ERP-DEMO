...
<div class="container-fluid mb-4">
    <div class="d-sm-flex justify-content-between">
        <div class="mb-3">
            <h2 class="page-heading m-0">Accounts, Billing, Logistic Dashboard</h2>
            <span class="page-label">Home - Accounts, Billing, Logistic Dashboard</span>
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-4">
            <div class="card shadow p-3">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="header-title m-0">Pending for Approval</h4>
        ...
        <div class="col-md-6 mb-4">
            <div class="card shadow p-3">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="header-title m-0">Under Purchase</h4>
                    <a href="{{url('crm-deal-track-list/underpurchase')}}" class=" btn-small">View All</a>
                </div>
                <div class="card-body pt-0  max-height">
                    <div class="table-responsive table-bordered" style="width: 100%; overflow-x: scroll;">
                        <table class="table table-nowrap table-centered mb-0 table-striped2">
                            <thead>
                                <tr>
                                    <th width="50px">Deal</th>
                                    <th width="300px">Company</th>
                                    <th width="180px">Owner</th>
                                    <th width="100px">LPO No</th>
                                    <th width="200px">Supplier Name</th>
                                    <th width="200px">Part No</th>
                                    <th width="130px">Expected&nbsp;Delivery</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><a href="{{url('crm-deal-track-approval/'.$top->id.'')}}" title="View Deal Track" class="text-dark">{{ $top->dealid->code }}</a></td>
                                    <td><?php try {?>{{ $top->customername->name }}<?php } catch (\Exception $e) { }?></td>
                                    <td>{{ $top->ownername->full_name }}</td>
                                    <td>{{ $top->lpo_no }}</td>
        ...
        <div class="col-md-6 mb-4">
            <div class="card shadow p-3">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="header-title m-0">Purchase Completed</h4>
                    <a href="{{url('crm-deal-track-list/purchasecompleted')}}" class=" btn-small">View All</a>
                </div>
                <div class="card-body pt-0  max-height">
                    <div class="table-responsive table-bordered">
                        <table class="table table-nowrap table-centered mb-0 table-striped2">
        ...
        */ ?>
        ...
        <div class="col-md-6 mb-4">
            <div class="card shadow p-3">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="header-title m-0">Do Process</h4>
                ...
                <div class="card-body pt-0  max-height">
                    <div class="table-responsive table-bordered">
                        <table class="table table-nowrap table-centered mb-0 table-striped2">
                            ...
                            <tbody>
                                @if(count($do_onprocess)>0)
                                @foreach ($do_onprocess as $top)
                                <tr>
                                    <td><a href="{{url('crm-deal-track-approval/'.$top->id.'')}}" title="View Deal Track" class="text-dark">{{ $top->dealid->code }}</a></td>
                                    <td><div style="width:150px; text-overflow: ellipsis; white-space: nowrap; overflow: hidden;"><?php try {?>{{ $top->customername->name }}<?php } catch (\Exception $e) { }?></div></td>
                                    <td>{{ $top->ownername->full_name }}</td>
                ...
                <div class="card-body pt-0  max-height">
                    <div class="table-responsive table-bordered">
                        <table class="table table-nowrap table-centered mb-0 table-striped2">
                            ...
                            <tbody>
                                @if(count($receivables_pending)>0)
                                @foreach ($receivables_pending as $top)
                                <tr>
                                    <td><a href="{{url('crm-deal-track-approval/'.$top->id.'')}}" title="View Deal Track" class="text-dark">{{ $top->dealid->code }}</a></td>
                                    <td><div style="width:150px; text-overflow: ellipsis; white-space: nowrap; overflow: hidden;"><?php try {?>{{ $top->customername->name }}<?php } catch (\Exception $e) { }?></div></td>
                                    <td>{{ $top->ownername->full_name }}</td>
