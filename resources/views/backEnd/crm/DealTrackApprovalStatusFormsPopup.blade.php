...
<div class="modal side-panel fade" id="modalAccount" data-bs-backdrop="false" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            {{--  @if(App\SysHelper::account_approval_access() && in_array($deal->accounts,[0,2,3]))  --}}
            ...
            <div class="col-lg-4 mb-1">
                <div class="form-check-label">Customer Status
                    <select class="form-control" name="customer_status" required>
                      ...
                      <option value="1" @if(count($accounts)>0) @if($accounts[0]->customer_status==1) selected @endif @else selected @endif>Approved</option>
                      <option value="2" @if(count($accounts)>0) @if($accounts[0]->customer_status==2) selected @endif @else @endif>Disapproved</option>
                    </select>
                  </div>
            </div>
            <div class="col-lg-4 mb-1">
                <div class="form-check-label">Credit Limit
                    <select class="form-control" name="credit_limit" required>
                      <option value="">-Select-</option>
                      <option value="1" @if(count($accounts)>0) @if($accounts[0]->credit_limit==1) selected @endif @else selected @endif>Approved</option>
                      <option value="2" @if(count($accounts)>0) @if($accounts[0]->credit_limit==2) selected @endif @endif>Disapproved</option>
                    </select>
                  </div>
            </div>
            <div class="col-lg-4 mb-1">
                <div class="form-check-label">Payment Terms
                    <select class="form-control" name="payment_terms" required>
                      <option value="">-Select-</option>
                      <option value="1" @if(count($accounts)>0) @if($accounts[0]->payment_terms==1) selected @endif @else selected @endif>Approved</option>
                      <option value="2" @if(count($accounts)>0) @if($accounts[0]->payment_terms==2) selected @endif @endif>Disapproved</option>
                    </select>
                  </div>
            </div>
            <div class="col-lg-4 mb-1">
                <div class="form-check-label">Overdue Payment
                    <select class="form-control" name="pending_payment" required>
                      <option value="">-Select-</option>
                      <option value="2" @if(count($accounts)>0) @if($accounts[0]->pending_payment==2) selected @endif @endif>Yes</option>
                      <option value="1" @if(count($accounts)>0) @if($accounts[0]->pending_payment==1) selected @endif @else selected @endif>No</option>
                    </select></div>
            </div>
            <div class="col-lg-4 mb-1">
                <div class="form-check-label">Other
                    <select class="form-control" name="other" required>
                      <option value="">-Select-</option>
                      <option value="1" @if(count($accounts)>0) @if($accounts[0]->other==1) selected @endif @else selected @endif>Approved</option>
                      <option value="2" @if(count($accounts)>0) @if($accounts[0]->other==2) selected @endif @endif>Disapproved</option>
                    </select>
                  </div>
            </div>
            <div class="col mb-10">
                <div class="no-gutters input-right-icon">
                    <div class="col">
                        <div class="input-effect">
                            <span class="form-label">@lang('Remarks')<span></span></span>
                            <textarea class="form-control" rows="1" id="remarks"  name="remarks">@if(count($accounts)>0) {{ $accounts[0]->remarks }} @else {{@$deal->paymentterms->title}} @if(@$deal->payment_terms == 22) {{@$deal->payment_terms_txt}} @endif @endif</textarea>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal side-panel fade" id="modalSales" data-bs-backdrop="false" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            {{--  @if(App\SysHelper::sales_approval_access() && $deal->accounts==1 && in_array($deal->sales,[0,2,3]))  --}}
            ...
            <div class="col-lg-4 mb-1">
                <div class="form-check-label">Margin
                    <select class="form-control" name="margin" required>
                      <option value="">-Select-</option>
                      <option value="1" @if(count($sales)>0) @if($sales[0]->margin==1) selected @endif @else selected @endif>Approved</option>
                      <option value="2" @if(count($sales)>0) @if($sales[0]->margin==2) selected @endif @endif>Disapproved</option>
                    </select>
                  </div>
            </div>
            <div class="col-lg-4 mb-1">
                <div class="form-check-label">Stock
                    <select class="form-control" name="stock" required>
                      <option value="">-Select-</option>
                      <option value="1" @if(count($sales)>0) @if($sales[0]->stock==1) selected @endif @else selected @endif>Approved</option>
                      <option value="2" @if(count($sales)>0) @if($sales[0]->stock==2) selected @endif @endif>Disapproved</option>
                    </select>
                  </div>
            </div>
            <div class="col-lg-4 mb-1">
                <div class="form-check-label">Purchase Quote
                    <select class="form-control" name="purcease_quote" required>
                      <option value="">-Select-</option>
                      <option value="1" @if(count($sales)>0) @if($sales[0]->purcease_quote==1) selected @endif @else selected @endif>Approved</option>
                      <option value="2" @if(count($sales)>0) @if($sales[0]->purcease_quote==2) selected @endif @endif>Disapproved</option>
                    </select>
                  </div>
            </div>
            <div class="col-lg-4 mb-1">
                <div class="form-check-label">Other
                    <select class="form-control" name="other" required>
                      <option value="">-Select-</option>
                      <option value="1" @if(count($sales)>0) @if($sales[0]->other==1) selected @endif @else selected @endif>Approved</option>
                      <option value="2" @if(count($sales)>0) @if($sales[0]->other==2) selected @endif @endif>Disapproved</option>
                    </select>
                  </div>
            </div>
            ...
            <div class="col-lg-4 mb-1">
                ...
                <option value="1"
    @if(isset($deal->purchease_approval))
        @if($deal->purchease_approval == 1) selected @endif
    @else
        @if(count($sales) > 0 && $sales[0]->purchase_approval == 1) selected @endif
    @endif
>
    Required
</option>
...
<option value="2"
    @if(isset($deal->purchease_approval))
        @if($deal->purchease_approval == 0) selected @endif
    @else
        @if(count($sales) > 0 && $sales[0]->purchase_approval == 2) selected @endif
    @endif
>
    Not Required
</option>
            ...
            <div class="col-lg-4 mb-1">
                <div class="form-check-label">Invoice Approval
                    <select class="form-control" name="invoice_approval" required>
                      <option value="1" @if(count($sales)>0) @if($sales[0]->invoice_approval == 1) selected @endif @else @if($deal->invoice_approval == 1) selected @endif @endif>Required</option>
                      <option value="2" @if(count($sales)>0) @if($sales[0]->invoice_approval == 2) selected @endif @else @if($deal->invoice_approval == 0) selected @endif @endif>Not Required</option>
                    </select>
                  </div>
            </div>
            <div class="col-lg-4 mb-1">
                <div class="form-check-label">Delivery Approval
                    <select class="form-control" name="delivery_approval" required>
                      <option value="1" @if(count($sales)>0) @if($sales[0]->delivery_approval == 1) selected @endif @else @if($deal->delivery_approval == 1) selected @endif @endif>Required</option>
                      <option value="2" @if(count($sales)>0) @if($sales[0]->delivery_approval == 2) selected @endif @else @if($deal->delivery_approval == 0) selected @endif @endif>Not Required</option>
                    </select>
                  </div>
            </div>
            <div class="col-lg-4 mb-1">
                <div class="form-check-label">Receivables Approval
                    <select class="form-control" name="receivables_approval" required>
                      <option value="1" @if(count($sales)>0) @if($sales[0]->receivables_approval == 1) selected @endif @else @if($deal->receivables_approval == 1) selected @endif @endif>Required</option>
                      <option value="2" @if(count($sales)>0) @if($sales[0]->receivables_approval == 2) selected @endif @else @if($deal->receivables_approval == 0) selected @endif @endif>Not Required</option>
                    </select>
                  </div>
            </div>
            ...
            <div class="col mb-10">
                <div class="no-gutters input-right-icon">
                    <div class="col">
                        <div class="input-effect">
                            <span class="form-label">@lang('Remarks')<span></span></span>
                            <textarea class="form-control" rows="1" id="remarks"  name="remarks">@if(count($sales)>0) {{ $sales[0]->remarks }} @endif</textarea>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal side-panel fade" id="modalPurchase" data-bs-backdrop="false" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            {{--  @if(App\SysHelper::purchase_approval_access() && $deal->accounts==1 && $deal->sales==1 && in_array($deal->purchease,[0,2,3]))  --}}
            ...
            <div class="col-lg-4 mb-1">
                <div class="form-check-label">Purchase Status
                    <select class="form-control" id="validation_re" name="validation" required>
                      ...
                      <option value="1" @if(count($purchease)>0) @if($purchease[0]->validation==1) selected @endif @endif>Purchase Completed</option>
                      <option value="3" @if(count($purchease)>0) @if($purchease[0]->validation==3) selected @endif @endif>Under Purchase</option>
                      <option value="4" @if(count($purchease)>0) @if($purchease[0]->validation==4) selected @endif @endif>Partial Delivery</option>
                      <option value="2" @if(count($purchease)>0) @if($purchease[0]->validation==2) selected @endif @endif>Disapproved</option>
                    </select>
                  </div>
            </div>
            <script>
...
$part_number_names_string = implode(', ', $part_number_names);
    ...
    $formatted_amounts = implode(' / ', $formatted_list);
            ...
            <div class="col-lg-4 mb-1 div_validation_re" style="display: none;">
              LPO No
              <input type="text" class="form-control primary-input" id="lpo_no_re" name="lpo_no" value="@if(count($po_detail)>0) {{ $po_no_doc }} @endif"/>
            ...
            <div class="col-lg-4 mb-1 div_validation_re" style="display: none;">
            Cost of Purchase
              <input type="text" step="any" class="form-control primary-input" id="cost_of_purchase_re" name="cost_of_purchase" value="@if(count($po_detail)>0) {{ $formatted_amounts }} @endif"/>
              ...
              <div class="col-lg-4 mb-1 div_validation_re" style="display: none;">
                  ...
                  <select class="form-control js-example-basic-single" name="cost_of_purchase_currency" id="cost_of_purchase_currency_re" required>
                    ...
                    @foreach ($currencylist as $value)
                        <option value="{{ @$value->id }}" @if(count($purchease)>0) @if($purchease[0]->cost_of_purchase_currency == @$value->id) selected @endif @else @if($po_currency == @$value->id) selected @endif @endif >{{ @$value->code }}</option>
                    @endforeach
                </select>
             ...
             <div class="col-lg-4 mb-1 div_validation_re" style="display: none;">
                          ...
                          <select class="form-control js-example-basic-single" name="ref_supplier_id[]" id="ref_supplier_id" multiple>
                            ...
                            @foreach (@$supplier_reference_list as $value)
                                <option value="{{ $value->id }}"
                                    @if(!empty(@$purchease) && @$purchease[0]->ref_supplier_id == $value->id) selected @endif   @if(in_array(@$value->id, @$vendorIds)) selected @endif>
                    ...
                    <input type="hidden" class="form-control primary-input" id="supplier_name_re" name="supplier_name" value="@if(count(@$purchease)>0) {{ $purchease[0]->supplier_name }} @else {{ $po_account_name }} @endif"/>
            </div>

            <div class="col-lg-4 mb-1" id="div_validation_re2" style="display: none;">
              Delivery Date
              <input type="text" class="form-control date-picker" id="delivery_date_re" name="delivery_date" value="@if(count(@$purchease)>0) {{ App\SysHelper::normalizeToDmy($purchease[0]->delivery_date)  }} @else {{ App\SysHelper::normalizeToDmy($deal->delivery_date) }} @endif"/>
            </div>

            <div class="col-lg-4 mb-1" id="div_validation2_re" style="display: none;">
              Partial Delivery Note
              <input type="text" class="form-control" id="partial_delivery_note" name="partial_delivery_note" value="@if(count($purchease)>0) {{ $purchease[0]->partial_delivery_note }} @endif"/>
            </div>
        
            <div class="col-lg-4 mb-1 div_validation_re" style="display: none;">
              Part No
              <input type="text" class="form-control primary-input" id="part_no_re" name="part_no" value="@if(count($po_detail)>0) {{ $part_number_names_string }} @endif"/>
            ...
            <div class="col-lg-4 mb-1">
                <div class="form-check-label">Purchase Quote
                    <select class="form-control" name="purchease_quote" required>
                      <option value="">-Select-</option>
                      <option value="1" @if(count($purchease)>0) @if($purchease[0]->purchease_quote==1) selected @endif @else selected @endif>Approved</option>
                      <option value="2" @if(count($purchease)>0) @if($purchease[0]->purchease_quote==2) selected @endif @endif>Disapproved</option>
                    </select>
                  </div>
            </div>
            <div class="col-lg-4 mb-1">
                <div class="form-check-label">Quote Request
                    <select class="form-control" name="quote_request" required>
                      <option value="">-Select-</option>
                      <option value="1" @if(count($purchease)>0) @if($purchease[0]->three_quote_request==1) selected @endif @else selected @endif>Approved</option>
                      <option value="3" @if(count($purchease)>0) @if($purchease[0]->three_quote_request==3) selected @endif @endif>Not Required</option>
                      <option value="2" @if(count($purchease)>0) @if($purchease[0]->three_quote_request==2) selected @endif @endif>Disapproved</option>
                    </select>
                  </div>
            </div>
             ...
             {{-- <div class="col-lg-4 mb-1">
                <div class="form-check-label">Other
                    <select class="form-control" name="other" required>
                      <option value="1" @if(count($purchease)>0) @if($purchease[0]->other == 1) selected @endif @endif>Approved</option>
                      <option value="2" @if(count($purchease)>0) @if($purchease[0]->other == 2) selected @endif @endif>Disapproved</option>
                    </select>
                  </div>
            </div> --}}
                <div class="col-lg-4 mb-1">
            ...
            <div class="col mb-10">
                <div class="no-gutters input-right-icon">
                    <div class="col">
                        <div class="input-effect">
                            <span class="form-label">@lang('Remarks')<span></span></span>
                            <textarea class="form-control" rows="1" id="remarks"  name="remarks">@if(count($purchease)>0) {{ $purchease[0]->remarks }} @endif</textarea>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal side-panel fade" id="modalInvoice" data-bs-backdrop="false" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            {{--  @if(App\SysHelper::invoice_approval_access() && $deal->sales==1 && $deal->accounts==1 && $deal->sales==1 && in_array($deal->purchease,[1,4]) && in_array($deal->invoice,[0,2,3]))  --}}
            ...
            <div class="col-lg-4 mb-1">
                <div class="form-check-label">Delivery Advice
                    <select class="form-control" name="delivery_advice" required>
                      <option value="1" @if(count($invoice)>0) @if($invoice[0]->delivery_advice == 1) selected @endif @endif>Approved</option>
                      <option value="2" @if(count($invoice)>0) @if($invoice[0]->delivery_advice == 2) selected @endif @endif>Disapproved</option>
                    </select>
                  </div>
            </div>
            <div class="col-lg-4 mb-1">
                <div class="form-check-label">Validation
                    <select class="form-control" name="validation" required>
                      <option value="1" @if(count($invoice)>0) @if($invoice[0]->validation == 1) selected @endif @endif>Approved</option>
                      <option value="2" @if(count($invoice)>0) @if($invoice[0]->validation == 2) selected @endif @endif>Disapproved</option>
                    </select>
                  </div>
            </div>
            <div class="col-lg-4 mb-1">
                <div class="form-check-label">Hold
                    <select class="form-control" name="hold" required>
                      <option value="1" @if(count($invoice)>0) @if($invoice[0]->hold == 1) selected @endif @endif>Approved</option>
                      <option value="2" @if(count($invoice)>0) @if($invoice[0]->hold == 2) selected @endif @endif>Disapproved</option>
                      <option value="3" @if(count($invoice)>0) @if($invoice[0]->hold == 3) selected @endif @endif>Pending</option>
                    </select>
                  </div>
            </div>
            <div class="col-lg-4 mb-1">
                <div class="form-check-label">Print
                    <select class="form-control" name="print" required>
                      <option value="1" @if(count($invoice)>0) @if($invoice[0]->print == 1) selected @endif @endif>Approved</option>
                      <option value="2" @if(count($invoice)>0) @if($invoice[0]->print == 2) selected @endif @endif>Disapproved</option>
                      <option value="3" @if(count($invoice)>0) @if($invoice[0]->print == 3) selected @endif @endif>Pending</option>
                    </select>
                  </div>
            </div>
            @php
            ...
            <div class="col-lg-4 mb-10">
                <div class="form-check-label">Invoice No
                  ...
                  @endphp
                    <input type="text" class="form-control" id="invoice_no" name="invoice_no" required value="@if(count($list_sales_invoice)>0) {{ @$invoice_si_list }} @endif" />
                  </div>
            </div>
            <div class="col-lg-4 mb-1">
                <div class="form-check-label">Partial Invoice
                    <select class="form-control" name="partial_invoice" id="partial_invoice_re">
                      <option value="0" @if(count($invoice)>0) @if($invoice[0]->partial_invoice == 0) selected @endif @endif>No</option>
                      <option value="1" @if(count($invoice)>0) @if($invoice[0]->partial_invoice == 1) selected @endif @endif>Yes</option>
                    </select>
                  </div>
            </div>
            <div class="col-lg-4 mb-1" id="partial_invoice_amount_div_re" style="display: none;">
                <div class="form-check-label">Partial Invoice Amount
                    <input type="number" step="any" class="form-control" name="partial_invoice_amount" id="partial_invoice_amount_re" value="@if(count($invoice)>0) {{ $invoice[0]->partial_invoice_amount }} @endif"/>
                  </div>
            </div>
            <script>
            ...
            <div class="col mb-10">
                <div class="no-gutters input-right-icon">
                    <div class="col">
                        <div class="input-effect">
                            <span class="form-label">@lang('Remarks')<span></span></span>
                            <textarea class="form-control" rows="1" id="remarks"  name="remarks">@if(count($invoice)>0) {{ $invoice[0]->remarks }} @endif</textarea>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal side-panel fade" id="modalDelivery" data-bs-backdrop="false" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
		  {{--  @if( $deal->purchease == 1 && ((session('logged_session_data.designation_id')==34 || Auth::user()->id== 74) && $deal->delivery !=1 &&  (($deal->delivery==0 || $deal->delivery==3 ) || ( $deal->purchease != 4 && $deal->invoice==1) || ($purchease[0]->validation !=3))))  --}}
{{--  @if( $deal->purchease == 1 && ((App\SysHelper::delivery_approval_access()) && $deal->accounts==1 && $deal->sales==1 && $deal->purchease==1 && $deal->invoice==1 && in_array($deal->delivery,[0,2,3,5])))  --}}
@if(App\SysHelper::delivery_approval_access())
...
<div class="col-lg-4 mb-1">
    <div class="form-check-label">DO No
        <input type="text" class="form-control" value="@if($dn_doc_numbers != ''){{ $dn_doc_numbers }} @endif" name="do_no" required />
      </div>
</div>
<div class="col-lg-4 mb-1">
    <label class="form-check-label">Print Invoice No</label>
    <input type="text" class="form-control" name="print_invoice_no"
           value="{{ @$invoice_si_list ?? '' }}" required />
</div>
...
<div class="col-lg-4 mb-1">
    <div class="form-check-label">Cash Collected
        <input type="number" class="form-control" value="{{ $cash_collected }}" step="any" name="cash_collected" required />
      </div>
</div>
@else
<div class="col-lg-4 mb-1">
...
<div class="col-lg-4 mb-1">
    <div class="form-check-label">Delivery Status
        <select class="form-control" name="delivery_status" required>
          ...
          <option value="1" @if($delivery_status=="1" || $delivery_status=="") selected @endif>Delivery Completed</option>
...
<div class="col-lg-4 mb-1">
  <div class="form-check-label">Delivered Through
      <select class="form-control js-example-basic-single" id="deliver_by_new_re" name="deliver_by" required>
          ...
          <option value="1" @if($deliver_by=="Courier" || $deliver_by==1) selected @endif>Courier</option>
          <option value="7" @if($deliver_by=="Forwarder" || $deliver_by==7) selected @endif>Forwarder</option>
          <option value="2" @if($deliver_by=="Driver" || $deliver_by==2) selected @endif>Driver</option>
          <option value="3" @if($deliver_by=="Local Delivery" || $deliver_by==3) selected @endif>Local Delivery</option>
          <option value="4" @if($deliver_by=="Office Boy" || $deliver_by==4) selected @endif>Office Boy</option>
          <option value="5" @if($deliver_by=="Collection by Client" || $deliver_by==5) selected @endif>Collection by Client</option>
          <option value="6" @if($deliver_by=="By Email" || $deliver_by==6) selected @endif>By Email</option>
      </select>
    </div>
</div>
@php
...
<div class="form-check-label" >Delivered By
    ...
    <select class="form-control js-example-basic-single" id="driver_re" name="driver">
        ...
        @foreach ($drivers as $value)
          <option value="{{ @$value->id }}" @if($driver_txt == $value->id) selected @endif>{{ @$value->first_name }} {{ @$value->last_name }}</option>
        @endforeach
        <option value="Other" @if($driver_is_other) selected @endif>Other</option>
    </select>
    <input type="text" class="form-control" id="other_driver_re" name="other_driver" placeholder="Other Driver" style="display: @if($driver_is_other) block @else none @endif;" value="@if($driver_is_other){{ $driver_txt }}@endif"/>
    <script>
...
<div class="form-check-label">Email IDs
    <input type="text" class="form-control" name="byemail" value="{{ $driver_txt }}" placeholder="Email Ids">
</div>
</div>
...
<div class="form-check-label" >Courier
    ...
    <select class="form-control js-example-basic-single" id="courier_re" name="courier">
        ...
        @foreach ($shipping as $value)
          <option value="{{ @$value->id }}" @if($driver_txt == @$value->id) selected @endif>{{ @$value->name }}</option>
        @endforeach
        <option value="Other" @if($courier_is_other) selected @endif>Other</option>
      </select>
      <input type="text" class="form-control" id="other_courier_re" name="other_courier" placeholder="Other Courier" style="display: @if($courier_is_other) block @else none @endif;" value="@if($courier_is_other){{ $driver_txt }}@endif"/>
      <script>
...
<div class="form-check-label" >Forwarder
    ...
    <select class="form-control js-example-basic-single" id="forwarder_re" name="forwarder">
        <option value="" selected>-Select-</option>
        @foreach ($forwader_suppliers as $value)
          <option value="{{ @$value->id }}" @if($driver_txt == @$value->id) selected @endif>{{ @$value->name }}</option>
        @endforeach
        <option value="Other" @if($forwarder_is_other) selected @endif>Other</option>
      </select>
      <input type="text" class="form-control" id="other_forwarder_re" name="other_forwarder" placeholder="Other Forwarder" style="display: @if($forwarder_is_other) block @else none @endif;" value="@if($forwarder_is_other){{ $driver_txt }}@endif"/>
      <script>
...
<div class="form-check-label" >Local Delivery
    ...
    <select class="form-control" id="localdelivery_re" name="localdelivery">
        ...
        <option value="Ahmed" @if($driver_txt=="Ahmed") selected @endif>Ahmed</option>
        ...
        <option value="Other" @if($localdelivery_is_other) selected @endif>Other</option>
    </select>
    <input type="text" class="form-control" id="other_localdelivery_re" name="other_localdelivery" placeholder="Other Local Delivery" style="display: @if($localdelivery_is_other) block @else none @endif;" value="@if($localdelivery_is_other){{ $driver_txt }}@endif"/>
    <script>
...
<div class="form-check-label" >Office Boy
    ...
    <select class="form-control js-example-basic-single" id="officeboy_re" name="officeboy">
      <option value="" @if($driver_txt=="") selected @endif>-Select-</option>
      @foreach ($office_boys as $value)
        <option value="{{ @$value->id }}" @if($driver_txt == @$value->id) selected @endif>{{ @$value->first_name }} {{ @$value->last_name }}</option>
      @endforeach
      <option value="Other" @if($officeboy_is_other) selected @endif>Other</option>
      
    </select>
    <input type="text" class="form-control" id="other_officeboy_re" name="other_officeboy" placeholder="Other Office Boy" style="display: @if($officeboy_is_other) block @else none @endif;" value="@if($officeboy_is_other){{ $driver_txt }}@endif"/>
    <script>
...
<div class="col-lg-4 mb-1" id="div_attach_file_re" style="display: none;">
  <div class="form-check-label" >AWB No</div>
    ...
    <input type="text" class="form-control" id="awb_no" name="awb_no" placeholder="AWB No" value="{{ $awb_no }}">
...
<div class="col mb-10">
    <div class="no-gutters input-right-icon">
        <div class="col">
            <div class="input-effect">
                <span class="form-label">@lang('Remarks')<span></span></span>
                <textarea class="form-control" rows="1" id="remarks"  name="remarks">{{ $remarks }}</textarea>
            </div>
        </div>
    </div>
</div>
...
<div class="modal side-panel fade" id="modalReceivables" data-bs-backdrop="false" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            {{--  @if(App\SysHelper::receivables_approval_access() && $deal->accounts==1 && $deal->sales==1 && $deal->purchease==1 && $deal->invoice==1 && $deal->delivery==1 && in_array($deal->receivables,[0,2,3]))  --}}
            ...
            <div class="row">
                  ...
                  <div class="form-check-label">Mode
                    ...
                    @endphp
                      <select class="form-control payment_mode" id="payment_mode" name="payment_mode" required>
                        <option value="" selected>-Select-</option>
                        <option value="1" @if($receipt_through == 1) selected @endif>Cash</option>
                        <option value="2" @if($receipt_through == 2 || $receipt_through == 3) selected @endif>Bank</option>
                      </select>
              ...
              <div class="col-lg-4 mb-1">
                  <div class="form-check-label">Collection
                      <select class="form-control payment_collection" name="payment_collection" required>
                        <option value="" selected>-Select-</option>
                        <option value="1" @if(count($receivables)>0) @if($receivables[0]->payment_collection == 1) selected @endif @else selected @endif>Approved</option>
                        <option value="2" @if(count($receivables)>0) @if($receivables[0]->payment_collection == 2) selected @endif @endif>Disapproved</option>
                        <option value="3" @if(count($receivables)>0) @if($receivables[0]->payment_collection == 3) selected @endif @endif>Order Cancelled</option>
                      </select>
                    </div>
              </div>
              <script>
              ...
              <div class="col-lg-4 mb-1 credit_note_div" style="display: none;">
                  <div class="form-check-label">Credit Note
                      <input type="text" class="form-control credit_note" name="credit_note" value="@if(count($receivables)>0) {{ $receivables[0]->credit_note }} @endif" />
                    </div>
              </div>
              <div class="col-lg-4 mb-1 no_cn_div">
                  <div class="form-check-label">Payment Status
                      <select class="form-control no_cn_req" name="payment_status" id="payment_status_re" required>
                        <option value="" selected>-Select-</option>
                        <option value="1" @if(count($receivables)>0) @if($receivables[0]->payment_status == 1) selected @endif @else selected @endif>Payment Received</option>
                        <option value="2" @if(count($receivables)>0) @if($receivables[0]->payment_status == 2) selected @endif @endif>Pending</option>
                      </select>
                    </div>
              </div>
              <script>
              ...
              <div class="col-lg-4 mb-1" id="payment_status_div_re" style="display: none;">
                  <div class="form-check-label text-danger">Reminder Date <?php if(count($receivables)>0) { $reminder_date = date('Y-m-d', strtotime($receivables[0]->reminder_date)); } else {$reminder_date = "";} ?>
                      <input type="date" class="form-control date-picker" name="reminder_date" id="reminder_date_re" placeholder="Select Date" value="{{ @App\SysHelper::normalizeToDmy($reminder_date) }}"/>
                      <select class="form-control" name="reminder_time">
                        <option value="" selected>-Select Time-</option>
                        <option value="09:00:00" @if(count($receivables)>0) @if(date('H:i:s', strtotime($receivables[0]->reminder_date)) == "09:00:00") selected @endif @endif>09:00 AM</option>
                        <option value="10:00:00" @if(count($receivables)>0) @if(date('H:i:s', strtotime($receivables[0]->reminder_date)) == "10:00:00") selected @endif @endif>10:00 AM</option>
                        <option value="11:00:00" @if(count($receivables)>0) @if(date('H:i:s', strtotime($receivables[0]->reminder_date)) == "11:00:00") selected @endif @endif>11:00 AM</option>
                        <option value="12:00:00" @if(count($receivables)>0) @if(date('H:i:s', strtotime($receivables[0]->reminder_date)) == "12:00:00") selected @endif @endif>12:00 PM</option>
                        <option value="13:00:00" @if(count($receivables)>0) @if(date('H:i:s', strtotime($receivables[0]->reminder_date)) == "13:00:00") selected @endif @endif>01:00 PM</option>
                        <option value="14:00:00" @if(count($receivables)>0) @if(date('H:i:s', strtotime($receivables[0]->reminder_date)) == "14:00:00") selected @endif @endif>02:00 PM</option>
                        <option value="15:00:00" @if(count($receivables)>0) @if(date('H:i:s', strtotime($receivables[0]->reminder_date)) == "15:00:00") selected @endif @endif>03:00 PM</option>
                        <option value="16:00:00" @if(count($receivables)>0) @if(date('H:i:s', strtotime($receivables[0]->reminder_date)) == "16:00:00") selected @endif @endif>04:00 PM</option>
                        <option value="17:00:00" @if(count($receivables)>0) @if(date('H:i:s', strtotime($receivables[0]->reminder_date)) == "17:00:00") selected @endif @endif>05:00 PM</option>
                        <option value="18:00:00" @if(count($receivables)>0) @if(date('H:i:s', strtotime($receivables[0]->reminder_date)) == "18:00:00") selected @endif @endif>06:00 PM</option>
                        <option value="19:00:00" @if(count($receivables)>0) @if(date('H:i:s', strtotime($receivables[0]->reminder_date)) == "19:00:00") selected @endif @endif>07:00 PM</option>
                        <option value="20:00:00" @if(count($receivables)>0) @if(date('H:i:s', strtotime($receivables[0]->reminder_date)) == "20:00:00") selected @endif @endif>08:00 PM</option>
                        <option value="21:00:00" @if(count($receivables)>0) @if(date('H:i:s', strtotime($receivables[0]->reminder_date)) == "21:00:00") selected @endif @endif>09:00 PM</option>
                      </select>
                    </div>
              </div>
              @php
              ...
              <div class="col-lg-4 mb-1 no_cn_div">
                <div class="form-check-label">Document No
                    <input type="text" class="form-control doc_number" id="doc_number" name="doc_number" required value="{{ @$receipt_details[0]->doc_number }}"/>
                  </div>
              </div>
              <div class="col-lg-4 mb-1 no_cn_div">
                <div class="form-check-label">Receipt Mode
                    <input type="text" class="form-control receipt_mode" id="receipt_mode_txt" name="receipt_mode_txt" required value="{{ @$receipt_details[0]->receiptmodeacc->account_name }}"/>
                    <input type="hidden" id="receipt_mode" name="receipt_mode" required value="{{ @$receipt_details[0]->receipt_mode }}"/>
                  </div>
              </div>
              <div class="col-lg-4 mb-1 no_cn_div">
                <div class="form-check-label">Receipt Date
                    <input type="text" class="form-control date-picker receipt_date" id="receipt_date" name="receipt_date" required value="{{ @$receipt_details[0]->receipt_date }}"/>
                  </div>
              </div>
              <div class="col-lg-4 mb-1 no_cn_div">
                <div class="form-check-label">Invoice No
                    <input type="text" class="form-control invoice_no" id="invoice_no" name="invoice_no" required value="{{ @$receipt_details[0]->bi_doc_no }}"/>
                  </div>
              </div>
              <div class="col-lg-4 mb-1 no_cn_div">
                <div class="form-check-label">Amount
                    <input type="text" class="form-control no_cn_req" id="amount" name="amount" required value="@if(count($receipt_details)>0) {{ $receipt_details[0]->debit_amount }} @endif"/>
                  </div>
              </div>
              <div class="col-lg-4 mb-1 receipt_through_div" style="display: none;">
                <div class="form-check-label">Receipt Through
                  <select class="form-control receipt_through" name="receipt_through" id="receipt_through">
                            <option value="1" @if(@$receipt_details[0]->receipt_through == 1) selected @endif>Bank Transfer</option>
                            <option value="2" @if(@$receipt_details[0]->receipt_through == 2) selected @endif>CDC Cheque</option>
                            <option value="3" @if(@$receipt_details[0]->receipt_through == 3) selected @endif>PDC Cheque</option>
                    </select>
                    <script>
                      $(document).ready(function () {
              ...
              <div class="col-lg-4 mb-1 pdc_cheque_div" style="display: none;">
                  <div class="form-check-label">Cheque Date
                      <input type="text" class="form-control date-picker" id="cheque_date_re" name="cheque_date" value="@if(count($receipt_details)>0) {{ @App\SysHelper::normalizeToDmy($receipt_details[0]->cheque_date) }} @else {{ @App\SysHelper::normalizeToDmy($cheque_date) }} @endif" />
                    </div>
              </div>
              <div class="col-lg-4 mb-1 pdc_cheque_div" style="display: none;">
                <div class="form-check-label">Cheque No
                    <input type="text" class="form-control" id="cheque_no" name="cheque_no" value="@if(count($receipt_details)>0) {{ $receipt_details[0]->cheque_number }} @else {{ $receipt_cheque_number }} @endif" />
                  </div>
              </div>
              <div class="col-lg-4 mb-1 pdc_cheque_div" style="display: none;">
                <div class="form-check-label">Bank Name
                    <input type="text" class="form-control" id="bank_name" name="bank_name" value="@if(count($receipt_details)>0) {{ $receipt_details[0]->cheque_bank_name }} @endif" />
                  </div>
              </div>
              ...
              <div class="col mb-10">
                  <div class="no-gutters input-right-icon">
                      <div class="col">
                          <div class="input-effect">
                              <span class="form-label">@lang('Remarks')<span></span></span>
                              <textarea class="form-control" rows="1" id="remarks"  name="remarks">@if(count($receivables)>0) {{ $receivables[0]->remarks }} @endif</textarea>
                          </div>
                      </div>
                  </div>
              </div>
...
@if(1)
{{-- @if(($deal->technical==1 && $deal->tech==0) && (App\SysHelper::professional_service_approval_access() && $deal->delivery==1)) --}}
