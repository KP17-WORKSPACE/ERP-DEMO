    ...
    <div class="container-fluid mb-4">
        <div class="d-flex justify-content-between align-items-center">
            <div class="mb-3">
                ...
                <span class="page-label">Home - Deal Details</span>
                            ...
                            $net_vat=App\SysHelper::get_vat($quoteitems[0]->currency_id); $currency_id=0; $t_cost=0; ?>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div id="desc_{{ $Item->id }}" onmouseover="show_tool_tip({{ $Item->id }})" onmouseout="hide_tool_tip({{ $Item->id }})" style="width:350px; text-overflow: ellipsis; white-space: nowrap; overflow: hidden;">{!! $Item->description !!}
                                            </div>
                                        </td>
