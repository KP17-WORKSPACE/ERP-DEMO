<style>
    ...
    .pdfarea {
        ...
        font-size: 12px;
        color: #555555;
        background-image: url('{!! asset("public/".$company->pdf_watermark."") !!}') !important;
    }
...
<div class="purchase-order-content-header sticky-top d-flex align-items-center justify-content-between" style="background-color: #f7f8fd">
    <div class="d-flex align-items-center gap-2">
        <h4 class="purchase-order-content-header-left mb-0">
            {{ $quotation->code }}
        </h4>

        {!! App\SysHelper::deal_pipeline($quotation->id) !!}
    </div>
  ...
  <div class="modal-dialog draggable modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body d-flex justify-content-center align-items-center gap-3">
           <a href="{{ url('crm-quote/' . $quotation->id . '/download/' . $quotation->quote_id) }}" class="btn btn-light text-dark"> <i
                            class="ico icon-bold-download-minimalistic text-success" style="font-size:13px"></i> Business Proposal</a>
        <a href="{{ url('crm-quote-pdf/' . $quotation->id) }}" class="btn btn-light text-dark"><i
            ...
            <div class="row">
                ...
                <div class="col-8 mb-2 pdfarea">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td align="left"><img style="margin-left:-12px" src="{{ asset('public/'.@$company->company_logo) }}" width="200px" />
                            </td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td style="width:14%; border: none;" align="left" valign="bottom">
                        {{ @$quotation->ownername->first_name[0] }} {{ @$quotation->ownername->last_name }}<br /><br /><br /><b class="bottom_b">Prepared
                            By</b></td>
                    <td style="width:55%; border: none;" align="center" valign="bottom">This document
                        is computer generated Signature is not required</td>
                    <td style="width:30%; border: none;" align="right" valign="bottom">
