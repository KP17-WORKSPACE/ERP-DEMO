                        ...
                        <ul id="short-list-items" class="nav flex-column nav-pills" id="companyTabNavs" role="tablist">
                         ...
                         @foreach($deals as $value)
                            <li class="nav-item w-100" role="presentation">
                                <button href="javascript:void(0)" class="nav-link data-item {{ @$edit->id  == $value->id ? 'active' : '' }}" data-id="{{ $value->id }}">
                                        ...
                                        <td class="text-end">{{@App\SysHelper::currancy_format_deal($value->deal_profit,$value->company_id)}} {{ $value->dealcurrency->code }}
                                          ...
                                          <td>
                                            ...
                                            @if(App\SysHelper::set_track($value->id) == 1)
                                                <a class="badge bg-{{ $color }}  py-1 px-2 @if($data == "Fulfill") @else deal-track-sales-person @endif" @if($data == "Fulfill") href="{{ url('crm-deals/'.$value->id.'/edit') }}" @endif onclick="list_style_search()" data-id="{{ $value->id }}"  title="Click to Fullfill">
            ...
            complete: function () {
                ...
                $("#loading_bg").css("display", "none");
                        ...
                        <div class="" role="tabpanel" aria-labelledby="data-tab" id="data-details">
                                ...
                                @include('backEnd.crm.DealFormEdit_edit')
...
$(document).ready(function() {
    function setManualWidths() {
        ...
        var  columnWidths = [80, 100, 150, 150, 120, 100, 120, 120, 70, 75, 80, 75];
