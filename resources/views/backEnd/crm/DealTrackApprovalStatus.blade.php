            ...
            transform: 'translateX(-50%)'
                                ...
                                <div class="d-flex align-items-center justify-content-start flex-grow-1 gap-1 header-height">
                                  ...
                                  <div class="track-stage-actions">
                                        ...
                                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'receivable-outstanding-modal', 'target' => '_blank', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                     ...
                     <td class="{{ $purchease_status }} d-flex align-items-center justify-content-between gap-1" style="height:23px">
                         ...
                         <div class="d-flex align-items-center justify-content-start flex-grow-1 header-height gap-1">
                            ...
                            @if (count($check_po) > 0)
                                ...
                                <a data-bs-toggle="modal" data-bs-target="#purchase_suppliers" class="btn-md light" title="Payment Voucher"><i class="ico icon-outline-airbuds-case-minimalistic title-15 {{ $purchease_status == 'bg-lightgreen text-dark' ? 'text-dark' : 'text-white' }}" style="font-size: 12px" aria-hidden="true"></i> </a>                                
                            @endif
                        ...
                        <div class="track-stage-actions">
                        <button type="button" title="View Purchase" class="@if($deal->purchease != 1 && $deal->purchease != 2) green-track-action-btn @else track-action-btn  @endif  d-inline-flex align-items-center gap-1" data-bs-modal-size="modal-md" data-bs-target="#purchase_auto_generate" data-bs-toggle="modal"> <svg @if($deal->purchease != 1 && $deal->purchease != 2) style="height: 11px;margin-top: -2px;" @else style="height:11px;fill:white"  @endif    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M352 128C352 110.3 337.7 96 320 96C302.3 96 288 110.3 288 128L288 288L128 288C110.3 288 96 302.3 96 320C96 337.7 110.3 352 128 352L288 352L288 512C288 529.7 302.3 544 320 544C337.7 544 352 529.7 352 512L352 352L512 352C529.7 352 544 337.7 544 320C544 302.3 529.7 288 512 288L352 288L352 128z"/></svg> PO</button>
                           ...
                           @if (count($check_po) > 0)
                                ...
                                @if($quoteitems->sum('po_qty') < $quoteitems->sum('qty'))
                                    <button type="button" title="Purchase Order Pending List" class="@if($deal->purchease != 1 && $deal->purchease != 2) green-track-action-btn @else track-action-btn  @endif d-inline-flex align-items-center gap-1" data-bs-modal-size="modal-md" data-bs-target="#po_pending_items_popup_win" id="btnsrlpopup" data-bs-toggle="modal"><svg @if($deal->purchease != 1 && $deal->purchease != 2) style="height: 11px;margin-top: -2px;" @else style="height:11px;fill:white"  @endif  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M352 128C352 110.3 337.7 96 320 96C302.3 96 288 110.3 288 128L288 288L128 288C110.3 288 96 302.3 96 320C96 337.7 110.3 352 128 352L288 352L288 512C288 529.7 302.3 544 320 544C337.7 544 352 529.7 352 512L352 352L512 352C529.7 352 544 337.7 544 320C544 302.3 529.7 288 512 288L352 288L352 128z"/></svg> LPO</button>
                                @endif
                          ...
                          @else
                                    <div>
                                        <button title="Purchase Order Pending List"  type="button" class="@if($deal->purchease != 1 && $deal->purchease != 2) green-track-action-btn @else track-action-btn  @endif d-inline-flex align-items-center gap-1"  onclick="window.location.href='../purchase-order/create/{{ $del->customername->name }}/{{ $del->ownername->full_name }}/{{ $deal->deal_id }}/{{ $deal->deal_code->code }}'"><svg @if($deal->purchease != 1 && $deal->purchease != 2) style="height: 11px;margin-top: -2px;" @else style="height:11px;fill:white"  @endif  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M352 128C352 110.3 337.7 96 320 96C302.3 96 288 110.3 288 128L288 288L128 288C110.3 288 96 302.3 96 320C96 337.7 110.3 352 128 352L288 352L288 512C288 529.7 302.3 544 320 544C337.7 544 352 529.7 352 512L352 352L512 352C529.7 352 544 337.7 544 320C544 302.3 529.7 288 512 288L352 288L352 128z"/></svg> LPO</button>
                                    </div>
                         @endif
...
@endphp
                        ...
                        <tr class=""  data-bs-popover="popover"
                            ...
                            data-bs-delay="500"
                                data-bs-html="true"
                                data-bs-content="{!! $supplierPopover !!}"
                            data-bs-placement="top"><td class="text-start truncate-text-custom"><span class="fw-bold">Supplier Name</span> :             {{ implode(', ', $names) }}</td></tr>
                        @endif
                       ...
                       <tr>
                         <td class=" bg-white d-flex align-items-center gap-2 flex-wrap" style="border-radius: 16px">
                             ...
                             @if ($deal->purchease_approval == 1 && $deal->purchease !=1 && !(count($check_po) > 0))
                            ...
                            @elseif($deal->purchease_approval != 1 && !(count($check_po) > 0))
                                @if (@App\SysHelper::purchase_approval_access())
                                    {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'crm-deal-track-approval-purchase-required', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                                    <input type="hidden" name="purchase_required_deal_id" value="{{ $deal->deal_id }}" />
            ...
            <script>
                    ...
                    $(document).on('click', '.po-item', function() {
                        ...
                        $.ajax({
                            ...
                            complete: function() {
                                ...
                                @foreach ($check_po as $po)<a class="btn-sm btn-success p-0 po-item cursor-pointer text-white" data-id="{{ $po->id }}" style="font-size: 10px;">&nbsp;{{ $po->doc_number }}&nbsp;</a>
                                @endforeach
                 ...
                 $(document).ready(function() {
                    $(document).on('click', '.pay-item', function() {
                        ...
                        var action = "{{ URL::to('payment-details-pdf') }}/" + id;
                        $('#loading_bg').show();
                        ...
                        $.ajax({
                            ...
                            complete: function() {
                                ...
                                @foreach ($list_payment as $pay)<a class="btn-sm btn-success p-0 pay-item cursor-pointer text-white" data-id="{{ $pay->id }}" style="font-size: 10px;">&nbsp;{{ $pay->doc_number }}&nbsp;</a>
                                @endforeach
                                @endif
...
@endif
                        ...
                        @else
                            @if ($deal->invoice_approval == 1)
                                <div style="float: right;">
                                    <a type="button" title="Sales Invoice Pending List" class="@if($deal->invoice != 1 && $deal->invoice != 2) green-track-action-btn @else track-action-btn  @endif d-inline-flex align-items-center gap-1" href="../sales-invoice/create/{{ $del->customername->name }}/{{ $del->ownername->full_name }}/{{ $deal->deal_id }}/{{ $deal->deal_code->code }}"><svg @if($deal->invoice != 1 && $deal->invoice != 2) style="height: 11px;margin-top: -2px;" @else style="height:11px;fill:white"  @endif  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M352 128C352 110.3 337.7 96 320 96C302.3 96 288 110.3 288 128L288 288L128 288C110.3 288 96 302.3 96 320C96 337.7 110.3 352 128 352L288 352L288 512C288 529.7 302.3 544 320 544C337.7 544 352 529.7 352 512L352 352L512 352C529.7 352 544 337.7 544 320C544 302.3 529.7 288 512 288L352 288L352 128z"/></svg> SI</a>
                                </div>
                            @endif
                        @endif
                        </div>
                    ...
                    <td class="bg-white d-flex align-items-center gap-1 flex-wrap" style="border-radius: 16px">
                        ...
                        @if (count($check_si) > 0)
                            ...
                            @foreach($list_sales_invoice as $list)
                                <a class="btn-sm btn-success text-white si-data-item p-0 cursor-pointer" data-id="{{$list->id}}" style="font-size: 10px;padding-right:3px !important;padding-left:3px !important" >{{ $list->doc_number }}</a>
                            @endforeach
                            @endif
            ...
            <div class="col p-1">
                <div class="card mb-3" style="border-radius: 16px">
                    ...
                    @endphp
                        ...
                        <div class="track-stage-actions">
                        <button title="View Delivery Note" class="@if($deal->delivery != 1 && $deal->delivery != 2) green-track-action-btn @else track-action-btn  @endif d-inline-flex align-items-center gap-1" type="button"  onclick="window.location.href='{{ url('delivery-note-add-deal/'.$deal->deal_id) }}'" > <svg @if($deal->delivery != 1 && $deal->delivery != 2) style="height: 11px;margin-top: -2px;" @else style="height:11px;fill:white"  @endif  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M352 128C352 110.3 337.7 96 320 96C302.3 96 288 110.3 288 128L288 288L128 288C110.3 288 96 302.3 96 320C96 337.7 110.3 352 128 352L288 352L288 512C288 529.7 302.3 544 320 544C337.7 544 352 529.7 352 512L352 352L512 352C529.7 352 544 337.7 544 320C544 302.3 529.7 288 512 288L352 288L352 128z"/></svg> DO</button>
 @if (($quoteitems->sum('dn_qty') < $quoteitems->sum('qty')) || ($po_check == 1 ))
                           {{-- @if($quoteitems->sum('dn_qty')==0)     --}}
                     <button title="Delivery Note Pending List" type="button" class="@if($deal->delivery != 1 && $deal->delivery != 2) green-track-action-btn @else track-action-btn  @endif d-inline-flex align-items-center gap-1" data-bs-modal-size="modal-md" data-bs-target="#dln_pending_items_popup_win" id="btnsrlpopup" data-bs-toggle="modal"><svg @if($deal->delivery != 1 && $deal->delivery != 2) style="height: 11px;margin-top: -2px;" @else style="height:11px;fill:white"  @endif  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M352 128C352 110.3 337.7 96 320 96C302.3 96 288 110.3 288 128L288 288L128 288C110.3 288 96 302.3 96 320C96 337.7 110.3 352 128 352L288 352L288 512C288 529.7 302.3 544 320 544C337.7 544 352 529.7 352 512L352 352L512 352C529.7 352 544 337.7 544 320C544 302.3 529.7 288 512 288L352 288L352 128z"/></svg> DLN </button>
                ...
                $(document).ready(function() {
                    $(document).on('click', '.dln-item', function() {
                        ...
                        $.ajax({
                            ...
                            @foreach ($delivery_note as $dn)<a class="btn-sm btn-success p-0 text-white dln-item cursor-pointer" data-id="{{$dn->id}}" style="font-size: 10px;">&nbsp;{{ $dn->doc_number }}&nbsp;</a>
                            @endforeach
                        </div>
                        </td>
 ...
 @endif
            ...
            @if (@$del->customername->grn_select == "yes")
    ...
    <table class="detail-item-table-sm" width="100%" style="table-layout: fixed; width:100%">
        ...
        <tr style="background:#deebe1 !important" class="text-start">
            <td class="mb-2">
                <div class="d-flex align-items-center justify-content-start flex-grow-1 header-height gap-1">
                    ...
                    @if(!$grn_status || $grn_status->grn_status != 1)
        ...
        <tr>
            <td class="text-start truncate-text-custom">
                ...
                @elseif($grn_status && $grn_status->grn_status == 2)
        ...
        <tr>
            <td class="text-start truncate-text-custom">
                ...
                @if($grn_status && $grn_status->remarks != '')
                    {!! $grn_status->remarks !!}
                @else
                    -
                @endif
         ...
         <tr>
            <td class="text-start truncate-text-custom">
                ...
                @if($grn_status)
                    {{ optional($grn_status->creator)->full_name ?: 'N/A' }}           {{ date('d/m/Y h:i A', strtotime($grn_status->created_at)) }}
                @else
                    -
                @endif
            </td>
         ...
         <tr>
            <td class="text-start truncate-text-custom">
                ...
                @if($grn_status)
                    {{ optional($grn_status->updater)->full_name ?: 'N/A' }}      {{ date('d/m/Y h:i A', strtotime($grn_status->updated_at)) }}
                @else
                    -
                @endif
            </td>
                    ...
                    <tr>
                        ...
                        <div class="track-stage-actions">
                            @if ($deal->receivables_approval == 1)
                                <div><button type="button" title="Journal Voucher" onclick="window.location.href='{{ url('journalvoucher-add-deal/'.$deal->deal_id.'/'.$del->cust_id) }}'" target="_blank" class="@if($deal->receivables != 1 && $deal->receivables != 2) green-track-action-btn @else track-action-btn  @endif d-inline-flex align-items-center gap-1"> <svg @if($deal->receivables != 1 && $deal->receivables != 2) style="height: 11px;margin-top: -2px;" @else style="height:11px;fill:white"  @endif  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M352 128C352 110.3 337.7 96 320 96C302.3 96 288 110.3 288 128L288 288L128 288C110.3 288 96 302.3 96 320C96 337.7 110.3 352 128 352L288 352L288 512C288 529.7 302.3 544 320 544C337.7 544 352 529.7 352 512L352 352L512 352C529.7 352 544 337.7 544 320C544 302.3 529.7 288 512 288L352 288L352 128z"/></svg> JV</button></div>
                            @endif

                            @if ($deal->receivables_approval == 1)

                                @if(count($check_receipt) == 0)
                                    <div><button type="button" title="Receipts" onclick="window.location.href='{{ url('receipt-add-deal/'.$deal->deal_id.'/'.$deal->payment_mode) }}'" target="_blank" class="@if($deal->receivables != 1 && $deal->receivables != 2) green-track-action-btn @else track-action-btn  @endif border-0 d-inline-flex align-items-center gap-1"><svg  @if($deal->receivables != 1 && $deal->receivables != 2) style="height: 11px;margin-top: -2px;" @else style="height:11px;fill:white"  @endif  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M352 128C352 110.3 337.7 96 320 96C302.3 96 288 110.3 288 128L288 288L128 288C110.3 288 96 302.3 96 320C96 337.7 110.3 352 128 352L288 352L288 512C288 529.7 302.3 544 320 544C337.7 544 352 529.7 352 512L352 352L512 352C529.7 352 544 337.7 544 320C544 302.3 529.7 288 512 288L352 288L352 128z"/></svg> REC</button></div>
                                @endif
                            @endif
                                     ...
                                     @if ($deal->receivables_approval == 1)
                                            ...
                                            @if(count($check_jv) > 0)
                                                    ...
                                                    @foreach ($check_jv as $cr)
                                                        <a class="btn-sm btn-success p-0 jv-data-item cursor-pointer text-white" data-id="{{ $cr->id }}" style="font-size: 10px;" >&nbsp;{{ $cr->doc_number }}&nbsp;</a>
                                                    @endforeach
                                            ...
                                            @if(count($check_receipt))
                                                ...
                                                @foreach ($check_receipt as $cr)
                                                    <a class="btn-sm btn-success p-0 rec-data-item cursor-pointer text-white" data-id="{{ $cr->id }}" style="font-size: 10px;">&nbsp;{{ $cr->doc_number }}&nbsp;</a>
                                                @endforeach
                                        ...
                                        <table  class="table table-hover" id="long-list" style="table-layout: fixed;width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="no-toggle"><input type="number" name="qty[]" class="form-control text-center border-0 po-qty" value="{{ abs($Item->qty-$Item->po_qty) }}" /></td>
                                                    <td class="text-end pe-0 no-toggle"><input name="unitprice[]" type="text" class="form-control text-end border-0 po-unitprice" value="{{ @App\SysHelper::com_curr_format($up,2,'.','') }}" /></td>
                                                    ...
                                                    <td class="text-end pe-0 no-toggle"><input name="value[]" type="text" readonly class="form-control text-end border-0 po-value" value="{{ @App\SysHelper::com_curr_format((($up * $Item->qty)),2,'.',',') }}"/></td>
                                                </tr>
                                        ...
                                        <table id="long-list" class="table table-hover" style="table-layout: fixed;width:100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-end" style="width:60px">@lang('Taxable')</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @if(count($quoteitems)>0)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ $Item->qty }}</td>
                                                    <td class="text-center">0</td>
                                                    <td class="no-toggle text-center"><input type="number" name="qty[]" class="form-control text-center border-0 si-qty" value="{{ abs($Item->qty-$Item->si_qty) }}" /></td>
                                                    <td class="text-end no-toggle pe-0"><input name="unitprice[]" type="text" step="any" class="form-control text-end border-0 si-unitprice" value="{{ @App\SysHelper::com_curr_format($up,2,'.','') }}" /></td>
                                                    
                                                    <td class="text-end no-toggle pe-0"><input name="value[]" type="text" readonly class="form-control text-end border-0 si-taxableamt" value="{{ @App\SysHelper::com_curr_format((($up * $Item->qty)),2,'.','') }}"/></td>
                                               <td class="text-end no-toggle pe-0"><input name="discount[]" type="text" step="any" class="form-control text-end border-0 si-discount" value="{{ @App\SysHelper::com_curr_format($Item->discount,2,'.','') }}"/></td>
                                                    <td class="text-end no-toggle pe-0"><input name="taxableamt[]" type="text" readonly class="form-control text-end border-0 si-value" value="{{ @App\SysHelper::com_curr_format((($up * $Item->qty) - ($Item->discount)),2,'.','') }}"/></td>
                                ...
                                <tr>
                                    <td class="no-toggle">
                                        <input class="si_charge_check form-check-input" type="checkbox"
                                            ...
                                            value="{{ $charges->selling_exp_account }}"
                                            id="si_charge_{{ $charges->id }}"
                            ...
                            <tr>
                                <td class="no-toggle">
                                    <input class="jv_det_check form-check-input" type="checkbox"
                                        name="jv_det_id[]"
                                        value="{{ $jv_det->id }}"
                                        id="jv_det_{{ $jv_det->id }}"
                                        data-jv-id="{{ $jv_det->id }}"
                                        checked />
                                    <input type="hidden" class="jv-det-amount"
                                        name="jv_det_amount[]"
                                        value="{{ $jv_det->debit_amount }}"
                                        data-jv-id="{{ $jv_det->id }}" />
                                    <input type="hidden" class="jv-det-credit-account"
                                        name="jv_det_credit_account[]"
                                        value="{{ $list_journalvoucher_det_other->where('transaction_no',$jv_det->transaction_no)->where('credit_amount',$jv_det->debit_amount)->max('account_id') }}"
                                        data-jv-id="{{ $jv_det->id }}" />
                                    <input type="hidden" class="jv-det-remarks"
                                        name="jv_det_remarks[]"
                                        value="{{ $jv_det->remarks }}"
                                        data-jv-id="{{ $jv_det->id }}" />
                                </td>
                            ...
                            <div class="row">
                                        ...
                                        <table id="long-list" class="table table-hover" style="table-layout: fixed;width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ $Item->qty }}</td>
                                                    <td class="text-center">0</td>
                                                    <td class="text-center"><input type="number" name="qty[]" class="form-control text-center border-0 dln-qty delivery-qty" value="{{ abs($Item->qty-$Item->dn_qty) }}" /></td>
                                                    <td class="text-end pe-0"><input name="unitprice[]" type="text" step="any" class="form-control text-end border-0 dln-unitprice delivery-unitprice" value="{{ @App\SysHelper::com_curr_format($up,2,'.','') }}" /></td>
                                                    <td class="text-end pe-0"><input name="value[]" type="text" readonly class="form-control text-end border-0 dln-value delivery-taxable" value="{{ @App\SysHelper::com_curr_format((($up * $Item->qty)),2,'.','') }}"/></td>
                                                  
                                                    <td class="text-end pe-0"><input name="discount[]" type="text" step="any" class="form-control text-end border-0 dln-discount delivery-discount" value="{{ @App\SysHelper::com_curr_format($Item->discount,2,'.','') }}"/></td>
                                                    <td class="text-end pe-0"><input name="taxableamt[]" type="text" readonly class="form-control text-end border-0 dln-value delivery-value" value="{{ @App\SysHelper::com_curr_format((($up * $Item->qty) - ($Item->discount)),2,'.','') }}"/></td>
                                                 <input type="hidden" name="product_id[]" value="{{ $Item->product_id }}" />
                               ...
                               <tr><td colspan="8">&nbsp;</td></tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ $Item->qty }}</td>
                                                    <td class="text-center">0</td>
                                                    <td><input type="number" name="qty[]" class="form-control border-0 dln-qty text-center  delivery-qty" value="{{ abs($Item->qty-$Item->dn_qty) }}" /></td>
...
<div class="modal side-panel fade" id="purchase_suppliers" data-bs-backdrop="false" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg draggable" style="width:50rem">
                <div class="modal-content">
                    ...
                    <div class="modal-body p-0">
                        <div class="container-fluid">
                            {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'store-payments-from-purchase-order', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                            <div class="row">
                                <div class="col-lg-12 p-0">
                                    <div class="">
...
@foreach ($po_list as $vendor_id => $vendor_pos)
...
<thead class="table-light">
    <tr class="fw-bold">
        ...
        <th>
            {{ optional($vendor_pos->first()->suppliername)->account_name }}
        </th>
...
<tbody>
@foreach ($vendor_pos as $pos)
    <tr class="po-row" data-vendor="{{ $vendor_id }}">
        ...
        <td class="text-start">{{ $pos->doc_number }}</td>

        <td class="text-end">
            {{ App\SysHelper::com_curr_format($pos->amount, 2, '.', ',') }}
        </td>
        ...
        <td class="text-end">
          <input
    data-name="payment_value[{{ $pos->id }}]"
    data-amount="{{ number_format($pos->amount, 2, '.', '') }}"
    name="payment_value[{{ $pos->id }}]"
    type="text"
    class="form-control text-end border-1 payment_value"
    value="{{ number_format($pos->amount, 2, '.', '') }}"
/>
        </td>
...
<tr class="fw-bold table-light">
    ...
    <td class="text-end fw-semibold">
        {{ App\SysHelper::com_curr_format($totalAmount, 2, '.', ',') }}
    </td>


    <td class="text-end fw-semibold">
        <!-- {{ App\SysHelper::com_curr_format($totalPayment, 2, '.', ',') }} -->
    </td>
</tr>
<tr class="fw-bold table-light">
    <td></td>
    ...
    <td class="text-end fw-semibold">
        {{ App\SysHelper::com_curr_format($sum, 2, '.', ',') }}
    </td>
...
<tr class="fw-bold table-light">
    ...
    <td class="text-end fw-semibold">
        ...
        @endphp
        {{ App\SysHelper::com_curr_format($executed, 2, '.', ',') }}
    </td>
...
<div class="modal side-panel fade" id="modalGRNSubmitted" data-bs-backdrop="false" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'crm-deal-track-approval-grn','method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'crm-deal-track-approval-grn']) }}
            ...
            <div class="col-12 mb-2">
                ...
                <div class="input-effect">
                    <select class="form-control js-example-basic-single" name="grn_submitted" required>
                      <option value="1" {{ isset($grn_status) && $grn_status->grn_status == 1 ? 'selected' : '' }}>Approved</option>
                      <option value="2" {{ isset($grn_status) && $grn_status->grn_status == 2 ? 'selected' : '' }}>Disapproved</option>
                    </select>
                  </div>
            </div>
                ...
                <div class="no-gutters input-right-icon">
                    <div class="col">
                        <div class="input-effect">
                            ...
                            <textarea class="form-control" rows="2" id="remarks"  name="remarks">{{ isset($grn_status) ? $grn_status->remarks : '' }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-footer m-0 p-0">
          ...
          <input type="hidden" id="grn_deal_track_id" name="grn_deal_track_id" value="{{ $deal->id }}" />
          <input type="hidden" id="grn_deal_id" name="grn_deal_id" value="{{ $deal->deal_id }}" />
