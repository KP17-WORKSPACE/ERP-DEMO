            ...
            <div class="col p-1" >
                <div class="card mb-3" style="border-radius: 16px" >
                    ...
                    @endphp
                        <tr>
                            ...
                            <div class="modal side-panel fade" id="ledgerModal" data-bs-backdrop="false" tabindex="-1" aria-labelledby="ledgerModal" aria-hidden="true">
                                <div class="modal-dialog modal-lg modal-dialog-scrollable" style="max-width:1100px;width:1100px;left:45rem">
                            ...
                            <div class="modal side-panel fade" id="osModal" data-bs-backdrop="false" tabindex="-1" aria-labelledby="osModal" aria-hidden="true">
                                ...
                                <div class="d-flex align-items-center justify-content-center flex-grow-1 gap-1">
                                    ...
                                    @if (App\SysHelper::get_company_status($del->customername) != 0 || 1)
                                        @if(App\SysHelper::account_approval_access() && in_array($deal->accounts,[0,2,3,1]) && ($deal->sales ==0))
                                            <a class="btn-md light" style="display: contents;" data-bs-toggle="modal" data-bs-target="#modalAccount">
                                                <i class="ico icon-outline-pen-new-square title-15 {{ $account_status == 'bg-lightgreen text-dark' ? 'text-dark' : 'text-white' }}" style="font-size: 12px"></i>
                                            </a>
                                        @endif
                                    @endif
                                </div>
                                  <div class="track-stage-actions">
                                        ...
                                        <button class="track-action-btn  openLedgerModal">Ledger</button>
                                        {{ Form::close() }}
                                        ...
                                        <button class="track-action-btn openOSModal" style="font-size:11px"> OS</button>                    
                                        {{ Form::close() }}
                                  </div>
                    ...
                    @if(($deal->accounts==0 || $deal->accounts==3) && (Auth::user()->role_id == 27 || Auth::user()->role_id == 28 || Auth::user()->role_id == 1))
                            <a class="text-danger float-left m-2" onclick="acc_updiv()">Set Pending</a>
                ...
                <div class="card mb-3" style="border-radius: 16px">
                    ...
                    @endphp
                     <tr>
                        ...
                        <a class="btn-md btn-light" style="display: contents;" data-bs-toggle="modal" data-bs-target="#modalSales"><i class="ico icon-outline-pen-new-square title-15 {{ $sales_status == 'bg-lightgreen text-dark' ? 'text-dark' : 'text-white' }}" style="font-size: 12px"></i></a>
                        @endif
                        </td>                
                    </tr>
                ...
                <table class="detail-item-table-sm" width="100%" style="table-layout: fixed;width:100%">
                    ...
                    <tr>
                     ...
                     <td class="{{ $purchease_status }} d-flex align-items-center justify-content-between gap-1">
                        ...
                        <button type="button" class=" btn-light border-0 d-inline-flex align-items-center gap-1" data-bs-modal-size="modal-md" data-bs-target="#purchase_auto_generate" data-bs-toggle="modal"> <svg style="height:14px"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M352 128C352 110.3 337.7 96 320 96C302.3 96 288 110.3 288 128L288 288L128 288C110.3 288 96 302.3 96 320C96 337.7 110.3 352 128 352L288 352L288 512C288 529.7 302.3 544 320 544C337.7 544 352 529.7 352 512L352 352L512 352C529.7 352 544 337.7 544 320C544 302.3 529.7 288 512 288L352 288L352 128z"/></svg> PO</button>
                        ...
                        @if(App\SysHelper::purchase_approval_access() && $deal->accounts==1 && $deal->sales==1 && in_array($deal->purchease,[0,2,3,1]) && (count($invoice)==0 && ($deal->invoice==0 || $deal->invoice==3 || $deal->invoice==1) ) && (($deal->invoice==0 || in_array($deal->invoice_approval,['0',''])) || ($deal->delivery==0 || in_array($deal->delivery_approval,['0',''])) || ($deal->receivables==0 || in_array($deal->receivables_approval,['0','']))))
                            ...
                            @if ($deal->purchease_approval == 1)
                                <a data-bs-toggle="modal" data-bs-target="#modalPurchase" class="btn-md light"><i class="ico icon-outline-pen-new-square title-15 {{ $purchease_status == 'bg-lightgreen text-dark' ? 'text-dark' : 'text-white' }}" style="font-size: 12px" aria-hidden="true"></i></a>                                
                            @endif
                            
                        @elseif(App\SysHelper::purchase_approval_access() && ($deal->purchease == 3 || $deal->purchease == 4))
                    
                        <a class="btn-md light" data-bs-toggle="modal" data-bs-target="#modalPurchase"><i style="font-size:16px" class="ico icon-outline-pen-new-square  {{ $purchease_status == 'bg-lightgreen text-dark' ? 'text-dark' : 'text-white' }}" style="font-size: 12px" aria-hidden="true"></i></a>
                        @endif
                         </div>
                          ...
                          @if (count($check_po) > 0)
                                ...
                                @if($po_item_count < $quoteitems->sum('qty'))
                                    <button type="button" class="btn-light text-truncate border-0 d-inline-flex align-items-center gap-1" data-bs-modal-size="modal-md" data-bs-target="#po_pending_items_popup_win" id="btnsrlpopup" data-bs-toggle="modal"><svg style="height:14px"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M352 128C352 110.3 337.7 96 320 96C302.3 96 288 110.3 288 128L288 288L128 288C110.3 288 96 302.3 96 320C96 337.7 110.3 352 128 352L288 352L288 512C288 529.7 302.3 544 320 544C337.7 544 352 529.7 352 512L352 352L512 352C529.7 352 544 337.7 544 320C544 302.3 529.7 288 512 288L352 288L352 128z"/></svg> LPO</button>
                                @endif
                          ...
                          @else
                                    <div>
                                        <button  type="button" class="btn-light text-truncate border-0 d-inline-flex align-items-center gap-1"  onclick="window.location.href='../purchase-order/create/{{ $del->customername->name }}/{{ $del->ownername->full_name }}/{{ $deal->deal_id }}/{{ $deal->deal_code->code }}'"><svg style="height:14px"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M352 128C352 110.3 337.7 96 320 96C302.3 96 288 110.3 288 128L288 288L128 288C110.3 288 96 302.3 96 320C96 337.7 110.3 352 128 352L288 352L288 512C288 529.7 302.3 544 320 544C337.7 544 352 529.7 352 512L352 352L512 352C529.7 352 544 337.7 544 320C544 302.3 529.7 288 512 288L352 288L352 128z"/></svg> LPO</button>
                                    </div>
                         @endif
                ...
                <tr>
                      ...
                      <td class="{{ $invoice_status }} d-flex align-items-center justify-content-between gap-1">
                        ...
                        <div class="d-flex align-items-center justify-content-center flex-grow-1 gap-1">
                            ...
                            @if(App\SysHelper::invoice_approval_access() && $deal->sales==1 && $deal->accounts==1 && $deal->sales==1 && in_array($deal->purchease,[1,4]) && in_array($deal->invoice,[0,2,3,1]) && ($deal->delivery==0 || count($delivery) == 0) && (($deal->delivery==0 || in_array($deal->delivery_approval,['0',''])) || ($deal->receivables==0 || in_array($deal->receivables_approval,['0','']))))

                            @if ($deal->invoice_approval == 1)
                            <a class="btn-md btn-light" style="display: contents;" data-bs-toggle="modal" data-bs-target="#modalInvoice"><i class="ico icon-outline-pen-new-square title-15 {{ $invoice_status == 'bg-lightgreen text-dark' ? 'text-dark' : 'text-white' }}" style="font-size: 12px"></i></a>
                            @endif

                            
                        @endif
                        
                        @if(App\SysHelper::invoice_approval_access() && $del->is_partial_invoice==1)
                            <a class="btn-md btn-light" style="display: contents;" data-bs-toggle="modal" data-bs-target="#modalInvoice"><i class="ico icon-outline-pen-new-square title-15 {{ $invoice_status == 'bg-lightgreen text-dark' ? 'text-dark' : 'text-white' }}" style="font-size: 12px"></i></a>
                        @endif
                        </div>
                        ...
                        @if (count($check_si) > 0)
                            ...
                            <i class="ico icon-outline-add-square text-success title-15" data-bs-modal-size="modal-md" data-bs-target="#si_pending_items_popup_win" id="btnsrlpopup" data-bs-toggle="modal" aria-hidden="true"></i>
                        ...
                        @elseif ($check_si_pending == 0)
                            @if ($deal->invoice_approval == 1)
                                <div style="float: right;">
                                    <button type="button" class="btn-light text-truncate border-0 d-inline-flex align-items-center gap-1" data-bs-modal-size="modal-md" data-bs-target="#si_pending_items_popup_win" id="btnsrlpopup" data-bs-toggle="modal"> <svg style="height:14px"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M352 128C352 110.3 337.7 96 320 96C302.3 96 288 110.3 288 128L288 288L128 288C110.3 288 96 302.3 96 320C96 337.7 110.3 352 128 352L288 352L288 512C288 529.7 302.3 544 320 544C337.7 544 352 529.7 352 512L352 352L512 352C529.7 352 544 337.7 544 320C544 302.3 529.7 288 512 288L352 288L352 128z"/></svg> SI</button>
                                </div>
                            @endif
                        @else
                            @if ($deal->invoice_approval == 1)
                                <div style="float: right;">
                                    <a type="button" class="btn-light text-truncate border-0 d-inline-flex align-items-center gap-1" href="../sales-invoice/create/{{ $del->customername->name }}/{{ $del->ownername->full_name }}/{{ $deal->deal_id }}/{{ $deal->deal_code->code }}"><svg style="height:14px"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M352 128C352 110.3 337.7 96 320 96C302.3 96 288 110.3 288 128L288 288L128 288C110.3 288 96 302.3 96 320C96 337.7 110.3 352 128 352L288 352L288 512C288 529.7 302.3 544 320 544C337.7 544 352 529.7 352 512L352 352L512 352C529.7 352 544 337.7 544 320C544 302.3 529.7 288 512 288L352 288L352 128z"/></svg> SI</a>
                                </div>
                            @endif
                        @endif
                    ...
                    @if (count($invoice) > 0)
                        ...
                        @if ($val->invoice_no != '')
                            <tr><td  class="text-start"><span class="fw-bold">Invoice No</span> : {{ $val->invoice_no }}
                        @endif
            ...
            <div class="col p-1">
                <div class="card mb-3" style="border-radius: 16px">
                    ...
                    @endphp
                        ...
                        <button class="btn-light text-truncate border-0 d-inline-flex align-items-center gap-1" type="button"  onclick="window.location.href='{{ url('delivery-note-add-deal/'.$deal->deal_id) }}'" > <svg style="height:14px"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M352 128C352 110.3 337.7 96 320 96C302.3 96 288 110.3 288 128L288 288L128 288C110.3 288 96 302.3 96 320C96 337.7 110.3 352 128 352L288 352L288 512C288 529.7 302.3 544 320 544C337.7 544 352 529.7 352 512L352 352L512 352C529.7 352 544 337.7 544 320C544 302.3 529.7 288 512 288L352 288L352 128z"/></svg> DO</button>
                                ...
                                @if(App\SysHelper::delivery_approval_access() && $deal->accounts==1 && $deal->sales==1 && $deal->purchease==1 && $deal->invoice==1 && in_array($deal->delivery,[0,2,3,1,4,5,6]) && ($deal->receivables==0 || count($receivables) == 0))
                                        ...
                                        <a class="btn-md btn-light" style="display: contents;" data-bs-toggle="modal" data-bs-target="#modalDelivery"><i class="ico icon-outline-pen-new-square title-15 {{ $delivery_status == 'bg-lightgreen text-dark' ? 'text-dark' : 'text-white' }}" style="font-size: 12px"></i></a>
                                            @endif
                     ...
                     <button type="button" class="btn-light text-truncate border-0 d-inline-flex align-items-center gap-1" data-bs-modal-size="modal-md" data-bs-target="#dln_pending_items_popup_win" id="btnsrlpopup" data-bs-toggle="modal"><svg style="height:14px"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M352 128C352 110.3 337.7 96 320 96C302.3 96 288 110.3 288 128L288 288L128 288C110.3 288 96 302.3 96 320C96 337.7 110.3 352 128 352L288 352L288 512C288 529.7 302.3 544 320 544C337.7 544 352 529.7 352 512L352 352L512 352C529.7 352 544 337.7 544 320C544 302.3 529.7 288 512 288L352 288L352 128z"/></svg> DLN </button>
                    ...
                    <tr>
                        <th class="{{ $receivables_status }} d-flex align-items-center justify-content-between gap-1">
                            ...
                            @if ($deal->receivables_approval == 1)
                                <div><button type="button" onclick="window.location.href='{{ url('journalvoucher-add-deal/'.$deal->deal_id.'/'.$del->cust_id) }}'" target="_blank" class="btn-light text-truncate border-0 d-inline-flex align-items-center gap-1"> <svg style="height:14px"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M352 128C352 110.3 337.7 96 320 96C302.3 96 288 110.3 288 128L288 288L128 288C110.3 288 96 302.3 96 320C96 337.7 110.3 352 128 352L288 352L288 512C288 529.7 302.3 544 320 544C337.7 544 352 529.7 352 512L352 352L512 352C529.7 352 544 337.7 544 320C544 302.3 529.7 288 512 288L352 288L352 128z"/></svg> JV</button></div>
                            @endif
                        <div class="d-flex align-items-center justify-content-center flex-grow-1 gap-1">
                                <b>Recievable</b>
                            @if(($deal->technical==1 && $deal->tech==1) || ($deal->technical==0))
                                ...
                                <a class="btn-md btn-light" style="display: contents;" data-bs-toggle="modal" data-bs-target="#modalReceivables"><i class="ico icon-outline-pen-new-square title-15 {{ $receivables_status == 'bg-lightgreen text-dark' ? 'text-dark' : 'text-white' }}" style="font-size: 12px"></i></a>
                            @endif
                        @endif
                        </div>
                            ...
                            @if ($deal->receivables_approval == 1)
                                ...
                                @if(count($check_receipt) == 0)
                                    <div ><button type="button" onclick="window.location.href='{{ url('receipt-add-deal/'.$deal->deal_id.'/'.$deal->payment_mode) }}'" target="_blank" class="btn-light text-truncate border-0 d-inline-flex align-items-center gap-1"><svg style="height:14px"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M352 128C352 110.3 337.7 96 320 96C302.3 96 288 110.3 288 128L288 288L128 288C110.3 288 96 302.3 96 320C96 337.7 110.3 352 128 352L288 352L288 512C288 529.7 302.3 544 320 544C337.7 544 352 529.7 352 512L352 352L512 352C529.7 352 544 337.7 544 320C544 302.3 529.7 288 512 288L352 288L352 128z"/></svg> Receipt</button></div>
                                @endif
                            @endif
...
{{-- Modal PO --}}
<div class="modal  fade" id="po_pending_items_popup_win" data-bs-backdrop="false" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                                ...
                                <div class="col-lg-12">
                                    <div class="">
                                        <table  class="table table-hover" id="long-list" style="table-layout: fixed;width:100%">
                                            <thead>
                                                <tr>
                                                    <th><input type="checkbox" id="po_check_all" onclick="po_check_fun()" checked/>
                                                    <script>
                                                    ...
                                                    <th class="text-center">@lang('Deal')</th>
                                                    <th class="text-center">@lang('Exe')</th>
                                                    <th class="text-center">@lang('Qty')</th>
                                                    <th class="text-end">@lang('Unitprice')</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="number" name="qty[]" class="form-control text-center" value="{{ abs($Item->qty-$Item->po_qty) }}" /></td>
                                                    <td class="text-end"><input name="unitprice[]" type="text" class="form-control text-end" value="{{ @App\SysHelper::com_curr_format($up,2,'.','') }}" /></td>
                                                    <td style="display: none;" class="text-end"><input name="discount[]" type="text" class="form-control text-end" value="{{ @App\SysHelper::com_curr_format($Item->discount,2,'.',',') }}"/></td>
                                                    <td class="text-end"><input name="value[]" type="text" readonly class="form-control text-end" value="{{ @App\SysHelper::com_curr_format((($up * $Item->qty)),2,'.',',') }}"/></td>
                                                </tr>
...
{{-- Modal SI --}}
<div class="modal fade" id="si_pending_items_popup_win" data-bs-backdrop="false" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                                ...
                                <div class="col-lg-12">
                                    <div class="equipment comon-status row mt-40 d-block">
                                        <table id="long-list" class="table table-hover" style="table-layout: fixed;width:100%">
                                            <thead>
                                                <tr>
                                                    <th width="30px"><input type="checkbox" id="si_check_all" onclick="si_check_fun()" checked/>
                                                        <script>
                                                    ...
                                                    <th>@lang('Description')</th>
                                                    <th class="text-center" width="60px">@lang('Deal Qty')</th>
                                                    <th class="text-center" width="60px">@lang('Executed Qty')</th>
                                                    <th class="text-center" width="60px">@lang('Qty')</th>
                                                    <th class="text-end">@lang('Unitprice')</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ $Item->qty }}</td>
                                                    <td class="text-center">0</td>
                                                    <td class="no-toggle text-center"><input type="number" name="qty[]" class="form-control text-center" value="{{ abs($Item->qty-$Item->si_qty) }}" /></td>
                                                    <td class="text-end no-toggle"><input name="unitprice[]" type="text" step="any" class="form-control text-end" value="{{ @App\SysHelper::com_curr_format($up,2,'.','') }}" /></td>
                                                    <td class="text-end no-toggle"><input name="discount[]" type="text" step="any" class="form-control text-end" value="{{ @App\SysHelper::com_curr_format($Item->discount,2,'.','') }}"/></td>
                                                    <td class="text-end no-toggle"><input name="value[]" type="text" readonly class="form-control text-end" value="{{ @App\SysHelper::com_curr_format((($up * $Item->qty) - ($Item->discount)),2,'.','') }}"/></td>
                                                </tr>
                                                <input type="hidden" name="product_id[]" value="{{ $Item->product_id }}" />
...
{{-- Modal DLN --}}
<div class="modal fade" id="dln_pending_items_popup_win" data-bs-backdrop="false" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header m-0 p-3">
                        <h4 class="modal-title">Delivery Note Pending List</h4>
						<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="">
                                        <table id="long-list" class="table table-hover" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th><input type="checkbox" id="dl_check_all" onclick="dl_check_fun()" checked/>
                                                        <script>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ $Item->qty }}</td>
                                                    <td class="text-center">0</td>
                                                    <td><input type="number" name="qty[]" class="form-control" value="{{ abs($Item->qty-$Item->dn_qty) }}" /></td>
                                                    <td class="text-end"><input name="unitprice[]" type="number" step="any" class="form-control text-end" value="{{ @App\SysHelper::com_curr_format($up,2,'.','') }}" /></td>
                                                    <td class="text-end"><input name="discount[]" type="number" step="any" class="form-control text-end" value="{{ @App\SysHelper::com_curr_format($Item->discount,2,'.','') }}"/></td>
                                                    <td class="text-end"><input name="value[]" type="number" readonly class="form-control text-end" value="{{ @App\SysHelper::com_curr_format((($up * $Item->qty) - ($Item->discount)),2,'.','') }}"/></td>
                                                </tr>
                                                <input type="hidden" name="product_id[]" value="{{ $Item->product_id }}" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">0</td>
                                                    <td><input type="number" name="qty[]" class="form-control" value="{{ abs($Item->qty-$Item->dn_qty) }}" /></td>
                                                    <td class="text-end"><input name="unitprice[]" type="number" step="any" class="form-control text-end" value="0" /></td>
                                                    <td class="text-end"><input name="discount[]" type="number" step="any" class="form-control text-end" value="0"/></td>
                                                    <td class="text-end"><input name="value[]" type="number" readonly class="form-control text-end" value="0"/></td>
                                                </tr>
...
<div class="modal side-panel fade" id="purchase_auto_generate" data-bs-backdrop="false" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                                        ...
                                        <table id="table_id" class="table table-bordered table-striped" cellspacing="0" width="100%">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>
                                                        GRN Required </th><th> : 
                                                        <input class="dl_check" type="checkbox" name="req_grn" checked value="1" />
                                                    </th>
                                                </tr>
                                                <tr>
                                                    <th>
                                                        PI Required </th><th> : 
                                                        <input class="dl_check" type="checkbox" name="req_pi" checked value="1" />
                                                    </th>
                                                </tr>
                                                <tr>
                                                    <th>
                                                        Payment Required </th><th> : 
                                                        <input class="dl_check" type="checkbox" name="req_pay" checked value="1" />
                                                    </th>
                                                </tr>
                                                <tr>
                                                    <th>
    ...
    <button type="submit" class="btn btn-light add-btn">
        <i class="ico icon-outline-bookmark-opened text-success"></i> Generate Selected
    </button>
</div>
