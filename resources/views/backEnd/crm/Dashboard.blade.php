   ...
   @php
    ...
    <aside class="left-nav col-12" id="leftSidebar">
        ...
        <div class="left-nav-list">
            ...
            <div class="row mt-3">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <select class="form-control form-card-select" id="filter_date">
                                ...
                                <option value="pm" @if ($_SESSION['page_date_id'] == 'pm') selected @endif>Previous Month
                                </option>
                                ...
                                <option value="pq" @if ($_SESSION['page_date_id'] == 'pq') selected @endif>Previous Quarter
                                </option>
                        ...
                        <div class="col-md-8">
                            ...
                            <select class="form-control form-card-select" id="main_filter_company">
                                ...
                                @foreach ($com_list as $list)
                                    <option value="{{ $list->id }}" @if (session('logged_session_data.company_id') == $list->id) selected @endif>
                ...
                @if (session('logged_session_data.company_id') == 100 &&
                        ...
                        <div class="col-lg-3 mb-4">
                            <div class="card shadow h-100">
                                ...
                                <div class="p-2">
                                    ...
                                    <h2><a href="{{ url('crm-deals-sales-report') }}">{{ @App\SysHelper::com_curr_format($trading_sales_value, 2, '.', ',') }}</a></h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 mb-4">
                ...
                <div class="mb-4 @if (session('logged_session_data.company_id') == 0) col-lg-8 @else col-lg-3 @endif ">
                                            ...
                                            <div
                                                ...
                                                <a href="{{ url('sales-invoice')  }}" >
                                                    ...
                                                    <div class="mb-0 font-weight-bold text-gray-800 font-card-large"
                                                        id="revenue">{{ @App\SysHelper::com_curr_format($trading_sales_value, 2, '.', ',') }}</div>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="d-inline-block d-flex justify-content-center dashboard-metric-small">
                                            <div
                                                class="text-center mb-2 rounded__box d-flex align-items-center justify-content-center">
                                                <a href="{{ url('crm-deals/show?stage_id=3') }}">
                        ...
                        @else
                            <div class="d-flex justify-content-center text-center">
                                ...
                                <div class="d-inline-block d-flex justify-content-center dashboard-metric-small">
                                    <div
                                        ...
                                        <a href="{{ url('crm-deals/show?stage_id=3') }}">
                                            ...
                                            <div class="mb-0 font-weight-bold text-gray-800 font-card-large"
                                                id="forcast">{{ @App\SysHelper::com_curr_format($sales[1], 2, '.', ',') }}</div>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="d-inline-block d-flex justify-content-center dashboard-metric-small">
                                    <div
                                        class="text-center mb-2 rounded__box d-flex align-items-center justify-content-center">
                                        <a href="{{ url('crm-deals/show?stage_id=4') }}">
                                            <div class="text-xs font-weight-bold text-dark text-uppercase">OnProcess</div>
                                            <div class="mb-0 font-weight-bold text-gray-800 font-card-large"
                                                id="on_process">{{ @App\SysHelper::com_curr_format($on_process, 2, '.', ',') }}</div>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="d-inline-block d-flex justify-content-center dashboard-metric-small">
                                <div
                                    ...
                                    <a href="#" onclick="project_click('project_revenue')">
                                        <div class="text-xs font-weight-bold text-dark text-uppercase">Revenue</div>
                                        <div class="mb-0 font-weight-bold text-gray-800 font-card-large"
                                            id="project_revenue">{{ $project[0] }}</div>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="d-inline-block d-flex justify-content-center dashboard-metric-small">
                                <div
                                    ...
                                    <a href="#" onclick="project_click('project_forcast')">
                                        <div class="text-xs font-weight-bold text-dark text-uppercase">Forecast</div>
                                        <div class="mb-0 font-weight-bold text-gray-800 font-card-large"
                                            id="project_forcast">{{ $project[1] }}</div>
                                    </a>
                                </div>
                            </div>
                            <script>
                            ...
                            @forelse ($sales_target as $top)
                                ...
                                <div class="mb-3 pb-3 border-bottom">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div>
                                            <p class="mb-1 font-weight-bold text-dark">{{ optional($top->userid)->full_name ?: 'Unknown' }}</p>
                                            <p class="mb-0 text-muted small">{{ $tp }}% of monthly target</p>
                                        </div>
                                        <div class="text-right">
                                            ...
                                            <p class="mb-0 text-muted small">
                                                Target: {{ App\SysHelper::com_curr_format($top->revenue_target_monthly, 2, '.', ',') }} AED
                                            </p>
                                        </div>
                                    </div>
    ...
    <div style="width: 101px;">
        <select class="form-control form-control-sm js-example-basic-single" 
            ...
            <option value="this_month" @if($t_filter_by=="this_month") selected @endif>This Month</option>
            <option value="today" @if($t_filter_by=="today") selected @endif>Today</option>
            <option value="this_week" @if($t_filter_by=="this_week") selected @endif>This Week</option>
            <option value="last_week" @if($t_filter_by=="last_week") selected @endif>Last Week</option>
            <option value="last_month" @if($t_filter_by=="last_month") selected @endif>Last Month</option>
            <option value="this_quarter" @if($t_filter_by=="this_quarter") selected @endif>This Quarter</option>
            <option value="pre_quarter" @if($t_filter_by=="pre_quarter") selected @endif>Previous Quarter</option>
            <option value="this_year" @if($t_filter_by=="this_year" || $t_filter_by=="") selected @endif>This Year</option>
            <option value="last_year" @if($t_filter_by=="last_year") selected @endif>Last Year</option>
        </select>
    </div>
</div>
...
<hr style="margin-top:6px">
                        <div class="max-height">
                             ...
                             As of: {{ date('d/m/Y', strtotime($t_from_date)) }}
                                to 
                                {{ date('d/m/Y', strtotime($t_to_date)) }}
                            ...
                            <div class="dashboard-trading-summary" style="margin-top:24px">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <span class=" fw-bold">{{ @App\SysHelper::com_curr_format($trading_sales_value, 2, '.', ',') }} </span>
                                </div>
                               
                            
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <strong>Gross Profit</strong>
                                    <span class="fw-bold text-success">{{ @App\SysHelper::com_curr_format($gross_profit_value, 2, '.', ',') }} </span>
                                </div>
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <strong>Gross Profit %</strong>
                                    <span class="fw-bold text-success">{{ $_trading_sales > 0 ? number_format(($gross_profit_value / $trading_sales_value) * 100, 2) . '%' : '0%' }}   </span>
                                </div>
                                 <div class="d-flex justify-content-between align-items-center mb-2">
                                    <strong>@if($_dashboard_net_profit != 0) Net Profit @else Net Loss @endif</strong>
                                    <span class="fw-bold {{ $_dashboard_net_profit != 0 ? 'text-success' : 'text-danger' }}">
                                        {{ @App\SysHelper::com_curr_format($_dashboard_net_profit != 0 ? $_dashboard_net_profit : $_dashboard_net_loss, 2, '.', ',') }}
                                    </span>
                                </div>

                                 <div class="d-flex justify-content-between align-items-center mb-2">
                                    <strong>Net Profit %</strong>
                                    <span class="fw-bold text-success">{{ $_trading_sales > 0 ? number_format(($_dashboard_net_profit   / $trading_sales_value) * 100, 2) . '%' : '0%' }}   </span>
                                </div>

                                
                                 <!-- <div class="d-flex justify-content-between align-items-center">
                                    <strong>COGS</strong>
                                    <span class="fw-bold"> {{ @App\SysHelper::com_curr_format($cogs, 2, '.', ',') }}</span>
                                </div> -->
                            </div>
