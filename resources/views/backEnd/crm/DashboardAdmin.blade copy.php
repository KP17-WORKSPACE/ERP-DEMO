...
{{--  Sales Performance Selecter-----------------------  --}}
        ...
        @if(session('logged_session_data.company_id') == 1 && Auth::user()->id == 1 && Auth::user()->id == 2 && Auth::user()->id == 3 && Auth::user()->id == 15)
...
<table class="table table-nowrap table-centered mb-0 table-striped2" style="width: 100%;">
    <thead>
        <tr>
            ...
            <div class="card p-4 max-height">
                ...
                <div>
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        ?>
                        <p class="mb-1 font-semibold">{{ @App\SysHelper::com_curr_format($total_sales[0], 2, '.', ',') }}AED / {{ @App\SysHelper::com_curr_format($top->revenue_target_monthly, 2, '.', ',') }}AED</p>
                    </div>
