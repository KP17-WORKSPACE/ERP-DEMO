        ...
        <div class="row">
            <div class="col-lg-6 mb-3">
                <div class="p-4 card h-100 @if($support->status==3) bg-3 @else bg-1 @endif">
                    ...
                    @endif                    
                    <a data-toggle="modal" data-target="#ModalProfessionalServicesRequest" data-backdrop="static" data-keyboard="false" class="btn-sm btn-danger" style="width: 85px;">Add Request</a>
    ...
    <div class="modal fade" id="ModalProfessionalServicesRequest" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document" style="min-width:50% !important;">
            <div class="modal-content">
                ...
                <input type="hidden" name="pre_sales_id" id="pre_sales_id" value="{{ $support->id }}">
                            ...
                            <div class="no-gutters input-right-icon">
                                <div class="col">
                                    <div class="input-effect">
                                        ...
                                        <input class="form-control" id="cust_name" type="text" required name="cust_name" value="{{@$support->customer->name}}" readonly>
                                        <input id="cust_id" type="hidden" required name="cust_id" value="{{ $support->customer_id }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="no-gutters input-right-icon">
                                <div class="col">
                                    <div class="input-effect">
                                        ...
                                        <input class="form-control" id="contact_person" type="text" required name="contact_person" value="{{ @$support->customer->first_name }} {{ @$support->customer->last_name }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="no-gutters input-right-icon">
                                <div class="col">
                                    <div class="input-effect">
                                        ...
                                        <input class="form-control" id="mobile" type="text" required name="mobile" value="{{ @$support->dealid->cust_no }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="no-gutters input-right-icon">
                                <div class="col">
                                    <div class="input-effect">
                                        ...
                                        <input class="form-control" id="location_of_work" type="text" autocomplete="off" required name="location_of_work" value="{{ @$support->site_name }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="no-gutters input-right-icon">
                                <div class="col">
                                    <div class="input-effect">
                                        ...
                                        <input class="form-control" id="service_date" type="date" required name="service_date" min="{{ date('Y-m-d') }}" value="{{ @$support->support_date }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="no-gutters input-right-icon">
                                <div class="col">
                                    <div class="input-effect">
                                        ...
                                        <input class="form-control" id="service_time" type="time" required name="service_time" value="{{ @$support->time_from }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="no-gutters input-right-icon">
                                <div class="col">
                                    <div class="input-effect">
                                        ...
                                        <select id="engineer" name="engineer[]" class="form-control js-example-basic-single" multiple required>
                                            <option></option>
                                        @php $englist=@App\SysHelper::get_engineer_list();
                                        @endphp
                                        @foreach($englist as $list)                                    
                                            <option value="{{ $list->user_id }}" @if(in_array($list->user_id,$eng)) selected @endif>{{ $list->full_name }}</option>
                                        @endforeach
                            ...
                            <div class="mb-3">
                                ...
                                <script>
                                    ...
                                    function view_scope_of_work2(id,dat){
                                        $('#row2_'+id).css('display','');
                                        $('#scope_of_work2_'+id).val(dat);
                                    }
                                </script>

                                @if (count($support_work)>0)
                                <input type="hidden" id="a_count" value="{{ count($support_work) }}" />
                                @for ($i=1; $i <= count($support_work); $i++)
                                <input type="hidden" id="a_{{ $i }}" value="{{ $support_work[$i-1]->work }}" />
                                @endfor
                                @endif
                                <script>
                                    var abc = $('#a_count').val();
