...
<body>
    ...
    <footer>
        ...
        <img src="{!! asset('public/uploads/crm_pdf_img/'.$pdffooter.'') !!}" width="100%"></footer>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td width="40%" style="line-height: 18px; vertical-align: top;">
                                    ...
                                    @if($quotation->customername->address!="")<p style="padding: 0px; margin: 0px; width: 250px;">{{ $quotation->address }}</p>@endif
                                ...
                                <td width="25%" style="line-height: 18px; vertical-align: top;">
                                    <b style="font-size: 14px;">&nbsp;<br />Quote No : {{$quotation->code }} - {{ $quotationitems[0]->quote_id }}</b><br />
