            ...
            <div class="table-responsive">
                ...
                @if (count($stocklist) > 0)
                    @foreach ($stocklist as $list)
                        ...
                        <div class="border bg-success text-left fw-bold text-white">&nbsp;&nbsp;{{ $partnolist[$i] }}
                            <?php try{ ?>
                        ...
                        <table id="long-list" class="table table-hover data-table" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width:100px;" class="text-end"><a
                                            style="padding: 2px 6px; font-size: 12px; line-height: 1;white-space: nowrap;"
                                ...
                                <tbody>
                                    ...
                                    {{-- {{ dd($value) }} --}}
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                @if ($value->slno != '')
                                                    <a style="padding: 2px 2px; font-size: 12px; line-height: 1;white-space: nowrap;"
