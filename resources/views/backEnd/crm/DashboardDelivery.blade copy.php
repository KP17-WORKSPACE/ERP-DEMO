            ...
            <div class="col-lg-6">
                <div class="white-box leadbox text-sm pt-3 pl-0 pr-0 pb-0" style="height: 350px; overflow-y: scroll;">
                    ...
                    <tr>
                        ...
                        <td><span class="btn-xs btn-warning">New</span></td>
                    </tr>
                    ...
                    {{--  <span class="text-info text-xs">{{ $top->deal_name }}</span> - <span class="text-xs">{{ $top->cust_name }}</span> <span class="text-xs"> {{ date('d/m/Y', strtotime($top->created_at)) }}</span> <a href="#"><i class="fa fa-info-circle text-xs text-info" aria-hidden="true"></i></a><hr class="mt-2 mb-2"/>  --}}
                    @endforeach
                    @endif
                </table>
                </div>
            ...
            <div class="col-lg-6">
                <div class="white-box leadbox text-sm pt-3 pl-0 pr-0 pb-0" style="height: 350px; overflow-y: scroll;">
                    ...
                    <tr>
                        ...
                        <td>
                            @if($top->delivery==3)
                                <span class="btn-xs btn-primary">Out For Delivery</span>
                            @endif                    
                            @if($top->delivery==4)
                                <span class="btn-xs btn-info">Pending For Delivery</span>
                            @endif
                        </td>
                    </tr>
                    {{--  <a href="{{url('crm-deal-track-approval/'.$top->id.'')}}" title="View Deal Track">{{ $top->deal_name }}</a> - <span class="text-xs">{{ $top->cust_name }}</span> <span class="text-xs"> {{ date('d/m/Y', strtotime($top->created_at)) }}</span>
