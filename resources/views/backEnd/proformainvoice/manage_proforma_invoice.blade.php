...
{{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'proforma-invoice', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'quotation-store-form', 'novalidate' => true]) }}
...
<div class="purchase-order-content-header sticky-top" style="background-color: #f7f8fd">
    <h4 class="purchase-order-content-header-left">
        ...
        New (<span class="font-weight-600"
            id="new_code">{{ App\SysHelper::get_new_code_lead('sys_proforma_invoice', 'PF', 'doc_number', session('logged_session_data.company_id')) }}</span>)
    </h4>
