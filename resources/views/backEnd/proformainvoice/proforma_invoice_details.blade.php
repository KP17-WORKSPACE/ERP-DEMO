    ...
    @endphp
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu" style="">
                <li><a class="dropdown-item" href="{{ url('proforma-invoice/'.$pfi->id.'/download') }}">
...
<div class="card mb-3">
    <div class="card-body">
        <div class="" id="deal-info" role="tabpanel" aria-labelledby="deal-info-tab">
                ...
                <div class="col-8 mb-2 pdfarea">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            @if ($pfi->proforma_invoice == 'CI')
                                    Commercial Invoice
                            @elseif($pfi->proforma_invoice == 'PI')
                                    Proforma Invoice
                            @else
                                Proforma Invoice
          ...
          <div style="text-align: right;">TRN No: {{ $company->vat_number }}</div>
                            </td>
                        </tr>
                    </table>
                    <br />
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="" style="text-align: left; padding-left: 0px;">
      ...
      <tr>
        <td style="line-height: 12px;">{{@$pfi->doc_number}}</td>
        <td style="line-height: 12px;">{{date('d/m/Y', strtotime(@$pfi->doc_date))}}</td>
        <td style="line-height: 12px;">{{@$pfi->reference_no}}</td>
        <td style="line-height: 12px;">{{date('d/m/Y', strtotime(@$pfi->reference_date))}}</td>
        <td style="line-height: 12px;">{{ @$des = App\SysPaymentTerms::getPaymentTermsName(@$quotation->track->payment_terms) }}</td>
      </tr>
    </table>
    <br />
