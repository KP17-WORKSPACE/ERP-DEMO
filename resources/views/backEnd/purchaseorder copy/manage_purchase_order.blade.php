            ...
            <div class="tab-pane fade show active" id="extra-fields" role="tabpanel"
                ...
                <div class="row gap-rows">
                    ...
                    <div class="col-2">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" id="narration" type="text"
                                name="narration" value="STOCK ORDER" required />
                        </div>
                    </div>
                    <div class="col-2">
                    ...
                    @foreach ($cart as $items)
                        <tr>
                            ...
                            <td><input type="text" class="form-control" name="part_number_txt[]"
                                    value="{{ $items->partno ?? 0 }}" />
                                <input type="hidden" name="part_number[]" value="{{ $items->part_number }}" />
                            </td>
                            <td><input type="text" class="form-control" name="description[]"
                                    value="{{ $items->description ?? 0 }}" /></td>




                            <td><input type="text" class="form-control text-center" name="tax[]"
                                    value="{{ @App\SysHelper::com_curr_format($items->tax ?? 0, 2, '.', '') }}"
                                    onchange="calc_change_new(this)" /></td>
                            <td><input type="text" class="form-control text-center" name="qty[]"
                                    value="{{ $items->qty }}" onkeypress="set_license_key_po({{ $i }})"
                                    onchange="calc_change_new(this)" /></td>
