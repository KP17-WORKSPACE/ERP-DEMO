                ...
                <div class="col-2">
                    ...
                    <div class="form-group"><select class="form-control js-example-basic-single" name="currency"
                            ...
                            @foreach (@$currency ?? [] as $value)
                                <option value="{{ @$value->id }}" @if (optional(@$company)->currency_id == $value->id) selected @endif>
                                    {{ @$value->code }}
                                </option>
                            @endforeach
                        </select>
                                    ...
                                    <table class="table table-hover popupPI" id="long-list"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width:80px">@lang('Part No')</th>
                                                ...
                                                <th class="resizable text-end" width="60px">@lang('Taxable')</th>
                                                <th class="resizable text-end" width="60px">@lang('VAT')</th>
                                                <th class="resizable text-end" width="60px">@lang('Total')</th>
                                            </tr>
                                        </thead>
                                        <tbody>
