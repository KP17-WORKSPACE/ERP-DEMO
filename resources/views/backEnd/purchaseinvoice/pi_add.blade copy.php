    ...
    <div class="purchase-order-content-header">
        <h4 class="purchase-order-content-header-left">
            New ({{ isset($edit) ? (!empty(@$edit->title) ? @$edit->title : old('doc_number')) : @App\SysHelper::get_new_code('sys_purchase_invoice','PI' ,'doc_number') }})
        </h4>
             ...
             <div class="dropdown">
                            ...
                            <div class="card mb-3">
                                ...
                                <input
                                    ...
                                    readonly>
                                        ...
                                        <input class="form-control date-picker" id="pi_date" type="text" autocomplete="off" name="pi_date" value="{{ @$value_date }}" style="margin-top: 0px">
                                            </div>
                                        </div>
                                        <div class="col-2">
                ...
                <div class="col-2 mb-2">
                    <div class="input-effect">
                        ...
                        <a data-modal-size="modal-md" data-target="#popup_grn_pending" id="addGRNPending" data-toggle="modal"></a>
                    ...
                    <div class="row gap-rows">
                                ...
                                <input
                                    ...
                                    value="{{ isset($edit) ? (!empty(@$edit->lpo_number) ? @$edit->lpo_number : old('lpo_number')) : '' }}">
                                            ...
                                            <div class="col-2">
                                                ...
                                                <div class="form-group">
                                                    <input class="form-control date-picker" id="lpo_date" type="text" autocomplete="off" name="lpo_date" value="{{ @$value_date }}" style="margin-top:0px;">
                                                </div>
                                            </div>
                                            <div class="col-2">
                        ...
                        <div class="form-group">
                            <select onchange="this.setAttribute('title', this.options[this.selectedIndex].text)"
                                ...
                                required class="form-control" name="payment_terms" id="payment_terms"
                            ...
                            <i class="ico icon-outline-alt-arrow-down dropdown-toggle-ico"></i>
                                ...
                                <input
                                    class="form-control"
                                    type="text" name="narration" data-bs-toggle="modal"
                                        data-bs-target="#narrationModal"  autocomplete="off" id="narration"
...
<!-- <a data-bs-toggle="modal" data-bs-target="#editModal"></a> -->
        ...
        <button id="btnModalAdjustmentNew" data-bs-toggle="modal" data-bs-target="#adjustmentModalNew"></button>
        <div class="modal side-panel fade" id="adjustmentModalNew" data-bs-backdrop="false" tabindex="-1" aria-labelledby="adjustmentModalLabel" aria-hidden="true">
                            ...
                            var getSelectedRows="";
                                for (var i = 0; i < data.unadjusted.length; i++) {
                                    ...
                                    getSelectedRows +="<tr>\
                                        ...
                                        <td class='border text-end'><input type='text' name='set_amt[]' id='set_amt_"+data.unadjusted[i].doc_number+"' class='form-control text-end' value='' onclick=\"set_adjust('"+(data.unadjusted[i].amount-data.unadjusted[i].adj_amount)+"','"+data.unadjusted[i].doc_number+"')\" />\
                            ...
                            var getSelectedRows2="";
                                for (var j = 0; j < data.unadjusted_pdc.length; j++) {
                                    getSelectedRows2 +="<tr>\
                                        ...
                                        <td class='border text-end'>"+(data.unadjusted_pdc[i].amount-data.unadjusted_pdc[i].adj_amount)+"</td>\
                                        <td class='border text-end'><input type='text' name='set_amt[]' id='set_amt_"+data.unadjusted_pdc[i].doc_number+"' class='form-control text-end' value='"+data.unadjusted_pdc[i].adj_amount+"' onclick=\"set_adjust('"+(data.unadjusted_pdc[i].amount-data.unadjusted_pdc[i].adj_amount)+"','"+data.unadjusted[i].doc_number+"')\" />\
