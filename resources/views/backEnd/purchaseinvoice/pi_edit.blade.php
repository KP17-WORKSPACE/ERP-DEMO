    <?php try { ?>
            ...
            {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'purchase-invoice-update', 'method' => 'POST', 'id' => 'purchase-invoice-create-form', 'novalidate' => true]) }}
    ...
    <div class="purchase-order-content-header">
        ...
        <div class="purchase-order-content-header-right">
            <a type="submit" class="btn btn-light text-dark" href="{{url('purchase-invoice/'. $edit_pi->id .'?pi_action=add')}}">
                                ...
                                readonly>
                                         ...
                                         <div class="col-2">
                                           ...
                                           @php
                                            ...
                                            @endphp
                                            <input class="form-control date-picker" id="pi_date" type="text" autocomplete="off" name="pi_date" value="{{ @$value }}">
                                            </div>
                                        </div>
                                        <div class="col-2">
...
@endphp
                                ...
                                <input class="form-control"
                                    ...
                                    value="{{ isset($edit_pi) ? (!empty(@$edit_pi->deal_id) ? @App\SysHelper::get_code_from_dealid(@$edit_pi->deal_id) : old('deal_id')) : '' }}">
                                                </div>
                                            </div>
...
@endphp
  ...
  <script>
                            ...
                            @foreach ($customer_reference_list as $value)
                            <option value="{{ @$value->id }}" @if(@$edit_pi->ref_company_id == @$value->id) selected @endif >{{ @$value->name }} 
                            ...
                            @endforeach
                                ...
                                <select class="form-control js-example-basic-single" required name="sales_person" id="sales_person">
                                    ...
                                    @if(isset($edit_pi) && $edit_pi->sales_person)
                                        @php
                                        ...
                                        @if(!$exists)
                                            ...
                                            @endif
                                        @endif
                                    @elseif(isset($edit_pi) && !is_null($edit_pi->sales_person_name) && $edit_pi->sales_person_name !== '')
                                        {{-- If sales_person_name is set (manual entry), append it as a manual option --}}
                                        <option value="{{ $edit_pi->sales_person_name }}" selected>{{ $edit_pi->sales_person_name }}</option>
                                ...
                                if ($sales.val() === 'OTH') {
                                    ...
                                    if (prev) {
                                        ...
                                        @foreach ($warehouses as $value)
                                            <option value="{{ @$value->id }}" @if (@$edit_pi->warehouse == $value->id) selected
                        ...
                        <div class="form-group">
                            <select class="form-control js-example-basic-single" name="shipping_supplier"
                                ...
                                @foreach ($customer as $value)
                                    ...
                                    <option value="{{ @$value->id }}" {{ $s }} @if($edit_pi->shipping_supplier == $value->id) selected @endif>
                                        {{ @$value->account_name }} 
                                        @if(@App\SysHelper::getCompanyCodeSettings()['is_customer_code'])
                                        ({{ @$value->account_code }})
                                        @endif
                    ...
                    <div class="col-2">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="shipping_contact_no"
                                id="shipping_contact_no" value="{{ $edit_pi->shipping_contact_no }}" />
                        </div>
                    </div>
                    <div class="col-3">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="shipping_address_1"
                                id="shipping_address_1" value="{{ $edit_pi->shipping_address_1 }}" />
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                           ...
                           <input class="form-control" type="number"  name="vat_percent" id="vat_percent" value="{{ @$edit_pi->vat_percent }}">
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                           ...
                           <input class="form-control" type="number"  name="vat_number" id="vat_number" value="{{ @$edit_pi->vat_number }}">
                        </div>
                    </div>
                    ...
                    @if (count($edit_pi_items)>0)
                        ...
                        <tr>
                            <td><input type="text" class="form-control text-center" name="sort_id[]" value="{{ $i }}" />
                                ...
                                <input type="hidden" name="part_number_txt[]" value="{{ $items->partno }}" />
                            </td>
                            <td>
                            ...
                            <td>
                        <textarea class="form-control" name="description[]" rows="1">{{ $items->description ?? 0 }}</textarea></td>
                            ...
                            <table class="table table-hover " id="long-list" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:100px;">@lang('Bill NO')</th>
