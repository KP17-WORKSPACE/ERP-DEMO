...
<style>
    ...
    <div class="purchase-order-content-header sticky-top d-flex align-items-center justify-content-between gap-2" style="background-color: #f7f8fd">
        <div class="d-flex align-items-center gap-2">
            ...
            @if(isset($grn->deal_id))
                {!! App\SysHelper::deal_pipeline_purchase($grn->deal_id) !!}
            @endif
        </div>
        <div class="purchase-order-content-header-right">

              <form method="GET" action="{{ url('goods-receipt-note-list', @$grn->id) }}">
        ...
        <form method="GET" action="{{ url('goods-receipt-note-list', @$grn->id) }}">
            ...
            {{-- <a class="btn btn-light text-dark" href="{{url('goods-receipt-note/'.$grn->id.'/edit')}}">
                <i class="ico icon-outline-pen-2 text-success"></i> Edit
            </a>
            <a class="btn btn-light text-dark" href="{{url('goods-receipt-note/create')}}">
                <i class="ico icon-outline-add-square text-success"></i> Add
            </a> --}}
                ...
                <div class="row">
                    ...
                    <div class="col-8 mb-2 pdfarea" >
                        ...
                        {{-- ************* --}}
                            ...
                            <tr>
                                <td align="left"><img style="margin-left:-11px"  src="{{asset('public/'.@$company->company_logo)}}" width="200px"/></td>
