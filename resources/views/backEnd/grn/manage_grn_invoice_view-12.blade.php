                ...
                @if (count($purchasegrn) > 0)
                    @foreach ($purchasegrn as $value)
                        <li class="nav-item w-100" role="presentation">
                            <button href="javascript:void(0)" class="nav-link grn-item {{ $loop->first ? 'active' : '' }}"
                                data-id="{{ $value->id }}">
                            ...
                            <td>
                                ...
                                @else
                                    @foreach (explode(',', $value->piv_no) as $piv)
                                        <a href="javacript:void(0);"onclick="list_style()"
            ...
            <script>
              ...
              <script>
                ...
                <div class="" role="tabpanel" aria-labelledby="grn-tab" id="grn-details">
                    ...
                    <div onclick="window.location.href='{{ url('goods-receipt-note/create') }}'" class="container-fluid d-flex flex-column justify-content-center align-items-center"
