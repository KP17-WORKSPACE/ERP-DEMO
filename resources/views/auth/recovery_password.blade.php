    ...
    <div class="login-container">
        ...
        <div class="right-panel">
            <div class="mb-8 text-center md:text-left">
                ...
                <p class="text-gray-500">Provide your email address to reset your password</p>
            </div>

            <form method="POST" action="{{ url('email/verify') }}" id="infix_form2" class="space-y-6">
                @csrf
                ...
                <div class="flex justify-end">
                    <a href="{{  url('login') }}" class="text-sm text-greenenergy-600 hover:text-greenenergy-800 font-medium">Back To Login?</a>
                </div>
