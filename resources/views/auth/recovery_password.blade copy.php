    ...
    <div class="venus-app page-login">
        <section class="content-container">
            <div class="content-bg">
                ...
                <form  method="POST" action="{{ url('email/verify') }}" class="login-box" >
                    @csrf
                    ...
                    <button type="submit" class="btn btn-dark btn-login-submit">Reset Password</button>
                    <div class="create-account"><a href="{{ url('login') }}">Back to Login</a></div>
