...
<body class="hight_100" style="background: #c2c2c2;">
	...
	<div class="col-md-8 mt-4 p-4" style="background: #ffffff;">
		<b style="font-size: 25px;">Supplier Form</b>
		<img  src="{{asset(@$company->company_logo)}}" width="200px" align="right"/><br /><br />


		<hr>
			{{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'supplier-form-store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
		...
		<div class="row mt-2">
			...
			<div class="col-md-2" style="display: none;">Customer Type
...
<div class="row pb-2" id="d_1">
	...
	<div class="col-md-3">
		...
		<input class="form-control" type="file" name="customer_documents_1" required/>
	</div>
