...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.create') @lang('lang.invoice') </h1>
            <div class="bc-pages">
                <a href="{{url('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('lang.invoice')</a>
                <a href="#">@lang('lang.create') @lang('lang.invoice')</a>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="main-title">
                            <h3 class="mb-30">@lang('lang.create') @lang('lang.invoice')
                            </h3>
                        </div>
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'infix/invoice-store', 'method' => 'POST', 'id' => 'create-invoice-form']) }}
                        <div class="white-box">
                            <div class="add-visitor p-2">
                                <div class="row">
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="single_invoice">
                                            <select class="niceSelect w-100 bb form-control{{ $errors->has('fees_type') ? ' is-invalid' : '' }}" name="project" id="project">
                                                <option data-display="project" value="">@lang('lang.payment')</option>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="single_invoice">
                                            <select class="niceSelect w-100 bb form-control{{ $errors->has('currency') ? ' is-invalid' : '' }}" name="currency" id="currency">
                                                ...
                                                <option value="{{@$value->id}}" {{@$generalSetting->currency == @$value->code? 'selected':''}}>{{@$value->code}} ({{@$value->symbol}})</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="single_invoice">
                                            <div class="no-gutters input-right-icon">
                                                <div class="col">
                                                    <div class="input-effect">
                                                        <input class="primary-input date" id="endDate" type="text" name="invoice_date" autocomplete="off">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="single_invoice">
                                            <div class="no-gutters input-right-icon">
                                                <div class="col">
                                                    <div class="input-effect">
                                                        <input class="primary-input date" id="endDate" type="text" name="due_date" autocomplete="off">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="single_invoice">
                                            <div class="input-effect invoice-custom">
                                                ...
                                                <input class="invoive-number primary-input form-control{{ $errors->has('invoice_no') ? ' is-invalid' : '' }}" type="text" name="invoice_no" id="invoice_no" autocomplete="off" step="any" value="{{@$invoice_number == ""? 1001:@$invoice_number+1}}" readonly="true">
                                ...
                                <div class="row mt-40">
                                    <div class="col-lg-3">
                                        <div class="single_invoice">
                                            <select class="niceSelect w-100 bb form-control{{ $errors->has('recurring') ? ' is-invalid' : '' }}" name="recurring" id="recurring">
                                                ...
                                                <option value="M">@lang('lang.Monthly')</option>
                                                <option value="Q">@lang('lang.Quarterly')</option>
                                                <option value="SA">@lang('lang.Semi') @lang('lang.Annually')</option>
                                                <option value="A">@lang('lang.Annually')</option>
                                                <option value="OT">@lang('lang.once') @lang('lang.time')</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="single_invoice">
                                            <select class="niceSelect w-100 bb form-control{{ $errors->has('payment_status') ? ' is-invalid' : '' }}" name="payment_status" id="payment_status">
                                                <option value="UP" selected>@lang('lang.unpaid')</option>
                                                <option value="P">@lang('lang.paid')</option>
                                                <option value="PP">@lang('lang.PARTIALLY') @lang('lang.paid')</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-3" id="partial_payment_div">
                                        <div class="single_invoice">
                                            <div class="input-effect">
                                                <input class="primary-input form-control{{ $errors->has('partial_payment') ? ' is-invalid' : '' }}" type="text" name="partial_payment" id="partial_payment" autocomplete="off" step="any">
                                ...
                                <div class="row mt-40">
                                    <div class="col-lg-3">
                                        <div class="input-effect">
                                            <input class="primary-input form-control" type="number" step="any" id="discount" name="discount" autocomplete="off">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="d-flex radio-btn-flex ml-40">
                                            <div class="mr-30">
                                                <input type="radio" name="discount_type" id="relationFather" value="P" class="common-radio relationButton">
                                                <label for="relationFather">%</label>
                                            </div>
                                            <div class="mr-30">
                                                <input type="radio" name="discount_type" id="relationMother" value="F" class="common-radio relationButton">
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12 text-right">
                                        <button type="button" class="primary-btn small fix-gr-bg mb-2" id="addInvoiceRowProduct">
                                ...
                                <table class="display without-box-shadow invoice_table mb-4" width="100%" id="product-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>@lang('lang.price') (<span id="currency_id">{{@$currency_symbol}}</span>)</th>
                                            <th>@lang('lang.total') (<span id="currency_id">{{@$currency_symbol}}</span>)</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="discount_amount_tr">
                                            ...
                                            <td>
                                                <input class="primary-input form-control" type="number" step="any" id="discount_amount" name="discount_amount" autocomplete="off" value="0" readonly=""></td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td colspan="3"></td>
                                            <td>@lang('lang.total') @lang('lang.amount'):</td>
                                            <td><input class="primary-input form-control" type="number" step="any" id="total" name="total" autocomplete="off" readonly="true"></td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td colspan="3"></td>
                                            <td>@lang('lang.paid') @lang('lang.amount'):</td>
                                            <td><input class="primary-input form-control" type="number" step="any" id="paid_amount" name="paid_amount" autocomplete="off" readonly="true"></td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td colspan="3"></td>
                                            <td>@lang('lang.due') @lang('lang.amount'):</td>
                                            <td><input class="primary-input form-control" type="number" step="any" id="due_amount" name="due_amount" autocomplete="off" readonly="true"></td>
                                            <td></td>
                                        </tr>
                                    </tbody>
                                ...
                                <div class="row mb-30">
                                    ...
                                    <div class="col-lg-6 mt-40">
                                        <div class="input-effect">
                                            <select class="niceSelect w-100 bb form-control{{ $errors->has('designation_id') ? ' is-invalid' : '' }}" name="designation_id" id="designation_id">
                                                <option data-display="Select Designations *" value="">@lang('lang.select') @lang('lang.sesignation') *</option>
                                    ...
                                    <div class="col-lg-6 mt-40">
                                        <div class="row no-gutters input-right-icon">
                                            <div class="col">
                                                <div class="input-effect">
                                                    <input class="primary-input form-control input-image {{ $errors->has('staff_photo') ? ' is-invalid' : '' }}" type="text" id="placeholderStaffsName" placeholder="{{isset($editData->file) && @$editData->file != '' ? showPicName(@$editData->file):'Customer Photo '}}" disabled>
                                                    <span class="focus-border"></span>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="row mt-25">
                                <div class="col-lg-12">
                                    <div class="input-effect">
                                        <input class="primary-input form-control" type="text" name="method" value="" id="title">
                        ...
                        <div class="col-lg-12 text-center mt-40">
                            <div class="mt-40 d-flex justify-content-between">
                                <button type="button" class="primary-btn tr-bg" data-dismiss="modal">@lang('lang.cancel')
                                </button>
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            var tr = "<tr class='ajax_table'>";
                ...
                var numItems = $('.ajax_table').length;
                if(numItems == 0){
                    $("#product-table tbody tr:first").after(tr);
                }else{
                    $("#product-table tbody tr.ajax_table:last").after(tr);
                }
