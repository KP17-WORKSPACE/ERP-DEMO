                        ...
                        <div class="row">
                            ...
                            <div class="col-3 mb-2 ">
                                ...
                                <input class="form-control" type="text" id="part_number" name="part_number"
                                    value="<?php echo e($str_partno); ?>" autocomplete="off">
        ...
        <div class="left-nav-list">
            ...
            <div class="table-responsive">
                ...
                <?php if(count($stocklist) > 0): ?>
                    <?php $__currentLoopData = $stocklist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    
                        <div class="border bg-success text-left fw-bold text-white d-block w-100" style="box-sizing: border-box;">&nbsp;&nbsp;<?php echo e($partnolist[$i]); ?>

                            <?php try{ ?>
                            
                            <span class=" text-white" style="padding-left: 50px;"><?php echo e(@App\SysHelper::get_product_description(null,$partnolist[$i])); ?></span>
                        ...
                        <table id="long-list" class="table table-hover data-table" width="100%" cellspacing="0" style="table-layout: fixed; width: 100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width:100px;"><?php echo app('translator')->getFromJson('Ref No'); ?></th>
                                    <th style="width:70px;"><?php echo app('translator')->getFromJson('Deal Id'); ?></th>
                                    <th><?php echo app('translator')->getFromJson('Account Name'); ?></th>
                                    <th><?php echo app('translator')->getFromJson('Reference Name'); ?></th>
                                    <th style="width:70px;" class="text-center"><?php echo app('translator')->getFromJson('In Qty'); ?></th>
                                    <th style="width:100px;" class="text-end"><?php echo app('translator')->getFromJson('In Rate'); ?></th>
                                    <th style="width:70px;" class="text-center"><?php echo app('translator')->getFromJson('Out Qty'); ?></th>
                                    <th style="width:100px;" class="text-end"><?php echo app('translator')->getFromJson('Out Rate'); ?></th>
                                    <th style="width:70px;" class="text-center"><?php echo app('translator')->getFromJson('Bal Qty'); ?></th>
                                    <th style="width:90px;" class="text-end"><?php echo app('translator')->getFromJson('Avg Rate'); ?></th>
                                    <th style="width:110px;" class="text-end"><a
                                            ...
                                            class="btn btn-light rounded-0" id="atag_srl_no<?php echo e($i); ?>"
                                            onclick="show_hide_srl_no(<?php echo e($i); ?>)">View All SrlNo</a></th>
                                </tr>
                            ...
                            <?php endif; ?>
                            <?php if($opb[0] > 0 || $opb[1] > 0): ?>
                                      <tr>
                                    <td><?php echo e(date('d-M-Y', strtotime(@$opb_date))); ?></td>
                                    <td colspan="3"></td>
                                    <td>Opening Balance</td>
                                    <td colspan="5"></td>
                                    <td class="text-center"><?php echo e($opb[0]); ?></td>
                                    <td class="text-end"><?php echo e($opb[1]); ?></td>
                                    <td></td>
                                </tr>
                            ...
                            <?php if(count($list) > 0): ?>
                                    ...
                                    <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php echo implode(', ', $refLinks); ?>

                                            </td>


                                            <td>
                                                <?php if($value->deal_id != 0): ?>
                                                    <?php
                                                        $deal_code = @App\SysHelper::get_code_from_dealid(
                                                            $value->deal_id
                                                        );
                                                    ?>
                                                    <a href="<?php echo e(url('get-url-deal-track/' . $deal_code)); ?>"
                                                        target="_blank"><?php echo e($deal_code); ?></a>
                                                <?php else: ?>
                                                    Without
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php if(@$value->accountname->account_name == '' && substr($value->doc_number, 0, 2) == 'SH'): ?>
                                                    Shortage Stock
                                                <?php elseif(@$value->accountname->account_name == '' && substr($value->doc_number, 0, 2) == 'EX'): ?>
                                                    Excess Stock
                                                <?php elseif(@$value->accountname->account_name == '' && substr($value->doc_number, 0, 2) == 'DI'): ?>
                                                    Demo In
                                                <?php elseif(@$value->accountname->account_name == '' && substr($value->doc_number, 0, 2) == 'DO'): ?>
                                                    Demo Out
                                                <?php elseif(@$value->accountname->account_name == '' && substr($value->doc_number, 0, 2) == 'RI'): ?>
                                                    
                                                    <?php echo e($value->description); ?>

                                                <?php elseif(@$value->accountname->account_name == '' && substr($value->doc_number, 0, 2) == 'RO'): ?>
                                            ...
                                            <td>
                                                ...
                                                <?php if(@$value->grn_reference): ?>
                                                    ...
                                                    ?>
                                                    <?php echo e(implode(', ', $selectedCompanyNames)); ?>

                                                <?php endif; ?>
                                                <?php echo e(@$value->dln_reference); ?>

                                                <?php echo e(@$value->srt_reference); ?>

                                                <?php if(@$value->prt_reference): ?>
                                                    <?php
                                                    ...
                                                    ?>
                                                    <?php echo e(implode(', ', $prtCompanyNames)); ?>

                                                <?php endif; ?>

                                                

                                                <?php if(@$value->accountname->account_name == '' && substr($value->doc_number, 0, 2) == 'RI'): ?>
                                                    RMA In
                                                <?php endif; ?>

                                                <?php if(@$value->accountname->account_name == '' && substr($value->doc_number, 0, 2) == 'RO'): ?>
                                                    RMA Out
                                                <?php endif; ?>

                                            </td>
                                            <td class="text-center"><?php echo e($value->qty_in); ?></td>
                                            <td class="text-end">
                                                <?php echo e(@App\SysHelper::com_curr_format($value->price_in, 2, '.', ',')); ?></td>
                                            ...
                                            ?>
                                            <?php if(str_contains($value->doc_number, 'SRT')): ?>
                                                <?php
                                                    $qty_in += $value->qty_in;
                                            ...
                                            <?php else: ?>
                                                ...
                                                ?>
                                            <?php endif; ?>
                                            <td class="text-center"><?php echo e($value->qty_out); ?></td>
                                            <td class="text-end">
                                                <?php echo e(@App\SysHelper::com_curr_format($value->price_out, 2, '.', ',')); ?></td>
                                            <td class="text-center"><?php echo e($bal_qty); ?></td>
                                            <td class="text-end"><?php echo e($avg_rate); ?></td>
                                            <td class="text-end">
                                                <?php if($value->slno != ''): ?>
                                                    <a style="padding: 2px 2px; font-size: 12px; line-height: 1.2; white-space: normal;"
                                                        ...
                                                        data-bs-target="#exampleModalCenter<?php echo e($value->doc_number); ?>">View
                                                        SrlNo</a>
                                                <?php endif; ?>
                                                <div class="all_srl_no_<?php echo e($i); ?>" style="display: none;">
                                                    <?php echo e(str_replace(',', ', ', $value->slno)); ?></div>
                                            </td>

                                            <div class="modal fade" id="exampleModalCenter<?php echo e($value->doc_number); ?>"
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLongTitle">
                                                                <?php echo e($partnolist[$i]); ?> | <?php echo e($value->doc_number); ?></h5>
                                                            <button type="button" class="btn-close"
                                                                data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body" style="line-height: 25px;">
                                                            <?php echo e(str_replace(',', ' | ', $value->slno)); ?>
                                ...
                                <tfoot>
                                    <tr class="bg-light">
                                        ...
                                        <th></th>
                                        <th></th>
                                        <th class="text-center"><?php echo e($total_qty_in); ?></th>
                                        <th class="text-end"></th>
                                        <th class="text-center"><?php echo e($total_qty_out); ?></th>
                                        <th class="text-end"></th>
                                        <th class="text-center"><?php echo e($bal_qty); ?></th>
                                        <th class="text-end"><?php echo e($avg_rate); ?></th>
                                           ...
                                           <?php
                                            ...
                                            <?php if($reserved_qty > 0): ?>
                                                ...
                                                <th class="text-center" data-stock="<?php echo e(json_encode($value)); ?>" onclick="openReservedStockListModal(this)">
                                                    Reserve: 
                                                    <span class="text-danger fw-bold"><?php echo e($reserved_qty); ?></span>                                                
                                                </th>
                                            <?php else: ?>
                                                <th></th>
