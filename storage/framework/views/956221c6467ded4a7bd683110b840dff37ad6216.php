        ...
        <aside class="left-nav col-3" id="leftSidebar">
                    ...
                    <div class="left-nav-list" id="invoice_list">
                        <ul id="short-list-items" class="nav flex-column nav-pills" id="companyTabNavs" role="tablist">
                         ...
                         <?php $__currentLoopData = $deals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="nav-item w-100" role="presentation">
                                <button href="javascript:void(0)" class="nav-link data-item <?php echo e($active_id == $value->id ? 'active' : ''); ?>" data-id="<?php echo e($value->id); ?>">
                              
                                    <div class="row w-100">

                                        <div class="col-12">
                                            <label class="form-control-plaintext truncate-text"> <?php echo e(@$value->customername->customer_name_display); ?>
                                        ...
                                        <div class="col-4">
                                            <div class="form-control-plaintext" style="font-size:11px"><?php echo e(@$value->code); ?></div>
                                        </div>
                                        <div class="col-4 pl-2">
                                            <div class="form-control-plaintext truncate-text" style="font-size:11px"><?php echo e(date('d/m/Y', strtotime(@$value->date))); ?></div>
                                        </div>

                                           
                                        <div class="col-4 text-end">
                                            <div class="form-control-plaintext truncate-text" style="font-size:11px">  <?php @$aed2 = @$value->deal_value; ?>
                                            <?php echo e(@App\SysHelper::currancy_format_deal(@$aed2,@$value->company_id)); ?> <?php echo e(@$value->dealcurrency->code); ?></div>
                                        </div>
...
<div class="search-filter-container mb-0 d-flex align-items-center justify-content-start flex-nowrap">
                            ...
                            <div class="row">
                                <div class="col-12">
            <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'crm-deals/show', 'method' => 'get', 'id' => 'crm-deals-search'])); ?>
            ...
            <div class="row">
                ...
                <div class="col-1-5">
                        ...
                        <input class="form-control" id="deal_id" type="text" autocomplete="off" name="deal_id" value="<?php echo e($ctrl_deal_id); ?>">
                    </div>
                    <div class="col-3">
                        ...
                        <select class="form-control js-example-basic-single" name="company_id" id="company_id">
                            ...
                            <option value="<?php echo e(@$value->id); ?>" <?php if($ctrl_cust_id == $value->id): ?> selected <?php endif; ?>><?php echo e(@$value->name); ?> - <?php echo e(@$value->code); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    ...
                    <div class="col-1-5">
                        ...
                        <select class="form-control js-example-basic-single" name="owner_id" id="owner_id">
                            ...
                            <option value="<?php echo e(@$value->user_id); ?>" <?php if($ctrl_owner == $value->user_id): ?> selected <?php endif; ?>><?php echo e(@$value->full_name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="col-1-5">
                        ...
                        <select class="form-control js-example-basic-single" name="owner_id" id="owner_id">
                            <option value="">-Select-</option>
                            <option value="33" <?php if($ctrl_owner == 33): ?> selected <?php endif; ?>>Jacob George</option>
                            <option value="31" <?php if($ctrl_owner == 31): ?> selected <?php endif; ?>>Sheikh Nadeem Akthar</option>
                            <option value="59" <?php if($ctrl_owner == 59): ?> selected <?php endif; ?>>Trison Thomas</option>
                        </select>
                    </div>
                    <?php endif; ?>

                    <?php if(Auth::user()->id == 27): ?>
                    <div class="col-1-5">
                        <label for="" class="form-label">Owner</label>
                        <select class="form-control js-example-basic-single" name="owner_id" id="owner_id">
                            <option value="">-Select-</option>
                            <option value="27" <?php if($ctrl_owner == 27): ?> selected <?php endif; ?>>Monica</option>
                            <option value="28" <?php if($ctrl_owner == 28): ?> selected <?php endif; ?>>Archana Revi</option>
                            <option value="30" <?php if($ctrl_owner == 30): ?> selected <?php endif; ?>>Faizaan Aslam Shaikh</option>
                            <option value="54" <?php if($ctrl_owner == 54): ?> selected <?php endif; ?>>Satyabhan Sikarwar</option>
                        </select>
                    </div>
                    <?php endif; ?>

                    <?php if(Auth::user()->id == 44): ?>
                    <div class="col-1-5">
                        <label for="" class="form-label">Owner</label>
                        <select class="form-control js-example-basic-single" name="owner_id" id="owner_id">
                            <option value="">-Select-</option>
                            <option value="44" <?php if($ctrl_owner == 44): ?> selected <?php endif; ?>>Rajiv R</option>
                            <option value="32" <?php if($ctrl_owner == 32): ?> selected <?php endif; ?>>Irshaad Aklekar</option>
                            <option value="34" <?php if($ctrl_owner == 34): ?> selected <?php endif; ?>>Stephen F Mendonsa</option>
                            <option value="45" <?php if($ctrl_owner == 79): ?> selected <?php endif; ?>>Shamshad Ahmed</option>
                        </select>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="col-1-5">
                        ...
                        <input class="form-control date-picker" id="date" type="text" autocomplete="off" name="date" value="<?php echo e(@App\SysHelper::normalizeToDmy($ctrl_date)); ?>">
                    </div>
                    <div class="col-1-5">
                        <label for="" class="form-label">To Date</label>
                        <input class="form-control date-picker" id="date2" type="text" autocomplete="off" name="date2" value="<?php echo e(@App\SysHelper::normalizeToDmy($ctrl_date2)); ?>">
                    </div>

                     <div class="col-1-5">
                        <label for="" class="form-label">Follow Up</label>
                        <input class="form-control date-picker" id="followup" type="text" autocomplete="off" name="followup" value="<?php echo e(@$ctrl_followup); ?>">
                    </div>
                    ...
                    <div class="col-1-5">
                        ...
                        <select class="form-control" name="isproject_id" id="isproject_id">
                            <option value="">-Select-</option>
                            <option value="1" <?php if(@$ctrl_isproject == "1"): ?> selected <?php endif; ?> >Project</option>
                            <option value="2" <?php if(@$ctrl_isproject == "2"): ?> selected <?php endif; ?> >Channel</option>
                            <option value="3" <?php if(@$ctrl_isproject == "3"): ?> selected <?php endif; ?> >Corporate</option>
                            <option value="4" <?php if(@$ctrl_isproject == "4"): ?> selected <?php endif; ?> >Ecommerce</option>
                            <option value="0" <?php if(@$ctrl_isproject == "0"): ?> selected <?php endif; ?> >Lead</option>
                            <option value="5" <?php if(@$ctrl_isproject == "5"): ?> selected <?php endif; ?> >Marketing</option>
                        </select>
                    </div>
                    <div class="col-1-5">
                        ...
                        <select class="form-control" name="stage_id" id="stage_id">
                            <option value="">-Select-</option>
                            <option value="1" <?php if($ctrl_stage == 1): ?> selected <?php endif; ?>>Prospecting</option>
                            <option value="2" <?php if($ctrl_stage == 2): ?> selected <?php endif; ?>>Quote</option>
                            <option value="3" <?php if($ctrl_stage == 3): ?> selected <?php endif; ?>>Closure</option>
                            <option value="4" <?php if($ctrl_stage == 4): ?> selected <?php endif; ?>>Won</option>
                            <option value="5" <?php if($ctrl_stage == 5): ?> selected <?php endif; ?>>Lost</option>
                            <option value="6" <?php if($ctrl_stage == 6): ?> selected <?php endif; ?>>completed</option>
                            <option value="7" <?php if($ctrl_stage == 7): ?> selected <?php endif; ?>>On Process</option>
                            <option value="8" <?php if($ctrl_stage == 8): ?> selected <?php endif; ?>>Cancelled</option>
                        </select>
                    </div>
                    <div class="col-1-5">
                        ...
                        <select class="form-control" name="source_id" id="source_id">
                            <option value="">-Select-</option>
                            <option value="Gitex 2023" <?php if($ctrl_source == "Gitex 2023"): ?> selected <?php endif; ?>>Gitex 2023</option>
                            <option value="Gitex" <?php if($ctrl_source == "Gitex"): ?> selected <?php endif; ?>>Gitex</option>
                            <option value="Chat" <?php if($ctrl_source == "Chat"): ?> selected <?php endif; ?>>Chat</option>
                            <option value="Call" <?php if($ctrl_source == "Call"): ?> selected <?php endif; ?>>Call</option>
                            <option value="Mail" <?php if($ctrl_source == "Mail"): ?> selected <?php endif; ?>>Mail</option>
                            <option value="Fulfillment" <?php if($ctrl_source == "Fulfillment"): ?> selected <?php endif; ?> >Fulfillment</option>
                            <option value="Ecommerce" <?php if($ctrl_source == "Ecommerce"): ?> selected <?php endif; ?> >Ecommerce</option>
                            <option value="Other" <?php if($ctrl_source == "Other"): ?> selected <?php endif; ?>>Other</option>
                        </select>
                    </div>
            ...
            <?php echo e(Form::close()); ?>
                        ...
                        <table class="table table-hover mt-2 data-table table-fixed-header" id="long-list" style="table-layout: fixed;width:100%">
                            <thead>
                                <tr>
                            <th style="width: 80px;" class="text-center"><?php echo app('translator')->getFromJson('Deal No'); ?></th>
                            <th class="text-center" style="width: 70px;"><?php echo app('translator')->getFromJson('Date'); ?></th>
                            <th style="width: 150px;"><?php echo app('translator')->getFromJson('Customer'); ?></th>
                            <th style="width: 150px;"><?php echo app('translator')->getFromJson('Deal Name'); ?></th>
                            <th style="width: 120px;"><?php echo app('translator')->getFromJson('Sales Person'); ?></th>

                            <th style="width: 120px" class="text-end"><?php echo app('translator')->getFromJson('Deal Value'); ?></th>
                            <th style="width: 120px;" class="text-end"><?php echo app('translator')->getFromJson('Deal Profit'); ?></th>

                            <th  style="width: 100px;"><?php echo app('translator')->getFromJson('Stage'); ?></th>
                            ...
                            <th class="text-center" style="width: 75px;"><?php echo app('translator')->getFromJson('Updated On'); ?></th>
                            <th class="text-center" style="width: 80px;"><?php echo app('translator')->getFromJson('Closing Date'); ?></th>
                            <th class="text-center" style="width: 75px;"><?php echo app('translator')->getFromJson('Actions'); ?></th>
        ...
        $deal_currency = "AED"; ?>
                        <?php $__currentLoopData = $deals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if((@$value->estimated_close_date <= Carbon\Carbon::today()) && ($value->stage == 1 || $value->stage == 2 || $value->stage == 3)): ?>
                                        <tr class="<?php echo e($value->deleted_at ? 'bg-dark' : ''); ?>" style="background-color:#ffebeb !important; color:#ff0000;">
                                    <?php else: ?>
                                        <tr class="<?php echo e($value->deleted_at ? 'bg-dark' : ''); ?>">
                                    <?php endif; ?>
                                        <td class="text-center no-toggle"><a class="data-item" onclick="list_style_new()" data-id="<?php echo e($value->id); ?>"><?php echo e(@$value->code); ?></a></td>
                                        <td class="text-center"><?php echo e(date('d/m/Y', strtotime(@$value->date))); ?></td>
                                        <td><?php echo e($value->customername->code); ?> - <?php echo e(@$value->customername->name); ?></td>
                                        <td><?php echo e(@$value->deal_name); ?></td>
                                        <td><?php echo e(@$value->ownername->full_name); ?></td>
                                          <td class="text-end" >
                                            <?php $aed = $value->deal_value; ?>
                                            <?php echo e(@App\SysHelper::currancy_format_deal($aed,$value->company_id)); ?>

                                            <?php $total_amount += $aed; ?> <?php echo e($value->dealcurrency->code); ?> <?php        $deal_currency = $value->dealcurrency->code; ?>
                                        </td>
                                        <td class="text-end"><?php echo e(@App\SysHelper::currancy_format_deal($value->deal_profit,$value->company_id)); ?> <?php echo e($value->dealcurrency->code); ?>
...
?>
                                            <?php if($value->stage == 1): ?> <span class="badge bg-primary py-1 px-2">Prospecting</span> <span><?php echo e($followupDate); ?></span> <?php endif; ?>
                                            <?php if($value->stage == 2): ?> <span class="badge bg-warning py-1 px-2">Quote</span> <span><?php echo e($followupDate); ?></span> <?php endif; ?>
                                            <?php if($value->stage == 3): ?> <span class="badge bg-info py-1 px-2">Closure</span> <?php endif; ?>
                                            ...
                                            <span class="badge bg-success py-1 px-2">Won</span><?php endif; ?>

                                            <?php if(App\SysHelper::set_track($value->id) == 1): ?>
                                                <a class="badge bg-<?php echo e($color); ?>  py-1 px-2 <?php if($data == "Fulfill"): ?> <?php else: ?> deal-track-sales-person <?php endif; ?>" <?php if($data == "Fulfill"): ?> href="<?php echo e(url('crm-deals/'.$value->id.'/edit')); ?>" <?php endif; ?> onclick="list_style_new()" data-id="<?php echo e($value->id); ?>"  title="Click to Fullfill">
                                                <?php if($data == "Fulfill"): ?><span class="spinner-grow spinner-grow-sm text-capatalize" role="status" aria-hidden="true"></span><?php endif; ?> <?php echo e($data); ?> </a>
                                            <?php endif; ?>

                                            <?php endif; ?>
                                            <?php if($value->stage == 5): ?> <span class="badge bg-danger py-1 px-2">Lost</span> <?php endif; ?>
                                            <?php if($value->stage == 6): ?> <span class="badge bg-secondary py-1 px-2">Cancelled</span> <?php endif; ?>
                                        </td>
                                        ...
                                        <td class="text-center">&nbsp;&nbsp; <?php echo e(date('d/m/Y h:i A', strtotime(@$value->updated_at))); ?></td>
                                        <td class="text-center">&nbsp; <?php echo e(date('d/m/Y', strtotime(@$value->estimated_close_date))); ?></td>
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center">
                                                      <a class="btn btn-sm btn-light open-comments-modal" style="cursor: pointer;"
                                                                data-deal-id="<?php echo e($value->id); ?>"><i class="ico icon-outline-chat-round-dots" style="font-size:16px" aria-hidden="true"></i></a>
                                            <a class="btn btn-sm btn-light" href="<?php echo e(url('crm-quote/'.$value->id.'/download/'.$value->quote_id)); ?>"><i class="ico icon-bold-download-minimalistic text-dark" style="font-size: 16px;"></i></a>
                                                <?php if(Auth::user()->role_id == 1): ?>
                                                <?php if($value->deleted_at): ?>
                                                    <button data-id="<?php echo e($value->id); ?>" data-bs-toggle="modal" data-bs-target="#restoreModal" type="button"
                                                ...
                                                <?php else: ?>
                                                    <button type="button" class="btn btn-sm btn-light open-delete-modal" data-id="<?php echo e($value->id); ?>" data-bs-toggle="modal"
                        ...
                        <tr>
                            <td colspan="11" class="text-center border-0">
                                <div class="d-flex justify-content-center mt-3">
                                    <?php echo e($deals->appends(request()->input())->links()); ?>
    ...
    $(document).on('click', '.data-item', function () {
        ...
        $(this).addClass('active');
           ...
           var newUrl = "<?php echo e(url('crm-deals/show')); ?>/" + id;
                        window.history.pushState({
                            path: newUrl
                        }, '', newUrl);

        var action = "<?php echo e(URL::to('crm-deals-details')); ?>/" + id;
...
$(document).ready(function(){
    ...
    $('#search_invoice').on('input', function(){
        ...
        $.ajax({
            url: "<?php echo e(route('crm-deals.search')); ?>",
            type: "GET",
            data: { query: query },
...
<script>
   function loadDealTrackDetails(id) {
    ...
    // Ajax load
    var action = "<?php echo e(URL::to('crm-deal-track')); ?>/" + id + "/view";
        ...
        $.ajax({            
            ...
            complete: function () {
                ...
                <?php if($action === 'add'): ?>
                    ...
                    <?php echo $__env->make('backEnd.crm.DealForm_add', $addData, \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>

                      
                <?php elseif($action === 'edit'): ?>
              
                    <?php echo $__env->make('backEnd.crm.DealFormEdit_edit', $editData, \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>

                    
                <?php elseif(!empty($selectedDeal) && is_array($selectedDeal)): ?>
                    <?php echo $__env->make('backEnd.crm.DealList_details', $selectedDeal, \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php else: ?>
                    ...
                    <div class="container-fluid d-flex flex-column justify-content-center align-items-center"
                        ...
                        <!-- Icon + Heading -->
                                 <a href="<?php echo e(url('crm-deals/show?deal_action=add')); ?>" class="text-decoration-none text-dark">
...
<script> 
            ...
            var actionUrl = "<?php echo e(url('crm-deals')); ?>/" + leadId + "/delete";
            $('#deleteForm').attr('action', actionUrl);
        });

        $(document).on('click', '.open-restore-modal', function () {
            var leadId = $(this).data('id');
            var actionUrl = "<?php echo e(url('crm-deals')); ?>/" + leadId + "/restore";
...
$(document).ready(function () {
    $('#exportExcelDeals').on('click', function (e) {
        ...
        var totalDeals = <?php echo json_encode($deals->count() ?? 0, 15, 512) ?>;
