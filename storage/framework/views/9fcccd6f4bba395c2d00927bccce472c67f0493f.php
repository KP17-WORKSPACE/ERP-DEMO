        ...
        <div class="long-list" id="filters-long">
            <div class="d-flex align-items-center justify-content-between">
                <div class="dropdown report-type-dropdown">
                    ...
                    ?>
                    <a class="text-dark report-type-trigger" href="javascript:void(0);" id="inventorySalesPersonReportTypeMenu"
                        data-bs-toggle="dropdown" aria-expanded="false">
                        Inventory Report Type <i class="icon-outline-alt-arrow-down ms-1"></i>
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="inventorySalesPersonReportTypeMenu">
            ...
            <div class="search-filter-container mt-1 mb-4 filter-field d-none border">
                <div class="card" style="width: 100%">
                    <div class="card-body">
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'inventory-salesperson-wise-report', 'method' => 'POST', 'id' => 'inventory-salesperson-wise-report'])); ?>
        ...
        <div class="left-nav-list">
            <div class="table-responsive mb-4 mt-4">
                <table id="long-list" class="table table-hover data-table" style="table-layout: fixed;width:100%">
                    ...
                    <tbody>
                        <?php
                            $company_wise_base_query = [
                                'from_date' => $from_date ?? '',
                                'to_date' => $to_date ?? '',
                                'supplier' => $ctrl_supplier ?? '',
                            ];
                        ?>
                        <?php $__empty_1 = true; $__currentLoopData = $salesperson_report_rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php
                                $q = $company_wise_base_query;
                                $q['sales_person'] = $row->sales_person_id;
                                $companyWiseUrl = url('inventory-company-wise-report') . '?' . http_build_query(array_filter($q, function ($v) {
                                    return $v !== '' && $v !== null;
                                }));
                            ?>
                            <tr>
                                <td class="text-center"><?php echo e($loop->iteration); ?></td>
                                <td><a href="<?php echo e($companyWiseUrl); ?>"><?php echo e($row->sales_person_name); ?></a></td>
