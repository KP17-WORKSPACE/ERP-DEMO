    ...
    <aside class="left-nav col-3" id="leftSidebar">
        ...
        <div class="short-list" id="filters-short">
            ...
            ?>
                ...
                <?php if($statusLabel != ''): ?>
                    <span class="text-<?php echo e($statusLabel['color']); ?>">(<?php echo e($statusLabel['label']); ?>)</span>
                <?php endif; ?>
            </h4>
                ...
                <div class="search-filter-container mb-0 d-flex align-items-center justify-content-center">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" style="">
                            ...
                            <li>
                                <a
                                    href="<?php echo e(url('crm-leads-report-company')); ?>"class="dropdown-item d-flex align-items-center"><i
            ...
            <div class="search-filter-container mt-1 mb-4 filter-field d-none border">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'crm-leads/show', 'method' => 'get', 'id' => 'crm-leads-search2'])); ?>
                        ...
                        <div class="row">
                                ...
                                <select class="form-control js-example-basic-single" name="company_id" id="company_id">
                                    ...
                                    <?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e(@$value->id); ?>"
                                            <?php if($ctrl_cust_id == $value->id): ?> selected <?php endif; ?>>
                            ...
                            <div class="col-1-5 mb-2 filter-field d-none">
                                ...
                                <select class="form-control js-example-basic-single" name="region_id" id="region_id">
                                    <option value="" <?php if($ctrl_status == ''): ?> selected <?php endif; ?>>-Select-
                                    </option>
                                    <?php $__currentLoopData = $country; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php if($ctrl_region_id == $value->id): ?> selected <?php endif; ?>
                                ...
                                <select class="form-control js-example-basic-single" name="brand_id" id="brand_id">
                                    ...
                                    <?php $__currentLoopData = $brand; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e(@$value->title); ?>"
                                            <?php if($ctrl_brand == $value->title): ?> selected <?php endif; ?>>
                            ...
                            <?php if(Auth::user()->role_id == 1 || Auth::user()->role_id == 35): ?>
                                    ...
                                    <select class="form-control js-example-basic-single" name="owner_id" id="owner_id">
                                        ...
                                        <?php $__currentLoopData = $staff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e(@$value->user_id); ?>"
                                                <?php if($ctrl_owner == $value->user_id): ?> selected <?php endif; ?>><?php echo e(@$value->full_name); ?>
                            ...
                            <div class="col-1-5 mb-2 filter-field d-none">
                                ...
                                <select class="form-contro js-example-basic-single" name="status_id" id="status_id">
                                    ...
                                    <option value="1" <?php if($ctrl_status == 1): ?> selected <?php endif; ?>>New</option>
                                    <option value="2" <?php if($ctrl_status == 2): ?> selected <?php endif; ?>>Qualified
                                    </option>
                                    <option value="3" <?php if($ctrl_status == 3): ?> selected <?php endif; ?>>Unqualified
                                    </option>
                                    <option value="4" <?php if($ctrl_status == 4): ?> selected <?php endif; ?>>Pending
                                        Response
                                    </option>
                                    <option value="10" <?php if($ctrl_status == 10): ?> selected <?php endif; ?>>Closed
                                    </option>
                                    <option value="5" <?php if($ctrl_status == 5): ?> selected <?php endif; ?>>Converted
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-1-5 mb-2 filter-field d-none">
                                ...
                                <select class="form-control js-example-basic-single" name="source_id" id="source_id">
                                    <option value="">-Select-</option>
                                    <option value="Gitex 2023" <?php if($ctrl_source == 'Gitex 2023'): ?> selected <?php endif; ?>>Gitex
                                        2023
                                    </option>
                                    <option value="Gitex" <?php if($ctrl_source == 'Gitex'): ?> selected <?php endif; ?>>Gitex
                                    </option>
                                    <option value="Chat" <?php if($ctrl_source == 'Chat'): ?> selected <?php endif; ?>>Chat
                                    </option>
                                    <option value="Call" <?php if($ctrl_source == 'Call'): ?> selected <?php endif; ?>>Call
                                    </option>
                                    <option value="Mail" <?php if($ctrl_source == 'Mail'): ?> selected <?php endif; ?>>Mail
                                    </option>
                                    <option value="Ecommerce" <?php if($ctrl_source == 'Ecommerce'): ?> selected <?php endif; ?>>Ecommerce
                                    </option>
                                    <option value="Other" <?php if($ctrl_source == 'Other'): ?> selected <?php endif; ?>>Other
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-1-5 mb-2 filter-field d-none">
                                ...
                                <select class="form-control js-example-basic-single" name="isproject_id" id="isproject_id">
                                    <option value="">-Select-</option>
                                    <option value="1" <?php if(@$ctrl_isproject == '1'): ?> selected <?php endif; ?>>Project
                                    </option>
                                    <option value="2" <?php if(@$ctrl_isproject == '2'): ?> selected <?php endif; ?>>Channel
                                    </option>
                                    <option value="3" <?php if(@$ctrl_isproject == '3'): ?> selected <?php endif; ?>>Corporate
                                    </option>
                                    <option value="0" <?php if(@$ctrl_isproject == '0'): ?> selected <?php endif; ?>>Lead
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-1-5 mb-2 filter-field d-none">
                                ...
                                <input class="form-control date-picker" id="followupdt_filter" type="text"
                                    ...
                                    value="<?php echo e($ctrl_followupdt_filter ? \Carbon\Carbon::parse($ctrl_followupdt_filter)->format('d/m/Y') : ''); ?>">
                            </div>
        ...
        <div class="left-nav-list">
                ...
                <?php if(count($leads) > 0): ?>
                    ...
                    <?php $__currentLoopData = $leads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="nav-item w-100" role="presentation">
                            <button class="nav-link lead-item <?php echo e($active_id == $item->id ? 'active' : ''); ?>"
                                data-id="<?php echo e($item->id); ?>" id="purchase-order-1-tab" data-bs-toggle="tab"
                                ...
                                <div class="row w-100">
                                      ...
                                      <div class="col-12">
                                        <label class="form-control-plaintext truncate-text">
                                            <?php echo e(@$item->customername->customer_name_display); ?>  
                                        
                                            <?php if(@App\SysHelper::getCompanyCodeSettings()['is_customer_code']): ?>
                                            (<?php echo e(@$item->customername->code); ?>)
                                            <?php endif; ?>
                                        </label>
                                    </div>
                                    ...
                                    <div class="col-4 text-center">
                                        <div class="form-control-plaintext" style="font-size:11px">
                                            <?php echo e(date('d/m/Y', strtotime(@$item->created_at))); ?></div>
                                    </div>
            ...
            <?php if(!empty($lead_stats['statusCounts'])): ?>
                        ...
                        <div class="row ">
                                ...
                                <div class="task-card-count ">
                                    <div class="filter-by-status" data-status-id="1" style="cursor:pointer;">
                                        ...
                                        <h5 class="task-title text-muted">New</h6>
                                            <div id="totalTasks" class="task-count">
                                                <?php echo e($lead_stats['statusCounts'][1] ?? 0); ?>

                                                (<?php echo e($lead_stats['total_leads'] > 0 ? round((($lead_stats['statusCounts'][1] ?? 0) / $lead_stats['total_leads']) * 100, 2) : 0); ?>%)
                                            </div>
                                    </div>
                                    <div class="sub-status collapse" id="newCollapse">
                                        <div class="sub-status-div" data-sub-status-id="1"><span
                                                ...
                                                <?php echo e($lead_stats['sub_statusCounts'][1] ?? 0); ?></span></div>
                                    </div>
                            ...
                            <div class="col-md-3 border  border-start-0" style="cursor:pointer;">
                                <div class="task-card-count  ">
                                    <div class="filter-by-status" data-status-id="4">
                                        ...
                                        <div id="dueToday" class="task-count"><?php echo e($lead_stats['statusCounts'][4] ?? 0); ?>

                                            (<?php echo e($lead_stats['total_leads'] > 0 ? round((($lead_stats['statusCounts'][4] ?? 0) / $lead_stats['total_leads']) * 100, 2) : 0); ?>%)
                                        </div>
                                    </div>
                                    <div class="sub-status collapse" id="pendingCollapse">
                                        <div class="sub-status-div" data-sub-status-id="9"><span
                                                ...
                                                for
                                                EUD</span><span
                                                class="sub-status-value"><?php echo e($lead_stats['sub_statusCounts'][9] ?? 0); ?></span>
                                        </div>
                                        ...
                                        <div class="sub-status-div" data-sub-status-id="10"><span
                                                ...
                                                for Vendor
                                                Price</span><span
                                                class="sub-status-value"><?php echo e($lead_stats['sub_statusCounts'][10] ?? 0); ?></span>
                                        </div>
                                        <div class="sub-status-div" data-sub-status-id="11"><span
                                                ...
                                                Waiting for
                                                Response</span><span
                                                class="sub-status-value"><?php echo e($lead_stats['sub_statusCounts'][11] ?? 0); ?></span>
                                        </div>
                                        <div class="sub-status-div" data-sub-status-id="12"><span
                                                class="sub-status-title">Other
                                                Reasons</span><span
                                                class="sub-status-value"><?php echo e($lead_stats['sub_statusCounts'][12] ?? 0); ?></span>
                                        </div>
                                    </div>
                                ...
                                <div class="task-card-count ">
                                    <div class="filter-by-status" data-status-id="2">
                                        ...
                                        <div id="dueTasks" class="task-count">
                                            <?php echo e(($lead_stats['statusCounts'][2] ?? 0) + ($lead_stats['statusCounts'][0] ?? 0)); ?>

                                            (<?php echo e($lead_stats['total_leads'] > 0 ? round(((($lead_stats['statusCounts'][2] ?? 0) + ($lead_stats['statusCounts'][0] ?? 0)) / $lead_stats['total_leads']) * 100, 2) : 0); ?>%)
                                        </div>
                                    </div>
                                ...
                                <div class="task-card-count  ">
                                    <div class="filter-by-status" data-status-id="3">
                                        ...
                                        <div id="notStartedCount" class="task-count">
                                            <?php echo e($lead_stats['statusCounts'][3] ?? 0); ?>

                                            (<?php echo e($lead_stats['total_leads'] > 0 ? round((($lead_stats['statusCounts'][3] ?? 0) / $lead_stats['total_leads']) * 100, 2) : 0); ?>%)
                                        </div>
                                    </div>
                                    <div class="sub-status collapse" id="unqualifiedCollapse">
                                        <div class="sub-status-div" data-sub-status-id="3"><span
                                                ...
                                                Issue</span><span
                                                class="sub-status-value"><?php echo e($lead_stats['sub_statusCounts'][3] ?? 0); ?></span>
                                        </div>
                                        <div class="sub-status-div" data-sub-status-id="4"><span
                                                class="sub-status-title">Not
                                                Interested</span><span
                                                class="sub-status-value"><?php echo e($lead_stats['sub_statusCounts'][4] ?? 0); ?></span>
                                        </div>
                                        <div class="sub-status-div" data-sub-status-id="5"><span
                                                class="sub-status-title">Wrong
                                                Contact</span><span
                                                class="sub-status-value"><?php echo e($lead_stats['sub_statusCounts'][5] ?? 0); ?></span>
                                        </div>
                                        <div class="sub-status-div" data-sub-status-id="6"><span
                                                class="sub-status-title">Timeline
                                                not matching</span><span
                                                class="sub-status-value"><?php echo e($lead_stats['sub_statusCounts'][6] ?? 0); ?></span>
                                        </div>
                                        <div class="sub-status-div" data-sub-status-id="7"><span
                                                class="sub-status-title">Product/Service
                                                mismatch</span><span
                                                class="sub-status-value"><?php echo e($lead_stats['sub_statusCounts'][7] ?? 0); ?></span>
                                        </div>
                                        <div class="sub-status-div" data-sub-status-id="8"><span
                                                class="sub-status-title">Other
                                                Reason</span><span
                                                class="sub-status-value"><?php echo e($lead_stats['sub_statusCounts'][8] ?? 0); ?></span>
                                        </div>
                                    </div>
                                ...
                                <div class="task-card-count ">
                                    <div class="filter-by-status" data-status-id="10">
                                        ...
                                        <div id="inProgressCount" class="task-count">
                                            <?php echo e($lead_stats['statusCounts'][10] ?? 0); ?>

                                            (<?php echo e($lead_stats['total_leads'] > 0 ? round((($lead_stats['statusCounts'][10] ?? 0) / $lead_stats['total_leads']) * 100, 2) : 0); ?>%)
                                        </div>
                                    </div>
                                    <div class="sub-status collapse" id="closedCollapse">
                                        <div class="sub-status-div" data-sub-status-id="13"><span
                                                ...
                                                Response</span><span
                                                class="sub-status-value"><?php echo e($lead_stats['sub_statusCounts'][13] ?? 0); ?></span>
                                        </div>
                                        <div class="sub-status-div" data-sub-status-id="14"><span
                                                class="sub-status-title">Other
                                                Reason</span><span class="sub-status-value">
                                                <?php echo e($lead_stats['sub_statusCounts'][14] ?? 0); ?></span>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-3 border  border-start-0">
                                ...
                                <div class="task-card-count  ">
                                    ...
                                    <div id="completedCount" class="task-count"><?php echo e($lead_stats['total_leads'] ?? 0); ?>
                            ...
                            <div class="col-md-3 border  border-start-0">
                                ...
                                <div class="task-card-count  ">
                                    ...
                                    <div id="completedCount" class="task-count"><?php echo e($lead_stats['avg_aging_days'] ?? 0); ?>
...
$(document).ready(function () {
        ...
        setManualWidths(currentView);
            ...
            <div class="table-responsive mb-4 mt-2">
                ...
                <table id="long-list" class="table table-hover data-table d-none table-fixed-header" style="table-layout: fixed;width:100%">
                    ...
                    <thead class="">
                        <tr>
                            <th class="text-center" style="width:80px"><?php echo app('translator')->getFromJson('Lead No'); ?></th>
                            <th class="text-center" style="width:80px"><?php echo app('translator')->getFromJson('Deal No'); ?></th>
                            <th class="text-center" data-column="date" style="width:80px"><?php echo app('translator')->getFromJson('Date'); ?></th>
                            <th style="width:150px"><?php echo app('translator')->getFromJson('Customer'); ?></th>
                            <th style="width:150px"><?php echo app('translator')->getFromJson('Lead Name'); ?></th>

                            <th style="width:100px"><?php echo app('translator')->getFromJson('Sales Person'); ?></th>
                            <th style="width: 50px"><?php echo app('translator')->getFromJson('Brand'); ?></th>

                            <th style="width:150px"><?php echo app('translator')->getFromJson('Status'); ?></th>
                            <th style="width:100px"><?php echo app('translator')->getFromJson('Sub Status'); ?></th>
                            <th style="width:50px" class="text-center"><?php echo app('translator')->getFromJson('Source'); ?></th>


                            <?php if(session('logged_session_data.company_id') == 1): ?>
                                <th class="col-hideable" style="width: 80px;"><?php echo app('translator')->getFromJson('Company'); ?></th>
                            <?php endif; ?>
                            <th class="col-hideable" data-column="region" style="width:50px"><?php echo app('translator')->getFromJson('Region'); ?></th>
                            <th class="col-hideable" data-column="updated" style="width:80px"><?php echo app('translator')->getFromJson('Updated On'); ?></th>
                            <th class="col-hideable" data-column="aging" style="width:50px"><?php echo app('translator')->getFromJson('Aging Days'); ?></th>
                            <th class="col-hideable" data-column="followups" style="width:50px"><?php echo app('translator')->getFromJson('Followups'); ?></th>
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $leads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr <?php if($value->status == 4): ?> <?php if($value->follow_up_date): ?>
                                <?php if(\Carbon\Carbon::parse($value->follow_up_date)->isToday()): ?>
                                ...
                                !important; color:#ff0000;" <?php endif; ?>
                                <?php endif; ?>
                        <?php endif; ?>

                        <?php if($value->deleted_at): ?> style="background-color:rgba(0, 0, 0, 0.19)" <?php endif; ?>>
                        <td class="text-center"><a class="lead-item" data-id="<?php echo e($value->id); ?>"
                                onclick="list_style_new()"><?php echo e(@$value->code); ?></a>
                        </td>
                        ...
                        <td class="text-center">
                            ...
                            <?php if($code): ?>
                                <a
                                    href="<?php echo e(url('crm-deals/show/' . $value->lead_deal_code->id)); ?>"><?php echo e($code); ?></a>
                            <?php else: ?>
                                --
                            <?php endif; ?>
                        ...
                        <td class="text-center" data-column="date"><?php echo e(date('d/m/Y', strtotime(@$value->created_at))); ?>

                            <?php echo e(date('h:i A', strtotime(@$value->created_at))); ?>
                        ...
                        <td>
                            ...
                            <?php if($value->status == 4): ?>
                                ...
                                <?php if($value->follow_up_date): ?>
                                    <span class="text-dark">Follow Up Date:
                                        <?php echo e($value->follow_up_date ? date('d/m/Y', strtotime(@$value->follow_up_date)) : ''); ?>
                            ...
                            <?php if($value->status == 0): ?>
                                ...
                                <?php if($d && $d->stage == 4): ?>
                                    ...
                                    <?php if($data != 'completed'): ?>
                                        ...
                                        <span class="badge bg-success text-capitalize"><?php echo e($data); ?></span>
                                    <?php else: ?>
                                        <span class="badge bg-success text-capitalize"><?php echo e($data); ?></span>
                                    <?php endif; ?>
                                <?php endif; ?>
                        ...
                        <td class="ellipsis-cell">
                            <?php if($value->sub_status == 8 || $value->sub_status == 12 || $value->sub_status == 14): ?>

                                <?php if($value->sub_status_comment): ?>
                                    <span class="badge <?php echo e($color); ?>"><?php echo e($value->sub_status_comment); ?></span>
                                <?php endif; ?>
                            <?php else: ?>
                                <?php if(isset($subStatusMap[$value->sub_status])): ?>
                                    <span class="badge <?php echo e($color); ?>">
                                        <?php echo e($subStatusMap[$value->sub_status]); ?>
                        ...
                        <?php if(session('logged_session_data.company_id') == 1): ?>
                            <td class="col-hideable"><?php echo e($value->company->company_name ?? ''); ?></td>
                        <?php endif; ?>
                        ...
                        <td class="col-hideable" data-column="region">
                            <?php echo e(@$value->customername->vatcountry->name); ?>

                        </td>

            
                        
                        <td class="text-center col-hideable" data-column="updated"><?php echo e(date('d/m/Y', strtotime(@$value->updated_at))); ?>

                            <?php echo e(date('h:i A', strtotime(@$value->updated_at))); ?>

                        </td>
                        <td class="text-center col-hideable" data-column="aging"><?php echo e($value->getAgingDays() > 0 ? $value->getAgingDays() : ''); ?></td>
                        <td class="text-center col-hideable" data-column="followups"><?php echo e($value->followup_count ?? ''); ?></td>

                        <td class="">

                            <div class="d-flex justify-content-center align-items-center">
                                <a class="btn btn-sm btn-light open-comments-modal" style="cursor: pointer;"
                                    data-lead-id="<?php echo e($value->id); ?>"><i class="ico icon-outline-chat-round-dots"
                                        style="font-size:16px" aria-hidden="true"></i></a>



                                <a href="<?php echo e(url('crm-leads/show/' . $value->id . '?lead_action=edit')); ?>" data-id="<?php echo e($value->id); ?>" class="btn btn-sm btn-light edit-lead-btn"><i
                                        class="ico icon-outline-pen-2 text-dark" style="font-size: 16px;"></i></a>


                                <?php if(Auth::user()->role_id == 1): ?>
                                    <?php if($value->deleted_at): ?>
                                        <button data-id="<?php echo e($value->id); ?>" data-bs-toggle="modal"
                                    ...
                                    <?php else: ?>
                                        <button type="button" class="btn btn-sm btn-light open-delete-modal"
                                            data-id="<?php echo e($value->id); ?>" data-bs-toggle="modal"
                        ...
                        <tr>
                            <td colspan="15" class="text-center border-0">
                                <div class="d-flex justify-content-center mt-3">
                                    <?php echo e($leads->appends(request()->input())->links()); ?>
    ...
    <div class="content-container col-9">
        <div class="tab-content display-flex-tabs" id="purchaseOrderTabContent">
                ...
                $(document).ready(function() {
                    ...
                    $(document).on('click', '.lead-item', function() {
                        ...
                        // }, '', newUrl);
                              ...
                              var newUrl = "<?php echo e(url('crm-leads/show')); ?>/" + id;
                        window.history.pushState({
                            path: newUrl
                        }, '', newUrl);


                        var action = "<?php echo e(URL::to('crm-leads')); ?>/" + id + "/view";
                        $('#loading_bg').show();
            ...
            <div class="" role="tabpanel" aria-labelledby="po-tab" id="leads-details">
                <?php if($action === 'add'): ?>
                    <?php echo $__env->make('backEnd.crm.LeadAdd', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php elseif($action === 'edit'): ?>
                    <?php echo $__env->make('backEnd.crm.LeadEdit', $editData, \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>

                    
                <?php elseif(!empty($selectedLead) && is_array($selectedLead)): ?>
                    <?php echo $__env->make('backEnd.crm.LeadView', $selectedLead, \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php else: ?>
                    ...
                    <div class="container-fluid d-flex flex-column justify-content-center align-items-center"
                        ...
                        <!-- Icon + Heading -->
                       <a href="<?php echo e(url('crm-leads/show?lead_action=add')); ?>" class="text-decoration-none text-dark">
    ...
    <script>
                        ...
                        if (res.data && res.data.length > 0) {
                            $.each(res.data, function(i, comment) {
                                ...
                                var row = `
                                    ...
                                    href="<?php echo e(asset('public/uploads/crm_lead_doc/')); ?>/${comment.commentsdoc}"
                                    target="_blank"><i class="ico icon-bold-paperclip text-success" style="font-size:16px"
                                        aria-hidden="true"></i></a>` : ''}
                                                            ` : `
                                                            ${comment.commentsdoc ? ` <a class=" p-0"
                                    href="<?php echo e(asset('public/uploads/crm_deal_doc/')); ?>/${comment.commentsdoc}"
                                    target="_blank"><i class="ico icon-bold-paperclip text-success" style="font-size:16px"
                                        aria-hidden="true"></i></a>` : ''}
                                                            `}</td>
        ...
        $(document).on('click', '.open-delete-modal', function() {
            ...
            var actionUrl = "<?php echo e(url('crm-leads')); ?>/" + leadId + "/delete";
            $('#deleteForm').attr('action', actionUrl);
        });

        $(document).on('click', '.open-restore-modal', function() {
            var leadId = $(this).data('id');
            var actionUrl = "<?php echo e(url('crm-leads')); ?>/" + leadId + "/restore";
                    ...
                    $('#commentsModalBody').append(
                        ` <tr>
                                        ...
                                        ${newComment.commentsdoc ? ` <a class=" p-0"
                                                                href="<?php echo e(asset('public/uploads/crm_lead_doc/')); ?>/${ newComment.commentsdoc }"
        ...
        $(document).ready(function() {
            ...
            const selectedSubStatus = <?php echo json_encode($ctrl_sub_status ?? '', 15, 512) ?>;
    ...
    $(document).ready(function () {
        $('#exportExcelLeads').on('click', function (e) {
            ...
            var totalLeads  = <?php echo json_encode($leads->count() ?? 0, 15, 512) ?>;
        ...
        new Chart(document.getElementById("statusPie"), {
            ...
            data: {
                ...
                datasets: [{
                    data: [
                        <?php echo e($lead_stats['statusCounts'][1] ?? 0); ?>,
                        <?php echo e($lead_stats['statusCounts'][4] ?? 0); ?>,
                        <?php echo e(($lead_stats['statusCounts'][2] ?? 0) + ($lead_stats['statusCounts'][0] ?? 0)); ?>,
                        <?php echo e($lead_stats['statusCounts'][3] ?? 0); ?>,
                        <?php echo e($lead_stats['statusCounts'][10] ?? 0); ?>
            ...
            data: {
                ...
                datasets: [{
                    data: [
                        <?php echo e($lead_stats['statusCounts'][1] ?? 0); ?>,
                        <?php echo e(($lead_stats['statusCounts'][2] ?? 0) + ($lead_stats['statusCounts'][0] ?? 0)); ?>,
                        <?php echo e($lead_stats['deals_statusCounts'][4] ?? 0); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#search_lead').on('input', function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('leads.search')); ?>",
                    type: "GET",
                    data: {
                        query: query
                    },
