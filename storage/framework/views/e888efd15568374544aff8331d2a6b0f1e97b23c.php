...
<div class="purchase-order-content-header sticky-top d-flex justify-content-between align-items-center" style="background-color: #f7f8fd">
    <div class="d-flex align-items-center">
        <h4 class="purchase-order-content-header-left mb-0">
            <?php echo e($leads->code); ?>

        </h4>

      
        <div class="pipeline-wrapper ms-2">
            <div class="pipeline-arrow <?php echo e($leads->status_info['color'] ?? 'secondary'); ?>"><?php echo e($leads->status_info['label'] ?? 'Unknown'); ?></div>

            <?php if(optional($edit->lead_deal_code)->code): ?>
            
                <div class="pipeline-arrow sky">
                    <a class="text-white" style="color: inherit; text-decoration: none;" href="<?php echo e(url('crm-deals/show/' . $edit->deal_id)); ?>">
                        <?php echo e($edit->lead_deal_code->code); ?>
    ...
    <div class="purchase-order-content-header-right d-flex align-items-center">
        ...
        <form method="GET" action="<?php echo e(url('crm-leads/show', @$edit->id)); ?>">
        ...
        <form method="GET" action="<?php echo e(url('crm-leads/show')); ?>">
        ...
        <div class="row">
            <div class="col-2">
                ...
                <div class="form-control-plaintext truncate-text-custom">
                    <?php echo e($leads->customername->customer_name_display); ?>
            ...
            <div class="col-2">
                ...
                <div class="form-control-plaintext truncate-text-custom">
                    <?php echo e($leads->ownername->first_name); ?> <?php echo e($leads->ownername->middle_name); ?>

                    <?php echo e($leads->ownername->last_name); ?>
            ...
            <div class="col-2">
                ...
                <div class="form-control-plaintext truncate-text-custom">
                    <?php echo e($leads->company->company_name); ?>
            ...
            <div style="cursor:pointer" data-bs-toggle="modal" data-bs-target="#updateLeadStatus" class="col-2 p-0">
                ...
                <div class="form-control-plaintext truncate-text-custom">
                    <p class="badge mb-1 bg-<?php echo e($leads->status_info['color']); ?> ">
                        <?php echo e($leads->status_info['label']); ?>

                    </p>

                    <?php if($leads->sub_status): ?>
                        <p class="badge <?php echo e($leads->sub_status_color); ?>">
                            <?php echo e($leads->sub_status_text); ?></p>
                    <?php endif; ?>
    ...
    <div class="card-body pb-0">
        ...
        <div class="row">
            ...
            <div class="col-2 mb-2">
                ...
                <div class="form-control-plaintext truncate-text-custom">
                    <?php echo e($leads->cust_name); ?>

                </div>
            </div>

            <?php if($edit->cust_designation != ''): ?>
                <div class="col-2 mb-2">
                    <label class="form-label">Designation:</label>
                    <div class="form-control-plaintext truncate-text-custom">
                        <?php echo e($edit->cust_designation); ?>
            ...
            <div class="col-2 mb-2">
                ...
                <div class="form-control-plaintext truncate-text-custom">
                    <?php echo e($leads->ownername->mobile); ?>
            ...
            <div class="col-2 mb-2">
                ...
                <div class="form-control-plaintext truncate-text-custom">
                    <?php echo e($leads->ownername->email); ?>
            ...
            <div class="col-2 mb-2 d-flex justify-content-between">
                <div style="width:48%">
                    ...
                    <div class="form-control-plaintext truncate-text-custom">
                        <?php echo e($edit->source); ?> <?php if($edit->source_o != ''): ?>
                            - <?php echo e($edit->source_o); ?>
                ...
                <div style="width:52%">
                    ...
                    <div class="form-control-plaintext truncate-text-custom">
                        <?php echo e($leadTypes[$edit->isproject] ?? 'N/A'); ?>
            ...
            <div class="col-2 mb-2">
                ...
                <div class="form-control-plaintext truncate-text-custom">
                    <?php echo e(@$leads->createdby->full_name); ?>
            ...
            <div class="col-2 mb-2">
                ...
                <div class="form-control-plaintext truncate-text-custom">
                    <?php echo e(date('d/m/Y h:i A', strtotime(@$leads->created_at))); ?>
            ...
            <div class="col-2 mb-2">
                ...
                <div class="form-control-plaintext truncate-text-custom">
                    <?php echo e(date('d/m/Y h:i A', strtotime(@$leads->updated_at))); ?>
            ...
            <?php if(optional($edit->lead_deal_code)->code): ?>
                <div style="cursor:pointer" class="col-2 mb-2">
                    ...
                    <div class="form-control-plaintext truncate-text-custom">
                        ...
                        <a class="fw-semibold" href="<?php echo e(url('crm-deals/show/' . $edit->deal_id)); ?>">
                            <?php echo e($edit->lead_deal_code->code); ?>
                ...
                <div class="col-2 mb-2">
                    ...
                    <div class="form-control-plaintext truncate-text-custom">
                        ...
                        <a class="btn-sm text-dark btn-light" data-bs-popover="popover" data-bs-trigger="hover"
                            data-bs-delay="500" data-bs-content="<?php echo e($leads->doc); ?>" data-bs-placement="top"
                            href="<?php echo e(asset('public/uploads/crm_lead_doc/')); ?>/<?php echo e($leads->doc); ?>"
                            target="_blank"><i
        ...
        <div class="tab-pane fade show active" id="internal-notes" role="tabpanel"
            ...
            <div class="row">
                                    ...
                                    <div class="card-body py-0">
                                        ...
                                        <div class="d-flex justify-content-between mb-0">
                                            ...
                                            <div class="d-flex align-items-baseline gap-2">
                                                <?php if($edit->doc): ?>
                                                    <a href="<?php echo e(asset('public/uploads/crm_lead_doc/' . $edit->doc)); ?>"
                                        ...
                                        <div class="text-end small text-muted">
                                            ...
                                            <span style="font-size:10px">
                                                ...
                                                <?php echo e($edit->createdby->first_name); ?> <?php echo e($edit->createdby->last_name); ?>
                                            ...
                                            <?php if($edit->deleted_at): ?>
                                                <span>•</span>

                                                <span class="text-danger" style="font-size:10px">
                                                    Deleted: <?php echo e(date('d/m/Y h:i A', strtotime($edit->deleted_at))); ?>
                                    ...
                                    <div class="card border-0 rounded-3 mb-2">
                                        <div class="card-body py-0">
                                            ...
                                            <div class="d-flex justify-content-between mb-0">
                                                ...
                                                <!-- Comment -->
                                                <p class="mb-0 fw-semibold text-break <?php if($cmts->deleted_at): ?> text-decoration-line-through text-muted <?php endif; ?>"
                                                ...
                                                <div class="d-flex align-items-baseline gap-2">
                                                    <?php if($cmts->commentsdoc): ?>
                                                        <a href="<?php echo e(asset('public/uploads/crm_lead_doc/' . $cmts->commentsdoc)); ?>"
                                                            target="_blank" class="btn btn-sm btn-light me-1"
                                                            style="min-height:17px">
                                                    ...
                                                    <?php if($cmts->created_by == Auth::user()->id): ?>
                                                        <?php if($cmts->deleted_at): ?>
                                                            <a href="<?php echo e(url('crm-leads-comments-restore/' . $cmts->id)); ?>"
                                                        ...
                                                        <?php else: ?>
                                                            <a href="<?php echo e(url('crm-leads-comments-delete/' . $cmts->id)); ?>"
                                            ...
                                            <div class="text-end small text-muted">
                                                ...
                                                <span style="font-size:10px">
                                                    ...
                                                    <?php echo e($cmts->createdby->first_name); ?>

                                                    <?php echo e($cmts->createdby->last_name); ?>
                                                ...
                                                <?php if($cmts->deleted_at): ?>
                                                    ...
                                                    <span class="text-danger" style="font-size:10px">
                                                        Deleted:
                                                        <?php echo e(date('d/m/Y h:i A', strtotime($cmts->deleted_at))); ?>
                ...
                <div class="col-5">
                    ...
                    <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'crm-leads-comments-add', 'method' => 'POST', 'id' => 'crm-leads-comments-add'])); ?>

                    <textarea name="comments" class="form-control capitalize-title" id="" cols="10" rows="3" required></textarea>

                    <input type="hidden" id="commentsid" name="commentsid" value="<?php echo e($edit->id); ?>" />
                ...
                <div class="card mb-0 mt-0">
                    <div class="card-body">
                        <div class="row" id="div_update">
                            ...
                            <div class="col-12">
                                ...
                                <select class="dynamicstxt  form-control" name="edit_status" id="edit_status"
                                    ...
                                    <option value="1" <?php echo e($leads->status == 1 ? 'selected' : ''); ?>>New</option>
                                    <option value="2"
                                        <?php echo e($leads->status == 2 || $leads->status == 0 ? 'selected' : ''); ?>>
                                        Qualified</option>
                                    <option value="3" <?php echo e($leads->status == 3 ? 'selected' : ''); ?>>Unqualified
                                    </option>
                                    <option value="4" <?php echo e($leads->status == 4 ? 'selected' : ''); ?>>Pending
                                        Response
                                    </option>
                                    <option value="10" <?php echo e($leads->status == 10 ? 'selected' : ''); ?>>Closed
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-12 mt-2">
                                ...
                                <input class=" form-control" type="text" name="qualified_deal_no"
                                    id="qualified_deal_no" value="<?php echo e(optional($edit->lead_deal_code)->code); ?>"
                                    style="display: none;" />
                            ...
                            <div class="col-12 mt-2">
                                ...
                                <input class="form-control date-picker" type="text" name="follow_up_date"
                                    id="follow_up_date"
                                    value="<?php echo e(@App\SysHelper::normalizeToDmy($leads->follow_up_date ?? date('Y-m-d', strtotime('+2 days')))); ?>"
                                    style="display: none;" />
                        ...
                        <textarea class="form-control mt-2" style="height:100px" name="lost_comments" rows="4" style="display: none;"
                            autocomplete="off" id="lost_comments" required placeholder="Reason (Max. 5 Words)"><?php echo e($leads->status == 4 ? $leads->sub_status_comment : ''); ?></textarea>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" id="btn_edit_status" onclick="change_status(<?php echo e($edit->id); ?>)"
...
<div class="modal side-panel fade" id="leadConvertModal" data-bs-backdrop="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a target="_blank" href="<?php echo e(url('crm-leads/' . $leads->id . '/convert')); ?>"
                    class="btn btn-light add-btn ms-2">
...
<script>
    function change_status(id) {
        ...
        var action = "<?php echo e(URL::to('crm-leads-update-status')); ?>";
        $.ajax({
            url: action,
            type: "POST",
            data: {
    ...
    $(document).ready(function() {
        ...
        const initialSubStatus = "<?php echo e($leads->sub_status ?? ''); ?>";
