    ...
    <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'goods-receipt-note-store', 'method' => 'POST', 'id' => 'goods-receipt-note-store-form', 'novalidate' => true])); ?>
    ...
    <div class="purchase-order-content-header">
        <h4 class="purchase-order-content-header-left">
            New
            (<?php echo e(isset($edit) ? (!empty(@$edit->title) ? @$edit->title : old('doc_number')) : @APP\SysHelper::get_new_code('sys_purchase_grn', 'GR', 'doc_number')); ?>)
        </h4>
        ...
        <div class="card-body">
            <div class="row gap-rows">
                ...
                <div class="col-2">
                    ...
                    <div class="form-group">
                        <input class="form-control" type="text" name="doc_number" autocomplete="off" id="doc_number"
                            value="<?php echo e(isset($edit) ? (!empty(@$edit->title) ? @$edit->title : old('doc_number')) : @APP\SysHelper::get_new_code('sys_purchase_grn', 'GR', 'doc_number')); ?>"
                            readonly>
                    </div>
                </div>
                <div class="col-2">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control date-picker" id="grn_date" type="text" autocomplete="off"
                            name="grn_date" value="<?php echo e(@$value_date); ?>">
                    </div>
                </div>
                <div class="col-2">
                ...
                <div class="col-2">
                    ...
                    <div class="form-group">
                        <input readonly value="<?php echo e(Auth::user()->full_name); ?>" type="text" class="form-control"
                    ...
                    <div class="col-10 mb-2">
                        <div class="row gap-rows">
                            ...
                            <div class="col-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control date-picker" id="bill_date" type="text"
                                        autocomplete="off" name="bill_date" value="<?php echo e(@$value_date); ?>"
                            ...
                            <div class="col-2">
                                ...
                                <div class="form-group">
                                    <input
                                        class="txtbx primary-input form-control date-picker <?php echo e($errors->has('lpo_date') ? ' is-invalid' : ''); ?>"
                                        type="text" name="lpo_date" autocomplete="off" id="lpo_date"
                                        value="<?php echo e($value_date); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-2">
                                ...
                                <div class="form-group">
                                    <input class="form-control" type="text" name="deal_id" autocomplete="off"
                                        value="<?php echo e(isset($edit) ? (!empty(@$edit->deal_id) ? @$edit->deal_id : old('deal_id')) : old('deal_id')); ?>"
                                        id="deal_id">
                                </div>
                            </div>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <select id="modal_ref_company_select"
                                                    ...
                                                    <?php $__currentLoopData = $customer_reference_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e(@$value->id); ?>"
                                                            <?php if(@$deal->cust_id == @$value->id): ?> selected <?php endif; ?>>
                                                            <?php echo e(@$value->name); ?> <?php if(@App\SysHelper::getCompanyCodeSettings()['is_customer_code']): ?>
                                                                (<?php echo e(@$value->code); ?>)
                                                            <?php endif; ?>
                                                        </option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php $__currentLoopData = $customer_reference_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<option value="<?php echo e(@$value->id); ?>" <?php if(@$deal->cust_id == @$value->id): ?> selected <?php endif; ?> ><?php echo e(@$value->name); ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control js-example-basic-single" required name="warehouse"
                                        ...
                                        <?php $__currentLoopData = $warehouses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e(@$value->id); ?>"><?php echo e(@$value->warehouse_name); ?>
                        ...
                        <div class="form-group">
                            <select class="form-control js-example-basic-single" name="shipping_supplier"
                                ...
                                <?php $__currentLoopData = $customer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e(@$value->id); ?>"
                                        <?php if($value->company_ship_to_id == session('logged_session_data.company_id')): ?> selected <?php endif; ?>>
            ...
            <div class="tab-pane fade" id="vat-details" role="tabpanel" aria-labelledby="vat-details-tab">
                <div class="row row-cols-6 gap-rows">
                    ...
                    <div class="col">
                        ...
                        <div class="form-group">
                            <select
                                class="form-control js-example-basic-single <?php echo e($errors->has('supplier_type') ? ' is-invalid' : ''); ?>"
    ...
    <div class="equipment comon-status row mt-4 d-block">
        ...
        <?php if(!empty($cfc_pi_id)): ?>
            <input type="hidden" name="cfc_pi_id" value="<?php echo e($cfc_pi_id); ?>" />
        <?php endif; ?>
    </div>
                                    ...
                                    <table class="table table-hover popupGRN" id="long-list"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <?php if(session('logged_session_data.company_id') == 2): ?>
                                                    <th style="width:30px" class="text-center"><?php echo app('translator')->getFromJson('HS Code'); ?></th>
                                                <?php endif; ?>
    ...
    <script>
        window.COMPANY_ID = <?php echo e((int) (session('logged_session_data.company_id') ?? 0)); ?>;
    </script>
    ...
    <script>
        ...
        function get_po_list(id) {
            $("#loading_bg").css("display", "block");
            var action = "<?php echo e(URL::to('goods-receipt-note-pending')); ?>";
            $.ajax({
                url: action,
                type: "POST",
                data: {
