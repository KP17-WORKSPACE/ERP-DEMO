...
<div class="purchase-order-content-header sticky-top d-flex align-items-center justify-content-between" style="background-color: #f7f8fd">
    ...
    <div class="purchase-order-content-header-right">
        <a class="btn btn-light text-dark btn-edit-deal" href="<?php echo e(url('crm-deals/show/' . $quotation->id . '?deal_action=edit')); ?>">
...
$(document).on("click", ".btn-edit-deal", function () {
    ...
    localStorage.removeItem("active-dealedit-tab");
        ...
        <a class="btn btn-light text-dark" href="<?php echo e(url('crm-deals/show?deal_action=add')); ?>">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td width="60%" style="line-height: 18px; vertical-align: top;width:70% !important;">
                                    ...
                                    <p style="padding: 0px; margin: 0px; width: 250px;">
                                        <?php echo e(@$quotation->customername->addresses->first()->address2); ?>,
                                        <?php echo e(@$quotation->customername->addresses->first()->city); ?></p> -->
                                    <p style="padding: 0px; margin: 0px; width: 250px;">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td style="width:14%; border: none;" align="left" valign="bottom">
                        <?php echo e(@$quotation->ownername->first_name[0]); ?> <?php echo e(@$quotation->ownername->last_name); ?><br /><br /><br /><b class="bottom_b">Prepared
                            By</b></td>
