        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title mb-0" id="editModalLabel">Sub Account -
                    <?php echo e(@App\SysHelper::get_new_sub_account_code()); ?></h4>
                <div class="d-flex align-items-center">
                    <a class="btn btn-light btn-sm me-2" style="padding: 2px 5px" href="<?php echo e(url('chartofaccounts-import-sub')); ?>">
                ...
                <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'chartofaccounts-store-sub', 'method' => 'POST', 'enctype' => 'multipart/form-data'])); ?>
                        ...
                        <div class="row">
                            <!-- <div class="col-4 mb-2">
                                <div class="input-effect">
                                    <label class="form-label"> <?php echo app('translator')->getFromJson('Sub Account Code'); ?> <span>*</span> </label>
                             ...
                             <input
                                        ...
                                        value="<?php echo e(isset($editData) ? @$editData->account_code : @App\SysHelper::get_new_sub_account_code()); ?>"
                                        required>
                            ...
                            <div class="col-3 mb-2">
                                ...
                                <div class="input-effect" style="position: relative;">
                                    <label class="form-label"> <?php echo app('translator')->getFromJson('Sub Account Name'); ?> <span>*</span> </label>
                                    <input
                            ...
                            <div class="col-3 mb-2">
                                <div class="input-effect">
                                    <label class="form-label"> <?php echo app('translator')->getFromJson('Select Account'); ?> <span>*</span> </label>
                                        ...
                                        <?php if(isset($accounts)): ?>
                                            <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e(@$val->id); ?>"
                                                    <?php if(isset($editData)): ?> <?php if(@$editData->main_account_id == @$val->id): ?> selected <?php endif; ?>
                                                    <?php endif; ?> ><?php echo e(@$val->account_code); ?> -
                            ...
                            <div class="col-3 mb-4">
                                <div class="input-effect">
                                    <label class="form-label"> <?php echo app('translator')->getFromJson('Prepaid/Accrued Exp'); ?> <span>*</span> </label>
                            ...
                            <div class="col-4 mb-2 opening-balance">
                                <div class="input-effect">
                                    ...
                                    <input
                                        ...
                                        type="text" id="debie_amount_sub" name="debit_amount" value="<?php echo e($debit_amount); ?>" required>
                            ...
                            <div class="col-4 mb-2 opening-balance">
                                <div class="input-effect">
                                    ...
                                    <input
                                        ...
                                        type="text" id="credit_amount_sub" name="credit_amount" value="<?php echo e($credit_amount); ?>" required>
                                    <span class="focus-border"></span>
                                </div>
                            </div>
    ...
    $value = Carbon\Carbon::parse($editData_tran->transaction_date)->format(
        'd/m/Y',
                                    ...
                                    <input
                                        ...
                                        type="text" name="opening_balance_date" value="<?php echo e($value); ?>"
                                        required>
                                    <span class="focus-border"></span>
                                </div>
                            </div>
                    ...
                    <div class="card-body bg-white m-0 p-0">
                        ...
                        <table class="table table-hover" id="long-list" style="table-layout: fixed;width:100%">
                            <thead id="table-head">
                                ...
                                <?php endif; ?>
                                <tr>
                                    <th class="text-center" style="padding-left: 14px"  style="width:250px"><?php echo app('translator')->getFromJson('Sub Account Code'); ?></th>
                                    <th style="width:300px"> <?php echo app('translator')->getFromJson('Sub Account Name'); ?></th>
                                    <th style="width:150px"><?php echo app('translator')->getFromJson('Account Name'); ?></th>
                                    <th><?php echo app('translator')->getFromJson('Main Heads'); ?></th>
                                    <th><?php echo app('translator')->getFromJson('Group'); ?></th>
                                    <th><?php echo app('translator')->getFromJson('Sub Group'); ?></th>
                                    <th class="text-end"><?php echo app('translator')->getFromJson('Opening Dr'); ?></th>
                                    <th class="text-end"><?php echo app('translator')->getFromJson('Opening Cr'); ?></th>
                                    <th class="text-center"><?php echo app('translator')->getFromJson('Status'); ?></th>
                                    <th class="text-center" style="width:150px"><?php echo app('translator')->getFromJson('lang.action'); ?></th>
                                </tr>
                            </thead>

                            <tbody>
                                <?php if(isset($sub_accounts)): ?>
                                    <?php $__currentLoopData = $sub_accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr <?php if($value->status == 2): ?> class="bg-dark" <?php endif; ?>>
                                            ...
                                            <td>
                                                <span
                                                    class=""><?php echo e(@$value->mainaccount->account_name); ?></span>
                                            </td>
                                            <td>
                                                <?php echo e(@$value->groupname->title); ?>

                                            </td>
                                            <td>
                                                <?php echo e(@$value->subgroupname->title); ?>

                                            </td>
                                            <td>
                                                <?php echo e(@$value->subgroup2name->title); ?>

                                            </td>

                                            <?php $tran_amt = $account_tran->where('account_id', $value->id)->first(); ?>
                                            <td class="text-end">
                                                <?php echo e(@App\SysHelper::com_curr_format(@$tran_amt->debit_amount, '', '', ',') ?? '0.00'); ?>

                                            </td>
                                            <td class="text-end">
                                                <?php echo e(@App\SysHelper::com_curr_format(@$tran_amt->credit_amount, '', '', ',') ?? '0.00'); ?>
                            ...
                            data-bs-placement="top"
                                                                href="<?php echo e(url('chartofaccounts-sub/' . $value->id . '/restore')); ?>"
                            ...
                            data-bs-placement="top"
                                                                href="<?php echo e(url('chartofaccounts-sub/' . $value->id . '/delete')); ?>"
                            ...
                            data-bs-placement="top" data-id="<?php echo e($value->id); ?>" data-name="<?php echo e($value->account_name); ?>"
                                                                >Move</a>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                </div>
                ...
                <div class="modal-body m-0 p-0 bg-white">
                    <div class="card mb-0 mt-0 bg-white">
                        <div class="card-body bg-white">
                            ...
                            <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'chartofaccounts-sub-update/' . @$editData->id, 'method' => 'PUT', 'enctype' => 'multipart/form-data', 'id' => 'editSubAccountForm2'])); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-3 mb-4">
                                    <div class="input-effect">
                                        <label class="form-label"> <?php echo app('translator')->getFromJson('Main Account'); ?> <span>*</span> </label>
                                        <select class="form-control js-example-basic-single" name="main_account_id"
                                            id="edit_main_account_id" required>
                                            <option value=""></option>
                                            <?php if(isset($accounts)): ?>
                                                <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($val->id); ?>"><?php echo e($val->account_code); ?> -
                                                        <?php echo e($val->account_name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endif; ?>
                                        </select>
                                    </div>
          ...
          <div class="modal modal-draggable side-panel fade" id="moveToSubGroup" data-bs-backdrop="false"
                                            ...
                                            <div class="modal-dialog modal-sm">
                                                <div class="modal-content">
                                                    ...
                                                    <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'chartofaccounts-sub-move', 'method' => 'POST', 'enctype' => 'multipart/form-data'])); ?>
