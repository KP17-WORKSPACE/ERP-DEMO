...
<div class="purchase-order-content-header">
    <h4 class="purchase-order-content-header-left">
        Edit - <?php echo e(@$edit_si->doc_number); ?>

    </h4>
    <div class="purchase-order-content-header-right">
        <a type="submit" class="btn btn-light text-dark"
            href="<?php echo e(url('sales-invoice/' . $edit_si->id . '?si_action=add')); ?>">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="<?php echo e(url('sales-invoice/' . $edit_si->id . '/delete')); ?>"><i
                            class="ico icon-outline-trash-bin-minimalistic text-danger"></i> Cancel SI</a></li>

                <li><a class="dropdown-item" href="<?php echo e(url('sales-invoice/' . $edit_si->id . '/download/t')); ?>"><i
                            class="ico icon-outline-document-medicine text-success"></i> Print</a></li>

                <li><a class="dropdown-item" href="<?php echo e(url('sales-invoice/' . $edit_si->id . '/download')); ?>"><i
        ...
        <div class="row gap-rows">
            <div class="col-4">
                <label class="form-label mb-0 d-flex justify-content-between align-items-center">
                    <span>Customer</span>
                    <a href="<?php echo e(url('customers?customer_action=add')); ?>" class="btn btn-sm p-0 ms-2"
                ...
                <div class="form-group">
                    <select class="form-control js-account-select" name="customer" id="customer" required>
                        ...
                        <?php $__currentLoopData = $customer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e(@$value->id); ?>" <?php echo e(isset($edit_si) ? (!empty($edit_si->customer) ?
            ...
            <div class="col-2">
                ...
                <div class="form-group">
                    <input class="form-control" type="text" name="doc_number" autocomplete="off" id="doc_number"
                        value="<?php echo e($edit_si->doc_number); ?>">
                    <input type="hidden" name="doc_number_main" value="<?php echo e($edit_si->doc_number); ?>">
                </div>
            </div>
            <div class="col-2">
        ...
        $currency1 = 2;
                    ...
                    <select class="form-control js-example-basic-single" name="currency" id="currency" readonly>
                        ...
                        <?php $__currentLoopData = $currency; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($edit_si->currency == @$value->id): ?>
            ...
            <div class="col-2">
                ...
                <div class="form-group">
                    <input class="form-control" type="text" name="createdby" autocomplete="off" id="createdby"
                        value="<?php echo e(isset($edit_si) ? (!empty(@$edit_si->created_by) ? @$edit_si->createdby->full_name : old('createdby')) : Auth::user()->full_name); ?>"
                        readonly>
                </div>
            </div>
        </div>
            ...
            <div class="row gap-rows">
                ...
                <div class="col-lg-10 mb-2">
                    <div class="row">
                        <div class="col-lg-3 mb-2">
                            <div class="input-effect">
                                ...
                                <input class="form-control" type="text" name="reference_no" autocomplete="off"
                                    id="reference_no" value="<?php echo e($edit_si->lpo_number); ?>" required>
                            </div>
                        </div>
                        <div class="col-lg-3 mb-2">
                            <div class="input-effect">
                                ...
                                <input class="form-control date-picker" type="text" name="reference_date"
                                    autocomplete="off" id="reference_date" value="<?php echo e($value); ?>" required>
                            </div>
                        </div>
                               <div class="col-lg-3 mb-2">
                            <div class="input-effect">
                                ...
                                <div class="form-group">
                                    <select class="form-control js-example-basic-single" name="payment_terms"
                                        ...
                                        <?php $__currentLoopData = $paymentterms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e(@$value->id); ?>" <?php echo e(isset($edit_si) ? !empty(@$edit_si->
                        ...
                        <div class="col-lg-3 mb-2">
                            <div class="input-effect">
                                ...
                                <select class="form-control js-example-basic-single" name="ref_supplier_id[]"
                                    ...
                                    <option value="TFS" <?php if(in_array('TFS', $selectedIds)): ?> selected <?php endif; ?>>TAKEN FROM
                                        STOCK</option>
                                    ...
                                    <?php $__currentLoopData = $supplier_reference_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e(@$value->id); ?>" <?php if(in_array($value->id, $selectedIds)): ?> selected
                                        <?php endif; ?>><?php echo e(@$value->account_name); ?>
                                ...
                                <input class="form-control" type="hidden" name="supplier_name" autocomplete="off"
                                    id="supplier_name" value="<?php echo e($edit_si->supplier_name); ?>" required>
                            </div>
                        </div>
                         <div class="col-lg-3 mb-2">
                            <div class="input-effect">
                                ...
                                <div class="form-group">
                                    <select class="form-control js-example-basic-single" name="sales_man" id="sales_man"
                                        ...
                                        <?php $__currentLoopData = $staff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e(@$value->user_id); ?>" <?php if(isset($edit_si)): ?> <?php if(
                                                                            $edit_si->
                                                                                sales_man == $value->user_id
                                                                        ): ?> selected <?php endif; ?> <?php else: ?> <?php if(
                                                $value->user_id ==
                                                Auth::user()->id
                                            ): ?> selected <?php endif; ?> <?php endif; ?>>
                        ...
                        <div class="col-lg-3 mb-2" style="display: none;">
                            <div class="input-effect">
                                ...
                                <input class="form-control" type="text" name="delivery_terms" autocomplete="off"
                                    id="delivery_terms"
                                    value="<?php echo e(isset($edit_si) ? (!empty(@$edit_si->delivery_terms) ? @$edit_si->delivery_terms : old('delivery_terms')) : 'Ex-Dubai'); ?>"
                                    required>
                            </div>
                        </div>
                        <div class="col-lg-3 mb-2">
                            <div class="input-effect">
                                ...
                                <input class="form-control" type="text" name="printed_invoice_number" autocomplete="off"
                                    ...
                                    value="<?php echo e(isset($edit_si) ? (!empty(@$edit_si->printed_invoice_number) ? @$edit_si->printed_invoice_number : old('printed_invoice_number')) : ''); ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 mb-2">
                            <div class="input-effect">
                                ...
                                <input class="form-control" type="text" name="deal_id" autocomplete="off" id="deal_id"
                                    value="<?php echo e(@App\SysHelper::get_code_from_dealid($edit_si->deal_id)); ?>" required>
                            </div>
                        </div>
                        
                        <div class="col-lg-3 mb-2">
                            <div class="input-effect">
                                <label class="form-label"><?php echo app('translator')->getFromJson('Update Deal'); ?></label>
                                <div class="form-group">
                        ...
                        <div class="col-lg-3 mb-2">
                            <div class="input-effect">
                                <label class="form-label"><?php echo app('translator')->getFromJson('Update Delivery Note'); ?></label>
                        ...
                        <div class="col-lg-8 mb-2">
                            <div class="input-effect">
                                ...
                                <input class="form-control" type="text" name="narration" autocomplete="off"
                                    id="narration" value="<?php echo e($edit_si->narration); ?>">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-3">
                    ...
                    <div class="form-group">
                        <select class="form-control js-example-basic-single" name="shipping_supplier"
                            ...
                            <option value=""></option>
                            <?php $__currentLoopData = $customer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e(@$value->id); ?>" <?php if(isset($edit_si)): ?>
                                    <?php if(!empty($edit_si->shipping_supplier)): ?> <?php if($edit_si->shipping_supplier == @$value->id): ?>
                                selected <?php endif; ?> <?php endif; ?> <?php endif; ?>><?php echo e(@$value->account_name); ?>
                ...
                <div class="col-2">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="shipping_name" id="shipping_name"
                            value="<?php echo e(isset($edit_si) ? (!empty(@$edit_si->shipping_name) ? @$edit_si->shipping_name : '') : old('shipping_name')); ?>" />
                    </div>
                </div>
                <div class="col-2">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="shipping_email" id="shipping_email"
                            value="<?php echo e(isset($edit_si) ? (!empty(@$edit_si->shipping_email) ? @$edit_si->shipping_email : '') : old('shipping_email')); ?>" />
                    </div>
                </div>
                <div class="col-2">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="shipping_contact_no" id="shipping_contact_no"
                            value="<?php echo e(isset($edit_si) ? (!empty(@$edit_si->shipping_contact_no) ? @$edit_si->shipping_contact_no : '') : old('shipping_contact_no')); ?>" />
                    </div>
                </div>
                <div class="col-3">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control"
                            value="<?php echo e(isset($edit_si) ? (!empty(@$edit_si->shipping_address) ? @$edit_si->shipping_address : '') : old('shipping_address_1')); ?>"
                        ...
                        <div class="form-group">
                            <select class="form-control js-example-basic-single" name="customer_country" id="country">
                                ...
                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e(@$value->id); ?>" <?php        try {?> <?php if(isset($edit_si)): ?> <?php if(@$edit_si->customer_country == $value->id): ?> selected <?php endif; ?> <?php endif; ?> <?php        } catch (\Throwable $th) {
                        ...
                        <div class="form-group" id="sectionStateDiv">
                            <select class="form-control js-example-basic-single" name="customer_state" id="state">
                                ...
                                <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($value->id); ?>" <?php if(isset($edit_si)): ?> <?php if(
                                        @$edit_si->customer_state ==
                                        $value->id
                                    ): ?> selected <?php endif; ?> <?php endif; ?>><?php echo e($value->name); ?>
                ...
                <div class="col-2">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="number" name="vat_percent" id="vat_percent"
                            value="<?php echo e(@$edit_si->vat_percent); ?>">
                    </div>
                </div>
                ...
                <div class="col-2">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="number" name="vat_number" id="vat_number"
                            value="<?php echo e(@$edit_si->vat_number); ?>">
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            <select class="form-control js-example-basic-single" name="customer_type"
                                ...
                                <?php $__currentLoopData = $customertype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e(@$value->id); ?>" <?php echo e(isset($edit_si) ? !empty(@$edit_si->customer_type) ?
                        ...
                        <div class="form-group">
                            <select class="form-control js-example-basic-single" name="sale_type" id="sale_type">
                                ...
                                <?php $__currentLoopData = $saletype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e(@$value->id); ?>" <?php echo e(isset($edit_si) ? !empty(@$edit_si->sale_type) ?
                                    @$edit_si->sale_type == @$value->id ? 'selected' : '' : '' : ''); ?>><?php echo e(@$value->title); ?>
                ...
                <div class="col mb-2">
                    <div class="input-effect">
                        ...
                        <input type="text" class="form-control" name="end_user_name" id="end_user_name"
                            autocomplete="off"
                            value="<?php echo e(isset($edit_si) ? (!empty(@$edit_si->end_user_name) ? @$edit_si->end_user_name : '') : old('end_user_name')); ?>" />
                ...
                <div class="col mb-2">
                    <div class="input-effect">
                        ...
                        <input type="text" class="form-control" name="contact_person_name" id="contact_person_name"
                            autocomplete="off"
                            value="<?php echo e(isset($edit_si) ? (!empty(@$edit_si->contact_person_name) ? @$edit_si->contact_person_name : '') : old('contact_person_name')); ?>">
                ...
                <div class="col mb-2">
                    <div class="input-effect">
                        ...
                        <input type="text" class="form-control" name="contact_person_email" id="contact_person_email"
                            autocomplete="off"
                            value="<?php echo e(isset($edit_si) ? (!empty(@$edit_si->contact_person_email) ? @$edit_si->contact_person_email : '') : old('contact_person_email')); ?>">
                ...
                <div class="col mb-2">
                    <div class="input-effect">
                        ...
                        <input type="text" class="form-control" name="contact_person_no" id="contact_person_no"
                            autocomplete="off"
                            value="<?php echo e(isset($edit_si) ? (!empty(@$edit_si->contact_person_no) ? @$edit_si->contact_person_no : '') : old('contact_person_no')); ?>">

                    </div>
                </div>

        <?php if($edit_si_items->where('productname.product_type', 2)->count() > 0): ?>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" name="device_serial"
                                value="<?php echo e($edit_si->device_serial); ?>" id="device_serial" data-bs-toggle="modal"
...
<div class="table-container" style="border: solid 1px #d9d9d9;">
    <table class="table table-hover form-item-table" id="myTable">
        ...
        <tbody>
            <?php if(isset($edit_si_items) && count($edit_si_items) > 0): ?>
                    <?php        $qty = 0;
                $unitprice = 0;
                $value = 0;
                $discount = 0;
                        ...
                        <?php $__currentLoopData = $edit_si_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><select class="form-control noborder " name="part_number[]">
                                        <option value="<?php echo e($dt->part_number); ?>"><?php echo e($dt->productname->part_number); ?></option>
                                    </select></td>
                                <td><textarea class="form-control" name="description[]" rows="1"><?php echo e($dt->description); ?></textarea></td>

                                <td>
                                    <input class="form-control text-end" type="text" name="cost[]" autocomplete="off"
                                        value="<?php echo e(@App\SysHelper::com_curr_format($dt->cost,2,'.',',')); ?>">
                                    <input class="form-control" type="text" name="part_number_txt[]" autocomplete="off" readonly="true"
                                        value="<?php echo e($dt->productname->part_number); ?>" hidden>
                                ...
                                <td><input type="text" class="form-control text-center" name="tax[]"
                                        value="<?php echo e(number_format($dt->tax, 0)); ?>" onchange="calc_change_new(this)"></td>
                                <td><input class="form-control text-center" type="number " name="qty[]" autocomplete="off" min="0"
                                        value="<?php echo e($dt->qty); ?>" onchange="calc_change_new(this)"></td>
                                <td><input class="form-control text-end" type="text" name="unitprice[]" step="any"
                                        value="<?php echo e(@App\SysHelper::com_curr_format($dt->unitprice,2,'.',',')); ?>" autocomplete="off"
                                ...
                                <td><input class="form-control text-end" type="text" name="value[]" autocomplete="off" min="0"
                                        value="<?php echo e(@App\SysHelper::com_curr_format($dt->value,2,'.',',')); ?>" readonly></td>
                                <td><input class="form-control text-end" type="text" name="discount[]" autocomplete="off" min="0"
                                        value="<?php echo e(@App\SysHelper::com_curr_format($dt->discount,2,'.',',')); ?>"
                                ...
                                <td><input class="form-control text-end" type="text" name="taxableamount[]" autocomplete="off" min="0"
                                        value="<?php echo e(@App\SysHelper::com_curr_format($dt->taxableamount,2,'.',',')); ?>" readonly></td>
                                <td><input class="form-control text-end" type="text" name="vatamount[]" autocomplete="off" min="0"
                                        value="<?php echo e(@App\SysHelper::com_curr_format($dt->vatamount,2,'.',',')); ?>" readonly></td>
                                <td><input class="form-control text-end" type="text" name="totalamount[]" autocomplete="off" min="0"
                                        value="<?php echo e(@App\SysHelper::com_curr_format($dt->taxableamount+$dt->vatamount,2,'.',',')); ?>"
                                        readonly></td>
                                <td><input class="form-control text-end" type="text" name="serial_no[]" value="<?php echo e($dt->serialno); ?>">
                                </td>
                ...
                <?php if(count($adj_list) > 0): ?>
                    <?php $__currentLoopData = $adj_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="text-end"><?php echo e(@App\SysHelper::com_curr_format(@$item->bi_balance_to_adjust,2,'.',',')); ?>

                            </td>
                            <td class="text-end"><?php echo e(@App\SysHelper::com_curr_format(@$item->bi_amount,2,'.',',')); ?></td>
                            <td class="text-end"><?php echo e(@App\SysHelper::com_curr_format(@$item->bi_cheque_amount -
                                @$item->bi_amount_adjusted,2,'.',',')); ?></td>
                            <td class="text-center"><a class="btn-sm btn-light"
                                    onclick="return delete_adjestments(<?php echo e($item->id); ?>);"><i
...
<script>
    function delete_adjestments(id) {
        var action = "<?php echo e(URL::to('delete-receipt-adjustment-json')); ?>";
            ...
            <div class="card-body" style="height: 420px; overflow-y: scroll;">
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <?php if(count($list_of_unadjusted) > 0): ?>
                                    <?php $__currentLoopData = $list_of_unadjusted; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="border"><a href="<?php echo e(url('get-url-receipt/' . @$p->doc_number)); ?>"
                                                    target="_blank"><?php echo e(@$p->doc_number); ?></a></td>
                                            <td class="border"><?php echo e(@$p->account_name); ?></td>
                                            <td class="border text-right"><?php echo e(@$p->amount - @$p->adj_amount); ?></td>
                                            <td class="border text-right"><input type="text" name="set_amt[]"
                                                    id="set_amt_<?php echo e(@$p->doc_number); ?>" class="form-control text-right" id=""
                                                    name="" value="<?php echo e(@$p->adj_amount); ?>"
                                                    onclick="set_adjust('<?php echo e(@$p->amount - @$p->adj_amount); ?>','<?php echo e(@$p->doc_number); ?>')" />
                                                <input type="hidden" name="receiptno[]" value="<?php echo e(@$p->doc_number); ?>" />
                                                <input type="hidden" name="set_amt_act[]"
                                                    value="<?php echo e(@$p->amount - @$p->adj_amount); ?>" />
                                            </td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                        ...
                        <input type="hidden" name="adj_cus_id" value="<?php echo e(@$edit_si->customer); ?>" />
                        <input type="hidden" name="adj_siv_id" value="<?php echo e(@$edit_si->id); ?>" />
                        <input type="hidden" name="adj_siv_no" value="<?php echo e(@$edit_si->doc_number); ?>" />
                        <input type="hidden" name="adj_siv_date" value="<?php echo e(@$edit_si->doc_date); ?>" />
                        <input type="hidden" name="adj_siv_amount" value="<?php echo e($adjusted_amt); ?>" />
                        <input type="hidden" name="adj_siv_amount_actual" value="<?php echo e($adjusted_amt_actual); ?>" />
...
<div class="modal side-panel fade" id="ModalChangeCurrancy" data-bs-backdrop="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-sm">
        ...
        'enctype' => 'multipart/form-data'
            ...
            <div class="modal-footer">
                <input type="hidden" name="cur_si_id" value="<?php echo e(@$edit_si->id); ?>" />
...
?>
                            <?php $__empty_1 = true; $__currentLoopData = $groupedItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <div class="part-serial-section" data-part-number="<?php echo e($dt['part_number']); ?>" data-qty="<?php echo e($dt['total_qty']); ?>" data-row-index="<?php echo e($loop->index); ?>">
                                    <div class="part-serial-header d-flex align-items-center justify-content-between mb-2   ">
                                        <div>
                                            <div class="part-name">Row <?php echo e($i_1++); ?>: <?php echo e($dt['product']->part_number); ?></div>
                                    ...
                                    <div class="serial-inputs-list" data-qty="<?php echo e($dt['total_qty']); ?>">
                                        ...
                                        <?php for($j = 1; $j <= ($dt['total_qty']); $j++): ?>
                                            <div class="serial-input-row" data-index="<?php echo e($j); ?>">
                                                <span class="text-muted" style="min-width: 20px;"><?php echo e($j); ?>.</span>
                                                <input type="text" name="serial_no[<?php echo e($dt['part_number']); ?>][]" class="form-control form-control-sm part-serial-input" value="<?php echo e(isset($existingSerials[$j-1]) ? e($existingSerials[$j-1]) : ''); ?>" autocomplete="off">
