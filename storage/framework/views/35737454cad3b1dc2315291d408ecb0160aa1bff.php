        ...
        <div class="long-list" id="filters-long">
            <div class="d-flex align-items-center justify-content-between">
                <div class="dropdown report-type-dropdown">
                    ...
                    ?>
                    <a class="text-dark report-type-trigger" href="javascript:void(0);" id="inventoryCompanyReportTypeMenu"
                        data-bs-toggle="dropdown" aria-expanded="false">
                        Inventory Report Type <i class="icon-outline-alt-arrow-down ms-1"></i>
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="inventoryCompanyReportTypeMenu">
            ...
            <div class="search-filter-container mt-1 mb-4 filter-field d-none border">
                <div class="card" style="width: 100%">
                    <div class="card-body">
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'inventory-company-wise-report', 'method' => 'POST', 'id' => 'inventory-company-wise-report'])); ?>
            ...
            <div class="table-responsive mb-4 mt-4">
                <table id="long-list" class="table table-hover data-table" style="table-layout: fixed;width:100%">
                    ...
                    <tbody>
                        ...
                        ?>
                        <?php $__empty_1 = true; $__currentLoopData = $company_report_rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php
                                $q = $brand_wise_base_query;
                                $q['company'] = $row->company_id;
                                $brandWiseUrl = url('inventory-brand-wise-report') . '?' . http_build_query(array_filter($q, function ($v) {
                                    return $v !== '' && $v !== null;
                                }));
                            ?>
                            <tr>
                                <td class="text-center"><?php echo e($loop->iteration); ?></td>
                                <td><a href="<?php echo e($brandWiseUrl); ?>"><?php echo e($row->company_name); ?></a></td>
