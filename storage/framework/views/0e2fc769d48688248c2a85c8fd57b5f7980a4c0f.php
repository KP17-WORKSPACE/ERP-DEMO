<style>
    ...
    <div class="purchase-order-content-header d-flex align-items-center justify-content-between gap-2">
        <div class="d-flex align-items-center gap-2">
            <h4 class="purchase-order-content-header-left">
                <?php echo e($sr->doc_number); ?>

            </h4>
            <?php if(isset($sr->deal_id)): ?>
                <?php echo App\SysHelper::deal_pipeline($sr->deal_id); ?>

            <?php endif; ?>
        </div>
        <div class="purchase-order-content-header-right">

           <a class="btn btn-light text-dark" href="<?php echo e(url('sales-return/'.$sr->id.'?sr_action=edit')); ?>">
                <i class="ico icon-outline-pen-2 text-success"></i> Edit
            </a>
            <a class="btn btn-light  text-dark" href="<?php echo e(url('sales-return/'.$sr->id.'?sr_action=add')); ?>">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="<?php echo e(url('sales-return/'.$sr->id.'/delete')); ?>"><i class="ico icon-outline-trash-bin-minimalistic text-danger"></i> Cancel SR</a></li>
                    <li><a class="dropdown-item" href="<?php echo e(url('sales-return/'.$sr->id.'/download')); ?>"><i class="ico icon-outline-document-medicine text-success"></i> Download</a></li>
    ...
    <div class="card mb-3 card-min-height">
        ...
        <tr>
            ...
            <?php if(@$sr->credit_note == 'CN'): ?>
                Credit Note
            <?php elseif(@$sr->credit_note == 'SR'): ?>
                Sales Return
            <?php else: ?>
                 Sales Return
            <?php endif; ?>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
         <td  width="60%"  valign="top" style="line-height: 18px;">
          ...
          <b><?php echo e(@$sr->accountname->account_name); ?></b><br>
   
           <?php if($state !=""): ?> <?php echo e(@$state); ?>, <?php endif; ?> <?php echo e($country); ?><br>
          T: <?php echo e(@$tel); ?>, M: <?php echo e(@$mobile); ?><br>
          E: <?php echo e(@$email); ?> <br>
          TRN: <?php echo e(@$trn_no); ?>
        ...
        <td>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                  ...
                  <td style="padding: 0px; margin: 0px">: <?php echo e(@$sr->doc_number); ?></td>
                </tr>
                <tr>
                  <td style="padding: 0px; margin: 0px">Sales Return Date</td>
                  <td style="padding: 0px; margin: 0px">: <?php echo e(date('d/m/Y', strtotime(@$sr->doc_date))); ?></td>
                </tr>
                <tr>
                  <td style="padding: 0px; margin: 0px">DO No</td>
                  <td style="padding: 0px; margin: 0px">: <?php echo e(@$sr->dn_doc_number); ?></td>
                </tr>
                <tr>
                  <td style="padding: 0px; margin: 0px">Invoice No</td>
                  <td style="padding: 0px; margin: 0px">: <?php echo e(@$sr->si_doc_number); ?></td>
                </tr>
                <tr>
                  <td style="padding: 0px; margin: 0px; vertical-align: top; white-space: nowrap;">Payment Terms:</td>
                  <td style="padding:0; margin:0; white-space:nowrap; max-width:250px; overflow:hidden; text-overflow:ellipsis;">: <?php echo e($sr->paymentterms->title); ?> <?php echo e($sr->payment_terms2); ?></td>
                </tr>
          </table>
        </td>
      </tr>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr class="item-head-row">
      ...
      <?php
          ...
          $total_amount=0;
      ?>
      <?php if(count($sr_item)>0): ?>
      <?php $__currentLoopData = $sr_item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
      <td class="item-row" style="width: 20px;"><?php echo e($i); ?> <?php $i++;?></td>
      <td class="item-row">
         <strong> <?php echo e($item->product->part_number); ?></strong><br />
        <span style="font-size: 10px;">  <?php echo nl2br($item->description); ?></span><br />
        <span style="font-weight: bold;">  <?php echo e($item->serial_no); ?></span></td>
          <td class="item-row" style="width: 30px; text-align: center;"><?php echo e($item->qty); ?></td>
          <td class="item-row" style="width: 70px; text-align: right;"><?php echo e(@App\SysHelper::com_curr_format($item->unitprice, 2, '.', ',')); ?></td>
          <td class="item-row" style="width: 80px; text-align: right;"><?php echo e(@App\SysHelper::com_curr_format($item->unitprice*$item->qty, 2, '.', ',')); ?></td>
      ...
      <?php endif; ?>
        ...
        <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr><td>
                <?php echo e($sr->currency_name->code); ?>  <?php echo ucwords(@App\SysHelper::convertAmountToWords(@App\SysHelper::com_curr_format($total_amount, 2, '.', ''), $sr->currency_name->r_code, $sr->currency_name->p_code));?>
              </td>
              </tr>
            </table>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <td valign="top" width="250px"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td style="width: 110px; text-align: left; font-weight: bold; border-bottom: solid 1px #2c2b6d;">Sub Total <?php echo e($sr->currency_name->code); ?></td>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td style="width: 110px; text-align: left; font-weight: bold; border-bottom: solid 1px #2c2b6d;">Discount <?php echo e($sr->currency_name->code); ?></td>
              <td style="width: 80px; text-align: right; font-weight: bold; border-bottom: solid 1px #2c2b6d;"><?php echo e(@App\SysHelper::com_curr_format($discount, 2, '.', ',')); ?></td>
            </tr>
          </table>
          <?php endif; ?>
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td style="width: 110px; text-align: left; font-weight: bold; border-bottom: solid 1px #2c2b6d;">Taxable Amt. <?php echo e($sr->currency_name->code); ?></td>
              <td style="width: 80px; text-align: right; font-weight: bold; border-bottom: solid 1px #2c2b6d;"><?php echo e(@App\SysHelper::com_curr_format($taxable_amt, 2, '.', ',')); ?></td>
            </tr>
          </table>
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td style="width: 110px; text-align: left; font-weight: bold; border-bottom: solid 1px #2c2b6d;">VAT Amount <?php echo e($sr->currency_name->code); ?></td>
              <td style="width: 80px; text-align: right; font-weight: bold; border-bottom: solid 1px #2c2b6d;"><?php echo e(@App\SysHelper::com_curr_format($vat_amount, 2, '.', ',')); ?></td>
            </tr>
          </table>
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td style="width: 110px; text-align: left; font-weight: bold; border-bottom: solid 1px #2c2b6d;">Total Amount <?php echo e($sr->currency_name->code); ?></td>
              <td style="width: 80px; text-align: right; font-weight: bold; border-bottom: solid 1px #2c2b6d;"><?php echo e(@App\SysHelper::com_curr_format($total_amount, 2, '.', ',')); ?></td>
            </tr>
          </table></td>
        </tr>
        </table>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td style="width: 30%; border: none; font-size: 10px;" align="left" valign="bottom"><?php echo e(@$po->createdby->full_name); ?><br/><b class="bottom_b">Prepared By</b></td>
          ...
          <td style="width: 30%; border: none; font-size: 10px;" align="right" valign="bottom"><?php echo e(@$company->company_name); ?> <br /><br /><br /><br /><b class="bottom_b">Authorised Signature</b></td>
        </tr>
        <tr>
    ...
    <div class="modal side-panel fade" id="adj_popup_win" data-bs-backdrop="false" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body m-0 p-3">
                    <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'sales-return-add-adjestment', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'sales-return-add-adjestment'])); ?>

                    <input type="hidden" value="<?php echo e($sr->doc_number); ?>" name="adj_srn_no">
                    <input type="hidden" value="<?php echo e($sr->dn_doc_number); ?>" name="adj_dn_doc_number">
                    <input type="hidden" value="<?php echo e($sr->doc_date); ?>" name="edit_adj_doc_date">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="equipment comon-status row mt-40 d-block">
                                    <input type="text" id="act_srn_adj_amount" value="<?php echo e($srn_adj_amount); ?>" hidden/>
                                    <input type="text" id="srn_adj_amount" value="<?php echo e($srn_adj_amount); ?>" hidden />

                                    <table class="table table-hover form-item-table" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th style="width:100px;"><?php echo app('translator')->getFromJson('Doc No'); ?></th>
                                                ...
                                                <th style="width:100px;" class="text-end"><?php echo app('translator')->getFromJson('Total'); ?></th>
                                                <th style="width:100px;" class="text-end"><?php echo app('translator')->getFromJson('Balance'); ?></th>
                                                <th style="width:100px;" class="text-end"><?php echo app('translator')->getFromJson('Paid'); ?></th>
                                                <th style="width:200px;" class="text-center"><?php echo app('translator')->getFromJson('Narration'); ?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php $i=0; ?>
                                            <?php if(count($srn_adjestment)>0): ?>
                                                <?php $__currentLoopData = $srn_adjestment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php
                                                    ...
                                                    <?php if($balance_amount > 0): ?>
                                                        <tr>
                                                            <td style="width:100px;"><input type="text" class="form-control" name="adj_siv_no[]" id="adj_siv_no_<?php echo e($i); ?>" value="<?php echo e($dt->doc_number); ?>" readonly /></td>
                                                            <td style="width:100px;"><input type="text" class="form-control" name="adj_doc_date[]" id="adj_doc_date_<?php echo e($i); ?>" value="<?php echo e(date('d/m/Y', strtotime($dt->doc_date))); ?>" readonly /></td>
                                                            <td style="width:100px;"><input type="text" class="form-control" name="lpo_number[]" id="lpo_number_<?php echo e($i); ?>" value="<?php echo e($dt->lpo_number); ?>" readonly /></td>
                                                            <td style="width:100px;"><input type="text" class="form-control text-end" name="adj_total[]" id="adj_total_<?php echo e($i); ?>" value="<?php echo e($dt->total_amount); ?>" readonly /></td>
                                                            <td style="width:100px;"><input type="text" class="form-control text-end" name="adj_balance[]" id="adj_balance_<?php echo e($i); ?>" value="<?php echo e($balance_amount); ?>" readonly /></td>
                                                            <td style="width:100px;"><input type="text" class="form-control text-end class_adj_paid" name="adj_paid[]" id="adj_paid_<?php echo e($i); ?>" value="" onchange="get_set_amount(<?php echo e($i); ?>)" onclick="set_adjestment(<?php echo e($i); ?>)" /></td>
                                                            <td style="width:100px;"><input type="text" class="form-control" name="narration[]" id="narration_<?php echo e($i); ?>" value="<?php echo e($dt->narration); ?>" /></td>
                                                        </tr>
                                                        <?php $i++; ?>
                                                    <?php endif; ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
