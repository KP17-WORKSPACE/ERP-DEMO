...
<body>
    ...
    <div class="login-container">
        ...
        <div class="left-panel">
            <div class="text-center mb-8 z-20">
                <div class="leaf-icon inline-flex items-center justify-center w-16 h-16 rounded-full bg-white bg-opacity-20 mb-6"
                    ...
                    <img src="<?php echo e(asset('public/design/assets/images/erp-logo-icon.png')); ?>" alt="Logo" class="w-10 h-10">
                </div>
        ...
        <div class="right-panel">
            ...
            <form action="<?php echo e(route('login')); ?>" name="login" method="POST" id="infix_form2" class="space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="flex justify-end">
                    <a href="<?php echo e(url('recovery/passord')); ?>" class="text-sm text-greenenergy-600 hover:text-greenenergy-800 font-medium">Forgot your
                        password?</a>
                </div>
  ...
  <script src="https://code.jquery.com/jquery-3.7.1.min.js"
    ...
    <script>
        ...
        <?php if($errors->any()): ?>
            toastr.error('<?php echo e($errors->first()); ?>', 'Login Failed');
        <?php endif; ?>
        <?php if(session('message-danger')): ?>
            toastr.error('<?php echo e(session('message-danger')); ?>', 'Access Denied');
        <?php endif; ?>
        <?php if(session('message-success')): ?>
            toastr.success('<?php echo e(session('message-success')); ?>', 'Success');
        <?php endif; ?>
    </script>
</body>
