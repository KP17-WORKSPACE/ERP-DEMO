    ...
    <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'purchase-invoice-store', 'method' => 'POST', 'id' => 'purchase-invoice-create-form', 'novalidate' => true])); ?>
    ...
    <div class="purchase-order-content-header">
        <h4 class="purchase-order-content-header-left">
            New
            (<?php echo e(isset($edit) ? (!empty(@$edit->title) ? @$edit->title : old('doc_number')) : @App\SysHelper::get_new_code('sys_purchase_invoice', 'PI', 'doc_number')); ?>)
        </h4>
                ...
                <div class="col-2">
                    ...
                    <div class="form-group">
                        <input class="form-control" type="text" name="doc_number" autocomplete="off" id="doc_number"
                            value="<?php echo e(isset($edit) ? (!empty(@$edit->title) ? @$edit->title : old('doc_number')) : @App\SysHelper::get_new_code('sys_purchase_invoice', 'PI', 'doc_number')); ?>"
                            readonly>
                    </div>
                </div>
                <div class="col-2">
                    ...
                    <div class="form-group">
                        <?php $value_date = \Carbon\Carbon::parse( now())->format('d/m/Y'); ?>
                        <input class="form-control date-picker" id="pi_date" type="text" autocomplete="off"
                            name="pi_date" value="<?php echo e(@$value_date); ?>" style="margin-top: 0px">
                    </div>
                </div>
                <div class="col-2">
                    ...
                    <div class="form-group"><select class="form-control js-example-basic-single" name="currency"
                            ...
                            <?php $__currentLoopData = @$currency ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e(@$value->id); ?>" <?php if(optional(@$company)->currency_id == $value->id): ?> selected <?php endif; ?>>
                        ...
                        <div class="col-2">
                                ...
                                <div class="form-group">
                                    <input class="form-control" type="text" name="grn_no" autocomplete="off"
                                        id="grn_no"
                                        value="<?php echo e(isset($edit) ? (!empty(@$edit->grn_no) ? @$edit->grn_no : old('grn_no')) : ''); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-2">
                                ...
                                <div class="form-group">
                                    <input class="form-control date-picker" type="text" name="grn_date"
                                        autocomplete="off" id="grn_date" required value="<?php echo e($value_date); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-2">
                                ...
                                <div class="form-group">
                                    <input class="form-control" required type="text" name="bill_number"
                                        ...
                                        value="<?php echo e(isset($edit) ? (!empty(@$edit->bill_number) ? @$edit->bill_number : old('bill_number')) : ''); ?>"
                                        >
                                </div>
                            </div>
                            <div class="col-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control date-picker" id="bill_date" type="text"
                                        autocomplete="off" name="bill_date" value="<?php echo e(@$value_date); ?>" required>
                                </div>
                            </div>
                             ...
                             <div class="col-2">
                                ...
                                <div class="form-group">
                                    <input
                                        ...
                                        value="<?php echo e(isset($edit) ? (!empty(@$edit->lpo_number) ? @$edit->lpo_number : old('lpo_number')) : ''); ?>">
                                </div>
                            </div>
                            <div class="col-2">
                                ...
                                <div class="form-group">
                                    <input class="form-control date-picker" id="lpo_date" type="text"
                                        autocomplete="off" name="lpo_date" value="<?php echo e(@$value_date); ?>"
                                    ...
                                    <select class="form-control js-example-basic-single" name="payment_terms"
                                        ...
                                        <?php $__currentLoopData = $paymentterms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e(@$value->id); ?>"
                                                <?php echo e(isset($edit) ? (!empty(@$edit->payment_terms) ? (@$edit->payment_terms == @$value->id ? 'selected' : '') : '') : ''); ?>>
                            ...
                            <div class="col-2">
                                ...
                                <div class="form-group">
                                    <input class="form-control" type="text" name="deal_id" autocomplete="off"
                                        id="deal_id"
                                        value="<?php echo e(isset($edit) ? (!empty(@$edit->deal_id) ? @$edit->deal_id : old('deal_id')) : ''); ?>">
                                </div>
                            </div>
                            ...
                            $(document).ready(function () {
                                ...
                                <!-- <div class="form-group">
                                    <select class="form-control js-example-basic-single" name="ref_company_id"
                                        ...
                                        <?php $__currentLoopData = $customer_reference_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e(@$value->id); ?>"
                                                <?php if(@$deal->cust_id == @$value->id): ?> selected <?php endif; ?>><?php echo e(@$value->name); ?>
                                    ...
                                    <input class="form-control" type="hidden" name="reference" autocomplete="off"
                                        value="<?php echo e(isset($edit) ? (!empty(@$edit->reference) ? @$edit->reference : old('reference')) : old('reference')); ?>"
                                        id="reference">
                                </div> -->
                            </div>
                            <div class="col-2">
                            ...
                            <div class="col-2">
                                ...
                                <div class="form-group">
                                    <!-- <input class="form-control" type="text" name="warehouse" autocomplete="off"
                                        value="<?php echo e(isset($edit) ? (!empty(@$edit->warehouse) ? @$edit->warehouse : old('warehouse')) : old('warehouse')); ?>"
                                        id="warehouse"> -->
                                        ...
                                        <?php $__currentLoopData = $warehouses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e(@$value->id); ?>"><?php echo e(@$value->warehouse_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="col-2">
                                ...
                                <div class="form-group">
                                    <input
                                        ...
                                        value="<?php echo e(isset($edit) ? (!empty(@$edit->boeno) ? @$edit->boeno : old('boeno')) : old('boeno')); ?>"
                                        id="boeno">
                                </div>
                            </div>
                            ...
                            <div class="col-2">
                                ...
                                <div class="form-group">
                                    <input
                                        ...
                                        value="<?php echo e(isset($edit) ? (!empty(@$edit->awbno) ? @$edit->awbno : old('awbno')) : old('awbno')); ?>"
                                        id="awbno">
                                </div>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    <input class="form-control" data-bs-toggle="modal"
                                        ...
                                        value="<?php echo e(isset($edit) ? (!empty(@$edit->narration) ? @$edit->narration : old('narration')) : ''); ?>">
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <select class="form-control js-example-basic-single" name="shipping_supplier"
                                ...
                                <?php $__currentLoopData = $customer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <option value="<?php echo e(@$value->id); ?>" <?php if($value->company_ship_to_id == session('logged_session_data.company_id')): ?>
                            ...
                            <select class="form-control js-example-basic-single" name="supplier_country"
                                ...
                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e(@$value->id); ?>" <?php try{?>
                                        <?php if(isset($edit)): ?> <?php if(@$edit->supplier_country == $value->id): ?> selected <?php endif; ?>
                                        <?php endif; ?>
                            ...
                            <div id="sectionStateDiv">
                                <select class="form-control js-example-basic-single" name="supplier_state"
                                    ...
                                    <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(isset($edit)): ?>
                                            <option data-display="<?php echo e($edit->vatstate->name); ?>"
                                                value="<?php echo e($edit->customer_state); ?>" selected>
                                                <?php echo e($edit->vatstate->name); ?></option>
                                        <?php else: ?>
                    ...
                    <div class="col">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="vat_percent" id="vat_percent"
                                value="<?php echo e(@$editData->vat_percent); ?>">
                        </div>
                    </div>
                    ...
                    <div class="col">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="vat_number" id="vat_number"
                                value="<?php echo e(@$editData->vat_number); ?>">
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            <select
                                ...
                                <?php $__currentLoopData = $suppliertype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e(@$value->id); ?>"
                                        <?php echo e(isset($edit) ? (!empty(@$edit->supplier_type) ? (@$edit->supplier_type == @$value->id ? 'selected' : '') : '') : ''); ?>>
                                        <?php echo e(@$value->title); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
            ...
            <tbody>
                <tr>
                    ...
                    <td><input class="form-control text-end" type="text" name="fright[]" autocomplete="off"
                            min="0" onchange="calc_change_new(this)" onblur="formatCurrency(this)"></td>
                    <td><input class="form-control text-end" type="text" name="customcharges[]" autocomplete="off"
                            min="0" onchange="calc_change_new(this)" onblur="formatCurrency(this)"></td>
                    ...
                    <tr id="fright_row_1">
                        ...
                        <td>
                            <select class="form-control js-example-basic-single" name="cfc_credit_account[]" id="cfc_credit_account_1"
                                ...
                                <?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<br>
                                    ...
                                    <table class="table table-hover popupPI" id="long-list"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width:30px" class="text-center"><?php echo app('translator')->getFromJson('SL'); ?></th>
                                                <th style="width:80px"><?php echo app('translator')->getFromJson('Part No'); ?></th>
                                                <th style="width:80px"><?php echo app('translator')->getFromJson('Description'); ?></th>
                                                <th style="width:30px" class="text-center"><?php echo app('translator')->getFromJson('Tax'); ?></th>
                                                <th style="width:30px" class="text-center"><?php echo app('translator')->getFromJson('GRN Qty'); ?></th>
                                                ...
                                                <th class="resizable text-end" width="40px" scope="col">Dis</th>
                                                <th class="resizable text-end" width="40px" scope="col">Freight
                                                </th>
                                                <th class="resizable text-end" width="40px" scope="col">Custom
                                                </th>
                                                <th class="resizable text-end" width="60px"><?php echo app('translator')->getFromJson('Taxable'); ?></th>
                                                <th class="resizable text-end" width="60px"><?php echo app('translator')->getFromJson('VAT'); ?></th>
                                                <th class="resizable text-end" width="60px"><?php echo app('translator')->getFromJson('Total'); ?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
    ...
    <script>
        function get_adjustment_list() {
            ...
            var action = "<?php echo e(URL::to('purchase-invoice-get-adjustment')); ?>";
            $.ajax({
                url: action,
                type: "POST",
                data: {
                    ...
                    if (data.unadjusted && data.unadjusted.length > 0) {
                        ...
                        for (var i = 0; i < data.unadjusted.length; i++) {
                            var a = (data.unadjusted[i].amount - data.unadjusted[i].adj_amount).toFixed(
                                <?php echo json_encode(session('logged_session_data.decimal_point'), 15, 512) ?>).replace(/\d(?=(\d{3})+\.)/g, '$&,');
                            getSelectedRows += "<tr>\
    ...
    <script>
        $(document).ready(function() {
            $('#adjustmentForm').on('submit', function(e) {
                ...
                // AJAX submission
                $.ajax({
                    url: "<?php echo e(url('purchase-invoice-add-adjustment-cart')); ?>", // Replace with your actual route
                    type: "POST",
                    data: formData,
                    success: function(response) {
                        // Handle success response
                        // alert('Adjustment saved successfully.');
                        //show toastr or any success message as needed
    ...
    <script>
        ...
        function popup_grn_pending(id) {
            ...
            $('input[name="pending_grn"]:checked').each(function() {
                selectedValues.push($(this).val());
            });

    
            IDs.push(id);
            var ids = IDs.filter(function(item, pos) {
                return IDs.indexOf(item) == pos;
            });
            $("#hd_pending_grn_id").val(selectedValues.join(","));
    ...
    <script>
        ...
        function get_po_list(id) {
            ...
            $("#loading_bg").css("display", "block");
            var action = "<?php echo e(URL::to('goods-receipt-note-for-pi')); ?>";
            $.ajax({
                url: action,
                type: "POST",
                data: {
        ...
        function get_deal_code() {
            var action = "<?php echo e(URL::to('get-deal-code-from-id')); ?>";
            $.ajax({
                url: action,
                type: "POST",
                data: {
    ...
    <script>
        ...
        function add_license_key() {
            ...
            var action = "<?php echo e(URL::to('add-grn-license-key-cart')); ?>";
            $.ajax({
                url: action,
                type: "POST",
                data: {
        ...
        function view_license_key() {
            $("#loading_bg").css("display", "block");
            var action = "<?php echo e(URL::to('view-grn-license-key-cart')); ?>";
            $.ajax({
                url: action,
                type: "POST",
                data: {
        ...
        function delete_license_key(id) {
            $("#loading_bg").css("display", "block");
            var action = "<?php echo e(URL::to('delete-grn-license-key-cart')); ?>";
            $.ajax({
                url: action,
                type: "POST",
                data: {
