...
<?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'proforma-invoice', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'quotation-store-form', 'novalidate' => true])); ?>
...
<div class="purchase-order-content-header sticky-top" style="background-color: #f7f8fd">
    <h4 class="purchase-order-content-header-left">
        ...
        New (<span class="font-weight-600"
            id="new_code"><?php echo e(App\SysHelper::get_new_code_lead('sys_proforma_invoice', 'PF', 'doc_number', session('logged_session_data.company_id'))); ?></span>)
    </h4>
                ...
                <div class="form-group">
                    <select class="form-control js-example-basic-single" name="cust_id" id="cust_id" required
                        ...
                        <?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e(@$value->id); ?>" <?php if(@$ctrl_cust_id == $value->id): ?> selected <?php endif; ?>>
                                <?php echo e(trim(@$value->name)); ?><?php if(@App\SysHelper::getCompanyCodeSettings()['is_customer_code'] == 1): ?>
                                (<?php echo e(trim(@$value->code)); ?>)<?php endif; ?>
                            </option>
            ...
            <div class="col-2">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date-picker" id="estimated_close_date" type="text" autocomplete="off"
                        name="estimated_close_date" value="<?php echo e(@$value); ?>" required>
                </div>
            </div>
            <div class="col-3">
                ...
                <div class="form-group">
                    <select class="form-control js-example-basic-single" name="owner" id="owner" required>
                               ...
                               <input class="form-control" type="hidden" name="deal_id" autocomplete="off" id="deal_id"
                        value="">
            ...
            <div class="col-2">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date-picker" id="lpo_date" type="text" autocomplete="off" name="doc_date"
                        value="<?php echo e(@$value_date); ?>" style="margin-top: 0px">
                </div>
            </div>
              ...
              <div class="col-2">
                                     ...
                                     <div class="form-group">
                                         ...
                                         <select class="form-control js-example-basic-single" required name="proforma_invoice" id="proforma_invoice">
                                            ...
                                            <option value="PI" selected>Proforma Invoice</option>
                        ...
                        <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart_items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td><textarea class="form-control" name="description[]"
                                        rows="1"><?php echo e($cart_items->description); ?></textarea></td>
                                <td>
                                    <input class="form-control text-end" type="text" name="cost[]" autocomplete="off"
                                        value="<?php echo e(number_format($cart_items->cost, 2)); ?>" onchange="calc_change_new(this)"
                                ...
                                <td><input type="number" class="form-control text-center" name="tax[]"
                                        value="<?php echo e($cart_items->vat); ?>" onchange="calc_change_new(this)"></td>
                                <td><input class="form-control text-center" type="number" name="qty[]" autocomplete="off"
                                        min="0" onchange="calc_change_new(this)" value="<?php echo e($cart_items->qty); ?>"></td>
                                <td><input class="form-control text-end" type="text" name="unitprice[]" step="any"
                                        value="<?php echo e(number_format($cart_items->price, 2)); ?>" autocomplete="off" min="0"
                                ...
                                <td><input class="form-control text-end" type="text" step="Any" name="discount[]"
                                        value="<?php echo e(number_format($cart_items->discount, 2)); ?>" autocomplete="off" min="0"
                                        onchange="calc_change_new(this)" onblur="formatCurrency(this)"></td>
                                    ...
                                    <div style="display:none">
                                        ...
                                        <select class="form-select js-example-basic-single"
                                            ...
                                            <?php $__currentLoopData = $country; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e(@$value->iso2); ?>|<?php echo e(@$value->id); ?>"><?php echo e(@$value->name); ?>
                                        ...
                                        <select class="form-control js-example-basic-single" name="state_ship"
                                            ...
                                            <?php if(isset($editData) && $editData->vat_state != ''): ?>
                                                <option data-display="<?php echo e($editData->vatstate->name); ?>"
                                                    ...
                                                    <?php echo e($editData->vatstate->name); ?>
                            ...
                            <div class="col">
                                <div class="">
                                    ...
                                    <select class="form-control js-example-basic-single" id="payment_terms2" required>
                                        <?php $__currentLoopData = $paymentterms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e(@$value->id); ?>" <?php if($value->id == 3): ?> selected <?php endif; ?>>
...
<script>
 ...
 function get_guote_list(id) {
            $("#loading_bg").css("display", "block");
            var action = "<?php echo e(URL::to('quotation-pending')); ?>";
            $.ajax({
                url: action,
                type: "POST",
                data: {
                ...
                success: function(dataResult) {
                    ...
                    if (len > 0) {
                        ...
                        for (var i = 0; i < len; i++) {
                            if (dataResult['data'] != "ERROR") {
                                var id = dataResult['data'][i].id;
                                var code = dataResult['data'][i].code;
                                ...
                                var innerHtml =
                                    ...
                                    ")' id='pending_qt_" + i +
                                    "' name='pending_qt' value='" + id +
                                    "'> <label for='pending_qt_" + i + "'> " + code +
                                    "</label><br />";
