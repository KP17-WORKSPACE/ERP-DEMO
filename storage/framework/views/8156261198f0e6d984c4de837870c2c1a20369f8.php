        ...
        <div class="" role="tabpanel" aria-labelledby="data-tab" id="data-details">
            <div class="purchase-order-content-header">
                ...
                <div class="purchase-order-content-header-right">
                    ...
                    <a class="btn btn-light text-dark" href="<?php echo e(url('receipt-add')); ?>">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" style="">
                            ...
                            <li>
                                <a
                                    href="<?php echo e(url('customer-ageing-report')); ?>"class="dropdown-item d-flex align-items-center"><i
        ...
        $(document).ready(function() {
          ...
          function view(accountId){
            $.ajax({
                ...
                type: "post",
                data: { _token: '<?php echo e(csrf_token()); ?>', id_deal: accountId },
                success: function(dataResult) {
                    ...
                    dataResult.forEach(function(re) {
                        ...
                        var attachmentHtml = '';
                        if (re.file) {
                            attachmentHtml = '<a href="<?php echo e(asset("public/uploads/outstand_comments_doc/")); ?>/' + re.file +
            ...
            <?php if(Auth::user()->role_id==1 || Auth::user()->role_id==2): ?>
                <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'receivable-outstanding', 'method' => 'POST', 'enctype' => 'multipart/form-data'])); ?>
                                        ...
                                        <div class="col-1-5 mb-20">
                                            <div class="input-effect">
                                                ...
                                                <select class="form-control js-example-basic-single" name="account_id[]" id="account_id" multiple>
                                                    <option value="view_all_cust" <?php if(in_array('view_all_cust', $selectedAccounts)): ?> selected <?php endif; ?>><?php echo app('translator')->getFromJson('View All Customers'); ?></option>
                                                    <?php $__currentLoopData = $accounts_select; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e(@$val->id); ?>" <?php if(in_array($val->id, $selectedAccounts)): ?> selected <?php endif; ?>><?php echo e(@$val->account_name); ?>
...
<!--                     
                                        <div class="col-1-5  mb-2">
                                            ...
                                            <input class="form-control" id="transaction_no" type="text" value="<?php echo e(@$ctrl_doc_no); ?>" autocomplete="off" name="transaction_no" >
                                        </div>
                                        <div class="col-1-5  mb-2">
                                            <label for="" class="form-check-label">Deal ID</label>
                                            <input class="form-control" id="deal_id" type="text" value="<?php echo e(@$ctrl_deal_id); ?>" autocomplete="off" name="deal_id" >
                                        </div>
                                        <div class="col-1-5  mb-2">
                                            <label for="" class="form-check-label">Amount</label>
                                            <input class="form-control" name="amount" id="amount" value="<?php echo e(@$ctrl_amount); ?>" />
                                        </div> -->
                                        ...
                                        <div class="col-1  mb-2">
                                            ...
                                            <select class="form-control js-example-basic-single" name="list_option" id="list_option">
                                                ...
                                                <option value="grn" <?php if(@$ctrl_list_option == 'grn'): ?> selected <?php endif; ?>>GRN</option>
                                            </select>
                                        </div>
                                        <div class="col-1  mb-2">
...
<style>
    ...
    border-bottom-color: #f0f1f3;
                ...
                <div id="collapse<?php echo e($aname->id); ?>" class="collapse" data-parent="#accordionExample">  
                <table class="table sub_table table-hover" id="long-list" style="border: solid 1px #e3e6f0; width:100%; table-layout:fixed;">
                    ...
                    <thead>
                      ...
                      <tr>
                        <th class="text-center" style="width:6%">Deal ID</th>
                          ...
                          <?php if(!$hideBasicColumns): ?>
                          <th class="text-center hidecol_<?php echo e($aname->id); ?>" style="width:6%">Receipt Date</th>
                          <th class="text-start hidecol_<?php echo e($aname->id); ?>" style="width:6%">Receipt No</th>
                          <?php endif; ?>
                    ...
                    ?>
                        ...
                        <?php if(((@App\SysHelper::com_curr_format($dt->debit_amount,2,'.','') != @App\SysHelper::com_curr_format($paid,2,'.','')) || (@App\SysHelper::com_curr_format($dt->credit_amount,2,'.',''))>0) && $is_hide2 == 0): ?>
                        ...
                        <td class="text-center">
                            ...
                            ?>
                                ...
                                <?php else: ?>
                                <a href="<?php echo e(url('crm-deal-track-approval-list/'.$deal_track_id)); ?>" target="_blank"><?php echo e($deal_code); ?></a><input type="hidden" id="inv_e_deal_code_<?php echo e($dt->transaction_no); ?>" value="<?php echo e($deal_code); ?>" /></td>
                                <?php endif; ?>
                            <td class="text-center"><?php echo e(date('d/m/Y', strtotime($dt->transaction_date))); ?><input type="hidden" id="inv_e_doc_date_<?php echo e($dt->transaction_no); ?>" value="<?php echo e(date('d/m/Y', strtotime($dt->transaction_date))); ?>" /></td>
                            <td class="text-center">
                                <?php if($dt->transaction_type=="opbinvoice"): ?>
                                <?php echo e($dt->transaction_no); ?>

                                <?php else: ?>
                                <a href="<?php echo e(url('get-url-sales-invoice/'.$dt->transaction_no)); ?>" target="_blank"><?php echo e($dt->transaction_no); ?></a><input type="hidden" id="inv_e_doc_no_<?php echo e($dt->transaction_no); ?>" value="<?php echo e($dt->transaction_no); ?>" /></td>
                                <?php endif; ?> <?php $all_sivno_count++ ?>
                            <td class="text-center"><?php echo e($lpo_no); ?><input type="hidden" id="inv_e_lpo_no_<?php echo e($dt->transaction_no); ?>" value="<?php echo e($lpo_no); ?>" /></td>
                            

                            
                            <td class="text-end"><?php if(str_contains($dt->transaction_no,'SR')): ?> - <?php echo e(@App\SysHelper::com_curr_format($dt->credit_amount,2,'.',',')); ?>

                                <input type="hidden" id="inv_e_amount_<?php echo e($dt->transaction_no); ?>" value="<?php echo e(@App\SysHelper::com_curr_format($dt->credit_amount,2,'.',',')); ?>" />
                                <?php else: ?>  <?php echo e(@App\SysHelper::com_curr_format($dt->debit_amount,2,'.',',')); ?> 
                                <input type="hidden" id="inv_e_amount_<?php echo e($dt->transaction_no); ?>" value="<?php echo e(@App\SysHelper::com_curr_format($dt->debit_amount,2,'.',',')); ?>" />
                                <?php endif; ?></td>
                            <td class="text-end"><?php echo e(@App\SysHelper::com_curr_format($paid,2,'.',',')); ?><input type="hidden" id="inv_e_adjustment_<?php echo e($dt->transaction_no); ?>" value="<?php echo e(@App\SysHelper::com_curr_format($paid,2,'.',',')); ?>" /></td>
                            <td class="text-end"><?php echo e(@App\SysHelper::com_curr_format($dt->debit_amount-abs($paid),2,'.',',')); ?>
                                ...
                                } else{ $b += $dt->debit_amount-abs($paid); } ?>
                            
                            </td>
                            <td class="text-end"><?php echo e(@App\SysHelper::com_curr_format($b,2,'.',',')); ?></td>

                            <?php $sum_b += $dt->debit_amount-abs($paid); $all_total += $dt->debit_amount-abs($paid); ?>
                            <input type="hidden" class="inv_e_total" value="<?php echo e($dt->debit_amount-abs($paid)); ?>" />
                            <script>
                            ...
                            <td class="text-center"><?php echo e($DueData[1]); ?> <?php $all_overdue += $DueData[1]; ?></td>
                            <?php }  ?>
                            <?php 
                            if($DueData[3] ==1)	  {
                                $gtot1+=$dt->debit_amount-abs($paid);
                                $all_0_30 += $dt->debit_amount-abs($paid);
                            ?><input type="hidden" class="inv_all_0_30" value="<?php echo e($dt->debit_amount-abs($paid)); ?>" /><?php
                            }
                            if($DueData[3] ==2)	  {
                                $gtot2+=$dt->debit_amount-abs($paid);
                                $all_31_60 += $dt->debit_amount-abs($paid);                                
                            ?><input type="hidden" class="inv_all_31_60" value="<?php echo e($dt->debit_amount-abs($paid)); ?>" /><?php
                            }
                            if($DueData[3] ==3)	  {
                                $gtot3+=$dt->debit_amount-abs($paid);
                                $all_61_90 += $dt->debit_amount-abs($paid);
                            ?><input type="hidden" class="inv_all_61_90" value="<?php echo e($dt->debit_amount-abs($paid)); ?>" /><?php
                            }
                            if($DueData[3] ==4)	  {
                                $gtot4+=$dt->debit_amount-abs($paid);
                                $all_90_above += $dt->debit_amount-abs($paid);
                            ?><input type="hidden" class="inv_all_90_above" value="<?php echo e($dt->debit_amount-abs($paid)); ?>" /><?php
                            }                                   
...
<?php if(!$hideBasicColumns): ?>
                            <?php if($DueData[3] ==1): ?>                            
                            <td class="text-end" ><?php echo e(@App\SysHelper::com_curr_format($dt->debit_amount-abs($paid),2,'.',',')); ?></td>
                            <?php else: ?> 	
                            ...
                            <?php endif; ?>
                             ...
                             <td class="text-start"><?php echo e($sales_person); ?></td>
                            <td class="text-start"><?php echo e($DueData[2]); ?></td>
                            <td class="text-center hidecol_<?php echo e($aname->id); ?>"><?php echo e(rtrim($receipt_date, ',')); ?> </td>
                             <td class="text-center hidecol_<?php echo e($aname->id); ?>"><?php $__currentLoopData = explode(',', rtrim($doc_number, ',')); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <a href="<?php echo e(url('get-url-receipt/' . trim($doc))); ?>" target="_blank">
        <?php echo e(trim($doc)); ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></td>
                    ...
                    <?php if(($dt->sum('debit_amount') != $paid || ($dt->sum('credit_amount'))>0)  && $is_hide == 0): ?>
                    
                    <tr>
                    <!-- <td class="text-center"><b><?php echo e($row_count_1); ?></b></td> -->
                    <td colspan="4"></td>
                        ...
                        <?php if(!$hideBasicColumns): ?>
                            ...
                            <td class="text-center" colspan="2">&nbsp </td>
                            <td class="text-center hidecol_<?php echo e($aname->id); ?>" width="150px">&nbsp;</td>
                            <td class="text-center hidecol_<?php echo e($aname->id); ?>" width="150px">&nbsp;</td>
                        <?php endif; ?>
                    ...
                    <?php else: ?>
                    <script>
                        $('.hidecol_'+<?php echo e($aname->id); ?>).css('display','');
                    </script>
                    <?php endif; ?>
 ...
 <?php $pdc2 = !empty($list_of_unadjusted_pdc) ? $list_of_unadjusted_pdc->where('account_id',$aname->id) : []; ?></tr>
                  ...
                  <?php if(count($pdc)>0 || count($pdc2)>0): ?>
                  <b>List of PDC:-</b>
                  <table class="table sub_table table-hover" id="long-list" style="border: solid 1px #e3e6f0; width:100%; table-layout:fixed;">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr id="row_pdc_received_<?php echo e($p->doc_number); ?>">
                            <td class="text-center"> 
                                <?php if(@App\SysHelper::get_code_from_dealid($deal_id) != 'Without Deal'): ?>
                                    <a href="<?php echo e(url('crm-deal-track-approval-list/'.$deal_id)); ?>" target="_blank"><?php echo e(@App\SysHelper::get_code_from_dealid($deal_id)); ?></a>
                                <?php else: ?>
                            ...
                            <td class="text-center"><a href="<?php echo e(url('get-url-receipt/' . $p->doc_number)); ?>" target="_blank"><?php echo e($p->doc_number); ?></a></td>
                            ...
                            <td class="text-center"><?php echo e(date('d/m/Y', strtotime($p->receipt_date))); ?></td>
                            <td class="text-center">
                            ...
                            <td class="text-center"><a class="text-danger text-center" id="btn_pdc_received_<?php echo e($p->doc_number); ?>" onclick="pdc_update('<?php echo e($p->doc_number); ?>','<?php echo e(@App\SysHelper::normalizeToDmy($p->receipt_date)); ?>',3)"><i class="ico icon-outline-pen-new-square" style="font-size: 16px" aria-hidden="true"></i></a></td>
                        ...
                        <tr id="row_pdc_received_<?php echo e($p->doc_number); ?>">
                            ...
                            <td class="text-center"><?php echo e($p->cheque_number); ?></td>
                            <td class="text-center"><?php echo e(date('d/m/Y', strtotime($p->receipt_date))); ?></td>
                            <td class="" colspan="2"><?php echo e($p->remarks); ?></td>
                            <td class="text-center"><a class="text-danger text-center" id="btn_pdc_received_<?php echo e($p->doc_number); ?>" onclick="pdc_update('<?php echo e($p->doc_number); ?>','<?php echo e(@App\SysHelper::normalizeToDmy($p->receipt_date)); ?>',2)"><i class="ico icon-outline-pen-new-square" style="font-size: 16px" aria-hidden="true"></i></a></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $unadj_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <?php
                            ...
                            ?>
                            <?php if(Illuminate\Support\Str::contains($docNumber, ['BR', 'CR'])): ?>
                               <?php
                                    if($p->doc_number){
                                    $deal_id = @App\SysReceipt::where('doc_number',$p->doc_number)->pluck('deal_id')->first();
                                    }
                            ...
                            <?php elseif(Illuminate\Support\Str::contains($docNumber, ['SR'])): ?>
                                <?php
                                    if($p->doc_number){
                        ...
                        <tr>
                            <td class="text-center"> <?php if(@App\SysHelper::get_code_from_dealid($deal_id)!= 'Without Deal'): ?>
                                ...
                                <?php endif; ?></td>
                            <td class=""><?php echo e(date('d/m/Y', strtotime($p->doc_date))); ?></td>
                            <?php
                                $docNumber = $p->doc_number;
                            ?>
                            <?php if(Illuminate\Support\Str::contains($docNumber, ['BR', 'CR'])): ?>
                                <td class="text-center">
                                    <a href="<?php echo e(url('get-url-receipt/' . $docNumber)); ?>" target="_blank"><?php echo e($docNumber); ?></a>
                                </td>
                            <?php elseif(Illuminate\Support\Str::contains($docNumber, ['JV'])): ?>
                                <td class="text-center">
                            ...
                            <?php elseif(Illuminate\Support\Str::contains($docNumber, ['SR'])): ?>
                                <td class="text-center">
                                    <a href="<?php echo e(url('get-url-sales-return/' . $docNumber)); ?>" target="_blank"><?php echo e($docNumber); ?></a>
                                </td>
                            <?php else: ?>
                            <td class="text-center">
            ...
            <div class="row">
                    ...
                    <div class="no-gutters input-right-icon">
                        <div class="col">
                            <div class="input-effect">
                                ...
                                <label class="form-label"><?php echo app('translator')->getFromJson('Receipt Date'); ?><span></span></label>
                ...
                <div class="col-lg-6 mb-12">
                    <div class="no-gutters input-right-icon">
                        <div class="col">
                            <div class="input-effect">
                                <label class="form-label"><?php echo app('translator')->getFromJson('Status'); ?><span></span></label>
...
<script>
    ...
    function pdc_update_save() {
        ...
        var action = "<?php echo e(URL::to('update-receivable-pdc')); ?>";
        $.ajax({
            url: action,
            type: "POST",
            data: {
