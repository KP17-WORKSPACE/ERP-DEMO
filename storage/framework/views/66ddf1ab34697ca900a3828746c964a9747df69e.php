...
<input type="hidden" name="net_vat" id="net_vat" value="0">
    ...
    <div class="purchase-order-content-header sticky-top" style="background-color: #f7f8fd">
        <h4 class="purchase-order-content-header-left">
            ...
            New (<span class="font-weight-600" id="new_code"><?php echo e(App\SysHelper::get_new_code_lead('sys_crm_deals', 'DL', 'code', session('logged_session_data.company_id'))); ?></span>)
        </h4>
            ...
            <button type="submit" class="btn btn-light">
             ...
             <div class="dropdown">
                ...
                <ul class="dropdown-menu">                    
                    <li><button class="dropdown-item d-flex align-items-center text-success"><i class="ico icon-bold-download-minimalistic  text-success title-15 me-2"></i> Save & Download</button></li>
    ...
    $(document).ready(function() {
                                    ...
                                    <div class="row gap-rows">
                                         ...
                                         <div class="col-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <option value="<?php echo e(@$value->id); ?>" <?php if(@$ctrl_cust_id == $value->id): ?> selected <?php endif; ?>><?php echo e(trim(@$value->name)); ?><?php if(@App\SysHelper::getCompanyCodeSettings()['is_customer_code'] == 1): ?> (<?php echo e(trim(@$value->code)); ?>)<?php endif; ?></option>
                                         ...
                                         <div class="col-2">
                                            ...
                                            <div class="form-group">
                                    <input class="form-control capitalize-title" type="text" name="deal_name" autocomplete="off" id="deal_name" value="<?php echo e(isset($edit) ? (!empty(@$edit->deal_name) ? @$edit->deal_name : old('deal_name')) : old('deal_name')); ?>" required>
                                            </div>
                                        </div>
        ...
        if (isset($edit) && $edit->estimated_close_date != "1970-01-01") {
         ...
         //$value = @App\SysHelper::normalizeToDmy(@$value);
                                    ?>
                                    <input class="form-control date-picker" id="estimated_close_date" type="text" autocomplete="off" name="estimated_close_date"
                                         ...
                                         <div class="col-2">                                        
                                            ...
                                            <div class="form-group">
                                                 <select class="form-control js-example-basic-single" name="company" id="company" required>
                                                    ...
                                                    <?php $__currentLoopData = $company; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    
                                                    <option value="<?php echo e(@$value2->id); ?>" <?php if(session('logged_session_data.company_id') == @$value2->id): ?> selected <?php endif; ?>><?php echo e(@$value2->company_name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
                            ...
                            <div class="tab-wrap mb-3">
                                ...
                                <div class="tab-content mb-3" id="purchaseDetailsTabsContent">
                                    <div class="tab-pane fade show active" id="extra-fields" role="tabpanel" aria-labelledby="extra-fields-tab">
                                        <div class="row gap-rows">
                                            ...
                                            <div class="col-lg-2 mb-2">
                                                <div class="input-effect">
                                                    ...
                                                    <input class="form-control capitalize-title" type="text" name="cust_name" autocomplete="off" id="cust_name" value="<?php echo e(isset($edit) ? (!empty(@$edit->cust_name) ? @$edit->cust_name : old('cust_name')) : old('cust_name')); ?>" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-2 mb-2">
                                                <div class="input-effect">
                                                    <label class="form-label">Designation</label>
                                                   <input class="form-control capitalize-title" type="text" name="designation" autocomplete="off" id="designation" value="<?php echo e(isset($edit) ? (!empty(@$edit->designation) ? @$edit->designation : old('designation')) : old('designation')); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2 mb-2">
                                                <div class="input-effect">
                                                    ...
                                                    <input class="form-control" type="text" name="cust_no" autocomplete="off" id="cust_no" value="<?php echo e(isset($edit) ? (!empty(@$edit->cust_no) ? @$edit->cust_no : old('cust_no')) : old('cust_no')); ?>">
                                                </div>
                                            </div>
                                            <div class="col-lg-2 mb-2">
                                                <div class="input-effect">
                                                    <label class="form-label">Email</label>
                                                  <input class="form-control" type="text" name="cust_email" autocomplete="off" id="cust_email" value="<?php echo e(isset($edit) ? (!empty(@$edit->cust_email) ? @$edit->cust_email : old('cust_email')) : old('cust_email')); ?>" data-bs-toggle="modal" data-bs-target="#EmailModal">
                                                </div>
                                            </div>
                                            <div class="col-lg-2 mb-2">
                                                <div class="input-effect">
                                                    <label class="form-label">Address<span></span></label>
                                                    <input class="form-control capitalize-title" type="text" name="address" data-bs-toggle="modal" data-bs-target="#AddressModal" autocomplete="off" id="address" value="<?php echo e(isset($edit) ? (!empty(@$edit->address) ? @$edit->address : old('address')) : old('address')); ?>">
                                                </div>
                                            </div>
                                            <div class="col-lg-2 mb-2">
                                                <div class="input-effect">
                                                    ...
                                                    <select class="form-control js-example-basic-single" name="tags[]" id="tags" multiple>
                                                        ...
                                                        <option value="<?php echo e(@$value->title); ?>"
                                                            <?php if(isset($edit)): ?>
                                                                <?php if(!empty($edit->tags)): ?>
                                                                    <?php if(str_contains($edit->tags, $value->title)): ?> selected <?php endif; ?>
                                                                <?php endif; ?>
                                                            <?php endif; ?> ><?php echo e(@$value->title); ?>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="input-effect">
                                                    <label class="form-label">Deal Value<span>*</span></label>
                                                    <div class="form-group">
                                                         <input class="form-control text-end" type="number" step="any" name="deal_value" autocomplete="off" id="deal_value" value="<?php echo e(isset($edit) ? (!empty(@$edit->deal_value) ? @App\SysHelper::currancy_format_deal_no($edit->deal_value, $edit->company_id) : old('deal_value')) : old('deal_value')); ?>">
                                                    </div>
                                            ...
                                            <div class="col-lg-2 mb-2">
                                                <div class="input-effect">
                                                    ...
                                                    ?>
                                                    <input class="form-control date-picker" id="date" type="text" name="date" value="<?php echo e(@App\SysHelper::normalizeToDmy($value)); ?>">
                                                </div>
                                            </div>
                                            <div class="col-lg-2 mb-2" style="display: none;">
                                                <div class="input-effect">
                                                    ...
                                                    <select class="form-control js-example-basic-single" name="stage" id="stage">
                                                        <option value="1" <?php if(@$edit->stage == 1): ?> selected <?php endif; ?> >Prospecting</option>
                                                        <option value="2" <?php if(@$edit->stage == 2): ?> selected <?php endif; ?> >Quote</option>
                                                        <option value="3" <?php if(@$edit->stage == 3): ?> selected <?php endif; ?> >Closure</option>
                                            ...
                                            <div class="col-lg-2 mb-2" style="display: none;">
                                                <div class="input-effect">
                                                    ...
                                                    <select class="form-control js-example-basic-single" name="source" id="source">
                                                        ...
                                                        <option value="Mail" <?php if(@$edit->source == "Mail"): ?> selected <?php endif; ?> <?php if(!isset($edit)): ?> selected <?php endif; ?>>Mail</option>
                                                        <option value="Website" <?php if(@$edit->source == "Website"): ?> selected <?php endif; ?> >Website</option>
                                                        <option value="Gitex 2023" <?php if(@$edit->source == "Gitex 2023"): ?> selected <?php endif; ?> >Gitex 2023</option>
                                                        <option value="Gitex" <?php if(@$edit->source == "Gitex"): ?> selected <?php endif; ?> >Gitex</option>
                                                        <option value="Fulfillment" <?php if(@$edit->source == "Fulfillment"): ?> selected <?php endif; ?> >Fulfillment</option>
                                                        <option value="Ecommerce" <?php if(@$edit->source == "Ecommerce"): ?> selected <?php endif; ?> >Ecommerce</option>
                                                        <option value="Other" <?php if(@$edit->source == "Other"): ?> selected <?php endif; ?> >Other</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-lg-2 mb-2" id="sourcediv" style="display: none;">
                                                <div class="input-effect">
                                                    ...
                                                    <input class="form-control" type="text" name="source_o" autocomplete="off" id="source_o" value="<?php echo e(isset($edit) ? (!empty(@$edit->source_o) ? @$edit->source_o : old('source_o')) : old('source_o')); ?>" style="display: none;" placeholder="Source">
                                                </div>
                                            </div>
                                            <div class="col-lg-2 mb-2">
                                                <div class="input-effect">
                                                    ...
                                                    <select class="form-control js-example-basic-single" name="isproject" id="isproject">
                                                        ...
                                                        <option value="1" <?php if(@$edit->isproject == "1"): ?> selected <?php endif; ?> >Reseller</option>
                                                        <option value="2" <?php if(@$edit->isproject == "2"): ?> selected <?php endif; ?> >Enduser</option>
                                                        <option value="3" <?php if(@$edit->isproject == "3"): ?> selected <?php endif; ?> >E-Commerece</option>
                                                        <option value="5" <?php if(@$edit->isproject == "5"): ?> selected <?php endif; ?> >Marketing</option>
                                                    </select>
                                                    <script>
                                        ...
                                        <option value="1" <?php if(@$edit->status == 1): ?> selected <?php endif; ?> >New</option>
                                        <option value="2" <?php if(@$edit->status == 2): ?> selected <?php endif; ?> >Qualified</option>
                                        <option value="3" <?php if(@$edit->status == 3): ?> selected <?php endif; ?> >Unqualified </option>
                                    </select>
                                        ...
                                        $('#status').on('change', function(e) {
                                            ...
                                            <div class="col-lg-2 mb-2">
                                                <div class="input-effect">
                                                    ...
                                                    <div class="form-control" style="padding: 1px 5px">
                                                        <input class="form-check-input" type="checkbox" value="1" id="is_professional_service" name="is_professional_service">
                                                        <label class="form-check-label" for="is_professional_service">Yes, Project Service</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-2 mb-2">
                                    ...
                                    <input class="form-control" data-bs-toggle="modal" value="<?php if(isset($edit)): ?> <?php echo e($edit->note); ?> <?php endif; ?>" data-bs-target="#NoteModal" name="note" rows="3" autocomplete="off" id="note">
                                                </div>
                                            </div>
                               ...
                               <div class="d-flex mb-2 justify-content-center">
                                                    <input type="hidden" name="quotation_generated" id="quotation_generated" 
                                                        value="<?php echo e(count($cart) > 0 ? 1 : 0); ?>">
                                ...
                                <script>
                                     function quote_generate() {
                                        ...
                                        if (x.style.height === "0px") {
                                            ...
                                            <div id="generate-quotation" style="height: <?php echo e(count($cart) > 0 ? 'auto' : '0px'); ?>; overflow: hidden; transition: all 0.5s ease;">
                                ...
                                <script>
                                    $('#payment_terms').on('change', function(e) {
                                        ...
                                        <div class="col-3">
                                            ...
                                            <div class="form-group">
                                                <textarea class="form-control" rows="3" id="terms_and_condition" data-bs-toggle="modal" data-bs-target="#narrationModal"  autocomplete="off" name="terms_and_condition"></textarea>
                                            </div>
                                            <script>
    ...
    $('#company').on('change', updateTerms);
                                 ...
                                 <table class="table table-hover form-item-table" id="myTable">
                                    <thead>                                                            
                                        <tr>
                                            ...
                                            <th class="resizable text-center" width="250px"><?php echo app('translator')->getFromJson('Part No'); ?> <a class="icon icon-outline-book text-dark" data-bs-toggle="modal" data-bs-target="#addproductModal"></a><div class="resizer"></div></th>
                                            <th class="resizable text-center" width="250px"><?php echo app('translator')->getFromJson('Description'); ?><div class="resizer"></div></th>
                                            <th class="resizable text-center" width="65px"><?php echo app('translator')->getFromJson('Cost'); ?><div class="resizer"></div></th>
                                            <th class="resizable text-center" width="65px"><?php echo app('translator')->getFromJson('Tax'); ?><div class="resizer"></div></th>
                                            <th class="resizable text-center" width="40px"><?php echo app('translator')->getFromJson('Qty'); ?><div class="resizer"></div></th>
                                            <th class="resizable text-center" width="100px"><?php echo app('translator')->getFromJson('Price'); ?><div class="resizer"></div></th>
                                            <th class="resizable text-center" width="100px"><?php echo app('translator')->getFromJson('Value'); ?><div class="resizer"></div></th>
                                            ...
                                            <th class="resizable text-center" width="100px"><?php echo app('translator')->getFromJson('Taxable'); ?><div class="resizer"></div></th>
                                    ...
                                    <?php if(isset($cart) && count($cart) > 0): ?>
                                        ...
                                        <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart_items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                         ...
                                         <tr>
                                            ...
                                            <td>                                                                    
                                                <input class="form-control text-end" type="text" name="cost[]" autocomplete="off" value="<?php echo e(number_format($cart_items->cost, 2)); ?>" onchange="calc_change_new(this)" onblur="formatCurrency(this)">
                                            ...
                                            <td><input type="number" class="form-control text-center" name="tax[]" value="<?php echo e($cart_items->vat); ?>" onchange="calc_change_new(this)" ></td>
                                            <td><input class="form-control text-center" type="number" name="qty[]" autocomplete="off" min="0" onchange="calc_change_new(this)" value="<?php echo e($cart_items->qty); ?>"></td>
                                            <td><input class="form-control text-end" type="text" name="unitprice[]" step="any" value="<?php echo e(number_format($cart_items->price, 2)); ?>" autocomplete="off" min="0" onchange="calc_change_new(this)" onblur="formatCurrency(this)"></td>
                                            <td><input class="form-control text-end" type="text" name="value[]" autocomplete="off" min="0" readonly></td>
                                            <td><input class="form-control text-end" type="text" step="Any" name="discount[]" value="<?php echo e(number_format($cart_items->discount, 2)); ?>" autocomplete="off" min="0" onchange="calc_change_new(this)" onblur="formatCurrency(this)"></td>
                            ...
                            <select class="form-control js-example-basic-single noborder" name="cfc_name[]" id="cfc_name_1">
                                ...
                                <?php $__currentLoopData = $customs_freight_account; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e(@$value->id); ?>"><?php if(@App\SysHelper::getCompanyCodeSettings(session('logged_session_data.company_id'))['is_account_code']): ?>
                                ...
                                <?php $__currentLoopData = $supplier; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e(@$value->id); ?>"> <?php if(@App\SysHelper::getCompanyCodeSettings(session('logged_session_data.company_id'))['is_supplier_code']): ?>
                                                        <?php echo e(@$value->account_name); ?> (<?php echo e(@$value->account_code); ?>)
                                                    <?php else: ?>
                                                        <?php echo e(@$value->account_name); ?>
...
$(document).on('input', 'input[name="discount[]"]', function () {
    ...
    $(document).on('click', 'textarea[name="description[]"]', function() {
        ...
        if (!partNumber) {
            return; // don't open popup when the row has no selected part number
        }
...
<script>
        ...
        function get_vat(id) {
            $("#loading_bg").css("display", "block");
            var action = "<?php echo e(URL::to('get-vat-by-id')); ?>";
            $.ajax({
                url: action,
                type: "GET",
                data: {
                                        ...
                                        $(document).ready(function(){
                                         ...
                                         $('#company_name_add').keyup(function(){ 
                                                ...
                                                if(query != '')
                                                {
                                                 ...
                                                 $.ajax({
                                                  url:"<?php echo e(route('autocomplete.customer_name')); ?>",
                                                  method:"POST",
                            ...
                            <div class="col">
                                <div class="">
                                    ...
                                    <select class="form-control js-example-basic-single" name="country_ship" id="country_ship">
                                        ...
                                        <option value="<?php echo e(@$value->id); ?>" <?php echo e(trim(strtolower($value->name)) == 'united arab emirates' ? 'selected' : ''); ?>><?php echo e(@$value->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                       ...
                                       <div style="display:none">
                                           ...
                                           <select class="form-select js-example-basic-single" style="width:30px;display:none" name="country_telephone" id="country_telephone" required>
                                                ...
                                                <?php $__currentLoopData = $country; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e(@$value->iso2); ?>|<?php echo e(@$value->id); ?>"><?php echo e(@$value->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                </div>
                                ...
                                <div class="">
                                    ...
                                    <div id="sectionStateDiv_ship">
                                        <select class="form-control js-example-basic-single" name="state_ship" id="state_ship">
                                            ...
                                            <?php    try { ?>
                                            <?php if(isset($editData) && $editData->vat_state != ''): ?>
                                                <option data-display="<?php echo e($editData->vatstate->name); ?>"
                                                    value="<?php echo e($editData->vat_state); ?>" selected>
                                                    <?php echo e($editData->vatstate->name); ?></option>
                                            <?php endif; ?>
                            ...
                            <div class="col">
                                <div class="">
                                    ...
                                    <select class="form-control js-example-basic-single" id="payment_terms2" required>
                                        <?php $__currentLoopData = $paymentterms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e(@$value->id); ?>" <?php if($value->id == 3): ?> selected <?php endif; ?>><?php echo e(@$value->title); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                                    ...
                                    <select class="form-control js-example-basic-single" name="designation_add" id="designation_add" required>
                                        ...
                                        <?php if(count($designation) > 0): ?>
                                            <?php $__currentLoopData = $designation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($val->title); ?>" <?php echo e(trim(strtolower($val->title)) == 'purchase' ? 'selected' : ''); ?>><?php echo e($val->title); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                    </select>
                                </div>
                                ...
                                <div class="">
                                    ...
                                    <select class="form-control js-example-basic-single" id="cust_sales_person" required>
                                        ...
                                        <?php $__currentLoopData = $sales_person; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($value->user_id); ?>"><?php echo e(@$value->full_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
...
$(document).ready(function() {
    $('#company').on('change', function() {
        ...
        $.ajax({
            url: "<?php echo e(url('/ajax/get-new-lead-code')); ?>",
            type: "GET",
            data: {
                table: 'sys_crm_deals',
                prefix: 'DL',
  ...
  <!-- Modal Support-->
    <div class="modal fade" id="ModalExcelQuote" data-bs-backdrop="false" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            ...
            <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'crm-quote-upload-excel-cart', 'method' => 'POST', 'id' => 'crm-quote-upload-excel-cart'])); ?>
                                    ...
                                    function readExcel() {
                                        ...
                                        reader.onload = function(event) {
                                            ...
                                            for (var i = 1; i < rows.length; i++) { // Skip header row
                                                ...
                                                // allow empty or undefined cell — fallback to empty string before trimming
