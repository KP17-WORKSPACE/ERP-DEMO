<?php try { ?>
    ...
    <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'quotation-store', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'quotation-store-form', 'novalidate' => true])); ?>
...
<div class="purchase-order-content-header sticky-top" style="background-color: #f7f8fd">
    <h4 class="purchase-order-content-header-left">
        ...
        New (<span class="font-weight-600"
            id="new_code"><?php echo e(App\SysHelper::get_new_code_lead('sys_crm_deals', 'DL', 'code', session('logged_session_data.company_id'))); ?></span>)
    </h4>
                    ...
                    <select class="form-control js-example-basic-single" name="cust_id" id="cust_id" required
                        ...
                        <?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e(@$value->id); ?>" <?php if(@$ctrl_cust_id == $value->id): ?> selected <?php endif; ?>>
                                ...
                                (<?php echo e(trim(@$value->code)); ?>)<?php endif; ?></option>
