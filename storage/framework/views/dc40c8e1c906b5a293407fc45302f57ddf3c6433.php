                ...
                <?php if(count($quotations) > 0): ?>
                    <?php $__currentLoopData = $quotations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="nav-item w-100" role="presentation">
                            <button class="nav-link proforma-item <?php echo e($active_id == $item->id ? 'active' : ''); ?>"
                                ...
                                <div class="row w-100">
                                    ...
                                    <div class="col-4">
                                        <div class="form-control-plaintext" style="font-size: 11px"><?php echo e(@$item->doc_number); ?></div>
                                    </div>
                                    <div class="col-4 text-center">
                                        <div class="form-control-plaintext" style="font-size: 11px">
                                            <?php echo e(date('d/m/Y', strtotime(@$item->doc_date))); ?></div>
                                    </div>
                                    <div class="col-4 text-end">
                                        <div class="form-control-plaintext truncate-text" style="font-size: 11px">
                                            <?php echo e(@$item->deal_code->code); ?>
                ...
                <table id="long-list" class="table table-hover data-table d-none" style="table-layout: fixed;width:100%">
                    ...
                    <thead class="text-center">
                        <tr>
                            ...
                            <th style="width: 90px;" class="text-center"><?php echo app('translator')->getFromJson('Deal ID'); ?></th>
                            <th style="width: 90px;" class="text-center"><?php echo app('translator')->getFromJson('QTN No'); ?></th>
                            <th style="width: 90px;" class="text-center"><?php echo app('translator')->getFromJson('PI No'); ?></th>
                            <th style="width: 300px;" class="text-start"><?php echo app('translator')->getFromJson('Customer Name'); ?></th>
                            <th style="width: 200px;" class="text-start"><?php echo app('translator')->getFromJson('Salesman Name'); ?></th>
                            <th style="width: 90px;" class="text-center"><?php echo app('translator')->getFromJson('Action'); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php $count =1; ?>
                        <?php $__currentLoopData = $quotations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="text-center"><a
                                        href="<?php echo e(url('get-url-deal-track/' . @$value->deal_code->code)); ?>"
                                        target="_blank"><?php echo e(@$value->deal_code->code); ?></a></td>
                                <td class="text-center"><?php echo e(@$value->deal_code->code); ?></td>
                                <td class="text-center"><?php echo e(@$value->doc_number); ?></td>
                                <td><?php echo e(@$value->customername->name); ?></td>
                                <td><?php echo e(@$value->salesman->full_name); ?></td>
                                <td class="text-center">
                                    <div class="d-flex justify-content-center align-items-center gap-1">
                                        <a class="btn btn-light btn-sm"
                                            href="<?php echo e(url('proforma-invoice/' . $value->id . '/download')); ?>"><i
    ...
    <div class="content-container col-9">
        <div class="tab-content display-flex-tabs" id="purchaseOrderTabContent">
            ...
            <script>
                $(document).ready(function() {
                    $(document).on('click', '.proforma-item', function() {
                        ...
                        var newUrl = "<?php echo e(url('proforma-invoice')); ?>/" + id;
                        window.history.pushState({
                            path: newUrl
                        }, '', newUrl);

                        var action = "<?php echo e(URL::to('proforma-invoice-details')); ?>/" + id;
                        $('#loading_bg').show();
            ...
            <div class="" role="tabpanel" aria-labelledby="po-tab" id="proforma-details">
                ...
                <?php if($action == 'add'): ?>
                    <?php echo $__env->make('backEnd.proformainvoice.manage_proforma_invoice', $createData, \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php elseif($action == 'edit'): ?>
                    <?php echo $__env->make('backEnd.proformainvoice.manage_proforma_invoice_edit', $editData, \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php elseif(!empty($selectedInv) && is_array($selectedInv)): ?>
                    <?php echo $__env->make('backEnd.proformainvoice.proforma_invoice_details', $selectedInv, \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php else: ?>
                 <form id="supplierForm" method="GET" action="<?php echo e(url('proforma-invoice')); ?>">
  ...
  <script>
        $(document).ready(function() {
            ...
            $('#documents_number').on('input', function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('proforma-crm.search')); ?>",
                    type: "GET",
                    data: {
                        query: query
                    },
...
$(document).ready(function() {
    $('#exportExcelProforma').on('click', function(e) {
        ...
        var totalItems = <?php echo json_encode(count($quotations), 15, 512) ?>;
