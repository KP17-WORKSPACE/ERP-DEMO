    ...
    <div class="purchase-order-content-header sticky-top d-flex align-items-center justify-content-between gap-2" style="background-color: #f7f8fd">
        <div class="d-flex align-items-center gap-2">
            <h4 class="purchase-order-content-header-left">
                <?php echo e($pi->doc_number); ?>

            </h4>
            <?php if(isset($pi->deal_id) && $pi->deal_id): ?>
                <?php echo App\SysHelper::deal_pipeline_purchase($pi->deal_id); ?>

            <?php endif; ?>
        </div>
        <div class="purchase-order-content-header-right">
          <a class="btn btn-light text-dark" href="<?php echo e(url('purchase-invoice/'.$pi->id.'?pi_action=edit')); ?>">
                <i class="ico icon-outline-pen-2 text-success"></i> Edit
            </a>
            <a class="btn btn-light text-dark" href="<?php echo e(url('purchase-invoice/'.$pi->id.'?pi_action=add')); ?>">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="<?php echo e(url('purchase-invoice/'.$pi->id.'/delete')); ?>"><i class="ico icon-outline-trash-bin-minimalistic text-danger"></i> Cancel GRN</a></li>
                    <li><a class="dropdown-item" href="<?php echo e(url('purchase-invoice/'.$pi->id.'/download')); ?>"><i class="ico icon-outline-document-medicine text-success"></i> Download</a></li>
  ...
  <br />
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
           <td width="60%" valign="top" style="line-height: 18px;">
                ...
                <b><?php echo e(@$pi->accountname->account_name); ?></b><br>
          ...
          <td valign="top" style="line-height: 18px;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td style="padding: 0px; margin: 0px">: <?php echo e(@$pi->doc_number); ?></td>
                  </tr>
                  
                  <tr>
                    <td style="padding: 0px; margin: 0px">Date:</td>
                    <td style="padding: 0px; margin: 0px">: <?php echo e(date('d/m/Y', strtotime(@$pi->pi_date))); ?></td>
                  </tr>
                  <tr>
                    <td style="padding: 0px; margin: 0px">Ref No:</td>
                    <td style="padding: 0px; margin: 0px">: <?php echo e(@$pi->lpo_number); ?></td>
                  </tr>
                  <tr>
                    <td style="padding: 0px; margin: 0px">Ref Date:</td>
                    <td style="padding: 0px; margin: 0px">: <?php echo e(date('d/m/Y', strtotime(@$pi->lpo_date))); ?></td>
                  </tr>
                  <tr>
                    <td style="padding: 0px; margin: 0px; vertical-align: top; white-space: nowrap;">Payment Terms:</td>
                    <td style="padding:0; margin:0; white-space:nowrap; max-width:190px; overflow:hidden; text-overflow:ellipsis;">: <?php echo e($pi->paymentterms->title); ?> <?php echo e($pi->payment_terms2); ?></td>
                  </tr>
            </table>
          </td>
        </tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="60%" valign="top" style="line-height: 18px;">Bill To,<br />
                <b style="font-size: 90%;"><?php echo e(@$company->company_name); ?></b><br>
                <div><?php echo nl2br($company->company_address); ?></div>
          ...
          <td valign="top" style="line-height: 18px;">Ship To,<br />
            <b style="font-size: 90%;"><?php echo e(@$pi->shippingSupplierName->account_name); ?></b><br>
            <?php echo e(@$pi->shipping_name); ?><br />
            <?php echo e(@$ship_address1); ?><br>
            T: <?php echo e(@$pi->shipping_contact_no); ?>, M: <?php echo e(@$ship_mob); ?><br/>
            E: <?php echo e(@$pi->shipping_email); ?><br/>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <?php
            ...
            $total_amount=0;
        ?>
        <?php if(count($pi_item)>0): ?>
        <?php $__currentLoopData = $pi_item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td class="item-row" >
              ...
              <?php echo nl2br($item->description); ?></td>
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
                <td class="font-weight-600">
                    <?php echo e($pi->currency_name->code); ?>
...
<li>Bank details:- Bank Name: <?php echo e(@$company->bank_name); ?>, Account Number: <?php echo e(@$company->account_number); ?></li>
                    ...
                    <?php else: ?>
                        <div style="padding-top: 2px; font-size: 11px">
                            <?php echo nl2br($pi->terms_and_condition); ?>
    ...
    <div class="col-4">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td style="width: 160px; text-align: left; font-weight: bold; border-bottom:1px solid #2c2b6d;">
                    Sub Total <?php echo e($pi->currency_name->code); ?>

                </td>
                <td style="width: 80px; text-align: right; font-weight: bold; border-bottom:1px solid #2c2b6d;">
                    <?php echo e(App\SysHelper::com_curr_format($sub_total, 2, '.', ',')); ?>
        ...
        <?php if( ($discount ?? 0) + ($deal_discount ?? 0) > 0 ): ?>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td></td>
                    <td style="width: 160px; text-align: left; font-weight: bold; border-bottom:1px solid #2c2b6d;">
                        Discount <?php echo e($pi->currency_name->code); ?>

                    </td>
                    <td style="width: 80px; text-align: right; font-weight: bold; border-bottom:1px solid #2c2b6d;">
                        <?php echo e(App\SysHelper::com_curr_format( ($discount ?? 0) + ($deal_discount ?? 0), 2, '.', ',')); ?>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td></td>
                <td style="width: 160px; text-align: left; font-weight: bold; border-bottom:1px solid #2c2b6d;">
                    Taxable Amt. <?php echo e($pi->currency_name->code); ?>

                </td>
                <td style="width: 80px; text-align: right; font-weight: bold; border-bottom:1px solid #2c2b6d;">
                    <?php echo e(App\SysHelper::com_curr_format( ($taxable_amt ?? 0) - ($deal_discount ?? 0), 2, '.', ',')); ?>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td></td>
                <td style="width: 160px; text-align: left; font-weight: bold; border-bottom:1px solid #2c2b6d;">
                    VAT Amount <?php echo e($pi->currency_name->code); ?>

                </td>
                <td style="width: 80px; text-align: right; font-weight: bold; border-bottom:1px solid #2c2b6d;">
                    <?php echo e(App\SysHelper::com_curr_format( ($vat_amount ?? 0) - ($deal_discount_vat_amount ?? 0), 2, '.', ',')); ?>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td></td>
                <td style="width: 160px; text-align: left; font-weight: bold; border-bottom:1px solid #2c2b6d;">
                    Total Amount <?php echo e($pi->currency_name->code); ?>

                </td>
                <td style="width: 80px; text-align: right; font-weight: bold; border-bottom:1px solid #2c2b6d;">
                    <?php echo e(App\SysHelper::com_curr_format( ($total_amount ?? 0) - ($deal_discount_amount ?? 0), 2, '.', ',')); ?>
    ...
    <br>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td rowspan="4" style="border: none; width:200px;" align="center" valign="bottom"><?php echo e(@$pi->createdby->full_name); ?><br /><b class="bottom_b" style="font-size: 10px;">Prepared By</b></td>
          <td rowspan="4" style="border: none; width:200px;" align="right" valign="bottom"><b class="bottom_b" style="font-size: 10px;">For <?php echo str_replace('SYSCOM DISTRIBUTIONS LLC BRANCH ABU DHABI 1','SYSCOM DISTRIBUTIONS LLC<br />BRANCH ABU DHABI 1',$company->company_name); ?></b></td>
        </tr>
        <tr>
