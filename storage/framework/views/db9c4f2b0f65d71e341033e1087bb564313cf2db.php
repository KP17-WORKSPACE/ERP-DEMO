...
<form id="companyAllForm" action="<?php echo e(route('company.basic.store')); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>

    
    <input type="hidden" id="saved_company_id" name="company_id" value="<?php echo e($companyRow->id ?? $nextId ?? ''); ?>">
            ...
            <div class="" role="tabpanel" aria-labelledby="data-tab" id="data-details">
                <div class="purchase-order-content-header">
                    <h4 class="purchase-order-content-header-left">
                        <?php echo e($isEdit ? 'Edit Company' : 'Add Company'); ?>
                    ...
                    <div class="purchase-order-content-header-right">
                        ...
                        <a class="btn btn-light" href="<?php echo e(url('staff-directory')); ?>">User List</a>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <?php if(session()->has('message-success')): ?>
                                    <div class="alert alert-success"><?php echo e(session('message-success')); ?></div>
                                <?php elseif(session()->has('message-danger')): ?>
                                    <div class="alert alert-danger"><?php echo e(session('message-danger')); ?></div>
                                <?php endif; ?>
                                                ...
                                                <div class="row gy-2">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <div class="input-effect">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm"
                                                                   value="<?php echo e($companyRow->id ?? $nextId); ?>" readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2">
                                                        <div class="input-effect">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm"
                                                                   name="company_name"
                                                                   value="<?php echo e(old('company_name', $companyRow->company_name ?? '')); ?>" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2">
                                                        <div class="input-effect">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm"
                                                                   name="trade_name"
                                                                   value="<?php echo e(old('trade_name', $companyRow->trade_name ?? '')); ?>">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2">
                                                        <div class="input-effect">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm"
                                                                   ...
                                                                   value="<?php echo e(old('legal_entity_type', $companyRow->legal_entity_type ?? '')); ?>" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2">
                                                        <div class="input-effect">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm"
                                                                   name="industry"
                                                                   value="<?php echo e(old('industry', $companyRow->industry ?? '')); ?>" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2">
                                                        <div class="input-effect">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm"
                                                                   name="parent_company"
                                                                   value="<?php echo e(old('parent_company', $companyRow->parent_company ?? '')); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row gy-2 mt-1">
                                                    <div class="col-lg-2">
                                                        ...
                                                        <input type="date" class="form-control form-control-sm"
                                                               ...
                                                               value="<?php echo e(old('date_of_incorporation', $fmt($companyRow->date_of_incorporation ?? ''))); ?>">
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2">
                                                        ...
                                                        <select name="country" id="country" class="form-select form-select-sm">
                                                            ...
                                                            <?php $__currentLoopData = $country; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $syscountry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <?php $selCountry = old('country', $companyRow->country ?? ''); ?>
                                                                <option value="<?php echo e($syscountry->id); ?>" <?php echo e((string)$selCountry===(string)$syscountry->id ? 'selected' : ''); ?>>
                                                                    <?php echo e($syscountry->name); ?>
                                                    ...
                                                    <div class="col-lg-2">
                                                        <div class="input-effect">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm"
                                                                   name="city" id="city"
                                                                   value="<?php echo e(old('city', $companyRow->city ?? '')); ?>" required>
                                                        </div>
                                                    </div>

                                                    <div class="col-lg-2">
                                                        <label class="form-label mb-1">Registered Address <span class="text-danger">*</span></label>
                                                        <textarea class="form-control form-control-sm" name="company_address" rows="1" required><?php echo e(old('company_address', $companyRow->company_address ?? '')); ?></textarea>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm"
                                                               name="sales_code"
                                                               value="<?php echo e(old('sales_code', $companyRow->sales_code ?? '')); ?>">
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm"
                                                               name="other_code"
                                                               value="<?php echo e(old('other_code', $companyRow->other_code ?? '')); ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row gy-2 mt-1">
                                                    <div class="col-lg-2">
                                                        ...
                                                        <select name="currency" class="form-select form-select-sm">
                                                            ...
                                                            <?php $selCurrency = old('currency', $companyRow->currency ?? ''); ?>
                                                            <?php $__currentLoopData = $currency; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $syscurrency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($syscurrency->code); ?>"
                                                                    <?php echo e($selCurrency===$syscurrency->code ? 'selected' : ''); ?>>
                                                                    <?php echo e($syscurrency->name); ?> (<?php echo e($syscurrency->code); ?>)
                                                                </option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm"
                                                               name="currency_digit"
                                                               value="<?php echo e(old('currency_digit', $companyRow->currency_digit ?? '')); ?>">
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2">
                                                        ...
                                                        <input type="date" class="form-control form-control-sm"
                                                               name="book_closed"
                                                               value="<?php echo e(old('book_closed', $fmt($companyRow->book_closed ?? ''))); ?>">
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2">
                                                        ...
                                                        <?php if(!empty($companyRow->company_logo)): ?>
                                                            <a class="small d-inline-block mt-1" target="_blank" href="<?php echo e(asset('public/'.ltrim($companyRow->company_logo,'/'))); ?>">Current file</a>
                                                        <?php endif; ?>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2">
                                                        ...
                                                        <?php if(!empty($companyRow->digital_stamp)): ?>
                                                            <a class="small d-inline-block mt-1" target="_blank" href="<?php echo e(asset('public/'.ltrim($companyRow->digital_stamp,'/'))); ?>">Current file</a>
                                                        <?php endif; ?>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2">
                                                        ...
                                                        <?php if(!empty($companyRow->company_profile)): ?>
                                                            <a class="small d-inline-block mt-1" target="_blank" href="<?php echo e(asset('public/'.ltrim($companyRow->company_profile,'/'))); ?>">Current file</a>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="tab-wrap mb-3">
                                                        ...
                                                        <div class="tab-content border p-3 bg-white" id="hrTabsContent">
                                                                ...
                                                                <div class="row gy-2">
                                                                    <div class="col-lg-2">
                                                                        ...
                                                                        <input type="email" class="form-control form-control-sm" name="email"
                                                                               value="<?php echo e(old('company_email', $companyRow->company_email ?? '')); ?>" required>
                                                                    </div>

                                                                    <div class="col-lg-2">
                                                                        <label class="form-label mb-1">Company Website</label>
                                                                        <input type="url" class="form-control form-control-sm" name="website"
                                                                               value="<?php echo e(old('website', $companyRow->website ?? '')); ?>">
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        <div class="input-effect">
                                                                            ...
                                                                            <select class="form-select form-select-sm js-example-basic-single" name="contact_sections[]" id="contactSections" multiple data-placeholder="Select sections">
                                                                                <option value="owner"   <?php echo e(in_array('owner', $sections)   ? 'selected' : ''); ?>>Owner</option>
                                                                                <option value="sponsor" <?php echo e(in_array('sponsor', $sections) ? 'selected' : ''); ?>>Sponsor</option>
                                                                                <option value="contact" <?php echo e(in_array('contact', $sections) ? 'selected' : ''); ?>>Contact Person</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="tab-pane fade" id="compliance-regulatory" role="tabpanel">
                                                                <div class="row gy-2">
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        ...
                                                                        <input type="text" class="form-control form-control-sm" name="business_license_number"
                                                                               value="<?php echo e(old('business_license_number', $companyRow->business_license_number ?? '')); ?>" required>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        ...
                                                                        <input type="date" class="form-control form-control-sm" name="license_issue_date"
                                                                               value="<?php echo e(old('license_issue_date', $fmt($companyRow->license_issue_date ?? ''))); ?>" required>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        ...
                                                                        <input type="date" class="form-control form-control-sm" name="license_expiry_date"
                                                                               value="<?php echo e(old('license_expiry_date', $fmt($companyRow->license_expiry_date ?? ''))); ?>" required>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        ...
                                                                        <?php if(!empty($companyRow->business_license_upload)): ?>
                                                                            <a class="small d-inline-block mt-1" target="_blank" href="<?php echo e(asset('public/'.ltrim($companyRow->business_license_upload,'/'))); ?>">Current file</a>
                                                                        <?php endif; ?>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        ...
                                                                        <input type="text" class="form-control form-control-sm" name="issuing_authority"
                                                                               value="<?php echo e(old('issuing_authority', $companyRow->issuing_authority ?? '')); ?>" required>
                                                                    </div>

                                                                    <div class="col-lg-2">
                                                                        <label class="form-label mb-1">Tax Applicable</label>
                                                                        <?php $selTax = old('tax_applicable', $companyRow->tax_applicable ?? ''); ?>
                                                                        <select class="form-control" name="tax_applicable" id="tax_applicable">
                                                                            <option value="">Select</option>
                                                                            <option value="vat"  <?php echo e($selTax==='vat'  ? 'selected' : ''); ?>>VAT</option>
                                                                            <option value="ct"   <?php echo e($selTax==='ct'   ? 'selected' : ''); ?>>CT</option>
                                                                            <option value="both" <?php echo e($selTax==='both' ? 'selected' : ''); ?>>Both</option>
                                                                            <option value="none" <?php echo e($selTax==='none' ? 'selected' : ''); ?>>Not Applicable</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                ?>
                                                                <div class="row gy-2 mt-1 <?php echo e($showVAT ? '' : 'd-none'); ?>" id="vatFields">
                                                                    <div class="col-lg-2">
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        ...
                                                                        <?php if(!empty($companyRow->vat_certificate)): ?>
                                                                            <a class="small d-inline-block mt-1" target="_blank" href="<?php echo e(asset('public/'.ltrim($companyRow->vat_certificate,'/'))); ?>">Current file</a>
                                                                        <?php endif; ?>
                                                                    </div>
                                                                </div>

                                                                
                                                                <div class="row gy-2 mt-1 <?php echo e($showCT ? '' : 'd-none'); ?>" id="ctFields">
                                                                    <div class="col-lg-2">
                                                                        ...
                                                                        <input type="text" class="form-control form-control-sm" name="corporate_tax_number"
                                                                               value="<?php echo e(old('corporate_tax_number', $companyRow->corporate_tax_number ?? '')); ?>">
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <label class="form-label mb-1">CT %</label>
                                                                        <input type="text" class="form-control form-control-sm" name="corporate_tax_vat"
                                                                               value="<?php echo e(old('corporate_tax_vat', $companyRow->corporate_tax_vat ?? '')); ?>">
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        ...
                                                                        <input type="date" class="form-control form-control-sm" name="corporate_tax_date"
                                                                               value="<?php echo e(old('corporate_tax_date', $fmt($companyRow->corporate_tax_date ?? ''))); ?>">
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        ...
                                                                        <?php if(!empty($companyRow->corporate_tax_certificate)): ?>
                                                                            <a class="small d-inline-block mt-1" target="_blank" href="<?php echo e(asset('public/'.ltrim($companyRow->corporate_tax_certificate,'/'))); ?>">Current file</a>
                                                                        <?php endif; ?>
                                                                    </div>
                                                                </div>
                                                            </div>
