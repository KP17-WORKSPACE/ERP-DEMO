    ...
    <aside class="left-nav col-3" id="leftSidebar">
        ...
        <div class="long-list  d-none" id="filters-long">
                ...
                <div class="search-filter-container mb-0">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" style="">
                            ...
                            <li>
                                <a href="<?php echo e(url('crm-amc-service-request-list')); ?>"
            ...
            <div class="search-filter-container mt-1 mb-4 filter-field d-none border">
                ...
                <div class="card" style="width:100%">
                    <div class="card-body">
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'goods-receipt-note-list', 'method' => 'get', 'id' => 'goods-receipt-note-list'])); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-1-5 mb-2">
                                ...
                                <input class="form-control" type="text" autocomplete="off" name="purchase_invoice_number"
                                    value="<?php echo e(@$ctrl_purchase_invoice_number); ?>">
                            </div>
                            <div class="col-1-5 mb-2">
                                ...
                                <input class="form-control" type="text" autocomplete="off" name="purchase_order_number"
                                    value="<?php echo e(@$ctrl_purchase_order_number); ?>">
                            </div>
                            <div class="col-1-5 mb-2">
                                <label for="" class="form-label">Purchase Return Number</label>
                                <input class="form-control" type="text" autocomplete="off"
                                    name="purchase_return_number" value="<?php echo e(@$ctrl_purchase_return_number); ?>">
                            </div>
                            <div class="col-1-5 mb-2">
        ...
        <div class="left-nav-list">
            ...
            <ul id="short-list" class="nav flex-column nav-pills" id="companyTabNavs" role="tablist">
                <?php if(count($purchasegrn) > 0): ?>
                    <?php $__currentLoopData = $purchasegrn; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="nav-item w-100" role="presentation">
                            <button href="javascript:void(0)"
                                class="nav-link grn-item <?php echo e($active_id == $value->id ? 'active' : ''); ?>"
            ...
            <div class="table-responsive mb-4 mt-4">
                <table id="long-list" class="table table-hover d-none data-table" style="table-layout: fixed;width:100%">
                    <thead>
                        <tr>
                            <th style="width: 100px" class="text-center"><?php echo app('translator')->getFromJson('GRN No'); ?></th>
                            <th style="width: 100px" class="text-center"><?php echo app('translator')->getFromJson('GRN Date'); ?></th>
                            <th style="width: 250px"><?php echo app('translator')->getFromJson('Supplier'); ?></th>
                            <th style="width: 250px"><?php echo app('translator')->getFromJson('Customer'); ?></th>
                            <th style="width: 100px" class="text-center"><?php echo app('translator')->getFromJson('PO No'); ?></th>
                            <th style="width: 100px" class="text-center"><?php echo app('translator')->getFromJson('PIV No'); ?></th>
                            <th style="width: 100px" class="text-center"><?php echo app('translator')->getFromJson('PRT No'); ?></th>
                            <th style="width: 100px" class="text-center"><?php echo app('translator')->getFromJson('Deal No'); ?></th>
                            <th style="width: 100px" class=""><?php echo app('translator')->getFromJson('Sales Person'); ?></th>
                            
                            <th class="text-end" style="width: 100px"><?php echo app('translator')->getFromJson('Amount'); ?></th>
                        ...
                        <?php $__currentLoopData = $purchasegrn; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr <?php if(@$value->status == 2): ?> class="bg-dark" <?php endif; ?>>
                                <td class="text-center"><a href="javascript:void(0)" onclick="list_style_new()"
                                        class="grn-item" data-id="<?php echo e($value->id); ?>"><?php echo e(@$value->doc_number); ?></a>
                                </td>
                                <td class="text-center"><?php echo e(date('d/m/Y', strtotime(@$value->grn_date))); ?></td>
        ...
        : [];
                             ...
                             ?>
                                ...
                                <td class="text-center">
                                    <?php if(empty($value->piv_no)): ?>
                                        <span class="text-dark">Pending</span>
                                    <?php else: ?>
                                        <?php $__currentLoopData = explode(',', $value->piv_no); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $piv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a href="javacript:void(0);"onclick="list_style_new()"
                                                data-id="<?php echo e(@App\SysHelper::getPurchaseIvoiceID($piv)); ?>"
                                                class="pi-item"><?php echo e(trim($piv)); ?></a>
                                            <?php if(!$loop->last): ?>
                                                ,
                                            <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                             ...
                             ?>
                                ...
                                <td class=""> <?php if(@$value->sales_person != null): ?>
                                ...
                                <td class="text-end"><?php echo e(@App\SysHelper::com_curr_format($value->amount, 2, '.', ',')); ?>

                                    <?php echo e($value->currency_name->code); ?>
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        <?php $__currentLoopData = explode(',', @$value->attach); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $att): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a href="<?php echo e(url(trim($att))); ?>" target="_blank"><i class="fa fa-paperclip"
                                ...
                                <td class="text-center">
                                    <a class="btn-sm mx-auto btn-light"
                                        href="<?php echo e(url('goods-receipt-note/' . $value->id . '/download')); ?>"> <i
    ...
    <div class="content-container col-9">
        <div class="tab-content display-flex-tabs" id="purchaseOrderTabContent">
                ...
                $(document).ready(function() {
                    $(document).on('click', '.grn-item', function() {
                        ...
                        $('.grn-item[data-id="' + id + '"]').addClass('active');
                         ...
                         var newUrl = "<?php echo e(url('goods-receipt-note-list')); ?>/" + id;
                        ...
                        var action = "<?php echo e(URL::to('purchasegrn-details')); ?>/" + id;
                        $('#loading_bg').show();
                        $.ajax({
                            url: action,
                            method: 'GET',
            ...
            <script>
                $(document).ready(function() {
                    $('.po-item').on('click', function() {
                        ...
                        var action = "<?php echo e(URL::to('purchase-details')); ?>/" + id;
                        $('#loading_bg').show();
            ...
            <script>
                $(document).ready(function() {
                    $('#exportExcelGRN').on('click', function(e) {
                        ...
                        var totalGRN = <?php echo json_encode($purchasegrn->count() ?? 0, 15, 512) ?>;
            ...
            <div class="" role="tabpanel" aria-labelledby="po-tab" id="grn-details">
                ...
                <?php if($action === 'add'): ?>
                    <?php echo $__env->make('backEnd.grn.grn_add', $addData, \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php elseif($action === 'edit'): ?>
                    <?php echo $__env->make('backEnd.grn.grn_edit', $editData, \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php elseif(isset($data) && !empty($data)): ?>
                    
                    <?php echo $__env->make('backEnd.grn.grn_details', $data, \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php else: ?>
                    <div onclick="window.location.href='<?php echo e(url('goods-receipt-note-list?grn_action=add')); ?>'"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#search_grn_id').on('input', function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('crm-grn.search')); ?>",
                    type: "GET",
                    data: {
                        query: query
                    },
