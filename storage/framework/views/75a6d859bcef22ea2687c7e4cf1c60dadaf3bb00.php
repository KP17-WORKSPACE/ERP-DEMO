        ...
        <div class="long-list" id="filters-long">
            ...
            <div class="search-filter-container mt-1 mb-4 filter-field d-none border">
                <div class="card" style="width: 100%">
                    <div class="card-body">
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'inventory-subcategory-wise-report', 'method' => 'POST', 'id' => 'inventory-subcategory-wise-report'])); ?>
            ...
            <div class="table-responsive mb-4 mt-4">
                <table id="long-list" class="table table-hover data-table" style="table-layout: fixed;width:100%">
                    ...
                    <tbody>
                        ...
                        ?>
                        <?php $__empty_1 = true; $__currentLoopData = $subcategory_report_rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo e($partWiseUrl); ?>"><?php echo e($row->sub_category_name); ?></a></td>
