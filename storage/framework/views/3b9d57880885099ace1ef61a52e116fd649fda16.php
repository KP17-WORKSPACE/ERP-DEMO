    ...
    <?php if(isset($select_cart)): ?>
        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'delivery-note-store', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'delivery-note-create-form', 'novalidate' => true, 'novalidate' => true])); ?>

        <input type="hidden" name="store_id" value="cart" />
    <?php else: ?>
        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'delivery-note-store', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'delivery-note-create-form', 'novalidate' => true])); ?>
    ...
    <div class="purchase-order-content-header">
        <h4 class="purchase-order-content-header-left">
            New
            (<?php echo e(isset($edit) ? (!empty(@$edit->title) ? @$edit->title : old('doc_number')) : @App\SysHelper::get_new_code('sys_delivery_note', 'DN', 'doc_number')); ?>)
        </h4>
                ...
                <div class="col-2">
                    ...
                    <div class="form-group">
                        <input class="form-control" type="text" name="doc_number" autocomplete="off" id="doc_number"
                            value="<?php echo e(isset($edit) ? (!empty(@$edit->title) ? @$edit->title : old('doc_number')) : @App\SysHelper::get_new_code('sys_delivery_note', 'DN', 'doc_number')); ?>"
                            readonly>
                    </div>
                </div>
                <div class="col-2">
        ...
        <div class="tab-content mb-3" id="purchaseDetailsTabsContent">
                            ...
                            <div class="col-lg-3 mb-2">
                                <div class="input-effect">
                                    ...
                                    <input class="form-control date-picker" id="invoice_date" type="text"
                                        name="invoice_date" value="<?php echo e(@$invoice_date); ?>">
                                </div>
                            </div>
                            <div class="col-lg-3 mb-2">
                                <div class="input-effect">
                                    ...
                                    <input class="form-control" type="text" id="lpo_no" name="lpo_no"
                                        value="<?php echo e($lpoValue); ?>" required>
                                </div>
                            </div>
                            <div class="col-lg-3 mb-2">
                                <div class="input-effect">
                                        ...
                                        <select class="form-control js-example-basic-single" name="payment_terms"
                                            ...
                                            <?php $__currentLoopData = $paymentterms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e(@$value->id); ?>"
                                                    <?php echo e(!empty($select_cart[0] ?? null) ? (!empty(@$select_cart[0]->payment_terms) ? (@$select_cart[0]->payment_terms == @$value->id ? 'selected' : '') : '') : ''); ?>

                                                    <?php echo e(isset($payment_terms) ? (!empty(@$payment_terms) ? (@$payment_terms == @$value->id ? 'selected' : '') : '') : ''); ?>>
                                    ...
                                    <div class="form-group">
                                        <select class="form-control js-example-basic-single" name="sales_man"
                                            ...
                                            <?php $__currentLoopData = $staff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e(@$value->user_id); ?>" <?php
                            ...
                            <div class="col-lg-3 mb-2">
                                <div class="input-effect">
                                    ...
                                    <input class="form-control" type="text" id="warehouse" name="warehouse"
                                        value="<?php echo e(isset($editData) ? (!empty(@$editData->warehouse) ? @$edit->warehouse : old('warehouse')) : 'Taken from stock'); ?>"
                                        required>
                                </div>
                            </div>
                            <script>
                            ...
                            <div class="col-lg-3 mb-2">
                                <div class="input-effect">
                                    ...
                                    <input class="form-control" type="text" id="driver" name="driver"
                                        value="<?php echo e(isset($editData) ? (!empty(@$editData->driver) ? @$edit->driver : old('driver')) : 'Salman'); ?>">
                                </div>
                            </div>
                            <div class="col-lg-3 mb-2">
                                <div class="input-effect">
                                    ...
                                    <input class="form-control" type="text" id="vehicleno" name="vehicleno"
                                        value="<?php echo e(isset($editData) ? (!empty(@$editData->vehicleno) ? @$edit->vehicleno : old('vehicleno')) : ''); ?>">
                                </div>
                            </div>
                            <div class="col-lg-3 mb-2">
                                <div class="input-effect">
                                    ...
                                    <input class="form-control" type="text" id="supplier_name"
                                        name="supplier_name"
                                        value="<?php if($supplier_name == ''): ?> Taken from stock <?php else: ?> <?php echo e($supplier_name); ?> <?php endif; ?>"
                                        required>
                                </div>
                            </div>
                            <div class="col-lg-3 mb-2">
                                <div class="input-effect">
                                    ...
                                    <input class="form-control" type="text" id="deal_id" name="deal_id"
                                        value="<?php echo e($dealid); ?>" required>
                                </div>
                            </div>
                            <div class="col-lg-3 mb-2">
                                <div class="input-effect">
                                    ...
                                    <input class="form-control" data-bs-toggle="modal"
                                        ...
                                        autocomplete="off"
                                        value="<?php echo e(isset($editData) ? (!empty(@$editData->narration) ? @$editData->narration : old('narration')) : old('narration')); ?>"
                                        id="narration">
                                </div>
                            </div>
                        </div>
                ...
                <div class="row gap-rows">
                        ...
                        <div class="form-group">
                            <select class="form-control js-example-basic-single" name="shipping_supplier"
                                ...
                                <?php $__currentLoopData = $customer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <option value="<?php echo e(@$value->id); ?>"
                                        <?php if(@$deal_det->delivery_company == $value->id): ?> selected <?php endif; ?>>
                    ...
                    <div class="col-2">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="shipping_name" id="shipping_name"
                                value="<?php echo e(@$deal_det->delivery_name); ?>" />
                        </div>
                    </div>
                    <div class="col-2">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="shipping_email" id="shipping_email"
                                value="<?php echo e(@$deal_det->delivery_email); ?>" />
                        </div>
                    </div>
                    <div class="col-2">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="shipping_contact_no"
                                id="shipping_contact_no" value="<?php echo e(@$deal_det->delivery_number); ?>" />
                        </div>
                    </div>
                    <?php
                    ...
                    <div class="col-3">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="shipping_address_1"
                                id="shipping_address_1" value="<?php echo e(@$shipping_address); ?>" />
                        </div>
                    </div>
                    ...
                    <!-- <div class="col-lg-3 mb-2">
                                    <div class="input-effect">
                                        ...
                                        <input type="text" class="form-control" value="<?php if(isset($deal_det)): ?> <?php echo e($deal_det->delivery_company); ?> <?php endif; ?>" id="shipping_name" name="shipping_name">
                                    </div>
                                </div>
                                <div class="col-lg-3 mb-2">
                                    <div class="input-effect">
                                        <label class="form-label"><?php echo app('translator')->getFromJson('Address'); ?> <span></span></label>
                                        <input type="text" class="form-control" value="<?php if(isset($deal_det)): ?> <?php echo e($deal_det->delivery_address); ?> <?php endif; ?>" id="shipping_address" name="shipping_address">
                                    </div>
                                </div> -->
                </div>
            </div>
            <div class="tab-pane fade show" id="vat-details" role="tabpanel" aria-labelledby="vat-details-tab">
                <div class="row gap-rows">
                            ...
                            <select class="form-control js-example-basic-single" name="customer_country"
                                ...
                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e(@$value->id); ?>" <?php try{?>
                                        <?php if(isset($deal_cust)): ?> <?php if(@$deal_cust->vat_country == $value->id): ?> selected <?php endif; ?>
                                        <?php endif; ?>
                    ...
                    <div class="col-lg-2 mb-2">
                        <div class="input-effect">
                            <label class="form-label"><?php echo app('translator')->getFromJson('Customer State'); ?></label>
                                ...
                                <select class="form-control js-example-basic-single" name="customer_state"
                                    ...
                                    <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($state->id); ?>"
                                            <?php if(isset($deal_cust) && $deal_cust->vat_state == $state->id): ?> selected <?php endif; ?>>
                            ...
                            <div class="form-group">
                                <select class="form-control" name="customer_type" id="customer_type">
                                    ...
                                    <?php $__currentLoopData = $customertype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e(@$value->id); ?>"
                                            <?php echo e(isset($deal_cust) ? (!empty(@$deal_cust->customer_type) ? (@$deal_cust->customer_type == @$value->id ? 'selected' : '') : '') : ''); ?>>
                                            <?php echo e(@$value->title); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <i class="ico icon-outline-alt-arrow-down dropdown-toggle-ico"></i>
                            ...
                            <div class="form-group">
                                <select class="form-control" name="sale_type" id="sale_type">
                                    ...
                                    <?php $__currentLoopData = $saletype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e(@$value->id); ?>"
                                            <?php echo e(isset($deal_cust) ? (!empty(@$deal_cust->sale_type) ? (@$deal_cust->sale_type == @$value->id ? 'selected' : '') : '') : ''); ?>>
                                            <?php echo e(@$value->title); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <i class="ico icon-outline-alt-arrow-down dropdown-toggle-ico"></i>
                    ...
                    <div class="col mb-2">
                        <div class="input-effect">
                            ...
                            <input type="text" class="form-control" name="contact_person_email"
                                ...
                                value="<?php if(isset($deal_enduser)): ?> <?php echo e($deal_enduser->email); ?> <?php endif; ?>">
                    ...
                    <div class="col mb-2">
                        <div class="input-effect">
                            ...
                            <input type="text" class="form-control" name="contact_person_no"
                                ...
                                value="<?php if(isset($deal_enduser)): ?> <?php echo e($deal_enduser->mobile_no); ?> <?php endif; ?>">
        ...
        <table class="table table-hover form-item-table" id="myTable">
            ...
            <tbody>
                ...
                <?php if(count($select_cart) > 0): ?>
                    <?php $i=0; ?>
                    <?php $__currentLoopData = $select_cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <tr>
                            <td><input type="text" class="form-control text-center" name="sort_id[]"
                                    value="<?php echo e($i + 1); ?>" /></td>
                            <td>
                                <select class="form-control noborder " name="part_number[]">
                                    <option value="<?php echo e($cart->part_number); ?>"><?php echo e($cart->part_number_txt); ?></option>
                                </select>
                            </td>
                            <td>
                                <textarea class="form-control" name="description[]" rows="1"><?php echo e($cart->description); ?></textarea>
                                <input type="hidden" name="product_type[]" value="<?php echo e($cart->product_type); ?>">
                            </td>
                            <td><input class="form-control text-center qty rc" type="number" id="tax_<?php echo e($i); ?>"
                                    name="tax[]" autocomplete="off" min="0" value="<?php echo e($cart->tax); ?>"
                                    onchange="calc_change(<?php echo e($i); ?>)"></td>
                            <td><input class="form-control text-center qty rc" type="number" id="qty_<?php echo e($i); ?>"
                                    data-enter-skip name="qty[]" autocomplete="off" min="0"
                                    value="<?php echo e($cart->qty); ?>" onchange="calc_change(<?php echo e($i); ?>)"
                                    onkeydown="return set_license_key_normal(event, this)"></td>
                            <td class="jshide"><input class="form-control text-end" type="text"
                                    id="unitprice_<?php echo e($i); ?>"
                                    value="<?php echo e(@App\SysHelper::com_curr_format($cart->unitprice, 2, '.', ',')); ?>"
                                    name="unitprice[]" autocomplete="off" min="0"
                                    onchange="calc_change(<?php echo e($i); ?>)" onblur="formatCurrency(this)"></td>
                            <td class="jshide"><input class="form-control text-end" type="text"
                                    id="value_<?php echo e($i); ?>" value="<?php echo e($value); ?>" name="value[]"
                                    autocomplete="off" min="0" readonly></td>
                            <td class="jshide"><input class="form-control text-end" type="text"
                                    id="discount_<?php echo e($i); ?>"
                                    value=" <?php echo e(@App\SysHelper::com_curr_format($cart->discount, 2, '.', ',')); ?>"
                                    name="discount[]" autocomplete="off" min="0"
                                    onchange="calc_change(<?php echo e($i); ?>)" onblur="formatCurrency(this)"></td>
                            <td class="jshide"><input class="form-control text-end" type="text"
                                    id="taxableamount_<?php echo e($i); ?>" value="<?php echo e($taxamount); ?>"
                                    name="taxableamount[]" readonly></td>
                            <td class="jshide"><input class="form-control text-end" type="text"
                                    id="vatamount_<?php echo e($i); ?>" value="<?php echo e($vatamount); ?>"
                                    name="vatamount[]" readonly></td>
                            <td class="jshide"><input class="form-control text-end" type="text"
                                    id="totalamount_<?php echo e($i); ?>"
                                    value="<?php echo e(@App\SysHelper::com_curr_format($totalamount, 2, '.', ',')); ?>"
                                    name="totalamount[]" readonly></td>
                            <td class="jshide"><input class="form-control srl" type="test"
                                    id="srl_<?php echo e($i); ?>" name="serial_no[]"
                                    onclick="srlno_add(<?php echo e($i); ?>)"></td>
                        </tr>
                        <?php $i++;
                        ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr>
                    <td><input type="text" class="form-control text-center" name="sort_id[]"
                            value="<?php echo e($select_cart ? count($select_cart) + 1 : 1); ?>" /></td>
                    <td class="noborder">
                        <select class="form-control noborder " name="part_number[]">
                        </select>
    ...
    <script>
        ...
        function get_dn_list(cus_id) {
            $("#loading_bg").css("display", "block");
            var action = "<?php echo e(URL::to('sales-invoice-pending')); ?>";
            $.ajax({
                url: action,
                type: "POST",
                data: {
    ...
    <script>
        ...
        function get_license_key(part_id) {
            $("#loading_bg").css("display", "block");
            var action = "<?php echo e(URL::to('dn-get-grn-license-key')); ?>";
            $.ajax({
                url: action,
                type: "POST",
                data: {
        ...
        function set_license_key() {
            $("#loading_bg").css("display", "block");
            var action = "<?php echo e(URL::to('dn-update-grn-license-key')); ?>";
