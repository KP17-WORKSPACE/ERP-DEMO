    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title mb-0" id="editModalLabel">Account - <?php echo e(@App\SysHelper::get_new_account_code()); ?>

                </h4>
                <div class="d-flex align-items-center">
                    <a class="btn btn-light btn-sm me-2" style="padding: 2px 5px" href="<?php echo e(url('chartofaccounts-import')); ?>">
                ...
                <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'chartofaccounts-store', 'method' => 'POST', 'enctype' => 'multipart/form-data','id'=>'account-form'])); ?>
                ...
                <div class="card mb-0 mt-0">
                    <div class="card-body bg-white text-start">
                        <div class="row">
                              ...
                              <input
                                        class="txtbx primary-input form-control <?php echo e($errors->has('account_code') ? 'is-invalid' : ' '); ?>"
                                        type="hidden" name="account_code"
                                        value="<?php echo e(isset($editData) ? @$editData->account_code : @App\SysHelper::get_new_account_code()); ?>"
                                        required>
                            ...
                            <div class="col-lg-4 mb-2">
                                <div class="input-effect" style="position: relative;">
                                    <label class="form-label"> <?php echo app('translator')->getFromJson('Account Name'); ?> <span>*</span> </label>
                                    <input
                                        class="txtbx primary-input form-control <?php echo e($errors->has('account_name') ? 'is-invalid' : ' '); ?>"
                                        type="text" id="account_name" name="account_name"
                                        value="<?php echo e(isset($editData) ? @$editData->account_name : old('account_name')); ?>"
                                        required>
...
$(document).ready(function() {
    ...
    $('#account_name').keyup(function(e) {
        ...
        if (query !== '') {
            $.ajax({
                url: "<?php echo e(route('autocomplete.account_name')); ?>",
                method: "POST",
                data: {
                    query: query,
        ...
        e.stopPropagation();
                            ...
                            <div class="col-lg-3 mb-2">
                                <div class="input-effect">
                                    <label class="form-label"> <?php echo app('translator')->getFromJson('Select Sub Group'); ?> <span>*</span> </label>
                                    <div class="input-effect" id="sectionSubGroup2Div">
                                        <select class="txtbx niceSelect w-100 bb form-control js-example-basic-single" 
                                            ...
                                            <?php if(isset($accountgroupsub2)): ?>
                                                <?php $__currentLoopData = $accountgroupsub2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e(@$val->id); ?>"
                                                        <?php if(isset($editData)): ?> <?php if(@$editData->subgroup2 == @$val->id): ?> selected <?php endif; ?>
                                                        <?php endif; ?> ><?php echo e(@$val->title); ?>
                            ...
                            <div class="col-lg-3 mb-2">
                                <div class="input-effect">
                                    <label class="form-label"> <?php echo app('translator')->getFromJson('Department'); ?> <span>*</span> </label>
                            ...
                            <div class="col-lg-2 mb-2">
                                <div class="input-effect">
                                    <label class="form-label"> <?php echo app('translator')->getFromJson('Prepaid/Accrued Exp'); ?>  </label>
                            ...
                            <div class="col-lg-4 mb-2 bank_div" style="display: none;">STL
                                <select class="form-control js-example-basic-single" name="stl" id="stl" onchange="fn_stl()">
                                    <option value="0"
                                        <?php if(isset($editData)): ?> <?php if(@$editData->stl == 0): ?> selected <?php endif; ?>
                                        <?php endif; ?>>Not Applicable</option>
                                    <option value="1"
                                        <?php if(isset($editData)): ?> <?php if(@$editData->stl == 1): ?> selected <?php endif; ?>
                                        <?php endif; ?>>Applicable</option>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-4 mb-2" id="stl_limit_div" style="display: none;">STL Limit
                                <input class="form-control" type="text" name="stl_limit" id="stl_limit"
                                    value="<?php if(isset($editData)): ?> <?php echo e(@App\SysHelper::com_curr_format(@$editData->stl_limit, 2, '.', ',')); ?> <?php endif; ?>"
                            ...
                            <div class="col-4 mb-2 opening-balance">
                                <div class="input-effect">
                                    <label class="form-label"> <?php echo app('translator')->getFromJson('Opening Balance Dr'); ?> <span>*</span> </label>
                                    <?php
                                        $debit_amount = '0.00';
                                    ...
                                    ?>
                                    <input
                                        class="primary-input form-control <?php echo e($errors->has('debit_amount') ? 'is-invalid' : ' '); ?>"
                                        type="text" id="debit_amount" name="debit_amount" value="<?php echo e($debit_amount); ?>" required>
    ...
    $(document).ready(function() {
        ...
        $('#debit_amount, #credit_amount').on('blur', function() {
            ...
            $(this).val(formatted);
                            ...
                            <div class="col-4 mb-2 opening-balance">
                                <div class="input-effect">
                                    <label class="form-label"> <?php echo app('translator')->getFromJson('Opening Balance Cr'); ?> <span>*</span> </label>
                                    <?php
                                        $credit_amount = '0.00';
                                        if (isset($editData_tran)) {
                                    ...
                                    ?>
                                    <input
                                        class="primary-input form-control <?php echo e($errors->has('credit_amount') ? 'is-invalid' : ' '); ?>"
                                        type="text" id="credit_amount" name="credit_amount" value="<?php echo e($credit_amount); ?>" required>
                                    <span class="focus-border"></span>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 mb-2 opening-balance">
                                ...
                                if (isset($editData_tran) && !empty($editData_tran->transaction_date)) {
                                    ...
                                    ?>
                                    <input
                                        class="primary-input form-control date-picker <?php echo e($errors->has('opening_balance_date') ? 'is-invalid' : ' '); ?>"
                        ...
                        ?>
                        <input type="hidden" name="cheque_company_top" value="<?php echo e($ct->company_top ?? '285px'); ?>">
                        <input type="hidden" name="cheque_company_left" value="<?php echo e($ct->company_left ?? '425px'); ?>">
                        <input type="hidden" name="cheque_date_top" value="<?php echo e($ct->date_top ?? '220px'); ?>">
                        <input type="hidden" name="cheque_date_left" value="<?php echo e($ct->date_left ?? '836px'); ?>">
                        <input type="hidden" name="cheque_amount_w_top" value="<?php echo e($ct->amount_w_top ?? '316px'); ?>">
                        <input type="hidden" name="cheque_amount_w_left" value="<?php echo e($ct->amount_w_left ?? '326px'); ?>">
                        <input type="hidden" name="cheque_amount_top" value="<?php echo e($ct->amount_top ?? '355px'); ?>">
                        <input type="hidden" name="cheque_amount_left" value="<?php echo e($ct->amount_left ?? '834px'); ?>">
                        <input type="hidden" name="cheque_font_size" value="<?php echo e($ct->font_size ?? '13px'); ?>">
        ...
        <div class="modal-content" style="z-index:2101;">
            ...
            $cheque_amount = "60,800.00";
                ...
                <div style="width:918px; height:605px; border:solid 1px #2e2e2e;">
                    <div id="ct_div_company"><?php echo e($company_c); ?></div>
                    <div id="ct_div_date"><?php echo e($cheque_date); ?></div>
                    <div id="ct_div_amount_w"><?php echo e($cheque_amount_w); ?></div>
                    <div id="ct_div_amount"><?php echo e($cheque_amount); ?></div>
                </div>
