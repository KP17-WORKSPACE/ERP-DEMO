...
class CreateSmLanguagePhrasesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('sm_language_phrases', function (Blueprint $table) {
            ...
            $table->string('default_phrases', 500)->nullable();
            $table->string('en', 500)->nullable();
            $table->string('es', 500)->nullable();
            $table->string('fr', 500)->nullable();
            $table->string('bn', 500)->nullable(); 
    ...
    $all_translate = [
        ...
        [ 22, 1 ,'admin_section ',' Reception Section ',' Reception de Administración ',' Section Reception ',' রিসেপশন বিভাগ'],
        ...
        [ 268 , 4 ,'item',' Product',' ít',' Article ',' পদ'],
        ...
        [ 482 , 9 ,'section ',' Sections',' Secciones ',' Sections',' সেকশনস'],
        ...
        [ 576 , 13,'item_category ',' Product Category ',' Categoría de artículo ',' Catégorie darticle ',' আইটেম বিভাগ '],
        [ 577 , 13,'item_list ',' Product List ',' Lista de articulos',' Liste des articles',' উপকরণ তালিকা'],
        [ 578 , 13,'item_store',' Product Store',' Tienda de articulos ',' Magasin darticles',' আইটেম স্টোর '],
        [ 579 , 13,'supplier','Supplier',' Supplier ','Supplier ','সরবরাহকারী'],
        [ 580 , 13,'item_receive',' Product Receive',' El artículo recibe',' Point recevoir',' আইটেম প্রাপ্তি'],
        [ 581 , 13,'item_receive_list ',' Product Receive List ',' Lista de artículos recibidos',' Item Receive List ',' আইটেম তালিকা প্রাপ্তি '],
        [ 582 , 13,'item_sell ',' Product Sell ',' Venta de artículos',' Article Vendre',' আইটেম বিক্রি'],
        [ 583 , 13,'item_issue',' Product Issue',' Emisión del artículo',' Question darticle',' আইটেম ইস্যু '],
        [ 584 , 13,'select_item_category',' Select Product Category',' Seleccione la categoría del artículo',' Sélectionner une catégorie darticle',' আইটেম বিভাগ নির্বাচন করুন '],
        ...
        [ 608 , 13,'issue_item',' Issue Product',' Elemento de emisión ',' Point démission',' সমস্যা আইটেম'],
        [ 609 , 13,'issue_a_item',' Issue a Product',' Emitir un artículo',' Émettre un article',' একটি আইটেম ইস্যু'],
        ...
        [ 613 , 13,'issued_item_list',' Issued Product List',' Lista de elementos emitidos ',' Liste darticles publiés',' ইস্যু আইটেম তালিকা'],
        ...
        [ 730 , 17,'school_name ','Business Name ','Business Name','Business Name','Business Name'],
        [ 731 , 17,'school_code ','Business Code ','Business Code','Business Code','Business'],
        ...
        [ 791 , 17,'site_title','Title','Title','Title','সাইট শিরোনাম'],
        ...
        [ 796 , 17,'school_address','Business Address','Business Address','Business Address','ঠিকানা'],
        ...
        [ 822 , 19,'inserted_message',' Inserted Successfully ',' Insertado con éxito ',' Inséré avec succès',' সফলভাবে সন্নিবেশ করানো হয়েছে '],
        ...
        [ 854 , 20,'passing_marks ',' Passing Marks ',' Marcas de paso',' Marques de passage','পাশ নম্বর'],
        ...
        // SELECT `id`, `modules`, `default_phrases`, `en`, `es`, `fr`, `bn`, `active_status`, `school_id`, `created_at`, `updated_at` FROM `sm_language_phrases` WHERE 1
        [ 869 , 20,'cost_center','Cost Center','centro de costo','centre de coûts','খরচ কেন্দ্র'],
        [ 870 , 20,'select_product','Select Product','Seleccionar producto','Sélectionner un produit','পণ্য নির্বাচন করুন'],
        [ 871 , 20,'item_name','Product Name','Product Name','Item Name','আইটেম নাম'],
        [ 872 , 20,'add_new_customer','Add New Customer','Add New Customer','Add New Customer','Add New Customer'],
        [ 873 , 20,'customer_list','Customer List','Customer List','Customer List','Customer List'],
        [ 874 , 20,'customer_info','Customer Information','Customer Information','Customer Information','Customer Information'],
        [ 875 , 20,'add_customer','Add Customer','Add Customer','Add Customer','Add Customer'],
        [ 876 , 20,'customer','Customer','Customer','Customer','Customer'],
        [ 877 , 20,'tender','Tender','Tender','Tender','Tender'],
        [ 878 , 20,'tender','Tender','Tender','Tender','Tender'],
        [ 879 , 20,'tender_no','Tender No','Tender No','Tender No','Tender No'],
        [ 880 , 20,'work_order_date','Work Order Date','Work Order Date','Work Order Date','Work Order Date'],
        [ 881 , 20,'delivery_date','Delivery Date','Delivery Date','Delivery Date','Delivery Date'], 
        [ 882 , 20,'bid_amount','Bid Amount','Bid Amount','Bid Amount','Bid Amount'], 
        [ NULL , 20,'discount_amount','Discount Amount','Discount Amount','Discount Amount','Discount Amount'], 
        [ NULL , 20,'work_order_no','Work Order No','Work Order No','Work Order No','Work Order No'],
        [ NULL , 20,'bid','Bid','Bid','Bid','Bid'],
        [ NULL , 20,'vendor','Vendor','Vendor','Vendor','Vendor'],
        [ NULL , 20,'percentage','Percentage','Percentage','Percentage','Percentage'],
        [ NULL , 20,'work','Work','Work','Work','Work'],
        [ NULL , 20,'open_date','Open Date','Open Date','Open Date','Open Date'],
        [ NULL , 20,'open','Open','Open','Open','Open'],
        [ NULL , 20,'opening','Opening','Opening','Opening','Opening'],
        [ NULL , 20,'order','Order','Order','Order','Order'],
        [ NULL , 20,'letter','Letter','Letter','Letter','Letter'],
        [ NULL , 20,'is_approved','Approved Status','Approved Status','Approved Status','Approved Status'],
        [ NULL , 20,'delivery','Delivery','Delivery','Delivery','Delivery'],
        [ NULL , 20,'up_coming','Upcoming','Upcoming','Upcoming','Upcoming'],
        [ NULL , 20,'tender_result','Tender Result','Tender Result','Tender Result','Tender Result'],

        [ NULL , 20,'product_receive','Product Receive','Product Receive','Product Receive','Product Receive'],
        [ NULL , 20,'supplier_name','Supplier Name','Supplier Name','Supplier Name','Supplier Name'],
        [ NULL , 20,'receive_date','Receive Date','Receive Date','Receive Date','Receive Date'],
        [ NULL , 20,'received_date','Received Date','Received Date','Received Date','Received Date'],
        [ NULL , 20,'part_number','Part Number','Part Number','Part Number','Part Number'],
        [ NULL , 20,'new_part_number','New Part Number','New Part Number','New Part Number','New Part Number'],
        [ NULL , 20,'denomination','Denomination','Denomination','Denomination','Denomination'],
        [ NULL , 20,'product_receive','Product Receive','Product Receive','Product Receive','Product Receive'],
        [ NULL , 20,'product_receive_list','Product Receive List','Product Receive List','Product Receive List','Product Receive List'],
        [ NULL , 20,'application','Application','Application','Application','Application'],
        [ NULL , 20,'customers','Customers','Customers','Customers','Customers'],
        [ NULL , 20,'vendors','Vendors','Vendors','Vendors','Vendors'],
        [ NULL , 20,'stock','Stocks','Stocks','Stocks','Stocks'],
        [ NULL , 20,'staffs','Staffs','Staffs','Staffs','Staffs'],
        [ NULL , 20,'lead','Lead','Lead','Lead','Lead'],
        [ NULL , 20,'add_lead','Add Lead','Add Lead','Add Lead','Add Lead'],
        [ NULL , 20,'lead_generation','Lead Generation','Lead Generation','Lead Generation','Lead Generation'],
        [ NULL , 20,'lead_setup','Lead Setup','Lead Setup','Lead Setup','Lead Setup'],
        [ NULL , 20,'project','Project','Project','Project','Project'],
        [ NULL , 20,'work_order','Work Order','Work Order','Work Order','Work Order'],
        [ NULL , 20,'bank_details','Bank Details','Bank Details','Bank Details','Bank Details'],
        [ NULL , 20,'online_payment_details','Payment Details','Payment Details','Payment Details','Payment Details'],
        [ NULL , 20,'select_item_category','Select Product Category','Select Item Category','Select Item Category','Select Item Category'], 
        ...
        [ NULL , 20,'date_formate','Date Format','Date Format','Date Format','Date Format'],
        [ NULL , 20,'duration','Duration','Duration','Duration','Duration'],
        [ NULL , 20,'subcategory','Subcategory','Subcategory','Subcategory','Subcategory'],
        [ NULL , 20,'sub','Sub ','Sub','Sub ','Sub'],
        [ NULL , 20,'Resume','Resume ','Resume','Resume ','Resume'],
        [ NULL , 20,'Visible_to_this_person','Visible to this person ','Visible to this person','Visible to this person ','Visible to this person'],
        [ NULL , 20,'section_sub_category','Section Subcategory','Section Subcategory','Section Subcategory ','Section Subcategory'],
        [ NULL , 20,'database','Database','Database','Database','Database'],
        [ NULL , 20,'competitors','Competitors','Competitors','Competitors','Competitors'], 
        [ NULL , 20,'sub_chart_account','Sub Chart Account','Sub Chart Account','Sub Chart Account','Sub Chart Account'], 
        [ NULL , 20,'account_of_head','Account Of Head','Account Of Head','Account Of Head','Account Of Head'],
        [ NULL , 20,'sub_chart_of_account','Sub Chart Of Account','Sub Chart Of Account','Sub Chart Of Account','Sub Chart Of Account'],
        [ NULL , 20,'product','Product','Product','Product','Product'],
        [ NULL , 20,'author_details','Author Details','Author Details','Author Details','Author Details'], 
        [ NULL , 20,'fixed','fixed','fixed','fixed','fixed'], 
        [ NULL , 20,'expired','Expired','Expired','Expired','মেয়াদোত্তীর্ণ'], 
        [ NULL , 20,'unit','Unit','Unit','Unit','Unit'], 
        [ NULL , 20,'Not_Leaves_Data','Not Leaves Data','Not Leaves Data','Not Leaves Data','Not Leaves Data'], 
        [ NULL , 20,'Public','Public','Public','Public','Public'], 
        [ NULL , 20,'Joining_Letter','Joining Letter','Joining Letter','Joining Letter','Joining Letter'], 
        [ NULL , 20,'won','Won','Won','Won','Won'], 
        [ NULL , 20,'short_form','Short Form','Short Form','Short Form','Short Form'], 
        [ NULL , 20,'unit_manage','Unit Manage','Unit Manage','Unit Manage','Unit Manage'], 
        [ NULL , 20,'brand_manage','Brand Manage','Brand Manage','Brand Manage','Brand Manage'], 
        [ NULL , 20,'manage','Manage','Manage','Manage','Manage'], 
        [ NULL , 20,'brand','Brand','Brand','Brand','Brand'], 
        [ NULL , 20,'make','Make','Make','Make','Make'], 
        [ NULL , 20,'id','id','id','id','id'], 
        [ NULL , 20,'Married','Married','Married','Married','Married'], 
        [ NULL , 20,'Unmarried','Unmarried','Unmarried','Unmarried','Unmarried'], 
        [ NULL , 20,'accounts_name','Accounts Name','Accounts Name','Accounts Name','Accounts Name'], 

        [ NULL , 20,'shipping_tracking_number','Shipping Tracking Number','Shipping Tracking Number','Shipping Tracking Number','Shipping Tracking Number'],
        [ NULL , 20,'shipping_mode','Shipping Mode','Shipping Mode','Shipping Mode','Shipping Mode'],

        [ NULL , 20,'destination','Destination','Destination','Destination','Destination'],
        [ NULL , 20,'tenders','Tenders','Tenders','Tenders','Tenders'],
        [ NULL , 20,'lowest_bidder','Lowest Bidder','Lowest Bidder','Lowest Bidder','Lowest Bidder'],
        [ NULL , 20,'user_activities','User Activities','User Activities','User Activities','User Activities'],
        [ NULL , 20,'work_orders','Work Orders','Work Orders','Work Orders','Work Orders'],
        [ NULL , 20,'enlisted_suppliers','Enlisted Suppliers','Enlisted Suppliers','Enlisted Suppliers','Enlisted Suppliers'],
        [ NULL , 20,'contact_person','Contact Person','Contact Person','Contact Person','Contact Person'],
        [ NULL , 20,'inspecting_departments','Inspecting Departments','Inspecting Departments','Inspecting Departments','Inspecting Departments'],
        [ NULL , 20,'end_user_name','End User Name','End User Name','End User Name','End User Name'],
        [ NULL , 20,'ticket_system','Ticket','Ticket','Ticket','Ticket'],
        [ NULL , 20,'ticket_category','Category','Category','Category','Category'],
        [ NULL , 20,'ticket_comment','Comment','Comment','Comment','Comment'],
        [ NULL , 20,'ticket_priority','Priority','Priority','Priority','Priority'],
        [ NULL , 20,'category_list','Category List','Category List','Category List','Category List'],
        [ NULL , 20,'ticket_list','Ticket List','Ticket List','Ticket List','Ticket List'],
        [ NULL , 20,'priority_list','Priority List','Priority List','Priority List','Priority List'],
        [ NULL , 20,'add_category','Add Category','Add Category','Add Category','Add Category'],
        [ NULL , 20,'add_ticket','Add Ticket','Add Ticket','Add Ticket','Add Ticket'],
        [ NULL , 20,'add_priority','Add Priority','Add Priority','Add Priority','Add Priority'], 
        [ NULL , 20,'comment_reply','Reply','Reply','Reply','Reply'], 
        [ NULL , 20, 'Sell','Sell','Sell','Sell','Sell'], 
        [ NULL , 20, 'Footer','Footer','Footer','Footer','Footer'], 
        [ Null , 7 ,'cash_issue',' Cash Issue',' Cash Issue',' Cash Issue',' Cash Issue '], 
        [ NULL , 20,'select','Select','Select','Select','Select'],
        [ NULL , 7 ,'cash_issue','Cash Issue',' Cash Issue',' Cash Issue',' Cash Issue '],
        [ NULL , 7 ,'advance_salary','Advance Salary','Advance Salary','Advance Salary','Advance Salary'],
        [ NULL , 7 ,'loan','Loan','Loan','Loan','Loan'],
        [ NULL , 7 ,'deduct','Deduct','Deduct','Deduct','Deduct'],
        [ NULL , 7 ,'contarct','contarct','contarct','contarct','contarct'],
        [ NULL , 7 ,'advance','Advance','Advance','Advance','Advance'], 
        [ NULL , 7 ,'quotations','Quotations','Quotations','Quotations','Quotations'], 
        [ NULL , 7 ,'quotation','Quotation','Quotation','Quotation','Quotation'], 
        [ NULL , 7 ,'quotation_type','Quotation Type','Quotation Type','Quotation Type','Quotation Type'], 
        [ NULL , 7 ,'sign_up','Sign up','Sign up','Sign up','Sign up'], 
        [ NULL , 7 ,'login','Login','Login','Login','Login'], 
        [ NULL , 7 ,'profile','Profile','Profile','Profile','Profile'],
        [ NULL , 7 ,'task','Task','Task','Task','Task'],
        [ NULL , 7 ,'recurring','recurring','recurring','recurring','recurring'],
        [ NULL , 7 ,'cycle','cycle','cycle','cycle','cycle'],
        [ NULL , 7 ,'Monthly','Monthly','Monthly','Monthly','Monthly'],
        [ NULL , 7 ,'Quarterly','Quarterly','Quarterly','Quarterly','Quarterly'],
        [ NULL , 7 ,'Semi','Semi','Semi','Semi','Semi'],
        [ NULL , 7 ,'Annually','Annually','Annually','Annually','Annually'],
        [ NULL , 7 ,'member','Member','Member','Member','Member'],
        [ NULL , 7 ,'petty_cash','Petty Cash','Petty Cash','Petty Cash','Petty Cash'],
        [ NULL , 7 ,'remaining_balance','Remaining Balance','Remaining Balance','Remaining Balance','Remaining Balance'],
        [ NULL , 7 ,'details_report','Details Report','Details Report','Details Report','Details Report'],
        [ NULL , 7 ,'invoice','Invoice','Invoice','Invoice','Invoice'],
        [ NULL , 7 ,'statement','Statement','Statement','Statement','Statement'],
        [ NULL , 7 ,'ledger','Ledger','Ledger','Ledger','Ledger'],
        [ NULL , 7 ,'created','Created','Created','Created','Created'],
        [ NULL , 7 ,'closing','Closing','Closing','Closing','Closing'],
        [ NULL , 7 ,'old','old','old','old','old'],
        [ NULL , 7 ,'Payslip_for_the_period_of','Payslip for the period of','Payslip for the period of','Payslip for the period of','Payslip for the period of'],
        [ NULL , 7 ,'sales','Sales','Sales','Sales','Sales'],
        [ NULL , 7 ,'Contract','Contract','Contract','Contract','Contract'],
        [ NULL , 7 ,'sale','Sale','Sale','Sale','Sale'],
        [ NULL , 7 ,'billing','Billing','Billing','Billing','Billing'],
        [ NULL , 7 ,'shipping','Shipping','Shipping','Shipping','Shipping'],
        [ NULL , 7 ,'investment','Investment','Investment','Investment','Investment'],
        [ NULL , 7 ,'transfer','Transfer','Transfer','Transfer','Transfer'],
        [ NULL , 7 , 'management', 'Management', 'Management', 'Management', 'Management'],
        [ NULL , 7 , 'team', 'Team', 'Team', 'Team', 'Team'],
        [ NULL , 7 , 'Are_you_sure_to_detete_this_item', 'Are you sure to detete this item', 'Are you sure to detete this item', 'Are you sure to detete this item', 'Are you sure to detete this item'],
        [ NULL , 7 , 'owner', 'Owner', 'Owner', 'Owner', 'Owner'],
        [ NULL , 7 , 'Debit_Credit_Voucher', 'Debit/Credit Voucher', 'Debit/Credit Voucher', 'Debit/Credit Voucher', 'Debit/Credit Voucher'],
        [ NULL , 7 , 'basic', 'Basic', 'Basic', 'Basic', 'Basic'],
        [ NULL , 7 , 'voucher', 'voucher', 'voucher', 'voucher', 'voucher'],
        [ NULL , 7 , 'Customer_Receiver', 'Customer/Receiver', 'Customer/Receiver', 'Customer/Receiver', 'Customer/Receiver'],
        [ NULL , 7 , 'no_', 'No.', 'No.', 'No.', 'No.'],
        [ NULL , 7 , 'no_', 'No.', 'No.', 'No.', 'No.'],
        [ NULL , 7 , 'tasks', 'Tasks', 'Tasks', 'Tasks', 'Tasks'],
        [ NULL , 7 , 'priority', 'Priority', 'Priority', 'Priority', 'Priority'],
        [ NULL , 7 , 'Responsible', 'Responsible', 'Responsible', 'Responsible', 'Responsible'],
        [ NULL , 7 , 'Online_Payment_Info_Details', 'Online Payment Info Details', 'Online Payment Info Details', 'Online Payment Info Details', 'Online Payment Info Details'],
        [ NULL , 7 , 'my', 'My', 'My', 'My', 'My'],
        [ NULL , 7 , 'Generated_By', 'Generated By', 'Generated By', 'Generated By', 'Generated By'],
        [ NULL , 7 , 'Low', 'Low', 'Low', 'Low', 'Low'],
        [ NULL , 7 , 'Medium', 'Medium', 'Medium', 'Medium', 'Medium'],
        [ NULL , 7 , 'High', 'High', 'High', 'High', 'High'],
        [ NULL , 7 , 'Sell_Details', 'Sell Details', 'Sell Details', 'Sell Details', 'Sell Details'],
        [ NULL , 7 , 'Permission_For', 'Permission For', 'Permission For', 'Permission For', 'Permission For'],
        [ NULL , 7 , 'marital', 'Marital', 'Marital', 'Marital', 'Marital'],
        [ NULL , 7 , 'Addresses', 'Addresses', 'Addresses', 'Addresses', 'Addresses'],
        [ NULL , 7 , 'ongoing', 'Ongoing', 'Ongoing', 'Ongoing', 'Ongoing'],
        [ NULL , 7 , 'Attachment', 'Attachment', 'Attachment', 'Attachment', 'Attachment'],
        [ NULL , 7 , 'confirm', 'Confirm', 'Confirm', 'Confirm', 'Confirm'],
        [ NULL , 7 , 'received_by', 'received by', 'received by', 'received by', 'received by'],
        [ NULL , 7 , 'received', 'Received', 'Received', 'Received', 'Received'],
        [ NULL , 7 , 'change', 'Change', 'Change', 'Change', 'Change'],
        [ NULL , 7 , 'document', 'Document', 'Document', 'Document', 'Document'],
        [ NULL , 7 , 'close', 'Close', 'Close', 'Close', 'Close'],
        [ NULL , 7 , 'Through', 'Through', 'Through', 'Through', 'Through'],
        [ NULL , 7 , 'Authorized', 'Authorized', 'Authorized', 'Authorized', 'Authorized'],
        [ NULL , 7 , 'Accountant', 'Accountant', 'Accountant', 'Accountant', 'Accountant'],
        [ NULL , 7 , 'Debit', 'Debit', 'Debit', 'Debit', 'Debit'],
        [ NULL , 7 , 'Driving_License ', 'Driving License ', 'Driving License ', 'Driving License ', 'Driving License '],
        [ NULL , 7 , 'You_can_view_ticket', 'You can view the ticket at any time at', 'You can view the ticket at any time at', 'You can view the ticket at any time at', 'You can view the ticket at any time at'],
        [ NULL , 7 , 'Terms', 'Terms', 'Terms', 'Terms', 'Terms'],
        [ NULL , 7 , ' ticket_is_created', 'This is the email that will be sent to the user once a ticket is created', 'This is the email that will be sent to the user once a ticket is created', 'This is the email that will be sent to the user once a ticket is created', 'This is the email that will be sent to the user once a ticket is created'],
        [ NULL , 7 , 'Created_on', 'Created on', 'Created on', 'Created on', 'Created on'],
        [ NULL , 7 , 'date', 'date', 'date', 'date', 'date'],
        [ NULL , 7 , 'cheque_issue_Date', 'cheque issue Date', 'cheque issue Date', 'cheque issue Date', 'cheque issue Date'],
        [ NULL , 7 , 'Cheque', 'Cheque', 'Cheque', 'Cheque', 'Cheque'],
        [ NULL , 7 , 'cancel_record', 'You are about to cancel the record. This cannot be undone. are you sure', 'You are about to cancel the record. This cannot be undone. are you sure', 'You are about to cancel the record. This cannot be undone. are you sure', 'You are about to cancel the record. This cannot be undone. are you sure'],
        [ NULL , 7 , 'year', 'year', 'year', 'year', 'year'],
        [ NULL , 7 , 'Item_Sell_list', 'Item Sell list', 'Item Sell list', 'Item Sell list', 'Item Sell list'],
        [ NULL , 7 , 'Item', 'Item', 'Item', 'Item', 'Item'],
        [ NULL , 7 , 'Issue_Item', 'Issue Item', 'Issue Item', 'Issue Item', 'Issue Item'],
        [ NULL , 7 , 'No', 'No', 'No', 'No', 'No'],
        [ NULL , 7 , 'table', 'table', 'table', 'table', 'table'],
        [ NULL , 7 , 'Leave_Status', 'Leave Status', 'Leave Status', 'Leave Status', 'Leave Status'],
        [ NULL , 7 , 'Are_to_return_this_amount', 'Are you sure to return this amount', 'Are you sure to return this amount', 'Are you sure to return this amount', 'Are you sure to return this amount'],
        [ NULL , 7 , 'Field', 'Field', 'Field', 'Field', 'Field'],
        [ NULL , 7 , 'PARTIALLY', 'PARTIALLY', 'PARTIALLY', 'PARTIALLY', 'PARTIALLY'],
        [ NULL , 7 , 'TAX_VAT_GST', 'TAX/VAT/GST', 'TAX/VAT/GST', 'TAX/VAT/GST', 'TAX/VAT/GST'],
        [ NULL , 7 , 'number', 'number', 'number', 'number', 'number'],
        [ NULL , 7 , 'No_Payroll_Data', 'No Payroll Data', 'No Payroll Data', 'No Payroll Data', 'No Payroll Data'],
        [ NULL , 7 , 'Part', 'Part', 'Part', 'Part', 'Part'],
        [ NULL , 7 , 'New_Product_Details', 'New Product Details', 'New Product Details', 'New Product Details', 'New Product Details'],
        [ NULL , 7 , 'Yes', 'Yes', 'Yes', 'Yes', 'Yes'],
        [ NULL , 7 , 'settting', 'settting', 'settting', 'settting', 'settting'],
        [ NULL , 7 , 'Ticket', 'Ticket', 'Ticket', 'Ticket', 'Ticket'],
        [ NULL , 7 , 'Support', 'Support', 'Support', 'Support', 'Support'],
        [ NULL , 7 , 'Thank_you', 'Thank you', 'Thank you', 'Thank you', 'Thank you'],
        [ NULL , 7 , 'for_contacting_our_support_team', 'for contacting our support team. A support ticket has been opened for you. You will be notified when a response is made by email. The details of your ticket are shown below', 'for contacting our support team. A support ticket has been opened for you. You will be notified when a response is made by email. The details of your ticket are shown below', 'for contacting our support team. A support ticket has been opened for you. You will be notified when a response is made by email. The details of your ticket are shown below', 'for contacting our support team'],
        [ NULL , 7 , 'prefix', 'prefix', 'prefix', 'prefix', 'prefix'],
        [ NULL , 7 , 'Bill_To', 'Bill To', 'Bill To', 'Bill To', 'Bill To'],
        [ NULL , 7 , 'After', 'After', 'After', 'After', 'After'],
        [ NULL , 7 , 'before', 'Before', 'Before', 'Before', 'Before'],
        [ NULL , 7 , 'Shipped_On', 'Shipped On', 'Shipped On', 'Shipped On', 'Shipped On'],
        [ NULL , 7 , 'notes', 'notes', 'notes', 'notes', 'notes'],
        [ NULL , 7 , 'Delivered_On', 'Delivered On', 'Delivered On', 'Delivered On', 'Delivered On'],
        [ NULL , 7 , 'Private', 'Private', 'Private', 'Private', 'Private'],
        [ NULL , 7 , 'Inspection_Completed_On', 'Inspection Completed On', 'Inspection Completed On', 'Inspection Completed On', 'Inspection Completed On'],
        [ NULL , 7 , 'QUOTATION_Completed_On', 'QUOTATION Completed On', 'QUOTATION Completed On', 'QUOTATION Completed On', 'QUOTATION Completed On'],
        [ NULL , 7 , 'Credit', 'Credit', 'Credit', 'Credit', 'Credit'],
        [ NULL , 7 , 'client', 'Client', 'Client', 'Client', 'Client'],
        [ NULL , 7 , 'setting', 'Setting', 'Setting', 'Setting', 'Setting'],
        [ NULL , 7 , 'Mode_of_Payment', 'Mode of Payment', 'Mode of Payment', 'Mode of Payment', 'Mode of Payment'],
        [ NULL , 7 , 'users', 'Users', 'Users', 'Users', 'Users'],
        [ NULL , 7 , 'approve', 'Approve', 'Approve', 'Approve', 'Approve'],
        [ NULL , 7 , ' In_Active', ' In Active', ' In Active', ' In Active', ' In Active'],
        [ NULL , 7 , 'meter', 'Meter', 'Meter', 'Meter', 'Meter'],
        [ NULL , 7 , 'Centimeter', 'Centimeter', 'Centimeter', 'Centimeter', 'Centimeter'],
        [ NULL , 7 , 'Millimeter', 'Millimeter', 'Millimeter', 'Millimeter', 'Millimeter'],
        [ NULL , 7 , 'Kilogram', 'Kilogram', 'Kilogram', 'Kilogram', 'Kilogram'],
        [ NULL , 7 , 'To_Do', 'To Do', 'To Do', 'To Do', 'To Do'],
        [ NULL , 7 , 'Recent_project', 'Recent project', 'Recent project', 'Recent project', 'Recent project'],
        [ NULL , 7 , 'time_zone', 'Time Zone', 'Time Zone', 'Time Zone', 'Time Zone'],
        [ NULL , 7 , 'Recent_Upcoming_Tenders', 'Recent Upcoming Tenders', 'Recent Upcoming Tenders', 'Recent Upcoming Tenders', 'Recent Upcoming Tenders'],
        [ NULL , 7 , 'Running_Projects', 'Running Projects', 'Running Projects', 'Running Projects', 'Running Projects'],
        [ NULL , 7 , 'Complete_Projects', 'Complete Projects', 'Complete Projects', 'Complete Projects', 'Complete Projects'],
        [ NULL , 7 , 'Work_Orders_This_Year', 'Work Orders This Year', 'Work Orders This Year', 'Work Orders This Year', 'Work Orders This Year'],
        [ NULL , 7 , 'Yearly_Work_Order', 'Yearly Work Order', 'Yearly Work Order', 'Yearly Work Order', 'Yearly Work Order'],
        [ NULL , 7 , 'Tenders_Won_This_Year', 'Tenders Won This Year', 'Tenders Won This Year', 'Tenders Won This Year', 'Tenders Won This Year'],
        [ NULL , 7 , 'Yearly_Won_Tenders', 'Yearly Won Tenders', 'Yearly Won Tenders', 'Yearly Won Tenders', 'Yearly Won Tenders'],
        [ NULL , 7 , 'Completed_Tenders', 'Completed Tenders', 'Completed Tenders', 'Completed Tenders', 'Completed Tenders'],
        [ NULL , 7 , 'Work_Orders', 'Work Orders', 'Work Orders', 'Work Orders', 'Work Orders'],
        [ NULL , 7 , 'Tenders_Won', 'Tenders Won', 'Tenders Won', 'Tenders Won', 'Tenders Won'],
        [ NULL , 7 , 'Upcoming_Tenders', 'Upcoming Tenders', 'Upcoming Tenders', 'Upcoming Tenders', 'Upcoming Tenders'],
        [ NULL , 7 , 'Task_Not_Assigned', 'Task Not Assigned', 'Task Not Assigned', 'Task Not Assigned', 'Task Not Assigned'],
        [ NULL , 7 , 'projects', 'Projects', 'Projects', 'Projects', 'Projects'],
        [NULL, 7, 'Prefix', 'prefix', 'prefix', 'prefix', 'prefix'],
        [ NULL , 7 , 'teams', 'Teams', 'Teams', 'Teams', 'Teams'],
        [ NULL , 7 , 'Activated', 'Activated', 'Activated', 'Activated', 'Activated'],
        [ NULL , 7 , 'Make_Default', 'Make Default', 'Make Default', 'Make Default', 'Make Default'],
        [ NULL , 7 , 'reccuring', 'Reccuring', 'Reccuring', 'Reccuring', 'Reccuring'],
        [ NULL , 7 , 'manage_currency', 'Manage currency', 'Manage currency', 'Manage currency', 'Manage currency'],
        [ NULL , 7 , 'Daily_Expense', 'Daily Expense', 'Daily Expense', 'Daily Expense', 'Daily Expense'],
        [ NULL , 17 , 'mail', 'Mail', 'Mail', 'Mail', 'Mail'],
        [ NULL , 17 , 'host', 'Host', 'Host', 'Host', 'Host'],
        [ NULL , 17 , 'encryption', 'Encryption', 'Encryption', 'Encryption', 'Encryption'],
        [ NULL , 13,'suppliers','Suppliers',' Suppliers','Suppliers','সরবরাহকারী'],
    ];
